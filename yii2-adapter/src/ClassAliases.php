...
class ClassAliases
{
    ...
    public function register(): void
    {
        ...
        class_alias(\CraftCms\Cms\Element\Queries\Concerns\QueriesNestedElements::class, \craft\elements\db\NestedElementQueryTrait::class);
        ...
        class_alias(\CraftCms\Cms\Element\Queries\AddressQuery::class, \craft\elements\db\AddressQuery::class);
        class_alias(\CraftCms\Cms\Element\Queries\AssetQuery::class, \craft\elements\db\AssetQuery::class);
        class_alias(\CraftCms\Cms\Element\Queries\ContentBlockQuery::class, \craft\elements\db\ContentBlockQuery::class);
        class_alias(\CraftCms\Cms\Element\Queries\ElementQuery::class, ElementQuery::class);
        class_alias(\CraftCms\Cms\Element\Queries\EntryQuery::class, \craft\elements\db\EntryQuery::class);
        class_alias(\CraftCms\Cms\Element\Queries\UserQuery::class, \craft\elements\db\UserQuery::class);
        class_alias(\CraftCms\Cms\Element\Queries\Exceptions\ElementNotFoundException::class, ElementNotFoundException::class);
        class_alias(\CraftCms\Yii2Adapter\Element\Queries\CategoryQuery::class, \craft\elements\db\CategoryQuery::class);
        class_alias(\CraftCms\Yii2Adapter\Element\Queries\GlobalSetQuery::class, \craft\elements\db\GlobalSetQuery::class);
        class_alias(\CraftCms\Yii2Adapter\Element\Queries\TagQuery::class, \craft\elements\db\TagQuery::class);

...
/** @deprecated 6.0.0 Use \CraftCms\Cms\User\Conditions\AffiliatedSiteConditionRule instead. */
class AffiliatedSiteConditionRule extends \CraftCms\Cms\User\Conditions\AffiliatedSiteConditionRule
{
    ...
    public function getConfig(): array
    {
        ...
        if (static::class === self::class) {
            $config['class'] = \CraftCms\Cms\User\Conditions\AffiliatedSiteConditionRule::class;
        }

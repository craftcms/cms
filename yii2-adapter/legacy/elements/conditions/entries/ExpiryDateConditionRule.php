...
/** @deprecated 6.0.0 Use \CraftCms\Cms\Entry\Conditions\ExpiryDateConditionRule instead. */
class ExpiryDateConditionRule extends \CraftCms\Cms\Entry\Conditions\ExpiryDateConditionRule
{
    ...
    public function getConfig(): array
    {
        ...
        if (static::class === self::class) {
            $config['class'] = \CraftCms\Cms\Entry\Conditions\ExpiryDateConditionRule::class;
        }

...
class GeneralConfig extends \CraftCms\Cms\Config\GeneralConfig
{
    ...
    /**
     * @var string The domain that cookies generated by Craft should be created for.
     *
     * @deprecated 6.0.0. Configure `session.domain` or set the `SESSION_DOMAIN` environment variable instead.
     */
    public string $defaultCookieDomain = '';

    /**
     * @var mixed The amount of time a user stays logged in when “Remember Me” is checked.
     *
     * @deprecated 6.0.0. Configure `auth.guards.craft.remember` instead.
     */
     ...
     *
     * @deprecated 6.0.0. Configure `auth.passwords.craft.expire` instead.
     */
    ...
    public function init(): void
    {
        ...
        $this->rememberedUserSessionDuration($this->rememberedUserSessionDuration);
        $this->verificationCodeDuration($this->verificationCodeDuration);
     ...
     * @deprecated 6.0.0. Configure `session.domain` or set the `SESSION_DOMAIN` environment variable instead.
     */
    #[Deprecated(message: 'in 6.0.0. Configure `session.domain` or set the `SESSION_DOMAIN` environment variable instead.')]
    public function defaultCookieDomain(string $value): self
    {
        $this->defaultCookieDomain = $value;

        app()->booting(function() use ($value) {
            Deprecator::log('generalConfig.defaultCookieDomain', 'Calling defaultCookieDomain() is deprecated. Configure `session.domain` or set the `SESSION_DOMAIN` environment variable instead.');
            ConfigFacade::set('session.domain', $value);
        });
    ...
    /**
     * The amount of time a user stays logged in when “Remember Me” is checked.
     *
     * @deprecated 6.0.0. Configure `auth.guards.craft.remember` instead.
     */
    #[Deprecated(message: 'in 6.0.0. Configure `auth.guards.craft.remember` instead.')]
    public function rememberedUserSessionDuration(mixed $value): self
    {
        ...
        app()->booting(function() {
            Deprecator::log('generalConfig.rememberedUserSessionDuration', 'Calling rememberedUserSessionDuration() is deprecated. Configure `auth.guards.craft.remember` instead.');
            ConfigFacade::set('auth.guards.craft.remember', floor($this->rememberedUserSessionDuration / 60));
        });
     ...
     * @deprecated 6.0.0. Configure `auth.passwords.craft.expire` instead.
     */
    #[Deprecated(message: 'in 6.0.0. Configure `auth.passwords.craft.expire` instead.')]

...
it('resolves legacy icon paths through Craft', function(string $alias, string $path) {
    ...
    'icons root' => ['@icons', ''],
    'explicit family' => ['@icons/brands/github.svg', 'brands/github.svg'],
    'app icons root' => ['@appicons', 'solid'],
    'family-neutral icon' => ['@appicons/github.svg', 'brands/github.svg'],
    'old app icon form' => ['@app/icons/github.svg', 'brands/github.svg'],

...
- Fixed a bug where incorrect source set would be returned for Assets that had a named transform set on them. ([#7352](https://github.com/craftcms/cms/issues/7352))

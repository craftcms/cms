...
- Fixed an error where it was sometimes impossible to use the public GraphQL schema on installations where admin changes were disabled. ([#7925](https://github.com/craftcms/cms/issues/7925))

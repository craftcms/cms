...
- Fixed a bug where users would get one extra try to login added to whatever the [maxInvalidLogins](https://craftcms.com/docs/config-settings#maxInvalidLogins) config setting was set to.

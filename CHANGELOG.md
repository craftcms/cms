...
- Fixed a bug where the quality setting was being ignored for all transforms that were not in either jpg or png format. ([#6629](https://github.com/craftcms/cms/issues/6629))

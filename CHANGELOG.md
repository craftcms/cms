...
- Timestamps that show the week day name are now always translated using the application language, even if the formatting locale is different. ([#7312](https://github.com/craftcms/cms/issues/7312))

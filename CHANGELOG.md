...
- Fixed a bug where replacing an asset file from the dedicated edit page would seem to not take effect until refreshing the page. ([#9700](https://github.com/craftcms/cms/issues/9700))

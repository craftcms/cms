...
- Fixed an error that could occur when upgrading to Craft 5 if the database user didn’t have permission to disable foreign key constraints. ([#15063](https://github.com/craftcms/cms/issues/15063))

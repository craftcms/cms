...
class ImageHelperTest extends TestCase
{
    ...
    {
        return [
            'crop1' => [200, 100, 600, 400, 200, 100, 'crop', null, true],
            'crop2' => [200, 100, 60, 40, 200, 100, 'crop', null, true],
            'crop3' => [200, 133, 60, 40, 200, null, 'crop', null, true],
            'crop4' => [150, 100, 60, 40, null, 100, 'crop', null, true],
            'crop5' => [60, 30, 60, 40, 200, 100, 'crop', null, false],
            'crop6' => [200, 100, 80, 40, 200, 100, 'crop', null, true],
            'crop7' => [80, 40, 80, 40, 200, 100, 'crop', null, false],
            'crop8' => [200, 100, 400, 600, 200, 100, 'crop', null, true],
            'crop9' => [200, 100, 40, 60, 200, 100, 'crop', null, true],
            'crop10' => [40, 20, 40, 60, 200, 100, 'crop', null, false],

            // https://github.com/craftcms/cms/issues/11837#issuecomment-1249186697
            'crop11' => [1280, 720, 3600, 2400, 1280, 720, 'crop', null, false],

            'stretch1' => [200, 100, 600, 400, 200, 100, 'stretch', null, true],
            'stretch2' => [200, 100, 60, 40, 200, 100, 'stretch', null, true],
            'stretch3' => [200, 133, 60, 40, 200, null, 'stretch', null, true],
            'stretch4' => [150, 100, 60, 40, null, 100, 'stretch', null, true],
            'stretch5' => [60, 30, 60, 40, 200, 100, 'stretch', null, false],
            'stretch6' => [200, 100, 80, 40, 200, 100, 'stretch', null, true],
            'stretch7' => [80, 40, 80, 40, 200, 100, 'stretch', null, false],
            'stretch8' => [200, 100, 400, 600, 200, 100, 'stretch', null, true],
            'stretch9' => [200, 100, 40, 60, 200, 100, 'stretch', null, true],
            'stretch10' => [40, 20, 40, 60, 200, 100, 'stretch', null, false],

            'fit1' => [150, 100, 600, 400, 200, 100, 'fit', null, true],
            'fit2' => [150, 100, 60, 40, 200, 100, 'fit', null, true],
            'fit3' => [200, 133, 60, 40, 200, null, 'fit', null, true],
            'fit4' => [150, 100, 60, 40, null, 100, 'fit', null, true],
            'fit5' => [60, 40, 60, 40, 200, 100, 'fit', null, false],
            'fit6' => [200, 100, 80, 40, 200, 100, 'fit', null, true],
            'fit7' => [80, 40, 80, 40, 200, 100, 'fit', null, false],
            'fit8' => [67, 100, 400, 600, 200, 100, 'fit', null, true],
            'fit9' => [67, 100, 40, 60, 200, 100, 'fit', null, true],
            'fit10' => [40, 60, 40, 60, 200, 100, 'fit', null, false],

            // https://github.com/craftcms/cms/issues/12023
            'fit11' => [160, 240, 240, 360, 240, 240, 'fit', null, false],
            'fit12' => [240, 160, 360, 240, 240, 240, 'fit', null, false],
            'fit13' => [160, 240, 240, 360, 240, 240, 'fit', null, true],
            'fit14' => [240, 160, 360, 240, 240, 240, 'fit', null, true],

            'fill no upscale' => [200, 400, 100, 200, 200, 400, 'fit', '#ff0000', false],
            'fill differing ratios' => [400, 400, 300, 400, 400, 400, 'fit', '#ff0000', false],
            'fill with upscale' => [200, 400, 100, 200, 200, 400, 'fit', '#ff0000', true],

            'crop with fill' => [200, 400, 400, 800, 200, 400, 'crop', '#ff0000', true],
        ];
    }

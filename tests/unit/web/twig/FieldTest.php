...
TWIG;
        ...
        $this->assertStringContainsString('<p id="foo-tip" class="notice with-icon">TEST TIP</p>', $html);
        $this->assertStringContainsString('<p id="foo-warning" class="warning with-icon">TEST WARNING</p>', $html);

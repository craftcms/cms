...
class MatrixTest extends TestCase
{
     ...
     */
    public function test_nested_element_manager_view_mode_uses_defined_entry_types(string $viewMode, bool $rendersEntries): void
    {
        $owner = new Entry([
            'id' => 999999,
            'sectionId' => 1013,
     ...
     * @dataProvider nestedElementManagerViewModeDataProvider
     */
    public function test_nested_element_manager_view_mode_uses_all_entry_types_without_handlers(string $viewMode): void
    {
        $owner = new Entry([
            'id' => 999999,
            'sectionId' => 1013,

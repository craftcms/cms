...
class TypeResolverTest extends TestCase
{
    ...
    public function testRunGqlResolveTest(): void
    {
        ...
        $data = [
            ...
            [Entry::class, ['title' => 'Theories of life multi-author', 'authorIds' => [1, 2, 3]], EntryResolver::class],
            [Entry::class, ['title' => 'Theories of life multi-author', 'authorIds' => [1, 2]], EntryResolver::class, true],

...
class __TwigTemplate_37e130d015758293183646f4353ff59d extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        // line 1
        yield "<div id=\"queue-manager-utility\" class=\"hidden\">
    <div v-if=\"activeJob\" class=\"readable\">
        ...
        <template v-if=\"activeJob.job\">
            ...
            <h4>";
        // line 30
        yield $this->env->getRuntime(\Twig\Runtime\EscaperRuntime::class)->escape($this->extensions['craft\web\twig\Extension']->translateFilter('Job Data', 'app'), 'html', null, true);
        yield '</h4>
    ...
    <template v-else-if="!loading">
                ...
                <table class="data fullwidth" v-if="jobs.length > 0 && !activeJob">
                    <thead>
                        <tr>
                            <th scope="col">';
        // line 40
        yield $this->env->getRuntime(\Twig\Runtime\EscaperRuntime::class)->escape($this->extensions['craft\web\twig\Extension']->translateFilter('Job', 'app'), 'html', null, true);
        yield '</th>
                            <th scope="col">';
        // line 41
        ...
        yield '</th>
                            <th scope="col">';
        // line 42
        yield $this->env->getRuntime(\Twig\Runtime\EscaperRuntime::class)->escape($this->extensions['craft\web\twig\Extension']->translateFilter('Progress', 'app'), 'html', null, true);
        yield '</th>
                        ...
                        <tr v-for="job in jobs">
                            ...
                            <td>
                                <button type="button" v-if="isRetryable(job)" class="btn small" data-icon="play" @click="retryJob(job)">
                                    <template v-if="job.status == 2">';
        // line 61
        yield $this->env->getRuntime(\Twig\Runtime\EscaperRuntime::class)->escape($this->extensions['craft\web\twig\Extension']->translateFilter('Restart', 'app'), 'html', null, true);
        yield '</template>
                                    <template v-else>';
        // line 62
        ...
        // line 66
        yield $this->env->getRuntime(\Twig\Runtime\EscaperRuntime::class)->escape($this->extensions['craft\web\twig\Extension']->translateFilter('Release', 'app'), 'html', null, true);
        yield '" aria-label="';
        yield $this->env->getRuntime(\Twig\Runtime\EscaperRuntime::class)->escape($this->extensions['craft\web\twig\Extension']->translateFilter('Release', 'app'), 'html', null, true);
        yield '" role="button" @click="releaseJob(job)"></a>
                            </td>
                        </tr>
                    </tbody>
                </table>
        ...
        <div v-else class="zilch">
            <p>';
        // line 74
        yield $this->env->getRuntime(\Twig\Runtime\EscaperRuntime::class)->escape($this->extensions['craft\web\twig\Extension']->translateFilter('No pending jobs.', 'app'), 'html', null, true);
        yield '</p>
        </div>
    </template>
</div>
';
    ...
    {
        return [141 => 74,  128 => 66,  121 => 62,  117 => 61,  95 => 42,  91 => 41,  87 => 40,  74 => 30,  43 => 1];
    }
...
", '_components/utilities/QueueManager/content.twig', '/tmp/packages/craft5/src/templates/_components/utilities/QueueManager/content.twig');
    }
}

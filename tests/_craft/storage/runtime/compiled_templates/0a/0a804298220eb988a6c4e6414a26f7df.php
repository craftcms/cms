...
/* _elements/toolbar */
class __TwigTemplate_ede5ee974f752d170ac64491f97472bb extends Template
{
    private $source;
...
';
        ...
        <button id="';
            ...
            echo 'status-label" type="button" class="btn menubtn statusmenubtn">
            ';
            // line 26
            echo $this->extensions['craft\web\twig\ComponentExtension']->render('status-indicator', ['status' => 'all']);
        ...
        <div class="menu">
            ...
            // line 35
            if ((isset($context['showStatusMenu']) || array_key_exists('showStatusMenu', $context) ? $context['showStatusMenu'] : (function () {
                throw new RuntimeError('Variable "showStatusMenu" does not exist.', 35, $this->source);
            })())) {
                // line 36
                echo '                    ';
                ...
                $context['_seq'] = twig_ensure_traversable(craft\helpers\Template::attribute($this->env, $this->source, (isset($context['elementInstance']) || array_key_exists('elementInstance', $context) ? $context['elementInstance'] : (function () {
                    throw new RuntimeError('Variable "elementInstance" does not exist.', 36, $this->source);
                })()), 'statuses', [], 'method'));
                foreach ($context['_seq'] as $context['status'] => $context['info']) {
                    ...
                    $context['color'] = (($this->env->getTest('instance of')->getCallable()((isset($context['color']) || array_key_exists('color', $context) ? $context['color'] : (function () {
                        throw new RuntimeError('Variable "color" does not exist.', 39, $this->source);
                    ...
                    echo '">
                                ';
                    // line 42
                    echo $this->extensions['craft\web\twig\ComponentExtension']->render('status-indicator', ['status' => $context['status'], 'color' => (isset($context['color']) || array_key_exists('color', $context) ? $context['color'] : (function () {
                        throw new RuntimeError('Variable "color" does not exist.', 42, $this->source);
                    })())]);
                    echo twig_escape_filter($this->env, (isset($context['label']) || array_key_exists('label', $context) ? $context['label'] : (function () {
                        throw new RuntimeError('Variable "label" does not exist.', 42, $this->source);
                    })()), 'html', null, true);
                    echo '
                            </a>
                        </li>
            ...
            if ((isset($context['isAdministrative']) || array_key_exists('isAdministrative', $context) ? $context['isAdministrative'] : (function () {
                throw new RuntimeError('Variable "isAdministrative" does not exist.', 48, $this->source);
            })())) {
                // line 49
                echo '                ';
                if ((isset($context['showStatusMenu']) || array_key_exists('showStatusMenu', $context) ? $context['showStatusMenu'] : (function () {
                    throw new RuntimeError('Variable "showStatusMenu" does not exist.', 49, $this->source);
                })())) {
                ...
                if ((($context['canHaveDrafts']) ?? (false))) {
                    // line 52
                    echo '                        <li><a data-drafts>';
                    echo $this->extensions['craft\web\twig\ComponentExtension']->render('status-indicator', ['status' => 'draft']);
                    echo twig_escape_filter($this->env, $this->extensions['craft\web\twig\Extension']->translateFilter('Drafts', 'app'), 'html', null, true);
                    echo '</a></li>
                    ';
                }
                // line 54
                echo '                    <li><a data-trashed>';
                echo $this->extensions['craft\web\twig\ComponentExtension']->render('status-indicator', ['status' => 'trashed']);
...
';
        ...
        // line 60
        if ((isset($context['showSiteMenu']) || array_key_exists('showSiteMenu', $context) ? $context['showSiteMenu'] : (function () {
            throw new RuntimeError('Variable "showSiteMenu" does not exist.', 60, $this->source);
        })())) {
            // line 61
            echo '    ';
            $this->loadTemplate('_elements/sitemenu', '_elements/toolbar', 61)->display($context);
        }
        // line 63
    ...
    ';
        ...
        echo twig_call_macro($macros['__internal_parse_1'], 'macro_text', [['class' => 'clearable', 'placeholder' => $this->extensions['craft\web\twig\Extension']->translateFilter('Search', 'app'), 'value' => craft\helpers\Template::attribute($this->env, $this->source, craft\helpers\Template::attribute($this->env, $this->source, craft\helpers\Template::attribute($this->env, $this->source,         // line 68
            (isset($context['craft']) || array_key_exists('craft', $context) ? $context['craft'] : (function () {
                throw new RuntimeError('Variable "craft" does not exist.', 68, $this->source);
            })()), 'app', []), 'request', []), 'getParam', [0 => 'search'], 'method'), 'inputAttributes' => ['aria' => ['label' => $this->extensions['craft\web\twig\Extension']->translateFilter('Search', 'app')]]]], 65, $context, $this->getSourceContext());
        // line 74
        echo '
    ';
        // line 75
...
';
    ...
    {
        return [193 => 83,  190 => 82,  188 => 75,  185 => 74,  183 => 68,  182 => 65,  178 => 63,  174 => 61,  172 => 60,  167 => 57,  159 => 54,  152 => 52,  150 => 51,  147 => 50,  142 => 49,  140 => 48,  137 => 47,  134 => 46,  123 => 42,  119 => 41,  116 => 40,  113 => 39,  110 => 38,  107 => 37,  102 => 36,  100 => 35,  93 => 32,  83 => 26,  77 => 25,  71 => 24,  68 => 23,  66 => 22,  63 => 21,  61 => 20,  57 => 18,  55 => 17,  53 => 16,  51 => 15,  49 => 14,  47 => 13,  45 => 12,  42 => 11,  40 => 3,  38 => 1];
    }
...
{% if showStatusMenu or isAdministrative %}
    <div>
        ...
        <button id=\"{{ idPrefix }}status-button\" aria-labelledby=\"{{ idPrefix }}status-label\" type=\"button\" class=\"btn menubtn statusmenubtn\">
            {{ component('status-indicator', {status: 'all'}) }}{{ \"All\"|t('app') }}
        </button>
        <div class=\"menu\">
            <ul class=\"padded\">
                <li>
            ...
            {% if isAdministrative %}
                ...
                <ul class=\"padded\">
                    {% if canHaveDrafts ?? false %}
                        <li><a data-drafts>{{ component('status-indicator', {status: 'draft'}) }}{{ 'Drafts'|t('app') }}</a></li>
                    {% endif %}
                    <li><a data-trashed>{{ component('status-indicator', {status: 'trashed'}) }}{{ \"Trashed\"|t('app') }}</a></li>
                </ul>
            {% endif %}
        </div>
    </div>

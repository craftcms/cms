...
/* _includes/links */
class __TwigTemplate_136e420bd575abe5f7902e6d3d67cfff extends Template
{
    private $source;
...
';
    ...
    public function macro_externalLinkIcon(...$__varargs__)
    {
        ...
        try {
            ...
            // line 2
            echo '    ';
            echo $this->extensions['craft\web\twig\Extension']->tagFunction('span', ['data-icon' => 'external', 'data-icon-size' => 'puny', 'role' => 'img', 'aria-label' => $this->extensions['craft\web\twig\Extension']->translateFilter('Opens in a new window', 'app')]);
            // line 7
            echo '
';
    ...
    public function macro_externalLink($__config__ = null, ...$__varargs__)
    {
        ...
        try {
            ...
            $context['linkAttributes'] = ['href' => craft\helpers\Template::attribute($this->env, $this->source,             // line 12
                (isset($context['config']) || array_key_exists('config', $context) ? $context['config'] : (function () {
                ...
                })()), 'link', []), 'target' => '_blank', 'rel' => 'noopener', 'html' => ((((craft\helpers\Template::attribute($this->env, $this->source,             // line 15
                    ...
                    })()), 'text', [])))).twig_call_macro($macros['_self'], 'macro_externalLinkIcon', [], 15, $context, $this->getSourceContext()))];
            // line 17
            echo '    ';
...
';
    ...
    {
        return [91 => 17,  89 => 15,  88 => 12,  86 => 11,  72 => 10,  61 => 7,  58 => 2,  45 => 1,  39 => 9];
    }

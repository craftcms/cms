...
test('asSize', function (string|int|float|null $input, string $output, int $sizeFormatBase = 1024, int $decimals = 3) {
    ...
    [10, '10 bytes', 1000],
    [100, '100 bytes', 1000],
    [1000, '1,000 bytes', 1000],
    [10000, '10.000 kilobytes', 1000],
    [100000, '100.000 kilobytes', 1000],
    [1000000, '1.000 megabyte', 1000],
    [10000000, '10.000 megabytes', 1000],
    [100000000, '100.000 megabytes', 1000],
    [1000000000, '1.000 gigabyte', 1000],
    [10000000000, '10.000 gigabytes', 1000],
    [100000000000, '100.000 gigabytes', 1000],
    [1000000000000, '1.000 terabyte', 1000],

    [0, '0 bytes', 1000, 0],
    [1, '1 byte', 1000, 0],
    [10, '10 bytes', 1000, 0],
    [100, '100 bytes', 1000, 0],
    [1000, '1,000 bytes', 1000, 0],
    [10000, '10 kilobytes', 1000, 0],
    [100000, '100 kilobytes', 1000, 0],
    [1000000, '1 megabyte', 1000, 0],
    [10000000, '10 megabytes', 1000, 0],
    [100000000, '100 megabytes', 1000, 0],
    [1000000000, '1 gigabyte', 1000, 0],
    [10000000000, '10 gigabytes', 1000, 0],
    [100000000000, '100 gigabytes', 1000, 0],
    [1000000000000, '1 terabyte', 1000, 0],
]);

test('asShortSize', function (string|int|float|null $input, string $output, int $sizeFormatBase = 1024, int $decimals = 3) {
    $this->formatter->sizeFormatBase = $sizeFormatBase;
    ...
    [100, '100 B', 1000],
    [1000, '1000 B', 1000],
    [10000, '10.000 KB', 1000],
    [100000, '100.000 KB', 1000],
    [1000000, '1.000 MB', 1000],
    [10000000, '10.000 MB', 1000],
    [100000000, '100.000 MB', 1000],
    [1000000000, '1.000 GB', 1000],
    [10000000000, '10.000 GB', 1000],
    [100000000000, '100.000 GB', 1000],
    [1000000000000, '1.000 TB', 1000],
    ...
    [1000, '1000 B', 1000, 0],
    [10000, '10 KB', 1000, 0],
    [100000, '100 KB', 1000, 0],
    [1000000, '1 MB', 1000, 0],
    [10000000, '10 MB', 1000, 0],
    [100000000, '100 MB', 1000, 0],
    [1000000000, '1 GB', 1000, 0],
    [10000000000, '10 GB', 1000, 0],
    [100000000000, '100 GB', 1000, 0],
    [1000000000000, '1 TB', 1000, 0],
]);

...
it('can get an entry by id', function () {
    ...
    expect($this->entries->getEntryById($entry->id))->toBeInstanceOf(\craft\elements\Entry::class);
});
...
it('can get an entry in a specific site', function () {
    ...
    expect($this->entries->getEntryById($entry->id, Site::first()->id))->toBeInstanceOf(\craft\elements\Entry::class);

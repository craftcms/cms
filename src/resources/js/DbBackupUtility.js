	...
	Craft.DbBackupUtility = Garnish.Base.extend(
		{
			...
			postActionRequest: function(params)
			{
				...
				Craft.postActionRequest('utilities/db-backup-perform-action', data, $.proxy(this, 'onActionResponse'),
					{
						complete: $.noop
					});
			},
			...
			onActionResponse: function(response, textStatus)
			{
				...
				while (this.loadingActions < Craft.DbBackupUtility.maxConcurrentActions && this.currentBatchQueue.length) {
					this.loadNextAction();
				}

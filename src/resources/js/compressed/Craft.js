...
try{localStorage[a]=JSON.stringify(b)}catch(a){}}},/**
	 ...
	 * @returns object
	 */
getElementInfo:function(b){var c=a(b);return c.hasClass("element")||(c=c.find(".element:first")),{id:c.data("id"),locale:c.data("locale"),label:c.data("label"),status:c.data("status"),url:c.data("url"),hasThumb:c.hasClass("hasthumb"),$element:c}},/**

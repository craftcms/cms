...
!function(a){"undefined"==typeof window.Craft&&(window.Craft={}),a.extend(Craft,{navHeight:48,/**
...
if("string"!=typeof b&&(b=""),-1!=b.search("://")||"//"==b.substr(0,2))return b;b=Craft.trim(b,"/");var e="";
...
var i=b.indexOf("?");-1!=i&&(c=b.substr(i+1)+(c?"&"+c:""),b=b.substr(0,i));
// Put it all together
var j;if(d){if(j=d,b){
...
-1==j.search(Craft.scriptName)&&(j=Craft.rtrim(j,"/")+"/"+Craft.scriptName);else{
// Move the path into the query string params
// Is the p= param already set?
if(c&&"p="==c.substr(0,2)){var l,m=c.indexOf("&");-1!=m?(l=c.substring(2,m),c=c.substr(m+1)):(l=c.substr(2),c=null),
// Just in case
...
escapeChars:function(a){Garnish.isArray(a)||(a=a.split());for(var b="",c=0;c<a.length;c++)b+="\\"+a[c];return b},/**
	 ...
	 * @return string
	 */
ltrim:function(a,b){if(!a)return a;void 0===b&&(b=" 	\n\r\x00\v");var c=new RegExp("^["+Craft.escapeChars(b)+"]+");return a.replace(c,"")},/**
...
filterArray:function(a,b){for(var c=[],d=0;d<a.length;d++){var e;e="function"==typeof b?b(a[d],d):a[d],e&&c.push(a[d])}return c},/**
	 ...
	 * @return boolean
	 */
inArray:function(b,c){return-1!=a.inArray(b,c)},/**
	 ...
	 */
removeFromArray:function(b,c){var d=a.inArray(b,c);return-1!=d?(c.splice(d,1),!0):!1},/**
...
lowercaseFirst:function(a){return a.charAt(0).toLowerCase()+a.slice(1)},/**
	 ...
	 */
secondsToHumanTimeDuration:function(a,b){"undefined"==typeof b&&(b=!0);var c=604800,d=86400,e=3600,f=60,g=Math.floor(a/c);a%=c;var h=Math.floor(a/d);a%=d;var i=Math.floor(a/e);a%=e;var j;return b?(j=Math.floor(a/f),a%=f):(j=Math.round(a/f),a=0),timeComponents=[],g&&timeComponents.push(g+" "+(1==g?Craft.t("week"):Craft.t("weeks"))),h&&timeComponents.push(h+" "+(1==h?Craft.t("day"):Craft.t("days"))),i&&timeComponents.push(i+" "+(1==i?Craft.t("hour"):Craft.t("hours"))),!j&&(b||g||h||i)||timeComponents.push(j+" "+(1==j?Craft.t("minute"):Craft.t("minutes"))),(a||b&&!g&&!h&&!i&&!j)&&timeComponents.push(a+" "+(1==a?Craft.t("second"):Craft.t("seconds"))),timeComponents.join(", ")},/**
	 * Converts extended ASCII characters to ASCII.
	 *
	 * @param string str
	 * @return string
	 */
asciiString:function(a){for(var b="",c=0;c<a.length;c++){var d=a.charCodeAt(c),e=a.charAt(c);if(d>=32&&128>d)b+=e;else for(var f in Craft.asciiCharMap)if(Craft.asciiCharMap.hasOwnProperty(f))for(var g=0;g<Craft.asciiCharMap[f].length;g++)Craft.asciiCharMap[f][g]==e&&(b+=f)}return b},/**
...
var c=a("script[src]");if(c.length){for(var d=[],e=0;e<c.length;e++){var f=c.eq(e).attr("src");d.push(f.replace(/[.?*+^$[\]\\(){}|-]/g,"\\$&"))}var g=new RegExp('<script\\s[^>]*src="(?:'+d.join("|")+')".*?></script>',"g");b=b.replace(g,"")}Garnish.$bod.append(b)}},/**
	 ...
	 */
initUiElements:function(b){a(".grid",b).grid(),a(".pane",b).pane(),a(".info",b).infoicon(),a(".checkbox-select",b).checkboxselect(),a(".fieldtoggle",b).fieldtoggle(),a(".lightswitch",b).lightswitch(),a(".nicetext",b).nicetext(),a(".pill",b).pill(),a(".formsubmit",b).formsubmit(),a(".menubtn",b).menubtn(),
// Make placeholders work for IE9, too.
a("input[type!=password], textarea",b).placeholder()},_elementIndexClasses:{},_elementSelectorModalClasses:{},/**
...
try{localStorage[a]=JSON.stringify(b)}catch(a){}}},/**
	 ...
	 * @returns object
	 */
getElementInfo:function(b){var c=a(b);c.hasClass("element")||(c=c.find(".element:first"));var d={id:c.data("id"),locale:c.data("locale"),label:c.data("label"),status:c.data("status"),url:c.data("url"),hasThumb:c.hasClass("hasthumb"),$element:c};return d},/**
	 * Shows an element editor HUD.
	 *
	 * @param object $element
	 */
showElementEditor:function(a){!Garnish.hasAttr(a,"data-editable")||a.hasClass("disabled")||a.hasClass("loading")||new Craft.ElementEditor(a)}}),
// -------------------------------------------
...
this.$main=this.$container.find(".main"),this.$toolbar=this.$container.find(".toolbar:first"),this.$toolbarTableRow=this.$toolbar.children("table").children("tbody").children("tr"),this.$statusMenuBtn=this.$toolbarTableRow.find(".statusmenubtn:first"),this.$localeMenuBtn=this.$toolbarTableRow.find(".localemenubtn:first"),this.$sortMenuBtn=this.$toolbarTableRow.find(".sortmenubtn:first"),this.$search=this.$toolbarTableRow.find(".search:first input:first"),this.$clearSearchBtn=this.$toolbarTableRow.find(".search:first > .clear"),this.$mainSpinner=this.$toolbar.find(".spinner:first"),this.$loadingMoreSpinner=this.$container.find(".spinner.loadingmore"),this.$sidebar=this.$container.find(".sidebar:first"),this.$sidebarButtonContainer=this.$sidebar.children(".buttons"),this.$elements=this.$container.find(".elements:first"),this.$sidebarButtonContainer.length||(this.$sidebarButtonContainer=a('<div class="buttons"/>').prependTo(this.$sidebar)),this.showingSidebar=this.$sidebar.length&&!this.$sidebar.hasClass("hidden"),this.$viewModeBtnTd=this.$toolbarTableRow.find(".viewbtns:first"),this.$viewModeBtnContainer=a('<div class="btngroup fullwidth"/>').appendTo(this.$viewModeBtnTd),"index"!=this.settings.context||Garnish.isMobileBrowser(!0)||this.addListener(Garnish.$win,"scroll resize","updateFixedToolbar");
...
if(
// The source selector
this.sourceSelect=new Garnish.Select(this.$sidebar.find("nav"),{multi:!1,allowEmpty:!1,vertical:!0,onSelectionChange:a.proxy(this,"onSourceSelectionChange")}),this._initSources(e),this.$localeMenuBtn.length){this.localeMenu=this.$localeMenuBtn.menubtn().data("menubtn").menu;
// Figure out the initial locale
var f=this.localeMenu.$options.filter(".sel:first");if(f.length||(f=this.localeMenu.$options.first()),f.length?this.locale=f.data("locale"):this.settings.criteria={id:"0"},this.localeMenu.on("optionselect",a.proxy(this,"onLocaleChange")),this.locale){
// Do we have a different locale stored in localStorage?
var g=Craft.getLocalStorage("BaseElementIndex.locale");if(g&&g!=this.locale){
// Is that one available here?
var h=this.localeMenu.$options.filter('[data-locale="'+g+'"]:first');h.length&&
// Todo: switch this to localeMenu.selectOption($storedLocaleOption) once Menu is updated to support that
h.trigger("click")}}}
// Is there a sort menu?
this.$sortMenuBtn.length&&(this.sortMenu=this.$sortMenuBtn.menubtn().data("menubtn").menu,this.$sortAttributesList=this.sortMenu.$container.children(".sort-attributes"),this.$sortDirectionsList=this.sortMenu.$container.children(".sort-directions"),this.sortMenu.on("optionselect",a.proxy(this,"onSortChange"))),this.onAfterHtmlInit(),"index"==this.settings.context?this.$scroller=Garnish.$win:this.$scroller=this.$main;
...
i=this.$sources.first()),
// Load up the elements!
this.initialized=!0,this.sourceSelect.selectItem(i),
// Status changes
this.$statusMenuBtn.length&&(this.statusMenu=this.$statusMenuBtn.menubtn().data("menubtn").menu,this.statusMenu.on("optionselect",a.proxy(this,"onStatusChange"))),this.addListener(this.$search,"textchange",a.proxy(function(){!this.searching&&this.$search.val()?this.onStartSearching():this.searching&&!this.$search.val()&&this.onStopSearching(),this.searchTimeout&&clearTimeout(this.searchTimeout),this.searchTimeout=setTimeout(a.proxy(this,"updateElements"),500)},this)),this.addListener(this.$clearSearchBtn,"click",a.proxy(function(){this.$search.val(""),this.searchTimeout&&clearTimeout(this.searchTimeout),Garnish.isMobileBrowser(!0)||this.$search.focus(),this.onStopSearching(),this.updateElements()},this)),
// Auto-focus the Search box
Garnish.isMobileBrowser(!0)||this.$search.focus()}},get $sources(){return this.sourceSelect?this.sourceSelect.$items:void 0},get totalVisible(){return this._isStructureTableDraggingLastElements()?this._totalVisiblePostStructureTableDraggee:this._totalVisible},get morePending(){return this._isStructureTableDraggingLastElements()?this._morePendingPostStructureTableDraggee:this._morePending},updateFixedToolbar:function(){(this.toolbarOffset||(this.toolbarOffset=this.$toolbar.offset().top,this.toolbarOffset))&&(this.updateFixedToolbar._scrollTop=Garnish.$win.scrollTop(),this.updateFixedToolbar._scrollTop>this.toolbarOffset-7?(this.$toolbar.hasClass("fixed")||(this.$elements.css("padding-top",this.$toolbar.outerHeight()+24),this.$toolbar.addClass("fixed")),this.$toolbar.css("width",this.$main.width())):this.$toolbar.hasClass("fixed")&&(this.$toolbar.removeClass("fixed"),this.$toolbar.css("width",""),this.$elements.css("padding-top","")))},initSource:function(a){this.sourceSelect.addItems(a),this.initSourceToggle(a)},initSourceToggle:function(a){var b=this._getSourceToggle(a);b.length&&this.addListener(b,"click","_onToggleClick")},deinitSource:function(a){this.sourceSelect.removeItems(a),this.deinitSourceToggle(a)},deinitSourceToggle:function(a){var b=this._getSourceToggle(a);b.length&&this.removeListener(b,"click")},getDefaultSourceKey:function(){return this.instanceState.selectedSource},onSourceSelectionChange:function(){
// If the selected source was just removed (maybe because its parent was collapsed),
// there won't be a selected source
// If the selected source was just removed (maybe because its parent was collapsed),
// there won't be a selected source
return this.sourceSelect.totalSelected?void(this.selectSource(this.sourceSelect.$selectedItems)&&this.updateElements()):void this.sourceSelect.selectItem(this.$sources.first())},onStartSearching:function(){
// Show the clear button and add/select the Score sort option
this.$clearSearchBtn.removeClass("hidden"),this.$scoreSortAttribute||(this.$scoreSortAttribute=a('<li><a data-attr="score">'+Craft.t("Score")+"</a></li>"),this.sortMenu.addOptions(this.$scoreSortAttribute.children())),this.$scoreSortAttribute.prependTo(this.$sortAttributesList),this.setSortAttribute("score"),this.getSortAttributeOption("structure").addClass("disabled"),this.searching=!0},onStopSearching:function(){
...
Craft.setLocalStorage(this.sourceStatesStorageKey,this.sourceStates)},/**
	 ...
	 */
getControllerData:function(){var b={context:this.settings.context,elementType:this.elementType,criteria:a.extend({status:this.status,locale:this.locale},this.settings.criteria),disabledElementIds:this.settings.disabledElementIds,source:this.instanceState.selectedSource,status:this.status,viewState:this.getSelectedSourceState(),search:this.searching?this.$search.val():null};
// Possible that the order/sort isn't entirely accurate if we're sorting by Score
return b.viewState.order=this.getSelectedSortAttribute(),b.viewState.sort=this.getSelectedSortDirection(),"table"==this.getSelectedSourceState("mode")&&"structure"==this.getSelectedSortAttribute()&&(b.collapsedElementIds=this.instanceState.collapsedElementIds),b},updateElements:function(){
// Ignore if we're not fully initialized yet
if(this.initialized){
// Prep the UI
// -------------------------------------------------------------
this.setIndexBusy(),this.removeListener(this.$scroller,"scroll"),"table"==this.getSelectedSourceState("mode")&&this.$table&&(Craft.cp.$collapsibleTables=Craft.cp.$collapsibleTables.not(this.$table));
// Fetch the elements
// -------------------------------------------------------------
var b=this.getControllerData();Craft.postActionRequest("element-index/get-elements",b,a.proxy(function(b,c){if(this.setIndexAvailable(),"success"==c){
// Cleanup
// -------------------------------------------------------------
this._prepForNewElements(),
// Selectable setup
// -------------------------------------------------------------
"index"==this.settings.context&&b.actions&&b.actions.length?(this.actions=b.actions,this.actionsHeadHtml=b.actionsHeadHtml,this.actionsFootHtml=b.actionsFootHtml):this.actions=this.actionsHeadHtml=this.actionsFootHtml=null,this.selectable=this.actions||this.settings.selectable,
// Update the view with the new container + elements HTML
// -------------------------------------------------------------
this.$elements.html(b.html),this.$scroller.scrollTop(0),"table"==this.getSelectedSourceState("mode")&&(this.$table=this.$elements.find("table:first"),Craft.cp.$collapsibleTables=Craft.cp.$collapsibleTables.add(this.$table)),
// Find the new container
this.$elementContainer=this.getElementContainer();
// Get the new elements
var d=this.$elementContainer.children();
// Initialize the selector stuff and the structure table sorter
this._setupNewElements(d),this._onUpdateElements(b,!1,d),"table"==this.getSelectedSourceState("mode")&&"structure"==this.getSelectedSortAttribute()&&
// Listen for toggle clicks
this.addListener(this.$elementContainer,"click",function(b){var c=a(b.target);c.hasClass("toggle")&&this._collapseElement(c)===!1&&this._expandElement(c)}),
// Listen for double-clicks
"index"==this.settings.context&&this.addListener(this.$elementContainer,"dblclick",function(b){var c=a(b.target);if("A"!=c.prop("nodeName")){var d;if(c.hasClass("element"))d=c;else if(d=c.closest(".element"),!d.length)return;Garnish.hasAttr(d,"data-editable")&&new Craft.ElementEditor(d)}})}},this))}},showActionTriggers:function(){
// Ignore if they're already shown
this.showingActionTriggers||(
// Hide any toolbar inputs
this.$toolbarTableRow.children().not(this.$selectAllContainer).addClass("hidden"),this._$triggers?this._$triggers.insertAfter(this.$selectAllContainer):this._createTriggers(),this.showingActionTriggers=!0)},handleActionTriggerSubmit:function(b){b.preventDefault();var c=a(b.currentTarget);
// Make sure Craft.ElementActionTrigger isn't overriding this
if(!c.hasClass("disabled")&&!c.data("custom-handler")){var d=c.data("action"),e=Garnish.getPostData(c);this.submitAction(d,e)}},handleMenuActionTriggerSubmit:function(b){var c=a(b.option);
// Make sure Craft.ElementActionTrigger isn't overriding this
if(!c.hasClass("disabled")&&!c.data("custom-handler")){var d=c.data("action");this.submitAction(d)}},submitAction:function(b,c){
// Make sure something's selected
var d=this.elementSelect.totalSelected,e=this.elementSelect.$items.length;if(0!=d){for(var f,g=0;g<this.actions.length;g++)if(this.actions[g].type==b){f=this.actions[g];break}if(!f)throw'The requested action "'+b+"\" doesn't exist.";if(f&&(!f.confirm||confirm(f.confirm))){
// Get ready to submit
var h=a.extend(this.getControllerData(),c,{elementAction:b,elementIds:this.getSelectedElementIds()});
// Do it
this.setIndexBusy(),Craft.postActionRequest("element-index/perform-action",h,a.proxy(function(b,c){if(this.setIndexAvailable(),"success"==c)if(b.success){this._prepForNewElements(),this.$elementContainer.html(""),this.elementSelect=this.createElementSelect();var f=a(b.html).appendTo(this.$elementContainer);
...
if(
// Initialize the selector stuff and the structure table sorter
this._setupNewElements(f),50>=e||e>d)for(var g=0;g<h.elementIds.length;g++){var i=this.getElementById(h.elementIds[g]);i&&this.elementSelect.selectItem(i)}this._onUpdateElements(b,!1,f),b.message&&Craft.cp.displayNotice(b.message),
// There may be a new background task that needs to be run
Craft.cp.runPendingTasks()}else Craft.cp.displayError(b.message)},this))}}},hideActionTriggers:function(){
// Ignore if there aren't any
this.showingActionTriggers&&(this._$triggers.detach(),this.$toolbarTableRow.children().not(this.$selectAllContainer).removeClass("hidden"),this.showingActionTriggers=!1)},updateActionTriggers:function(){
// Do we have an action UI to update?
if(this.actions){var a=this.elementSelect.totalSelected;0!=a?(a==this.elementSelect.$items.length?(this.$selectAllCheckbox.removeClass("indeterminate"),this.$selectAllCheckbox.addClass("checked")):(this.$selectAllCheckbox.addClass("indeterminate"),this.$selectAllCheckbox.removeClass("checked")),this.showActionTriggers()):(this.$selectAllCheckbox.removeClass("indeterminate checked"),this.hideActionTriggers())}},/**
...
maybeLoadMore:function(){this.canLoadMore()&&this.loadMore()},/**
	 ...
	 */
canLoadMore:function(){if(!this.morePending)return!1;
// Check if the user has reached the bottom of the scroll area
if(this.$scroller[0]==Garnish.$win[0]){var a=Garnish.$win.innerHeight(),b=Garnish.$win.scrollTop(),c=Garnish.$bod.height();return a+b>=c}var d=this.$scroller.prop("scrollHeight"),e=this.$scroller.scrollTop(),f=this.$scroller.outerHeight();return f+15>=d-e},/**
	 * Loads the next batch of elements.
	 */
loadMore:function(){if(this.morePending&&!this.loadingMore){this.loadingMore=!0,this.$loadingMoreSpinner.removeClass("hidden"),this.removeListener(this.$scroller,"scroll");var b=this.getLoadMoreData();Craft.postActionRequest("element-index/get-more-elements",b,a.proxy(function(b,c){if(this.loadingMore=!1,this.$loadingMoreSpinner.addClass("hidden"),"success"==c){var d=a(b.html).appendTo(this.$elementContainer);(this.actions||this.settings.selectable)&&(this.elementSelect.addItems(d.filter(":not(.disabled)")),this.updateActionTriggers()),this.structureTableSort&&this.structureTableSort.addItems(d),this._onUpdateElements(b,!0,d)}},this))}},/**
	 ...
	 */
getLoadMoreData:function(){var a=this.getControllerData();
// If we are dragging the last elements on the page,
// tell the controller to only load elements positioned after the draggee.
return a.offset=this.totalVisible,this._isStructureTableDraggingLastElements()&&(a.criteria.positionedAfter=this.structureTableSort.$targetItem.data("id")),a},/**
	 * Returns the element container.
	 */
getElementContainer:function(){return"table"==this.getSelectedSourceState("mode")?this.$table.children("tbody:first"):this.$elements.children("ul")},createElementSelect:function(){return new Garnish.Select(this.$elementContainer,{multi:this.actions||this.settings.multiSelect,vertical:"thumbs"!=this.getSelectedSourceState("mode"),handle:"index"==this.settings.context?".checkbox, .element":null,filter:":not(a):not(.toggle)",checkboxMode:"index"==this.settings.context&&this.actions,onSelectionChange:a.proxy(this,"onSelectionChange")})},getSelectedElementIds:function(){for(var a=this.elementSelect.$selectedItems,b=[],c=0;c<a.length;c++)b.push(a.eq(c).data("id"));return b},onUpdateElements:function(a,b){this.settings.onUpdateElements(a,b)},onStatusChange:function(b){this.statusMenu.$options.removeClass("sel");var c=a(b.selectedOption).addClass("sel");this.$statusMenuBtn.html(c.html()),this.status=c.data("status"),this.updateElements()},onLocaleChange:function(b){this.localeMenu.$options.removeClass("sel");var c=a(b.selectedOption).addClass("sel");this.$localeMenuBtn.html(c.html()),this.locale=c.data("locale"),this.initialized&&(
// Remember this locale for later
Craft.setLocalStorage("BaseElementIndex.locale",this.locale),
// Update the elements
this.updateElements())},getSortAttributeOption:function(a){return this.$sortAttributesList.find('a[data-attr="'+a+'"]:first')},getSelectedSortAttribute:function(){return this.$sortAttributesList.find("a.sel:first").data("attr")},setSortAttribute:function(a){
// Find the option (and make sure it actually exists)
var b=this.getSortAttributeOption(a);if(b.length){this.$sortAttributesList.find("a.sel").removeClass("sel"),b.addClass("sel");var c=b.text();this.$sortMenuBtn.attr("title",Craft.t("Sort by {attribute}",{attribute:c})),this.$sortMenuBtn.text(c),this.setSortDirection("asc"),"score"==a||"structure"==a?this.$sortDirectionsList.find("a").addClass("disabled"):this.$sortDirectionsList.find("a").removeClass("disabled")}},getSortDirectionOption:function(a){return this.$sortDirectionsList.find("a[data-dir="+a+"]:first")},getSelectedSortDirection:function(){return this.$sortDirectionsList.find("a.sel:first").data("dir")},setSortDirection:function(a){"desc"!=a&&(a="asc"),this.$sortMenuBtn.attr("data-icon",a),this.$sortDirectionsList.find("a.sel").removeClass("sel"),this.getSortDirectionOption(a).addClass("sel")},onSortChange:function(b){var c=a(b.selectedOption);if(!c.hasClass("disabled")&&!c.hasClass("sel")){
// Is this an attribute or a direction?
c.parent().parent().is(this.$sortAttributesList)?this.setSortAttribute(c.data("attr")):this.setSortDirection(c.data("dir"));
// Save it to localStorage (unless we're sorting by score)
var d=this.getSelectedSortAttribute();"score"!=d&&this.setSelecetedSourceState({order:d,sort:this.getSelectedSortDirection()}),this.updateElements()}},getSourceByKey:function(a){if(this.$sources){var b=this.$sources.filter('[data-key="'+a+'"]:first');if(b.length)return b}},selectSource:function(b){if(this.$source&&this.$source[0]&&this.$source[0]==b[0])return!1;
// Create the buttons if there's more than one mode available to this source
if(b[0]!=this.sourceSelect.$selectedItems[0]&&this.sourceSelect.selectItem(b),this.$source=b,this.sourceKey=b.data("key"),this.setInstanceState("selectedSource",this.sourceKey),this.searching&&(
// Clear the search value without triggering the textchange event
this.$search.data("textchangeValue",""),this.$search.val(""),this.onStopSearching()),
// Sort menu
// ----------------------------------------------------------------------
...
var d=this.getSelectedSourceState("mode");
// Try to keep using the current view mode
return d&&this.doesSourceHaveViewMode(d)||(d=this.viewMode&&this.doesSourceHaveViewMode(this.viewMode)?this.viewMode:this.sourceViewModes[0].mode),this.selectViewMode(d),this.onSelectSource(),!0},setStoredSortOptionsForSource:function(){
// Default to whatever's first
this.setSortAttribute(),this.setSortDirection("asc");var a=this.getSelectedSourceState("order"),b=this.getSelectedSourceState("sort");a&&(a=this.getDefaultSort(),Garnish.isArray(a)&&(b=a[1],a=a[0])),"asc"!=b&&"desc"!=b&&(b="asc"),this.setSortAttribute(a),this.setSortDirection(b)},getDefaultSort:function(){
// Does the source specify what to do?
// Does the source specify what to do?
return Garnish.hasAttr(this.$source,"data-default-sort")?this.$source.attr("data-default-sort").split(":"):[this.$sortAttributesList.find("a:first").data("attr"),"asc"]},getViewModesForSource:function(){var a=[{mode:"table",title:Craft.t("Display in a table"),icon:"list"}];return Garnish.hasAttr(this.$source,"data-has-thumbs")&&a.push({mode:"thumbs",title:Craft.t("Display as thumbnails"),icon:"grid"}),a},onSelectSource:function(){this.settings.onSelectSource(this.sourceKey)},onAfterHtmlInit:function(){this.settings.onAfterHtmlInit()},onSelectionChange:function(){this.updateActionTriggers(),this.settings.onSelectionChange()},doesSourceHaveViewMode:function(a){for(var b=0;b<this.sourceViewModes.length;b++)if(this.sourceViewModes[b].mode==a)return!0;return!1},selectViewMode:function(a,b){
// Make sure that the current source supports it
b||this.doesSourceHaveViewMode(a)||(a=this.sourceViewModes[0].mode),
// Has anything changed?
a!=this.viewMode&&(
// Deselect the previous view mode
this.viewMode&&"undefined"!=typeof this.viewModeBtns[this.viewMode]&&this.viewModeBtns[this.viewMode].removeClass("active"),this.viewMode=a,this.setSelecetedSourceState("mode",this.viewMode),"undefined"!=typeof this.viewModeBtns[this.viewMode]&&this.viewModeBtns[this.viewMode].addClass("active"))},rememberDisabledElementId:function(b){var c=a.inArray(b,this.settings.disabledElementIds);-1==c&&this.settings.disabledElementIds.push(b)},forgetDisabledElementId:function(b){var c=a.inArray(b,this.settings.disabledElementIds);-1!=c&&this.settings.disabledElementIds.splice(c,1)},enableElements:function(b){b.removeClass("disabled").parents(".disabled").removeClass("disabled");for(var c=0;c<b.length;c++){var d=a(b[c]).data("id");this.forgetDisabledElementId(d)}this.settings.onEnableElements(b)},disableElements:function(b){b.removeClass("sel").addClass("disabled");for(var c=0;c<b.length;c++){var d=a(b[c]).data("id");this.rememberDisabledElementId(d)}this.settings.onDisableElements(b)},getElementById:function(a){return this.$elementContainer.find("[data-id="+a+"]:first")},enableElementsById:function(b){b=a.makeArray(b);for(var c=0;c<b.length;c++){var d=b[c],e=this.getElementById(d);e.length?this.enableElements(e):this.forgetDisabledElementId(d)}},disableElementsById:function(b){b=a.makeArray(b);for(var c=0;c<b.length;c++){var d=b[c],e=this.getElementById(d);e.length?this.disableElements(e):this.rememberDisabledElementId(d)}},addButton:function(b){this.showingSidebar?this.$sidebarButtonContainer.append(b):a('<td class="thin"/>').prependTo(this.$toolbarTableRow).append(b)},addCallback:function(b,c){return a.proxy(function(){"function"==typeof b&&b.apply(this,arguments),c.apply(this,arguments)},this)},setIndexBusy:function(){this.$mainSpinner.removeClass("hidden"),this.isIndexBusy=!0},setIndexAvailable:function(){this.$mainSpinner.addClass("hidden"),this.isIndexBusy=!1},disable:function(){this.sourceSelect.disable(),this.elementSelect&&this.elementSelect.disable(),this.base()},enable:function(){this.sourceSelect.enable(),this.elementSelect&&this.elementSelect.enable(),this.base()},
// Private methods
// =========================================================================
_getSourcesInList:function(a){return a.children("li").children("a")},_getChildSources:function(a){var b=a.siblings("ul");return this._getSourcesInList(b)},_getSourceToggle:function(a){return a.siblings(".toggle")},_initSources:function(b){for(var c=0;c<b.length;c++)this.initSource(a(b[c]))},_deinitSources:function(b){for(var c=0;c<b.length;c++)this.deinitSource(a(b[c]))},_onToggleClick:function(b){this._toggleSource(a(b.currentTarget).prev("a")),b.stopPropagation()},_toggleSource:function(a){a.parent("li").hasClass("expanded")?this._collapseSource(a):this._expandSource(a)},_expandSource:function(a){a.parent("li").addClass("expanded");var b=this._getChildSources(a);this._initSources(b)},_collapseSource:function(a){a.parent("li").removeClass("expanded");var b=this._getChildSources(a);this._deinitSources(b)},_prepForNewElements:function(){this.actions&&(
// Get rid of the old action triggers regardless of whether the new batch has actions or not
this.hideActionTriggers(),this._$triggers=null),
// Reset the element select
this.elementSelect&&(this.elementSelect.destroy(),delete this.elementSelect),this.$selectAllContainer&&
// Git rid of the old select all button
this.$selectAllContainer.detach()},_setupNewElements:function(b){this.selectable&&(
// Initialize the element selector
this.elementSelect=this.createElementSelect(),this.elementSelect.addItems(b.filter(":not(.disabled)")),this.actions&&(
// First time?
this.$selectAllContainer?
// Reset the select all button
this.$selectAllCheckbox.removeClass("indeterminate checked"):(
// Create the select all button
this.$selectAllContainer=a('<td class="selectallcontainer thin"/>'),this.$selectAllBtn=a('<div class="btn"/>').appendTo(this.$selectAllContainer),this.$selectAllCheckbox=a('<div class="checkbox"/>').appendTo(this.$selectAllBtn),this.addListener(this.$selectAllBtn,"click",function(){0==this.elementSelect.totalSelected?this.elementSelect.selectAll():this.elementSelect.deselectAll()})),
...
// -------------------------------------------------------------
"index"==this.settings.context&&"table"==this.getSelectedSourceState("mode")&&"structure"==this.getSelectedSortAttribute()&&Garnish.hasAttr(this.$table,"data-structure-id")?this.structureTableSort=new Craft.StructureTableSorter(this,b,{onSortChange:a.proxy(this,"_onStructureTableSortChange")}):this.structureTableSort=null},_onUpdateElements:function(a,b,c){Craft.appendHeadHtml(a.headHtml),Craft.appendFootHtml(a.footHtml),this._isStructureTableDraggingLastElements()?(this._totalVisiblePostStructureTableDraggee=a.totalVisible,this._morePendingPostStructureTableDraggee=a.more):(this._totalVisible=a.totalVisible,this._morePending=this._morePendingPostStructureTableDraggee=a.more),this.morePending&&(
// Is there room to load more right now?
this.canLoadMore()?this.loadMore():this.addListener(this.$scroller,"scroll","maybeLoadMore")),"table"==this.getSelectedSourceState("mode")&&Craft.cp.updateResponsiveTables(),this.onUpdateElements(b,c)},_collapseElement:function(a,b){if(!b&&!a.hasClass("expanded"))return!1;a.removeClass("expanded");for(
...
this.instanceState.collapsedElementIds||(this.instanceState.collapsedElementIds=[]),this.instanceState.collapsedElementIds.push(d),this.setInstanceState("collapsedElementIds",this.instanceState.collapsedElementIds),
...
if(b.addClass("expanded"),this.instanceState.collapsedElementIds){var d=b.parent().parent(),e=d.data("id"),f=a.inArray(e,this.instanceState.collapsedElementIds);if(-1!=f){this.instanceState.collapsedElementIds.splice(f,1),this.setInstanceState("collapsedElementIds",this.instanceState.collapsedElementIds);
// Add a temporary row
var g=this._createSpinnerRowAfter(d),h=this.getControllerData();h.criteria.descendantOf=e,Craft.postActionRequest("element-index/get-more-elements",h,a.proxy(function(b,c){
// Do we even care about this anymore?
if(g.parent().length&&"success"==c){
// Are there more descendants we didn't get in this batch?
if(b.more){
// Remove all the elements after it
var d=g.nextAll();this.elementSelect&&this.elementSelect.removeItems(d),this.structureTableSort&&this.structureTableSort.removeItems(d),d.remove(),this._totalVisible-=d.length}else
// Maintain the current 'more' status so
b.more=this._morePending;var e=a(b.html);g.replaceWith(e),(this.actions||this.settings.selectable)&&(this.elementSelect.addItems(e.filter(":not(.disabled)")),this.updateActionTriggers()),this.structureTableSort&&this.structureTableSort.addItems(e),
// Tweak response.totalVisible to account for the elements that come before them
b.totalVisible+=this._totalVisible,this._onUpdateElements(b,!0,e)}},this))}}},_createSpinnerRowAfter:function(b){return a('<tr data-spinnerrow><td class="centeralign" colspan="'+b.children().length+'"><div class="spinner"/></td></tr>').insertAfter(b)},_isStructureTableDraggingLastElements:function(){return this.structureTableSort&&this.structureTableSort.dragging&&this.structureTableSort.draggingLastElements},_createTriggers:function(){for(var b=[],c=[],d=[],e=0;e<this.actions.length;e++){var f=this.actions[e];if(f.trigger){var g=a('<form id="'+f.type+'-actiontrigger"/>').data("action",f.type).append(f.trigger);this.addListener(g,"submit","handleActionTriggerSubmit"),b.push(g)}else f.destructive?d.push(f):c.push(f)}var h;if(c.length||d.length){var i=a("<form/>");h=a('<div class="btn menubtn" data-icon="settings" title="'+Craft.t("Actions")+'"/>').appendTo(i);var j=a('<ul class="menu"/>').appendTo(i),k=this._createMenuTriggerList(c),l=this._createMenuTriggerList(d);k&&k.appendTo(j),k&&l&&a("<hr/>").appendTo(j),l&&l.appendTo(j),b.push(i)}
// Add a filler TD
b.push(""),this._$triggers=a();for(var e=0;e<b.length;e++){var m=a('<td class="'+(e<b.length-1?"thin":"")+'"/>').append(b[e]);this._$triggers=this._$triggers.add(m)}this._$triggers.insertAfter(this.$selectAllContainer),Craft.appendHeadHtml(this.actionsHeadHtml),Craft.appendFootHtml(this.actionsFootHtml),Craft.initUiElements(this._$triggers),h&&h.data("menubtn").on("optionSelect",a.proxy(this,"handleMenuActionTriggerSubmit"))},_createMenuTriggerList:function(b){if(b&&b.length){for(var c=a("<ul/>"),d=0;d<b.length;d++){var e=b[d].type;a('<li><a id="'+e.replace(/[\[\]\\]+/g,"-")+'-actiontrigger" data-action="'+e+'">'+b[d].name+"</a></li>").appendTo(c)}return c}}},
// Static Properties
// =============================================================================
{defaults:{context:"index",storageKey:null,criteria:null,disabledElementIds:[],selectable:!1,multiSelect:!1,onUpdateElements:a.noop,onSelectionChange:a.noop,onEnableElements:a.noop,onDisableElements:a.noop,onSelectSource:a.noop,onAfterHtmlInit:a.noop}}),/**
 * Element Select input
 */
Craft.BaseElementSelectInput=Garnish.Base.extend({elementSelect:null,elementSort:null,modal:null,$container:null,$elementsContainer:null,$elements:null,$addElementBtn:null,_initialized:!1,init:function(b){
...
this.settings.modalStorageKey&&(this.modalStorageKey="BaseElementSelectInput."+this.settings.modalStorageKey),1==this.settings.limit&&(this.settings.sortable=!1),this.$container=this.getContainer(),
...
return b.addClass("removable"),b.prepend('<input type="hidden" name="'+this.settings.name+'[]" value="'+a.id+'"><a class="delete icon" title="'+Craft.t("Remove")+'"></a>'),b},appendElement:function(a){a.appendTo(this.$elementsContainer)},animateElementIntoPlace:function(a,b){var c=a.offset(),d=b.offset(),e=b.clone().appendTo(Garnish.$bod);b.css("visibility","hidden"),e.css({position:"absolute",zIndex:1e4,top:c.top,left:c.left});var f={top:d.top,left:d.left};e.velocity(f,Craft.BaseElementSelectInput.ADD_FX_DURATION,function(){e.remove(),b.css("visibility","visible")})},updateDisabledElementsInModal:function(){this.modal.elementIndex&&this.modal.elementIndex.disableElementsById(this.getDisabledElementIds())},getElementById:function(a){for(var b=0;b<this.$elements.length;b++){var c=this.$elements.eq(b);if(c.data("id")==a)return c}},onSelectElements:function(a){this.trigger("selectElements",{elements:a}),this.settings.onSelectElements(a)},onRemoveElements:function(){this.trigger("removeElements"),this.settings.onRemoveElements()}},{ADD_FX_DURATION:200,REMOVE_FX_DURATION:200,defaults:{id:null,name:null,fieldId:null,elementType:null,sources:null,criteria:{},sourceElementId:null,limit:null,modalStorageKey:null,modalSettings:{},onSelectElements:a.noop,onRemoveElements:a.noop,sortable:!0,selectable:!0,editable:!0}}),/**
 * Element selector modal class
 */
Craft.BaseElementSelectorModal=Garnish.Modal.extend({elementType:null,elementIndex:null,$body:null,$selectBtn:null,$sidebar:null,$sources:null,$sourceToggles:null,$main:null,$search:null,$elements:null,$tbody:null,$buttons:null,$cancelBtn:null,$footerSpinner:null,init:function(b,c){this.elementType=b,this.setSettings(c,Craft.BaseElementSelectorModal.defaults);
// Build the modal
var d=a('<div class="modal elementselectormodal"></div>').appendTo(Garnish.$bod),e=a('<div class="body"><div class="spinner big"></div></div>').appendTo(d),f=a('<div class="footer"/>').appendTo(d);this.base(d,this.settings),this.$footerSpinner=a('<div class="spinner hidden"/>').appendTo(f),this.$buttons=a('<div class="buttons rightalign first"/>').appendTo(f),this.$cancelBtn=a('<div class="btn">'+Craft.t("Cancel")+"</div>").appendTo(this.$buttons),this.$selectBtn=a('<div class="btn disabled submit">'+Craft.t("Select")+"</div>").appendTo(this.$buttons),this.$body=e,this.addListener(this.$cancelBtn,"activate","cancel"),this.addListener(this.$selectBtn,"activate","selectElements")},onFadeIn:function(){if(this.elementIndex)
// Auto-focus the Search box
Garnish.isMobileBrowser(!0)||this.elementIndex.$search.focus();else{
// Get the modal body HTML based on the settings
var b={context:"modal",elementType:this.elementType,sources:this.settings.sources};Craft.postActionRequest("elements/get-modal-body",b,a.proxy(function(b,c){"success"==c&&(this.$body.html(b),this.$body.has(".sidebar:not(.hidden)").length&&this.$body.addClass("has-sidebar"),
// Initialize the element index
this.elementIndex=Craft.createElementIndex(this.elementType,this.$body,{context:"modal",storageKey:this.settings.storageKey,criteria:this.settings.criteria,disabledElementIds:this.settings.disabledElementIds,selectable:!0,multiSelect:this.settings.multiSelect,onSelectionChange:a.proxy(this,"onSelectionChange"),onUpdateElements:a.proxy(this,"onUpdateElements"),onEnableElements:a.proxy(this,"onEnableElements"),onDisableElements:a.proxy(this,"onDisableElements")}))},this))}this.base()},onUpdateElements:function(a){a||
// Double-clicking should select the elements
this.addListener(this.elementIndex.$elementContainer,"dblclick","selectElements")},onSelectionChange:function(){this.updateSelectBtnState()},updateSelectBtnState:function(){this.$selectBtn&&(this.elementIndex.elementSelect.totalSelected?this.enableSelectBtn():this.disableSelectBtn())},enableSelectBtn:function(){this.$selectBtn.removeClass("disabled")},disableSelectBtn:function(){this.$selectBtn.addClass("disabled")},enableCancelBtn:function(){this.$cancelBtn.removeClass("disabled")},disableCancelBtn:function(){this.$cancelBtn.addClass("disabled")},showFooterSpinner:function(){this.$footerSpinner.removeClass("hidden")},hideFooterSpinner:function(){this.$footerSpinner.addClass("hidden")},onEnableElements:function(a){this.elementIndex.elementSelect.addItems(a)},onDisableElements:function(a){this.elementIndex.elementSelect.removeItems(a)},cancel:function(){this.$cancelBtn.hasClass("disabled")||this.hide()},selectElements:function(){if(this.elementIndex&&this.elementIndex.elementSelect&&this.elementIndex.elementSelect.totalSelected){this.elementIndex.elementSelect.clearMouseUpTimeout();var a=this.elementIndex.elementSelect.getSelectedItems(),b=this.getElementInfo(a);this.onSelect(b),this.settings.disableElementsOnSelect&&this.elementIndex.disableElements(this.elementIndex.elementSelect.getSelectedItems()),this.settings.hideOnSelect&&this.hide()}},getElementInfo:function(b){for(var c=[],d=0;d<b.length;d++){var e=a(b[d]);c.push(Craft.getElementInfo(e))}return c},show:function(){this.updateSelectBtnState(),this.base()},onSelect:function(a){this.settings.onSelect(a)},disable:function(){this.elementIndex&&this.elementIndex.disable(),this.base()},enable:function(){this.elementIndex&&this.elementIndex.enable(),this.base()}},{defaults:{resizable:!0,storageKey:null,sources:null,criteria:null,multiSelect:!1,disabledElementIds:[],disableElementsOnSelect:!1,hideOnSelect:!0,onCancel:a.noop,onSelect:a.noop}}),/**
 * Input Generator
 */
...
var e={ids:JSON.stringify(b)};Craft.postActionRequest(this.settings.reorderAction,e,a.proxy(function(a,b){"success"==b&&(a.success?Craft.cp.displayNotice(Craft.t(this.settings.reorderSuccessMessage)):Craft.cp.displayError(Craft.t(this.settings.reorderFailMessage)))},this))},handleDeleteBtnClick:function(b){if(!(this.settings.minItems&&this.totalItems<=this.settings.minItems)){var c=a(b.target).closest("tr");this.confirmDeleteItem(c)&&this.deleteItem(c)}},confirmDeleteItem:function(a){var b=this.getItemName(a);return confirm(Craft.t(this.settings.confirmDeleteMessage,{name:b}))},deleteItem:function(b){var c={id:this.getItemId(b)};Craft.postActionRequest(this.settings.deleteAction,c,a.proxy(function(a,c){"success"==c&&this.handleDeleteItemResponse(a,b)},this))},handleDeleteItemResponse:function(a,b){var c=this.getItemId(b),d=this.getItemName(b);a.success?(b.remove(),this.totalItems--,this.updateUI(),this.onDeleteItem(c),Craft.cp.displayNotice(Craft.t(this.settings.deleteSuccessMessage,{name:d}))):Craft.cp.displayError(Craft.t(this.settings.deleteFailMessage,{name:d}))},onDeleteItem:function(a){this.settings.onDeleteItem(a)},getItemId:function(a){return a.attr(this.settings.idAttribute)},getItemName:function(a){return a.attr(this.settings.nameAttribute)},updateUI:function(){
...
// CMD/CTRL + Y, CMD/CTRL + SHIFT + Z
return(a.metaKey||a.ctrlKey)&&(89==a.keyCode||90==a.keyCode&&a.shiftKey)?(this.redo(),!1):void 0},this)),this.addListener(Garnish.$doc,"keydown",a.proxy(function(a){return!a.metaKey&&!a.ctrlKey||a.shiftKey||90!=a.keyCode?void 0:(this.undo(),!1)},this))},removeListeners:function(){this.removeListener(Garnish.$doc,"keydown")},addOperation:function(a){this.doneOperations.push(a),
...
this.rotation=e,this.cleanUpRotationDegrees(),this.renderImage(!0,d),this.animationInProgress=!1)};h.call(this)}},cleanUpRotationDegrees:function(){this.rotation=this._cleanUpDegrees(this.rotation),this.frameRotation=this._cleanUpDegrees(this.frameRotation)},/**
		 ...
		 */
_cleanUpDegrees:function(a){return a>360?a-=360:0>a&&(a+=360),a=Math.round(10*a)/10},
...
clipImage:function(){var a=Garnish.$doc[0].createElement("canvas");a.width=this.canvas.width,a.height=this.canvas.height;var b=a.getContext("2d");b.fillStyle="white",b.fillRect(0,0,a.width,a.height),b.globalCompositeOperation="xor",this.prepareImageFrameRectangle(b),b.fill(),this.canvasContext.drawImage(a,0,0)},/**
		 ...
		 */
calculateLargestProportionalRectangle:function(a,b,c){var d,e;c>=b?(d=b,e=c):(d=c,e=b),
// Angle normalization in range [-PI..PI)
a>180&&(a=180-a),0>a&&(a+=180);var f=a*(Math.PI/180);f>Math.PI/2&&(f=Math.PI-f);var g,h,i=d/(e*Math.sin(f)+d*Math.cos(f));return c>=b?(g=d*i,h=e*i):(g=e*i,h=d*i),{w:g,h:h}}},{defaults:{resizable:!1,shadeClass:"assetEditor"}}),/**
 * Asset index class
 */
Craft.AssetIndex=Craft.BaseElementIndex.extend({$includeSubfoldersContainer:null,$includeSubfoldersCheckbox:null,showingIncludeSubfoldersCheckbox:!1,$uploadButton:null,$uploadInput:null,$progressBar:null,$folders:null,uploader:null,promptHandler:null,progressBar:null,_uploadTotalFiles:0,_uploadFileProgress:{},_uploadedFileIds:[],_currentUploaderSettings:{},_fileDrag:null,_folderDrag:null,_expandDropTargetFolderTimeout:null,_tempExpandedFolders:[],_fileConflictTemplate:{message:"File “{file}” already exists at target location.",choices:[{value:"keepBoth",title:Craft.t("Keep both")},{value:"replace",title:Craft.t("Replace it")}]},_folderConflictTemplate:{message:"Folder “{folder}” already exists at target location",choices:[{value:"replace",title:Craft.t("Replace the folder (all existing files will be deleted)")},{value:"merge",title:Craft.t("Merge the folder (any conflicting files will be replaced)")}]},init:function(a,b,c){this.base(a,b,c),"index"==this.settings.context&&this._initIndexPageMode()},initSource:function(a){this.base(a),this._createFolderContextMenu(a),"index"==this.settings.context&&(this._folderDrag&&this._getSourceLevel(a)>1&&this._folderDrag.addItems(a.parent()),this._fileDrag&&this._fileDrag.updateDropTargets())},deinitSource:function(a){this.base(a);
...
// File dragging
// ---------------------------------------------------------------------
this._fileDrag=new Garnish.DragDrop({activeDropTargetClass:"sel",helperOpacity:.75,filter:a.proxy(function(){return this.elementSelect.getSelectedItems()},this),helper:a.proxy(function(a){return this._getFileDragHelper(a)},this),dropTargets:a.proxy(function(){for(var b=[],c=0;c<this.$sources.length;c++)b.push(a(this.$sources[c]));return b},this),onDragStart:b,onDropTargetChange:c,onDragStop:a.proxy(this,"_onFileDragStop")}),
// Folder dragging
// ---------------------------------------------------------------------
...
if(i.prompt){var j={message:this._fileConflictTemplate.message,choices:this._fileConflictTemplate.choices};j.message=Craft.t(j.message,{file:i.filename}),i.prompt=j,this.promptHandler.addPrompt(i)}i.error&&alert(i.error)}this.setIndexAvailable(),this.progressBar.hideProgressBar();var k=!1,l=function(){
...
for(var e=0;e<d.length;e++)a("[data-id="+d[e]+"]").remove();this.elementSelect.deselectAll(),this._collapseExtraExpandedFolders(c),k&&this.updateElements()};if(this.promptHandler.getPromptCount()){
...
for(var n=0;n<b.length;n++)Craft.postActionRequest("assets/delete-folder",{folderId:b[n]});this.setIndexAvailable(),this.progressBar.hideProgressBar(),this._folderDrag.returnHelpersToDraggees(),this._selectSourceByFolderId(h)},this);b.length>0?this._moveFile(b,0,a.proxy(function(){g(c,d,e)},this)):g(c,d,e)},/**
	 ...
	 * @private
	 */
_getParentSource:function(a){return this._getSourceLevel(a)>1?a.parent().parent().siblings("a"):void 0},/**
...
this._uploadedFileIds.push(d.fileId),d.prompt){var g={message:this._fileConflictTemplate.message,choices:this._fileConflictTemplate.choices};g.message=Craft.t(g.message,{file:d.filename}),d.prompt=g,this.promptHandler.addPrompt(d)}}else d.error?alert(Craft.t("Upload failed for {filename}. The error message was: ”{error}“",{filename:e,error:d.error})):alert(Craft.t("Upload failed for {filename}.",{filename:e})),f=!1;
...
this.uploader.isLastUpload()&&(this.setIndexAvailable(),this.progressBar.hideProgressBar(),this.promptHandler.getPromptCount()?this.promptHandler.showBatchPrompts(a.proxy(this,"_uploadFollowup")):f&&this.updateElements())},/**
	 ...
	 * @private
	 */
_uploadFollowup:function(b){this.setIndexBusy(),this.progressBar.resetProgressBar(),this.promptHandler.resetPrompts();var c=a.proxy(function(){this.setIndexAvailable(),this.progressBar.hideProgressBar(),this.updateElements()},this);this.progressBar.setItemCount(b.length);var d=a.proxy(function(b,c,e){var f={fileId:b[c].fileId,filename:b[c].filename,userResponse:b[c].choice};Craft.postActionRequest("assets/save-asset",f,a.proxy(function(a,f){"success"==f&&a.fileId&&this._uploadedFileIds.push(a.fileId),c++,this.progressBar.incrementProcessedItemCount(1),this.progressBar.updateProgressBar(),c==b.length?e():d(b,c,e)},this))},this);this.progressBar.showProgressBar(),d(b,0,c)},/**
	 * Perform actions after updating elements
	 * @private
	 */
onUpdateElements:function(a,b){
// See if we have freshly uploaded files to add to selection
if("index"==this.settings.context&&(a||this._fileDrag.removeAllItems(),this._fileDrag.addItems(b)),this._uploadedFileIds.length){for(var c=null,d=0;d<this._uploadedFileIds.length;d++)c=this.$main.find(".element[data-id="+this._uploadedFileIds[d]+"]:first").parent(),"table"==this.getSelectedSourceState("mode")&&(c=c.parent()),this.elementSelect&&this.elementSelect.selectItem(c);
// Reset the list.
...
this._$firstRowCells=this.$elementContainer.children("tr:first").children();for(var h=b.children(),i=0;i<h.length;i++){
// Hard-set the cell widths
var j=a(h[i]);
// Skip the checkbox cell
if(Garnish.hasAttr(j,"data-checkboxcell"))j.remove(),d.css("margin-"+Craft.left,19);else{var k=a(this._$firstRowCells[i]),l=k.width();k.width(l),j.width(l)}}return d;case"thumbs":var d=a('<div class="elements thumbviewhelper"/>').appendTo(Garnish.$bod),e=a('<ul class="thumbsview"/>').appendTo(d);return b.appendTo(e),d}return a()},/**
...
this._tempExpandedFolders.push(this.dropTargetFolder)},_collapseFolder:function(a){a.parent().hasClass("expanded")&&a.siblings(".toggle").click()},_createFolderContextMenu:function(b){var c=[{label:Craft.t("New subfolder"),onClick:a.proxy(this,"_createSubfolder",b)}];
// For all folders that are not top folders
"index"==this.settings.context&&this._getSourceLevel(b)>1&&(c.push({label:Craft.t("Rename folder"),onClick:a.proxy(this,"_renameFolder",b)}),c.push({label:Craft.t("Delete folder"),onClick:a.proxy(this,"_deleteFolder",b)})),new Garnish.ContextMenu(b,c,{menuClass:"menu"})},_createSubfolder:function(b){var c=prompt(Craft.t("Enter the name of the folder"));if(c){var d={parentId:this._getFolderIdFromSourceKey(b.data("key")),folderName:c};this.setIndexBusy(),Craft.postActionRequest("assets/create-folder",d,a.proxy(function(c,d){if(this.setIndexAvailable(),"success"==d&&c.success){this._prepareParentForChildren(b);var e=a('<li><a data-key="folder:'+c.folderId+'"'+(Garnish.hasAttr(b,"data-has-thumbs")?" data-has-thumbs":"")+' data-upload="'+b.attr("data-upload")+'">'+c.folderName+"</a></li>"),f=e.children("a:first");this._appendSubfolder(b,e),this.initSource(f)}"success"==d&&c.error&&alert(c.error)},this))}},_deleteFolder:function(b){if(confirm(Craft.t("Really delete folder “{folder}”?",{folder:a.trim(b.text())}))){var c={folderId:this._getFolderIdFromSourceKey(b.data("key"))};this.setIndexBusy(),Craft.postActionRequest("assets/delete-folder",c,a.proxy(function(a,c){if(this.setIndexAvailable(),"success"==c&&a.success){var d=this._getParentSource(b);
 ...
 * Asset Select input
 */
Craft.AssetSelectInput=Craft.BaseElementSelectInput.extend({requestId:0,hud:null,uploader:null,progressBar:null,init:function(){this.base.apply(this,arguments),this._attachUploader()},/**
...
// Make a couple tweaks
b.addClass("removable"),b.prepend('<input type="hidden" name="'+this.settings.name+'[]" value="'+a.id+'"><a class="delete icon" title="'+Craft.t("Remove")+'"></a>'),b.appendTo(this.$elementsContainer);var c=-(b.outerWidth()+10);this.$addElementBtn.css("margin-"+Craft.left,c+"px");var d={};d["margin-"+Craft.left]=0,this.$addElementBtn.velocity(d,"fast"),this.addElements(b),delete this.modal}},/**
	 * On upload start.
	 */
 ...
 */
Craft.AssetSelectorModal=Craft.BaseElementSelectorModal.extend({$selectTransformBtn:null,_selectedTransform:null,init:function(b,c){if(c=a.extend({},Craft.AssetSelectorModal.defaults,c),c.canSelectImageTransforms&&"undefined"==typeof Craft.AssetSelectorModal.transforms){var d=this.base;
// Prevent this.base() from getting called until later
return void this.fetchTransformInfo(a.proxy(function(){
// Finally call this.base()
d.call(this,b,c),this.createSelectTransformButton()},this))}this.base(b,c),c.canSelectImageTransforms&&this.createSelectTransformButton()},fetchTransformInfo:function(b){Craft.postActionRequest("assets/get-transform-info",a.proxy(function(a,c){"success"==c&&a instanceof Array?Craft.AssetSelectorModal.transforms=a:Craft.AssetSelectorModal.transforms=[],b()},this))},createSelectTransformButton:function(){if(Craft.AssetSelectorModal.transforms.length){var b=a('<div class="btngroup"/>').appendTo(this.$buttons);this.$selectBtn.appendTo(b),this.$selectTransformBtn=a('<div class="btn menubtn disabled">'+Craft.t("Select Transform")+"</div>").appendTo(b);for(var c=a('<div class="menu" data-align="right"></div>').insertAfter(this.$selectTransformBtn),d=a("<ul></ul>").appendTo(c),e=0;e<Craft.AssetSelectorModal.transforms.length;e++)a('<li><a data-transform="'+Craft.AssetSelectorModal.transforms[e].handle+'">'+Craft.AssetSelectorModal.transforms[e].name+"</a></li>").appendTo(d);var f=new Garnish.MenuBtn(this.$selectTransformBtn,{onOptionSelect:a.proxy(this,"onSelectTransform")});f.disable(),this.$selectTransformBtn.data("menuButton",f)}},onSelectionChange:function(b){var c,d;if(this.elementIndex.elementSelect.totalSelected&&this.settings.canSelectImageTransforms&&Craft.AssetSelectorModal.transforms.length){c=!0;for(var e=this.elementIndex.elementSelect.getSelectedItems(),f=0;f<e.length;f++)if(!a(".element.hasthumb:first",e[f]).length){c=!1;break}}else c=!1;d=this.$selectTransformBtn?this.$selectTransformBtn.data("menuButton"):null,c?(d&&d.enable(),this.$selectTransformBtn.removeClass("disabled")):this.$selectTransformBtn&&(d&&d.disable(),this.$selectTransformBtn.addClass("disabled")),this.base()},onSelectTransform:function(b){var c=a(b).data("transform");this.selectImagesWithTransform(c)},selectImagesWithTransform:function(b){
// First we must get any missing transform URLs
"undefined"==typeof Craft.AssetSelectorModal.transformUrls[b]&&(Craft.AssetSelectorModal.transformUrls[b]={});for(var c=this.elementIndex.elementSelect.getSelectedItems(),d=[],e=0;e<c.length;e++){var f=a(c[e]),g=Craft.getElementInfo(f).id;"undefined"==typeof Craft.AssetSelectorModal.transformUrls[b][g]&&d.push(g)}d.length?(this.showFooterSpinner(),this.fetchMissingTransformUrls(d,b,a.proxy(function(){this.hideFooterSpinner(),this.selectImagesWithTransform(b)},this))):(this._selectedTransform=b,this.selectElements(),this._selectedTransform=null)},fetchMissingTransformUrls:function(b,c,d){var e=b.pop(),f={fileId:e,handle:c,returnUrl:!0};Craft.postActionRequest("assets/generate-transform",f,a.proxy(function(a,f){Craft.AssetSelectorModal.transformUrls[c][e]=!1,"success"==f&&a.url&&(Craft.AssetSelectorModal.transformUrls[c][e]=a.url),
// More to load?
b.length?this.fetchMissingTransformUrls(b,c,d):d()},this))},getElementInfo:function(a){var b=this.base(a);if(this._selectedTransform)for(var c=0;c<b.length;c++){var d=b[c].id;"undefined"!=typeof Craft.AssetSelectorModal.transformUrls[this._selectedTransform][d]&&Craft.AssetSelectorModal.transformUrls[this._selectedTransform][d]!==!1&&(b[c].url=Craft.AssetSelectorModal.transformUrls[this._selectedTransform][d])}return b},onSelect:function(a){this.settings.onSelect(a,this._selectedTransform)}},{defaults:{canSelectImageTransforms:!1},transformUrls:{}}),
// Register it!
Craft.registerElementSelectorModalClass("Asset",Craft.AssetSelectorModal),function(a){/**
 * AuthManager class
 */
...
-1!=this.remainingSessionTime&&this.remainingSessionTime<Craft.AuthManager.minSafeSessiotTime?(
...
-1!=this.remainingSessionTime&&this.remainingSessionTime<Craft.AuthManager.minSafeSessiotTime+Craft.AuthManager.checkInterval?this.setCheckRemainingSessionTimer(this.remainingSessionTime-Craft.AuthManager.minSafeSessiotTime+1):this.setCheckRemainingSessionTimer(Craft.AuthManager.checkInterval))},/**
	 * Shows the logout warning modal.
	 */
showLogoutWarningModal:function(){var b;if(this.showingLoginModal?(this.hideLoginModal(!0),b=!0):b=!1,this.showingLogoutWarningModal=!0,!this.logoutWarningModal){var c=a('<form id="logoutwarningmodal" class="modal alert fitted"/>'),d=a('<div class="body"/>').appendTo(c),e=a('<div class="buttons right"/>').appendTo(d),f=a('<div class="btn">'+Craft.t("Log out now")+"</div>").appendTo(e),g=a('<input type="submit" class="btn submit" value="'+Craft.t("Keep me logged in")+'" />').appendTo(e);this.$logoutWarningPara=a("<p/>").prependTo(d),this.logoutWarningModal=new Garnish.Modal(c,{autoShow:!1,closeOtherModals:!1,hideOnEsc:!1,hideOnShadeClick:!1,shadeClass:"modal-shade dark",onFadeIn:function(){Garnish.isMobileBrowser(!0)||
...
hideLogoutWarningModal:function(a){this.showingLogoutWarningModal=!1,this.logoutWarningModal&&(a?this.logoutWarningModal.quickHide():this.logoutWarningModal.hide(),this.decrementLogoutWarningInterval&&clearInterval(this.decrementLogoutWarningInterval))},/**
	 ...
	 */
showLoginModal:function(){var b;if(this.showingLogoutWarningModal?(this.hideLogoutWarningModal(!0),b=!0):b=!1,this.showingLoginModal=!0,!this.loginModal){var c=a('<form id="loginmodal" class="modal alert fitted"/>'),d=a('<div class="body"><h2>'+Craft.t("Your session has ended.")+"</h2><p>"+Craft.t("Enter your password to log back in.")+"</p></div>").appendTo(c),e=a('<div class="inputcontainer">').appendTo(d),f=a('<table class="inputs fullwidth"/>').appendTo(e),g=a("<tr/>").appendTo(f),h=a("<td/>").appendTo(g),i=a('<td class="thin"/>').appendTo(g),j=a('<div class="passwordwrapper"/>').appendTo(h);this.$passwordInput=a('<input type="password" class="text password fullwidth" placeholder="'+Craft.t("Password")+'"/>').appendTo(j),this.$passwordSpinner=a('<div class="spinner hidden"/>').appendTo(e),this.$loginBtn=a('<input type="submit" class="btn submit disabled" value="'+Craft.t("Login")+'" />').appendTo(i),this.$loginErrorPara=a('<p class="error"/>').appendTo(d),this.loginModal=new Garnish.Modal(c,{autoShow:!1,closeOtherModals:!1,hideOnEsc:!1,hideOnShadeClick:!1,shadeClass:"modal-shade dark",onFadeIn:a.proxy(function(){Garnish.isMobileBrowser(!0)||
...
var f=a("form[data-saveshortcut]:first");1==f.length&&this.addListener(Garnish.$doc,"keydown",function(b){
// Give other stuff on the page a chance to prepare
return(b.metaKey||b.ctrlKey)&&b.keyCode==Garnish.S_KEY&&(b.preventDefault(),this.trigger("beforeSaveShortcut"),f.data("saveshortcut-redirect")&&a('<input type="hidden" name="redirect" value="'+f.data("saveshortcut-redirect")+'"/>').appendTo(f),f.submit()),!0}),Garnish.$win.on("load",a.proxy(function(){if(
// Look for forms that we should watch for changes on
this.$confirmUnloadForms=a("form[data-confirm-unload]"),this.$confirmUnloadForms.length){Craft.forceConfirmUnload||(this.initialFormValues=[]);for(var b=0;b<this.$confirmUnloadForms.length;b++){var c=a(this.$confirmUnloadForms);Craft.forceConfirmUnload||(this.initialFormValues[b]=c.serialize()),this.addListener(c,"submit",function(){this.removeListener(Garnish.$win,"beforeunload")})}this.addListener(Garnish.$win,"beforeunload",function(b){for(var c=0;c<this.$confirmUnloadForms.length;c++)if(Craft.forceConfirmUnload||this.initialFormValues[c]!=a(this.$confirmUnloadForms[c]).serialize()){var d=Craft.t("Any changes will be lost if you leave this page.");return b?b.originalEvent.returnValue=d:window.event.returnValue=d,d}})}},this)),this.addListener(this.$upgradePromo,"click","showUpgradeModal");var g=a("#wrongedition-modal");g.length&&new Craft.WrongEditionModal(g)},/**
...
this.updateResponsiveTables()},onActionItemListResize:function(){this.$siteName.css("max-width","calc(100% - "+(this.$headerActionsList.width()+14)+"px)")},updateResponsiveNav:function(){
// Is an overflow menu going to be needed?
if(this.onWindowResize._cpWidth<this.totalNavWidth)
// Is the nav too tall?
if(
// Show the overflow menu button
this.showingOverflowNavMenu||(this.$overflowNavMenuBtn?this.$overflowNavMenuItem.show():(
// Create it
this.$overflowNavMenuItem=a("<li/>").appendTo(this.$nav),this.$overflowNavMenuBtn=a('<a class="menubtn" title="'+Craft.t("More")+'">…</a>').appendTo(this.$overflowNavMenuItem),this.$overflowNavMenu=a('<div id="overflow-nav" class="menu" data-align="right"/>').appendTo(this.$overflowNavMenuItem),this.$overflowNavMenuList=a("<ul/>").appendTo(this.$overflowNavMenu),new Garnish.MenuBtn(this.$overflowNavMenuBtn)),this.showingOverflowNavMenu=!0),this.$nav.height()>Craft.CP.navHeight)
// Move items to the overflow menu until the nav is back to its normal height
do this.addLastVisibleNavItemToOverflowMenu();while(this.$nav.height()>Craft.CP.navHeight&&this.visibleNavItems>0);else{
// See if we can fit any more nav items in the main menu
for(;this.$nav.height()==Craft.CP.navHeight&&this.visibleNavItems<this.totalNavItems;)this.addFirstOverflowNavItemToMainMenu();
// Now kick the last one back.
this.addLastVisibleNavItemToOverflowMenu()}else if(this.showingOverflowNavMenu){
// Move any nav items in the overflow menu back to the main nav menu
for(
// Hide the overflow menu button
this.$overflowNavMenuItem.hide();this.visibleNavItems<this.totalNavItems;)this.addFirstOverflowNavItemToMainMenu();this.showingOverflowNavMenu=!1}},updateResponsiveTables:function(){for(this.updateResponsiveTables._i=0;this.updateResponsiveTables._i<this.$collapsibleTables.length;this.updateResponsiveTables._i++)this.updateResponsiveTables._$table=this.$collapsibleTables.eq(this.updateResponsiveTables._i),this.updateResponsiveTables._containerWidth=this.updateResponsiveTables._$table.parent().width(),this.updateResponsiveTables._check=!1,
...
this.trackTaskProgressTimeout||(this.trackTaskProgressTimeout=setTimeout(a.proxy(function(){Craft.queueActionRequest("tasks/get-running-task-info",a.proxy(function(a,b){"success"==b&&(this.trackTaskProgressTimeout=null,this.setRunningTaskInfo(a,!0),"running"==a.status?
// Check again in one second
this.trackTaskProgress():"pending"==a.status&&
 ...
 */
Craft.CategoryIndex=Craft.BaseElementIndex.extend({$newCategoryBtn:null,onAfterHtmlInit:function(){
// Get the New Category button
this.$newCategoryBtn=this.$sidebar.find("> .buttons > .btn"),this.base()},getDefaultSourceKey:function(){
// Did they request a specific category group in the URL?
if("index"==this.settings.context&&"undefined"!=typeof defaultGroupHandle)for(var b=0;b<this.$sources.length;b++){var c=a(this.$sources[b]);if(c.data("handle")==defaultGroupHandle)return c.data("key")}return this.base()},onSelectSource:function(){if("index"==this.settings.context){
// Get the handle of the selected source
var a=this.$source.data("handle");
// Update the URL
if("undefined"!=typeof history){var b="categories";a&&(b+="/"+a),history.replaceState({},"",Craft.getUrl(b))}
// Update the New Category button
this.$newCategoryBtn.attr("href",Craft.getUrl("categories/"+a+"/new"))}this.base()}}),
// Register it!
...
var d=parseInt(this.$tr.attr("data-id").substr(this.table.settings.rowIdPrefix.length));d>this.table.biggestId&&(this.table.biggestId=d),this.$textareas=a(),this.niceTexts=[];var e={},f=0;for(var g in this.table.columns){var h=this.table.columns[g];Craft.inArray(h.type,Craft.EditableTable.textualColTypes)&&($textarea=a("textarea",this.$tds[f]),this.$textareas=this.$textareas.add($textarea),this.addListener($textarea,"focus","onTextareaFocus"),this.addListener($textarea,"mousedown","ignoreNextTextareaFocus"),this.niceTexts.push(new Garnish.NiceText($textarea,{onHeightChange:a.proxy(this,"onTextareaHeightChange")})),("singleline"==h.type||"number"==h.type)&&(this.addListener($textarea,"keypress",{type:h.type},"validateKeypress"),this.addListener($textarea,"textchange",{type:h.type},"validateValue")),e[g]=$textarea),f++}
// Now that all of the text cells have been nice-ified, let's normalize the heights
this.onTextareaHeightChange();
// Now look for any autopopulate columns
for(var g in this.table.columns){var h=this.table.columns[g];h.autopopulate&&"undefined"!=typeof e[h.autopopulate]&&!e[g].val()&&("handle"==h.autopopulate?new Craft.HandleGenerator(e[g],e[h.autopopulate]):new Craft.BaseInputGenerator(e[g],e[h.autopopulate]))}var i=this.$tr.children().last().find(".delete");this.addListener(i,"click","deleteRow")},onTextareaFocus:function(b){this.onTextareaHeightChange();var c=a(b.currentTarget);return c.data("ignoreNextFocus")?void c.data("ignoreNextFocus",!1):void setTimeout(function(){var a=c.val();
...
"FORM"==this.$trigger.prop("nodeName")?this.addListener(this.$trigger,"submit","handleTriggerActivation"):this.addListener(this.$trigger,"click","handleTriggerActivation")),this.updateTrigger(),Craft.elementIndex.elementSelect.on("selectionChange",a.proxy(this,"updateTrigger"))},updateTrigger:function(){
// Ignore if the last element was just unselected
0!=Craft.elementIndex.elementSelect.totalSelected&&(this.validateSelection()?this.enableTrigger():this.disableTrigger())},/**
	 * Determines if this action can be performed on the currently selected elements.
	 *
	 * @return boolean
	 */
validateSelection:function(){var a=!0;return this.$selectedItems=Craft.elementIndex.elementSelect.$selectedItems,!this.settings.batch&&this.$selectedItems.length>1?a=!1:"function"==typeof this.settings.validateSelection&&(a=this.settings.validateSelection(this.$selectedItems)),a},enableTrigger:function(){this.triggerEnabled||(this.$trigger.removeClass("disabled"),this.triggerEnabled=!0)},disableTrigger:function(){this.triggerEnabled&&(this.$trigger.addClass("disabled"),this.triggerEnabled=!1)},handleTriggerActivation:function(a){a.preventDefault(),a.stopPropagation(),this.triggerEnabled&&this.settings.activate(this.$selectedItems)}},{defaults:{type:null,batch:!0,validateSelection:null,activate:null}}),/**
 * Element editor
 */
Craft.ElementEditor=Garnish.Base.extend({$element:null,elementId:null,locale:null,$form:null,$fieldsContainer:null,$cancelBtn:null,$saveBtn:null,$spinner:null,$localeSelect:null,$localeSpinner:null,hud:null,init:function(b){this.$element=b,this.elementId=b.data("id"),this.$element.addClass("loading");var c={elementId:this.elementId,locale:this.$element.data("locale"),includeLocales:!0};Craft.postActionRequest("elements/get-editor-html",c,a.proxy(this,"showHud"))},showHud:function(b,c){if(this.$element.removeClass("loading"),"success"==c){var d=a();if(b.locales){var e=a('<div class="header"/>'),f=a('<div class="select"/>').appendTo(e);this.$localeSelect=a("<select/>").appendTo(f),this.$localeSpinner=a('<div class="spinner hidden"/>').appendTo(e);for(var g=0;g<b.locales.length;g++){var h=b.locales[g];a('<option value="'+h.id+'"'+(h.id==b.locale?' selected="selected"':"")+">"+h.name+"</option>").appendTo(this.$localeSelect)}this.addListener(this.$localeSelect,"change","switchLocale"),d=d.add(e)}this.$form=a("<form/>"),this.$fieldsContainer=a('<div class="fields"/>').appendTo(this.$form),this.updateForm(b);var i=a('<div class="footer"/>').appendTo(this.$form);this.$spinner=a('<div class="spinner hidden"/>').appendTo(i);var j=a('<div class="buttons right"/>').appendTo(i);this.$cancelBtn=a('<div class="btn">'+Craft.t("Cancel")+"</div>").appendTo(j),this.$saveBtn=a('<input class="btn submit" type="submit" value="'+Craft.t("Save")+'"/>').appendTo(j),d=d.add(this.$form),this.hud=new Garnish.HUD(this.$element,d,{bodyClass:"body elementeditor",closeOtherHUDs:!1}),this.hud.on("hide",a.proxy(function(){delete this.hud},this)),this.addListener(this.$form,"submit","saveElement"),this.addListener(this.$cancelBtn,"click",function(){this.hud.hide()})}},switchLocale:function(){var b=this.$localeSelect.val();if(b!=this.locale){this.$localeSpinner.removeClass("hidden");var c={elementId:this.elementId,locale:b};Craft.postActionRequest("elements/get-editor-html",c,a.proxy(function(a,b){this.$localeSpinner.addClass("hidden"),"success"==b?this.updateForm(a):this.$localeSelect.val(this.locale)},this))}},updateForm:function(b){this.locale=b.locale,this.$fieldsContainer.html(b.html),Garnish.requestAnimationFrame(a.proxy(function(){Craft.appendHeadHtml(b.headHtml),Craft.appendFootHtml(b.footHtml),Craft.initUiElements(this.$fieldsContainer)},this))},saveElement:function(b){b.preventDefault(),this.$spinner.removeClass("hidden");var c=this.$form.serialize();Craft.postActionRequest("elements/save-element",c,a.proxy(function(a,b){if(this.$spinner.addClass("hidden"),"success"==b)if("success"==b&&a.success){if(this.locale==this.$element.data("locale")){
// Update the label
...
// Update Live Preview
"undefined"!=typeof Craft.livePreview&&Craft.livePreview.updateIframe(!0),this.closeHud()}else this.updateForm(a),Garnish.shake(this.hud.$hud)},this))},closeHud:function(){this.hud.hide(),delete this.hud}}),/**
 * Entry index class
 */
Craft.EntryIndex=Craft.BaseElementIndex.extend({$newEntryBtnGroup:null,$newEntryMenuBtn:null,newEntryLabel:null,onAfterHtmlInit:function(){
// Figure out if there are multiple sections that entries can be created in
this.$newEntryBtnGroup=this.$sidebar.find("> .buttons > .btngroup"),this.$newEntryBtnGroup.length&&(this.$newEntryMenuBtn=this.$newEntryBtnGroup.children(".menubtn"),this.newEntryLabel=this.$newEntryMenuBtn.text()),this.base()},getDefaultSourceKey:function(){
// Did they request a specific section in the URL?
if("index"==this.settings.context&&"undefined"!=typeof defaultSectionHandle){if("singles"==defaultSectionHandle)return"singles";for(var b=0;b<this.$sources.length;b++){var c=a(this.$sources[b]);if(c.data("handle")==defaultSectionHandle)return c.data("key")}}return this.base()},onSelectSource:function(){if("index"==this.settings.context){var b;
// Update the URL
if(
// Get the handle of the selected source
b="singles"==this.$source.data("key")?"singles":this.$source.data("handle"),"undefined"!=typeof history){var c="entries";b&&(c+="/"+b),history.replaceState({},"",Craft.getUrl(c))}
// Update the New Entry button
this.$newEntryBtnGroup.length&&("singles"!=b&&b?(this.$newEntryBtn?this.$newEntryBtn.remove():this.$newEntryMenuBtn.removeClass("add icon").text(""),this.$newEntryBtn=a('<a class="btn submit add icon"/>').text(this.newEntryLabel).prependTo(this.$newEntryBtnGroup),this.$newEntryBtn.attr("href",Craft.getUrl("entries/"+b+"/new"))):this.$newEntryBtn&&(this.$newEntryBtn.remove(),this.$newEntryBtn=null,this.$newEntryMenuBtn.addClass("add icon").text(this.newEntryLabel)))}this.base()}}),
// Register it!
Craft.registerElementIndexClass("craft\\app\\elements\\Entry",Craft.EntryIndex),/**
 * Handle Generator
 */
Craft.EntryUrlFormatGenerator=Craft.BaseInputGenerator.extend({generateTargetValue:function(a){a=a.replace("/<(.*?)>/g",""),a=a.toLowerCase(),a=Craft.asciiString(a),a=a.replace(/^[^a-z]+/,""),a=a.replace(/[^a-z0-9]+$/,"");
// Get the "words"
var b=Craft.filterArray(a.split(/[^a-z0-9]+/)),c=b.join("-");return c&&this.settings.suffix&&(c+=this.settings.suffix),c}}),Craft.FieldLayoutDesigner=Garnish.Base.extend({$container:null,$tabContainer:null,$unusedFieldContainer:null,$newTabBtn:null,$allFields:null,tabGrid:null,unusedFieldGrid:null,tabDrag:null,fieldDrag:null,init:function(b,c){this.$container=a(b),this.setSettings(c,Craft.FieldLayoutDesigner.defaults),this.$tabContainer=this.$container.children(".fld-tabs"),this.$unusedFieldContainer=this.$container.children(".unusedfields"),this.$newTabBtn=this.$container.find("> .newtabbtn-container > .btn"),this.$allFields=this.$unusedFieldContainer.find(".fld-field"),
// Set up the layout grids
this.tabGrid=new Craft.Grid(this.$tabContainer,Craft.FieldLayoutDesigner.gridSettings),this.unusedFieldGrid=new Craft.Grid(this.$unusedFieldContainer,Craft.FieldLayoutDesigner.gridSettings);for(var d=this.$tabContainer.children(),e=0;e<d.length;e++)this.initTab(a(d[e]));this.fieldDrag=new Craft.FieldLayoutDesigner.FieldDrag(this),this.settings.customizableTabs&&(this.tabDrag=new Craft.FieldLayoutDesigner.TabDrag(this),this.addListener(this.$newTabBtn,"activate","addTab"))},initTab:function(b){if(this.settings.customizableTabs){var c=b.find(".tabs .settings"),d=a('<div class="menu" data-align="center"/>').insertAfter(c),e=a("<ul/>").appendTo(d);a('<li><a data-action="rename">'+Craft.t("Rename")+"</a></li>").appendTo(e),a('<li><a data-action="delete">'+Craft.t("Delete")+"</a></li>").appendTo(e),new Garnish.MenuBtn(c,{onOptionSelect:a.proxy(this,"onTabOptionSelect")})}for(var f=b.children(".fld-tabcontent").children(),g=0;g<f.length;g++)this.initField(a(f[g]))},initField:function(b){var c=b.find(".settings"),d=a('<div class="menu" data-align="center"/>').insertAfter(c),e=a("<ul/>").appendTo(d);b.hasClass("fld-required")?a('<li><a data-action="toggle-required">'+Craft.t("Make not required")+"</a></li>").appendTo(e):a('<li><a data-action="toggle-required">'+Craft.t("Make required")+"</a></li>").appendTo(e),a('<li><a data-action="remove">'+Craft.t("Remove")+"</a></li>").appendTo(e),new Garnish.MenuBtn(c,{onOptionSelect:a.proxy(this,"onFieldOptionSelect")})},onTabOptionSelect:function(b){if(this.settings.customizableTabs){var c=a(b),d=c.data("menu").$trigger.parent().parent().parent(),e=c.data("action");switch(e){case"rename":this.renameTab(d);break;case"delete":this.deleteTab(d)}}},onFieldOptionSelect:function(b){var c=a(b),d=c.data("menu").$trigger.parent(),e=c.data("action");switch(e){case"toggle-required":this.toggleRequiredField(d,c);break;case"remove":this.removeField(d)}},renameTab:function(a){if(this.settings.customizableTabs){var b=a.find(".tabs .tab span"),c=b.text(),d=prompt(Craft.t("Give your tab a name."),c);d&&d!=c&&(b.text(d),a.find(".id-input").attr("name",this.getFieldInputName(d)))}},deleteTab:function(b){if(this.settings.customizableTabs){for(var c=b.find(".fld-field"),d=0;d<c.length;d++){var e=a(c[d]).attr("data-id");this.removeFieldById(e)}this.tabGrid.removeItems(b),this.tabDrag.removeItems(b),b.remove()}},toggleRequiredField:function(b,c){b.hasClass("fld-required")?(b.removeClass("fld-required"),b.find(".required-input").remove(),setTimeout(function(){c.text(Craft.t("Make required"))},500)):(b.addClass("fld-required"),a('<input class="required-input" type="hidden" name="'+this.settings.requiredFieldInputName+'" value="'+b.data("id")+'">').appendTo(b),setTimeout(function(){c.text(Craft.t("Make not required"))},500))},removeField:function(a){var b=a.attr("data-id");a.remove(),this.removeFieldById(b),this.tabGrid.refreshCols(!0)},removeFieldById:function(a){var b=this.$allFields.filter("[data-id="+a+"]:first"),c=b.closest(".fld-tab");b.removeClass("hidden"),c.hasClass("hidden")?(c.removeClass("hidden"),this.unusedFieldGrid.addItems(c),this.settings.customizableTabs&&this.tabDrag.addItems(c)):this.unusedFieldGrid.refreshCols(!0)},addTab:function(){if(this.settings.customizableTabs){var b=a('<div class="fld-tab"><div class="tabs"><div class="tab sel draggable"><span>Tab '+(this.tabGrid.$items.length+1)+'</span><a class="settings icon" title="'+Craft.t("Rename")+'"></a></div></div><div class="fld-tabcontent"></div></div>').appendTo(this.$tabContainer);this.tabGrid.addItems(b),this.tabDrag.addItems(b),this.initTab(b)}},getFieldInputName:function(a){return this.settings.fieldInputName.replace(/__TAB_NAME__/g,Craft.encodeUriComponent(a))}},{gridSettings:{itemSelector:".fld-tab:not(.hidden)",minColWidth:240,percentageWidths:!1,fillMode:"grid",snapToGrid:30},defaults:{customizableTabs:!0,fieldInputName:"fieldLayout[__TAB_NAME__][]",requiredFieldInputName:"requiredFields[]"}}),Craft.FieldLayoutDesigner.BaseDrag=Garnish.Drag.extend({designer:null,$insertion:null,showingInsertion:!1,$caboose:null,draggingUnusedItem:!1,addToTabGrid:!1,/**
	 * Constructor
	 */
...
// Add the edit button
b.find(".tabs .tab").append('<a class="settings icon" title="'+Craft.t("Edit")+'"></a>');
// Remove any hidden fields
var d=b.find(".fld-field"),e=d.filter(".hidden").remove();d=d.not(e),d.prepend('<a class="settings icon" title="'+Craft.t("Edit")+'"></a>');for(var f=0;f<d.length;f++){var g=a(d[f]),h=this.designer.getFieldInputName(c);g.append('<input class="id-input" type="hidden" name="'+h+'" value="'+g.data("id")+'">')}this.designer.fieldDrag.addItems(d),this.designer.initTab(b),
...
// Hide the group too?
if(a.prepend('<a class="settings icon" title="'+Craft.t("Edit")+'"></a>'),this.designer.initField(a),
...
Garnish.$win.trigger("resize"))},hideTarget:function(a){a&&a.length&&("select"==this.type?a.addClass("hidden"):("link"==this.type&&(this.$toggle.removeClass("expanded"),this.$toggle.addClass("collapsed")),a.css("overflow","hidden"),a.velocity("stop"),a.velocity({height:0},"fast",function(){a.addClass("hidden")})))}}),Craft.Grid=Garnish.Base.extend({$container:null,$items:null,items:null,totalCols:null,colPctWidth:null,sizeUnit:null,possibleItemColspans:null,possibleItemPositionsByColspan:null,itemPositions:null,itemColspansByPosition:null,layouts:null,layout:null,itemHeights:null,leftPadding:null,init:function(b,c){this.$container=a(b),
// Is this already a grid?
this.$container.data("grid")&&(Garnish.log("Double-instantiating a grid on an element"),this.$container.data("grid").destroy()),this.$container.data("grid",this),this.setSettings(c,Craft.Grid.defaults),"pct"==this.settings.mode?this.sizeUnit="%":this.sizeUnit="px",this.$items=this.$container.children(this.settings.itemSelector),this.setItems(),this.refreshCols(!0),
// Adjust them when the container is resized
this.addListener(this.$container,"resize","refreshCols"),Garnish.$doc.ready(a.proxy(this,"refreshCols"))},addItems:function(b){this.$items=a().add(this.$items.add(b)),this.setItems(),this.refreshCols(!0)},removeItems:function(b){this.$items=a().add(this.$items.not(b)),this.setItems(),this.refreshCols(!0)},setItems:function(){for(this.setItems._={},this.items=[],this.setItems._.i=0;this.setItems._.i<this.$items.length;this.setItems._.i++)this.items.push(a(this.$items[this.setItems._.i]));delete this.setItems._},refreshCols:function(b){if(this.items.length){if(this.refreshCols._={},
// Check to see if the grid is actually visible
this.refreshCols._.oldHeight=this.$container[0].style.height,this.$container[0].style.height=1,this.refreshCols._.scrollHeight=this.$container[0].scrollHeight,this.$container[0].style.height=this.refreshCols._.oldHeight,0==this.refreshCols._.scrollHeight)return void delete this.refreshCols._;
// Same number of columns as before?
if(this.settings.cols?this.refreshCols._.totalCols=this.settings.cols:this.refreshCols._.totalCols=Math.floor(this.$container.width()/this.settings.minColWidth),0==this.refreshCols._.totalCols&&(this.refreshCols._.totalCols=1),b!==!0&&this.totalCols===this.refreshCols._.totalCols)return void delete this.refreshCols._;if(this.totalCols=this.refreshCols._.totalCols,"grid"==this.settings.fillMode)for(this.refreshCols._.itemIndex=0;this.refreshCols._.itemIndex<this.items.length;){for(
...
if(this.removeListener(this.$items,"resize"),1==this.totalCols)return this.$container.height("auto"),this.$items.show().css({position:"relative",width:"auto",top:0}).css(Craft.left,0),void delete this.refreshCols._;for(this.$items.css("position","absolute"),"pct"==this.settings.mode&&(this.colPctWidth=100/this.totalCols),
// The setup
...
for(this.leftPadding=this.getItemWidth(this.refreshCols._.totalEmptyCols)/2,"fixed"==this.settings.mode&&(this.leftPadding+=(this.$container.width()-this.settings.minColWidth*this.totalCols)/2),this.refreshCols._.i=0;this.refreshCols._.i<this.items.length;this.refreshCols._.i++)this.items[this.refreshCols._.i].css("width",this.getItemWidth(this.layout.colspans[this.refreshCols._.i])+this.sizeUnit).css(Craft.left,this.leftPadding+this.getItemWidth(this.layout.positions[this.refreshCols._.i])+this.sizeUnit);
...
// Remove HTML tags
var b=a.replace("/<(.*?)>/g","");b=b.replace(/['"‘’“”\[\]\(\)\{\}:]/g,""),b=b.toLowerCase(),b=Craft.asciiString(b),b=b.replace(/^[^a-z]+/,"");
// Make it camelCase
...
// Initialize the tabs
var c=this.$pane.children(".tabs"),d=c.find("a");if(d.length){this.tabs={};
// Find the tabs that link to a div on the page
for(var e=0;e<d.length;e++){var f=a(d[e]),g=f.attr("href");g&&"#"==g.charAt(0)&&(this.tabs[g]={$tab:f,$target:a(g)},this.addListener(f,"activate","selectTab")),!this.selectedTab&&f.hasClass("sel")&&(this.selectedTab=g)}document.location.hash&&"undefined"!=typeof this.tabs[document.location.hash]?this.tabs[document.location.hash].$tab.trigger("activate"):this.selectedTab||a(d[0]).trigger("activate")}this.initContent()},/**
	 * Selects a tab.
	 */
selectTab:function(b){if(!this.selectedTab||b.currentTarget!=this.tabs[this.selectedTab].$tab[0]){
// Hide the selected tab
this.deselectTab();var c=a(b.currentTarget).addClass("sel");this.selectedTab=c.attr("href");var d=this.tabs[this.selectedTab].$target;d.removeClass("hidden"),d.hasClass("content")&&(this.hasSidebar&&(this.removeListener(this.$content,"resize"),this.removeListener(this.$sidebar,"resize"),this.removeListener(Garnish.$win,"scroll resize")),this.$content=d,this.initContent()),Garnish.$win.trigger("resize")}},/**
	 * Deselects the current tab.
	 */
deselectTab:function(){this.selectedTab&&(this.tabs[this.selectedTab].$tab.removeClass("sel"),this.tabs[this.selectedTab].$target.addClass("hidden"))},initContent:function(){this.hasSidebar=this.$content.hasClass("has-sidebar"),this.hasSidebar&&(this.$sidebar=this.$content.children(".sidebar"),this.showingSidebar=!0,this.updateResponsiveSidebar(),this.addListener(this.$content,"resize",function(){this.updateResponsiveSidebar(),this.updateSidebarStyles()}),this.addListener(this.$sidebar,"resize","setMinContentSizeForSidebar"),this.setMinContentSizeForSidebar(),this.addListener(Garnish.$win,"scroll resize","updateSidebarStyles"),this.updateSidebarStyles())},updateResponsiveSidebar:function(){this.$content.width()+parseInt(this.$content.css("margin-"+Craft.left))<Craft.Pane.minContentWidthForSidebar?this.showingSidebar&&this.hideSidebar():this.showingSidebar||this.showSidebar()},showSidebar:function(){this.$content.removeClass("hiding-sidebar"),this.$sidebarBtn.remove(),this.showingSidebar=!0,this.updateSidebarStyles(),this.setMinContentSizeForSidebar(),this.peekingSidebar&&this.stopPeeking()},hideSidebar:function(){this.$content.addClass("hiding-sidebar"),this.$sidebarBtn=a('<a class="show-sidebar" title="'+Craft.t("Show sidebar")+'"></a>').appendTo(this.$content),this.addListener(this.$sidebarBtn,"click","togglePeekingSidebar"),this.showingSidebar=!1,this.setMinContentSizeForSidebar()},togglePeekingSidebar:function(){this.peekingSidebar?this.stopPeeking():this.startPeeking(),this.setMinContentSizeForSidebar()},startPeeking:function(){this.$content.animateLeft(194,"fast"),this.$sidebarBtn.addClass("showing").attr("title",Craft.t("Hide sidebar")),this.peekingSidebar=!0,this.updateSidebarStyles(),this.addListener(this.$sidebar,"click",a.proxy(function(a){"A"==a.target.nodeName&&this.togglePeekingSidebar()},this))},stopPeeking:function(){this.$content.animateLeft(0,"fast"),this.$sidebarBtn.removeClass("showing").attr("title",Craft.t("Show sidebar")),this.peekingSidebar=!1,this.removeListener(this.$sidebar,"click")},setMinContentSizeForSidebar:function(){this.showingSidebar||this.peekingSidebar?this.setMinContentSizeForSidebar._minHeight=this.$sidebar.prop("scrollHeight")-48:this.setMinContentSizeForSidebar._minHeight=0,this.$content.css("min-height",this.setMinContentSizeForSidebar._minHeight)},updateSidebarStyles:function(){(this.showingSidebar||this.peekingSidebar)&&(this.updateSidebarStyles._styles={},this.updateSidebarStyles._scrollTop=Garnish.$win.scrollTop(),this.updateSidebarStyles._contentOffset=this.$content.offset().top,this.updateSidebarStyles._contentHeight=this.$content.height()-24,this.updateSidebarStyles._windowHeight=Garnish.$win.height(),
// Have we scrolled passed the top of the content div?
this.updateSidebarStyles._scrollTop>this.updateSidebarStyles._contentOffset-24?(
...
this.updateSidebarStyles._styles.maxHeight=Math.min(this.updateSidebarStyles._contentHeight-(this.updateSidebarStyles._scrollTop-this.updateSidebarStyles._contentOffset),this.updateSidebarStyles._windowHeight-48),this.$sidebar.css(this.updateSidebarStyles._styles))},destroy:function(){this.base(),this.$pane.data("pane",null)}},{minContentWidthForSidebar:514}),/**
 * Password Input
 */
 ...
 * Slug Generator
 */
Craft.SlugGenerator=Craft.BaseInputGenerator.extend({generateTargetValue:function(a){a=a.replace(/<(.*?)>/g,""),a=a.replace(/['"‘’“”\[\]\(\)\{\}:]/g,""),a=a.toLowerCase(),Craft.limitAutoSlugsToAscii&&(a=Craft.asciiString(a));
// Get the "words". Split on anything that is not alphanumeric.
var b=Craft.filterArray(XRegExp.matchChain(a,[XRegExp("[\\p{L}\\p{N}]+")]));return b.length?b.join(Craft.slugWordSeparator):""}}),/**
 * Structure class
 */
...
var d=this.$insertion.next().add(this.$insertion.prev());-1==a.inArray(this.$draggee[0],d)?(this.$insertion.replaceWith(this.$draggee),c=!0):(this.$insertion.remove(),c=!1)}else{var e=this._.$closestTargetLi.children("ul");
// Make sure this is a different parent than the draggee's
if(b&&e.length&&e[0]==b[0])c=!1;else{if(e.length)this._.$closestTargetLi.hasClass("collapsed")&&this._.$closestTarget.children(".toggle").trigger("click");else{var f=a('<div class="toggle" title="'+Craft.t("Show/hide children")+'"/>').prependTo(this._.$closestTarget);this.structure.initToggle(f),e=a("<ul>").appendTo(this._.$closestTargetLi)}this.$draggee.appendTo(e),c=!0}}if(
...
// Make it real
var i=this.$draggee.children(".row").children(".element"),j={structureId:this.structure.id,elementId:i.data("id"),locale:i.data("locale"),prevId:this.$draggee.prev().children(".row").children(".element").data("id"),parentId:this.$draggee.parent("ul").parent("li").children(".row").children(".element").data("id")};Craft.postActionRequest("structures/move-element",j,function(a,b){"success"==b&&Craft.cp.displayNotice(Craft.t("New order saved."))})}}
...
this.draggingLastElements=!c.length,this.maxLevels&&this.draggingLastElements&&this.elementIndex.morePending){
...
// Copy the column widths
this._$firstRowCells=this.elementIndex.$elementContainer.children("tr:first").children();for(var g=b.children(),h=0;h<g.length;h++){var i=a(g[h]);
// Skip the checkbox cell
if(Garnish.hasAttr(i,"data-checkboxcell"))i.remove();else{
// Hard-set the cell widths
var j=a(this._$firstRowCells[h]),k=j.width();
// Is this the title cell?
if(j.width(k),i.width(k),Garnish.hasAttr(j,"data-titlecell")){this._$titleHelperCell=i;var l=parseInt(j.css("padding-"+Craft.left));this._titleHelperCellOuterWidth=k+l-(this.elementIndex.actions?12:0),i.css("padding-"+Craft.left,Craft.StructureTableSorter.BASE_PADDING)}}}return c},/**
	 * Returns whether the draggee can be inserted before a given item.
	 */
canInsertBefore:function(a){return this._loadingDraggeeLevelDelta?!1:this._getLevelBounds(a.prev(),a)!==!1},/**
	 * Returns whether the draggee can be inserted after a given item.
	 */
canInsertAfter:function(a){return this._loadingDraggeeLevelDelta?!1:this._getLevelBounds(a,a.next())!==!1},
// Events
// -------------------------------------------------------------------------
/**
	 * On Drag Start
...
this.elementIndex.maybeLoadMore(),this.base()},/**
	 * On Drag
	 */
...
k.addClass("expanded");
// Add a temporary row
var l=this.elementIndex._createSpinnerRowAfter(i);
// Remove the target item
this.elementIndex.elementSelect&&this.elementIndex.elementSelect.removeItems(this.$targetItem),this.removeItems(this.$targetItem),this.$targetItem.remove(),this.elementIndex._totalVisible--}break}i=i.prev()}Craft.postActionRequest("structures/move-element",h,a.proxy(function(a,b){"success"==b&&(Craft.cp.displayNotice(Craft.t("New position saved.")),this.onPositionChange(),
// Were we waiting on this to complete so we can expand the new parent?
l&&l.parent().length&&(l.remove(),this.elementIndex._expandElement(k,!0)),
// See if we should run any pending tasks
Craft.cp.runPendingTasks())},this))}},onSortChange:function(){this.elementIndex.elementSelect&&this.elementIndex.elementSelect.resetItemOrder(),this._positionChanged=!0,this.base()},onPositionChange:function(){Garnish.requestAnimationFrame(a.proxy(function(){this.trigger("positionChange"),this.settings.onPositionChange()},this))},onReturnHelpersToDraggees:function(){
...
if(this._$firstRowCells.css("width",""),this.draggingLastElements&&this.elementIndex.morePending){
// Update the element index's record of how many items are actually visible
this.elementIndex._totalVisible+=this.newDraggeeIndexes[0]-this.oldDraggeeIndexes[0];var a=this.$draggee.last().nextAll();a.length&&(this.removeItems(a),a.remove(),this.elementIndex.maybeLoadMore())}this.base()},
// Private methods
// =========================================================================
/**
...
_getLevelIndent:function(a){return(a-1)*Craft.StructureTableSorter.LEVEL_INDENT},/**
	 ...
	 */
_getAjaxBaseData:function(a){return{structureId:this.structureId,elementId:a.data("id"),locale:a.find(".element:first").data("locale")}},/**
...
// Create its toggle
a('<span class="toggle expanded" title="'+Craft.t("Show/hide children")+'"></span>').insertAfter(this._updateAncestors._$ancestor.find("> td .move:first"));this._ancestors=this._updateAncestors._newAncestors,delete this._updateAncestors._i,delete this._updateAncestors._$ancestor,delete this._updateAncestors._newAncestors}},
// Static Properties
// =============================================================================
...
// No "add" button
getAddElementsBtn:a.noop,searchForTags:function(){this.searchMenu&&this.killSearchMenu();var b=this.$addTagInput.val();if(b){this.$spinner.removeClass("hidden");for(var c=[],d=0;d<this.$elements.length;d++){var e=a(this.$elements[d]).data("id");e&&c.push(e)}this.settings.sourceElementId&&c.push(this.settings.sourceElementId);var f={search:this.$addTagInput.val(),tagGroupId:this.settings.tagGroupId,excludeIds:c};Craft.postActionRequest("tags/search-for-tags",f,a.proxy(function(b,c){if(this.$spinner.addClass("hidden"),"success"==c){for(var d=a('<div class="menu tagmenu"/>').appendTo(Garnish.$bod),e=a("<ul/>").appendTo(d),g=0;g<b.tags.length;g++){var h=a("<li/>").appendTo(e);a('<a data-icon="tag"/>').appendTo(h).text(b.tags[g].title).data("id",b.tags[g].id)}if(!b.exactMatch){var h=a("<li/>").appendTo(e);a('<a data-icon="+"/>').appendTo(h).text(f.search)}e.find("> li:first-child > a").addClass("hover"),this.searchMenu=new Garnish.Menu(d,{attachToElement:this.$addTagInput,onOptionSelect:a.proxy(this,"selectTag")}),this.addListener(d,"mousedown",a.proxy(function(){this._ignoreBlur=!0},this)),this.searchMenu.show()}},this))}else this.$spinner.addClass("hidden")},selectTag:function(b){var c=a(b),d=c.data("id"),e=c.text(),f=a('<div class="element removable" data-id="'+d+'" data-editable/>').appendTo(this.$elementsContainer),g=a('<input type="hidden" name="'+this.settings.name+'[]" value="'+d+'"/>').appendTo(f);a('<a class="delete icon" title="'+Craft.t("Remove")+'"></a>').appendTo(f),a('<span class="label">'+e+"</span>").appendTo(f);var h=-(f.outerWidth()+10);this.$addTagInput.css("margin-"+Craft.left,h+"px");var i={};if(i["margin-"+Craft.left]=0,this.$addTagInput.velocity(i,"fast"),this.$elements=this.$elements.add(f),this.addElements(f),this.killSearchMenu(),this.$addTagInput.val(""),this.$addTagInput.focus(),!d){
// We need to create the tag first
f.addClass("loading disabled");var j={groupId:this.settings.tagGroupId,title:e};Craft.postActionRequest("tags/create-tag",j,a.proxy(function(a,b){"success"==b&&a.success?(f.attr("data-id",a.id),g.val(a.id),f.removeClass("loading disabled")):(this.removeElement(f),"success"==b&&
// Some sort of validation error that still resulted in  a 200 response. Shouldn't be possible though.
Craft.cp.displayError(Craft.t("An unknown error occurred.")))},this))}},killSearchMenu:function(){this.searchMenu.hide(),this.searchMenu.destroy(),this.searchMenu=null}},{defaults:{tagGroupId:null}}),/**
 * Craft Upgrade Modal
 */
Craft.UpgradeModal=Garnish.Modal.extend({$container:null,$body:null,$compareScreen:null,$checkoutScreen:null,$successScreen:null,$checkoutForm:null,$checkoutLogo:null,$checkoutPrice:null,$checkoutSubmitBtn:null,$checkoutSpinner:null,$checkoutFormError:null,$checkoutSecure:null,clearCheckoutFormTimeout:null,$ccNameInput:null,$ccNumInput:null,$ccMonthInput:null,$ccYearInput:null,$ccCvcInput:null,submittingPurchase:!1,stripePublicKey:null,editions:null,edition:null,init:function(b){this.$container=a('<div id="upgrademodal" class="modal loading"/>').appendTo(Garnish.$bod),this.base(this.$container,a.extend({resizable:!0},b)),Craft.postActionRequest("app/get-upgrade-modal",a.proxy(function(b,c){if(this.$container.removeClass("loading"),"success"==c){if(b.success){this.stripePublicKey=b.stripePublicKey,this.editions=b.editions,this.$container.append(b.modalHtml),this.$compareScreen=this.$container.children("#upgrademodal-compare"),this.$checkoutScreen=this.$container.children("#upgrademodal-checkout"),this.$successScreen=this.$container.children("#upgrademodal-success"),this.$checkoutLogo=this.$checkoutScreen.find(".logo:first"),this.$checkoutPrice=this.$checkoutScreen.find(".price:first"),this.$checkoutForm=this.$checkoutScreen.find("form:first"),this.$checkoutSubmitBtn=this.$checkoutForm.find(".submit:first"),this.$checkoutSpinner=this.$checkoutForm.find(".spinner:first"),this.$ccNameInput=this.$checkoutForm.find("#cc-name"),this.$ccNumInput=this.$checkoutForm.find("#cc-num"),this.$ccMonthInput=this.$checkoutForm.find("#cc-month"),this.$ccYearInput=this.$checkoutForm.find("#cc-year"),this.$ccCvcInput=this.$checkoutForm.find("#cc-cvc"),this.$checkoutSecure=this.$checkoutScreen.find(".secure:first");var d=this.$compareScreen.find(".buybtn");this.addListener(d,"click","onBuyBtnClick");var e=this.$compareScreen.find(".btn.test");this.addListener(e,"click","onTestBtnClick"),this.addListener(this.$checkoutForm,"submit","submitPurchase");var f=this.$checkoutScreen.find("#upgrademodal-cancelcheckout");this.addListener(f,"click","cancelCheckout")}else{var g;g=b.error?b.error:Craft.t("An unknown error occurred."),this.$container.append('<div class="body">'+g+"</div>")}
// Include Stripe.js
a('<script type="text/javascript" src="https://js.stripe.com/v1/"></script>').appendTo(Garnish.$bod)}},this))},onHide:function(){this.clearCheckoutFormInABit(),this.base()},onBuyBtnClick:function(b){var c=a(b.currentTarget);this.edition=c.data("edition");var d=this.editions[this.edition],e=this.getWidth();switch(this.edition){case 1:this.$checkoutLogo.attr("class","logo craftclient").text("Craft Client");break;case 2:this.$checkoutLogo.attr("class","logo craftpro").text("Craft Pro")}d.salePrice?this.$checkoutPrice.html('<span class="listedprice">'+d.formattedPrice+"</span> "+d.formattedSalePrice):this.$checkoutPrice.html(d.formattedPrice),this.clearCheckoutFormTimeout&&clearTimeout(this.clearCheckoutFormTimeout),this.$compareScreen.velocity("stop").animateLeft(-e,"fast",a.proxy(function(){this.$compareScreen.addClass("hidden")},this)),this.$checkoutScreen.velocity("stop").css(Craft.left,e).removeClass("hidden").animateLeft(0,"fast")},onTestBtnClick:function(b){var c={edition:a(b.currentTarget).data("edition")};Craft.postActionRequest("app/test-upgrade",c,a.proxy(function(b,c){if("success"==c){var d=this.getWidth();this.$compareScreen.velocity("stop").animateLeft(-d,"fast",a.proxy(function(){this.$compareScreen.addClass("hidden")},this)),this.onUpgrade()}},this))},cancelCheckout:function(){var b=this.getWidth();this.$compareScreen.velocity("stop").removeClass("hidden").animateLeft(0,"fast"),this.$checkoutScreen.velocity("stop").animateLeft(b,"fast",a.proxy(function(){this.$checkoutScreen.addClass("hidden")},this)),this.clearCheckoutFormInABit()},submitPurchase:function(b){if(b.preventDefault(),!this.submittingPurchase){this.cleanupCheckoutForm();var c=(b.data.pkg,{name:this.$ccNameInput.val(),number:this.$ccNumInput.val(),exp_month:this.$ccMonthInput.val(),exp_year:this.$ccYearInput.val(),cvc:this.$ccCvcInput.val()}),d=!0;c.name||(d=!1,this.$ccNameInput.addClass("error")),Stripe.validateCardNumber(c.number)||(d=!1,this.$ccNumInput.addClass("error")),Stripe.validateExpiry(c.exp_month,c.exp_year)||(d=!1,this.$ccMonthInput.addClass("error"),this.$ccYearInput.addClass("error")),Stripe.validateCVC(c.cvc)||(d=!1,this.$ccCvcInput.addClass("error")),d?(this.submittingPurchase=!0,
// Get a CC token from Stripe.js
this.$checkoutSubmitBtn.addClass("active"),this.$checkoutSpinner.removeClass("hidden"),Stripe.setPublishableKey(this.stripePublicKey),Stripe.createToken(c,a.proxy(function(b,c){if(c.error)this.onPurchaseResponse(),this.showError(c.error.message),Garnish.shake(this.$checkoutForm,"left");else{
// Pass the token along to Elliott to charge the card
var d={ccTokenId:c.id,edition:this.edition,expectedPrice:this.editions[this.edition].salePrice?this.editions[this.edition].salePrice:this.editions[this.edition].price};Craft.postActionRequest("app/purchase-upgrade",d,a.proxy(this,"onPurchaseUpgrade"))}},this))):Garnish.shake(this.$checkoutForm,"left")}},onPurchaseResponse:function(){this.submittingPurchase=!1,this.$checkoutSubmitBtn.removeClass("active"),this.$checkoutSpinner.addClass("hidden")},onPurchaseUpgrade:function(b,c){if(this.onPurchaseResponse(),"success"==c)if(b.success){var d=this.getWidth();this.$checkoutScreen.velocity("stop").animateLeft(-d,"fast",a.proxy(function(){this.$checkoutScreen.addClass("hidden")},this)),this.onUpgrade()}else{if(b.errors){var e="";for(var f in b.errors)e&&(e+="<br>"),e+=b.errors[f];this.showError(e)}else var e=Craft.t("An unknown error occurred.");Garnish.shake(this.$checkoutForm,"left")}},showError:function(b){this.$checkoutFormError=a('<p class="error centeralign">'+b+"</p>").insertBefore(this.$checkoutSecure)},onUpgrade:function(){this.$successScreen.css(Craft.left,this.getWidth()).removeClass("hidden").animateLeft(0,"fast");var a=this.$successScreen.find(".btn:first");this.addListener(a,"click",function(){location.reload()}),this.trigger("upgrade")},cleanupCheckoutForm:function(){this.$checkoutForm.find(".error").removeClass("error"),this.$checkoutFormError&&(this.$checkoutFormError.remove(),this.$checkoutFormError=null)},clearCheckoutForm:function(){this.$ccNameInput.val(""),this.$ccNumInput.val(""),this.$ccMonthInput.val(""),this.$ccYearInput.val(""),this.$ccCvcInput.val("")},clearCheckoutFormInABit:function(){
 ...
 * File Manager.
 */
Craft.Uploader=Garnish.Base.extend({uploader:null,allowedKinds:null,$element:null,settings:null,_rejectedFiles:{},_extensionList:null,_totalFileCounter:0,_validFileCounter:0,init:function(b,c){this._rejectedFiles={size:[],type:[],limit:[]},this.$element=b,this.allowedKinds=null,this._extensionList=null,this._totalFileCounter=0,this._validFileCounter=0,c=a.extend({},this.defaultSettings,c);var d=c.events;delete c.events,c.allowedKinds&&c.allowedKinds.length&&("string"==typeof c.allowedKinds&&(c.allowedKinds=[c.allowedKinds]),this.allowedKinds=c.allowedKinds,delete c.allowedKinds),c.autoUpload=!1,this.uploader=b.fileupload(c);for(var e in d)this.uploader.on(e,d[e]);this.settings=c,this.uploader.on("fileuploadadd",a.proxy(this,"onFileAdd"))},/**
...
return this.getInProgress()<2},/**
	 * Called on file add.
	 */
onFileAdd:function(b,c){b.stopPropagation();var d=!1;if(this.allowedKinds){if(!this._extensionList){this._extensionList=[];for(var e=0;e<this.allowedKinds.length;e++)for(var f=this.allowedKinds[e],g=0;g<Craft.fileKinds[f].length;g++){var h=Craft.fileKinds[f][g];this._extensionList.push(h)}}d=!0}
// Make sure that file API is there before relying on it
return c.process().done(a.proxy(function(){var b=c.files[0],e=!0;if(d){var f=b.name.match(/\.([a-z0-4_]+)$/i),g=f[1];-1==a.inArray(g.toLowerCase(),this._extensionList)&&(e=!1,this._rejectedFiles.type.push("“"+b.name+"”"))}b.size>this.settings.maxFileSize&&(this._rejectedFiles.size.push("“"+b.name+"”"),e=!1),

...
"index"==this.settings.context&&this.addListener(this.$elementContainer,"dblclick",function(b){var c=a(b.target);if("A"!=c.prop("nodeName")){var d;if(c.hasClass("element"))d=c;else if(d=c.closest(".element"),!d.length)return;Garnish.hasAttr(d,"data-editable")&&this.createElementEditor(d)}}),

!function(a){/**
	 ...
	 */
Craft.RichTextInput=Garnish.Base.extend({id:null,linkOptions:null,volumes:null,elementLocale:null,redactorConfig:null,$textarea:null,redactor:null,linkOptionModals:null,init:function(b){
// Redactor I config setting normalization
if(this.id=b.id,this.linkOptions=b.linkOptions,this.volumes=b.volumes,this.transforms=b.transforms,this.elementLocale=b.elementLocale,this.redactorConfig=b.redactorConfig,this.linkOptionModals=[],this.redactorConfig.lang||(this.redactorConfig.lang=b.redactorLang),this.redactorConfig.direction||(this.redactorConfig.direction=b.direction||Craft.orientation),this.redactorConfig.imageUpload=!0,this.redactorConfig.fileUpload=!0,this.redactorConfig.dragImageUpload=!1,this.redactorConfig.dragFileUpload=!1,

...
return this.getWidth._width},_onResizeStart:function(){this.resizeStartWidth=this.getWidth();this.resizeStartHeight=this.getHeight()},_onResize:function(){Garnish.ltr?(this.desiredWidth=this.resizeStartWidth+2*this.resizeDragger.mouseDistX,this.desiredHeight=this.resizeStartHeight+2*this.resizeDragger.mouseDistY):(this.desiredWidth=this.resizeStartWidth-2*this.resizeDragger.mouseDistX,this.desiredHeight=this.resizeStartHeight-2*this.resizeDragger.mouseDistY);this.updateSizeAndPosition()},destroy:function(){this.base();
this.dragger&&this.dragger.destroy();this.resizeDragger&&this.resizeDragger.destroy()}},{relativeElemPadding:8,defaults:{draggable:!1,dragHandleSelector:null,resizable:!1,onShow:c.noop,onHide:c.noop,onFadeIn:c.noop,onFadeOut:c.noop,closeOtherModals:!0},instances:[],visibleModal:null});Garnish.NiceText=Garnish.Base.extend({$input:null,$hint:null,$stage:null,autoHeight:null,focussed:!1,showingHint:!1,val:null,inputBoxSizing:"content-box",height:null,minHeight:null,interval:null,initialized:!1,init:function(a,
b){this.$input=c(a);this.settings=c.extend({},Garnish.NiceText.defaults,b);this.$input.data("nicetext")&&(Garnish.log("Double-instantiating a transparent text input on an element"),this.$input.data("nicetext").destroy());this.$input.data("nicetext",this);this.getVal();if(this.autoHeight=this.settings.autoHeight&&"TEXTAREA"==this.$input.prop("nodeName"))this.minHeight=this.getHeightForValue(""),this.updateHeight(),this.addListener(Garnish.$win,"resize","updateHeight");this.settings.hint&&(this.$hintContainer=
c('<div class="texthint-container"/>').insertBefore(this.$input),this.$hint=c('<div class="texthint">'+this.settings.hint+"</div>").appendTo(this.$hintContainer),this.$hint.css({top:parseInt(this.$input.css("borderTopWidth"))+parseInt(this.$input.css("paddingTop")),left:parseInt(this.$input.css("borderLeftWidth"))+parseInt(this.$input.css("paddingLeft"))+1}),Garnish.copyTextStyles(this.$input,this.$hint),this.val?this.$hint.hide():this.showingHint=!0,this.addListener(this.$hint,"mousedown",function(a){a.preventDefault();
this.$input.focus()}));this.addListener(this.$input,"focus","onFocus");this.addListener(this.$input,"blur","onBlur");this.addListener(this.$input,"keydown","onKeyDown");this.initialized=!0},getVal:function(){return this.val=this.$input.val()},showHint:function(){this.$hint.fadeIn(Garnish.NiceText.hintFadeDuration);this.showingHint=!0},hideHint:function(){this.$hint.fadeOut(Garnish.NiceText.hintFadeDuration);this.showingHint=!1},checkInput:function(){var a=this.val!==this.getVal();a&&(this.$hint&&
(this.showingHint&&this.val?this.hideHint():this.showingHint||this.val||this.showHint()),this.autoHeight&&this.updateHeight());return a},buildStage:function(){this.$stage=c("<stage/>").appendTo(Garnish.$bod);this.$stage.css({display:"block",position:"absolute",top:-9999,left:-9999,wordWrap:"break-word"});this.inputBoxSizing=this.$input.css("box-sizing");"border-box"==this.inputBoxSizing&&this.$stage.css({"border-top":this.$input.css("border-top"),"border-right":this.$input.css("border-right"),"border-bottom":this.$input.css("border-bottom"),
"border-left":this.$input.css("border-left"),"padding-top":this.$input.css("padding-top"),"padding-right":this.$input.css("padding-right"),"padding-bottom":this.$input.css("padding-bottom"),"padding-left":this.$input.css("padding-left"),"-webkit-box-sizing":this.inputBoxSizing,"-moz-box-sizing":this.inputBoxSizing,"box-sizing":this.inputBoxSizing});Garnish.copyTextStyles(this.$input,this.$stage)},getHeightForValue:function(a){this.$stage||this.buildStage();"border-box"==this.inputBoxSizing?this.$stage.css("width",
this.$input.outerWidth()):this.$stage.css("width",this.$input.width());if(a)a=a.replace(/&/g,"&amp;"),a=a.replace(/</g,"&lt;"),a=a.replace(/>/g,"&gt;"),a=a.replace(/ /g,"&nbsp;"),a=a.replace(/[\n\r]$/g,"<br/>&nbsp;"),a=a.replace(/[\n\r]/g,"<br/>");else{a="&nbsp;";for(var b=1;b<this.$input.prop("rows");b++)a+="<br/>&nbsp;"}this.$stage.html(a);this.getHeightForValue._height="border-box"==this.inputBoxSizing?this.$stage.outerHeight():this.$stage.height();this.minHeight&&this.getHeightForValue._height<
...
!1;clearInterval(this.interval);this.checkInput()},onKeyDown:function(){setTimeout(c.proxy(this,"checkInput"),1)},destroy:function(){this.base();null!==this.$hint&&this.$hint.remove();null!==this.$stage&&this.$stage.remove()}},{interval:100,hintFadeDuration:50,defaults:{autoHeight:!0,onHeightChange:c.noop}});Garnish.Pill=Garnish.Base.extend({$outerContainer:null,$innerContainer:null,$btns:null,$selectedBtn:null,$input:null,init:function(a){this.$outerContainer=c(a);this.$outerContainer.data("pill")&&

...
a.prop("nodeName")},onFocus:function(a){this.elements.length?(a=this.elements[0],this.setFocus(a),this.setCarotPos(a,0)):this.addTextElement()},addTextElement:function(a){var b=new q(this);this.addElement(b.$input,a);return b},addElement:function(a,b){if("undefined"==typeof b)if(this.focussedElement){var e=this.focussedElement,d=this.getElementIndex(e);if(this.isText(e)){var f=e.prop("selectionStart"),g=e.prop("selectionEnd"),k=e.val(),f=k.substring(0,f),g=k.substr(g);f&&g?(e.val(f).trigger("change"),
e=new q(this),e.$input.val(g).trigger("change"),this.addElement(e.$input,d+1),b=d+1):b=f?d+1:d}else b=d+1}else b=this.elements.length;"undefined"!=typeof this.elements[b]?(a.insertBefore(this.elements[b]),this.elements.splice(b,0,a)):(b=this.elements.length,this.$container.append(a),this.elements.push(a));this.isText(a)||(0!=b&&this.isText(this.elements[b-1])||(this.addTextElement(b),b++),b!=this.elements.length-1&&this.isText(this.elements[b+1])||this.addTextElement(b+1));this.addListener(a,"click",
...
this.getElementIndex(a);if(0<a&&(a=this.elements[a-1],this.setFocus(a),this.isText(a))){var b=a.val().length;this.setCarotPos(a,b)}},focusNextElement:function(a){a=this.getElementIndex(a);a<this.elements.length-1&&(a=this.elements[a+1],this.setFocus(a),this.isText(a)&&this.setCarotPos(a,0))},setCarotPos:function(a,b){a.prop("selectionStart",b);a.prop("selectionEnd",b)}});var q=Garnish.Base.extend({parentInput:null,$input:null,$stage:null,val:null,focussed:!1,interval:null,init:function(a){this.parentInput=
a;this.$input=c('<input type="text"/>').appendTo(this.parentInput.$container);this.$input.css("margin-right",2-q.padding+"px");this.setWidth();this.addListener(this.$input,"focus","onFocus");this.addListener(this.$input,"blur","onBlur");this.addListener(this.$input,"keydown","onKeyDown");this.addListener(this.$input,"change","checkInput")},getIndex:function(){return this.parentInput.getElementIndex(this.$input)},buildStage:function(){this.$stage=c("<stage/>").appendTo(Garnish.$bod);this.$stage.css({position:"absolute",

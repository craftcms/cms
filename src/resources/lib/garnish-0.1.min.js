...
Garnish.Menu.defaults);this.$container=c(a);this.$options=this.$container.find("a");this.$options.data("menu",this);this.settings.attachToElement&&(this.$trigger=c(this.settings.attachToElement));this.addListener(this.$container,"mousedown",function(a){a.stopPropagation()});this.addListener(this.$options,"click","selectOption")},setPositionRelativeToTrigger:function(){var a=Garnish.$win.height(),b=Garnish.$win.scrollTop(),c=this.$trigger.offset(),e=this.$trigger.outerWidth(),f=this.$trigger.outerHeight(),

...
if(!this.showing){if(this.settings.closeOtherHUDs)for(var b in Garnish.HUD.activeHUDs)Garnish.HUD.activeHUDs[b].hide();this.$hud.css("top",Garnish.$win.scrollTop());this.$hud.show();this.determineBestPosition();this.setPosition();this.$shade.show();this.showing=!0;Garnish.HUD.activeHUDs[this._namespace]=this;Garnish.escManager.register(this,"hide");this.addListener(Garnish.$win,"resize",function(){this.updateElementProperties();this.setPosition()});this.addListener(this.$shade,"click","hide");this.settings.closeBtn&&
this.addListener(this.settings.closeBtn,"activate","hide");this.onShow()}},onShow:function(){this.trigger("show")},updateElementProperties:function(){this.windowWidth=Garnish.$win.width();this.windowHeight=Garnish.$win.height();this.windowScrollLeft=Garnish.$win.scrollLeft();this.windowScrollTop=Garnish.$win.scrollTop();this.triggerWidth=this.$trigger.outerWidth();this.triggerHeight=this.$trigger.outerHeight();this.triggerOffset=this.$trigger.offset();this.triggerOffset.right=this.triggerOffset.left+
this.triggerWidth;this.triggerOffset.bottom=this.triggerOffset.top+this.triggerHeight;this.width=this.$hud.outerWidth();this.height=this.$hud.outerHeight()},determineBestPosition:function(){this.updateElementProperties();this.minHorizontalClearance=this.width+this.settings.triggerSpacing+this.settings.windowSpacing;this.minVerticalClearance=this.height+this.settings.triggerSpacing+this.settings.windowSpacing;var a=[this.triggerOffset.top-this.windowScrollTop,this.windowWidth+this.windowScrollLeft-
this.triggerOffset.right,this.windowHeight+this.windowScrollTop-this.triggerOffset.bottom,this.triggerOffset.left-this.windowScrollLeft],b=Math.max.apply(null,a),a=c.inArray(b,a);this.position=Garnish.HUD.positions[a];this.tipClass&&this.$tip.removeClass(this.tipClass);this.tipClass=this.settings.tipClass+"-"+Garnish.HUD.tipClasses[a];this.$tip.addClass(this.tipClass)},setPosition:function(){if("top"==this.position||"bottom"==this.position){var a=this.windowWidth+this.windowScrollLeft-(this.width+
this.settings.windowSpacing),b=this.windowScrollLeft+this.settings.windowSpacing,c=this.triggerOffset.left+Math.round(this.triggerWidth/2),e=c-Math.round(this.width/2);e>a&&(e=a);e<b&&(e=b);this.$hud.css("left",e);this.$tip.css({left:c-e-this.settings.tipWidth/2,top:""});a="top"==this.position?this.triggerOffset.top-(this.height+this.settings.triggerSpacing):this.triggerOffset.bottom+this.settings.triggerSpacing;this.$hud.css("top",a)}else b=this.windowHeight+this.windowScrollTop-(this.height+this.settings.windowSpacing),
e=this.windowScrollTop+this.settings.windowSpacing,c=this.triggerOffset.top+Math.round(this.triggerHeight/2),a=c-Math.round(this.height/2),a>b&&(a=b),a<e&&(a=e),this.$hud.css("top",a),this.$tip.css({top:c-a-this.settings.tipWidth/2,left:""}),e="left"==this.position?this.triggerOffset.left-(this.width+this.settings.triggerSpacing):this.triggerOffset.right+this.settings.triggerSpacing,this.$hud.css("left",e)},hide:function(){this.$hud.hide();this.$shade.remove();this.showing=!1;delete Garnish.HUD.activeHUDs[this._namespace];
Garnish.escManager.unregister(this);this.onHide()},onHide:function(){this.trigger("hide")}},{positions:["top","right","bottom","left"],tipClasses:["bottom","left","top","right"],defaults:{hudClass:"hud",tipClass:"tip",bodyClass:"body",triggerSpacing:7,windowSpacing:20,tipWidth:8,onShow:c.noop,onHide:c.noop,closeBtn:null,closeOtherHUDs:!0}});Garnish.LightSwitch=Garnish.Base.extend({settings:null,$outerContainer:null,$innerContainer:null,$input:null,$toggleTarget:null,on:null,dragger:null,dragStartMargin:null,

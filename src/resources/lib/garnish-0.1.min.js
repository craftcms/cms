...
a>=h||a>=l?f:g-h;(f=this.$container.data("align"))||(f="left");Garnish.$bod.hasClass("rtl")&&("left"==f?f="right":"right"==f&&(f="left"));switch(f){case "right":b.right=Garnish.$win.width()-(c.left+e);break;case "center":b.left=Math.round(c.left+e/2-this.$container.outerWidth()/2);break;case "left":b.left=c.left}this.$container.css(b)},show:function(){this.$trigger&&this.setPositionRelativeToTrigger();this.$container.fadeIn(50);Garnish.escManager.register(this,"hide")},hide:function(){this.$container.fadeOut("fast");

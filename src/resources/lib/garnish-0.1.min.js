...
b}else if(a){var f=h.prototype.extend;h._prototyping||"function"==typeof this||(f=this.extend||f);for(var g={toSource:null},k=["constructor","toString","valueOf"],p=h._prototyping?0:1;l=k[p++];)a[l]!=g[l]&&f.call(this,l,a[l]);for(var l in a)g[l]||f.call(this,l,a[l])}return this}};h=h.extend({constructor:function(a){this.extend(a)}},{ancestor:Object,version:"1.1",forEach:function(a,b,d){for(var c in a)void 0===this.prototype[c]&&b.call(d,a[c],c,a)},implement:function(){for(var a=0;a<arguments.length;a++)if("function"==

...
"_onResize")}));this.addListener(this.$container,"click",function(a){a.stopPropagation()});this.visible&&this.show()},show:function(){this.settings.closeOtherModals&&Garnish.Modal.visibleModal&&Garnish.Modal.visibleModal!=this&&Garnish.Modal.visibleModal.hide();this.$container&&(this.$shade.appendTo(Garnish.$bod),this.$container.appendTo(Garnish.$bod),this.$container.show(),this.updateSizeAndPosition(),this.$shade.fadeIn(50),this.$container.delay(50).fadeIn(c.proxy(this,"onFadeIn")),this.addListener(this.$shade,
"click","hide"),this.addListener(Garnish.$win,"resize","updateSizeAndPosition"));Garnish.escManager.register(this,"hide");this.visible||(this.visible=!0,Garnish.Modal.visibleModal=this,this.settings.onShow())},hide:function(a){a&&a.stopPropagation();this.$container&&(this.$container.fadeOut("fast"),this.$shade.fadeOut("fast",c.proxy(this,"onFadeOut")),this.removeListener(this.$shade,"click"),this.removeListener(Garnish.$win,"resize"));this.visible=!1;Garnish.Modal.visibleModal=null;Garnish.escManager.unregister(this);

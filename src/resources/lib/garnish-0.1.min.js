...
!0));if(-1!=b.search(/\bresize\b/))for(d=0;d<f.length;d++)(function(a){a==window||document.attachEvent||a.__resizeTriggers__||("static"==getComputedStyle(a).position&&(a.style.position="relative"),a.__resizeLast__={},a.__resizeTriggers__=document.createElement("div"),a.__resizeTriggers__.className="resize-triggers",a.__resizeTriggers__.innerHTML='<div class="expand-trigger"><div></div></div><div class="contract-trigger"></div>',c(a.__resizeTriggers__).prependTo(a),q(a),a.addEventListener("scroll",
r,!0),Garnish.$win.on("resize",function(){r.apply(a)}))})(f[d])},removeListener:function(a,b){b=this._formatEvents(b);c(a).off(b)},removeAllListeners:function(a){c(a).off(this._namespace)},destroy:function(){this.removeAllListeners(this._$listeners)}});if(!document.attachEvent)var s=function(){var a=window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||function(a){return window.setTimeout(a,20)};return function(b){return a(b)}}(),t=function(){var a=window.cancelAnimationFrame||
window.mozCancelAnimationFrame||window.webkitCancelAnimationFrame||window.clearTimeout;return function(b){return a(b)}}(),q=function(a){var b=a.__resizeTriggers__;a=b.firstElementChild;var b=b.lastElementChild,c=a.firstElementChild;b.scrollLeft=b.scrollWidth;b.scrollTop=b.scrollHeight;c.style.width=a.offsetWidth+1+"px";c.style.height=a.offsetHeight+1+"px";a.scrollLeft=a.scrollWidth;a.scrollTop=a.scrollHeight},r=function(a){var b=this;q(b);b.__resizeRAF__&&t(b.__resizeRAF__);b.__resizeRAF__=s(function(){if(b.offsetWidth!=
b.__resizeLast__.width||b.offsetHeight!=b.__resizeLast__.height)b.__resizeLast__.width=b.offsetWidth,b.__resizeLast__.height=b.offsetHeight,c(b).trigger("resize")})};Garnish.BaseDrag=Garnish.Base.extend({$items:null,dragging:!1,mousedownX:null,mousedownY:null,mouseDistX:null,mouseDistY:null,$targetItem:null,targetItemMouseDiffX:null,targetItemMouseDiffY:null,mouseX:null,mouseY:null,lastMouseX:null,lastMouseY:null,scrollProperty:null,scrollDir:null,_:null,init:function(a,b){!b&&c.isPlainObject(a)&&
(b=a,a=null);this.settings=c.extend({},Garnish.BaseDrag.defaults,b);this.$items=c();this._={};a&&this.addItems(a)},onMouseDown:function(a){if(a.which==Garnish.PRIMARY_CLICK&&!this.$targetItem){if(a.currentTarget!=a.target&&this.settings.ignoreHandleSelector){var b=c(a.target);if(b.is(this.settings.ignoreHandleSelector)||b.closest(this.settings.ignoreHandleSelector).length)return}a.preventDefault();this.$targetItem=c(c.data(a.currentTarget,"drag-item"));this.mousedownX=this.mouseX=a.pageX;this.mousedownY=

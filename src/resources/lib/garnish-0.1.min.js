...
this.callbackFrame=null);this.callbackFrame=Garnish.requestAnimationFrame(c.proxy(function(){this.callbackFrame=null;this.trigger("selectionChange");this.settings.onSelectionChange()},this))},_actAsCheckbox:function(a){return Garnish.isCtrlKeyPressed(a)?!this.settings.checkboxMode:this.settings.checkboxMode},_canDeselect:function(a){return this.settings.allowEmpty||this.totalSelected>a.length},_selectItems:function(a){a.addClass(this.settings.selectedClass);this.$selectedItems=this.$selectedItems.add(a);
...
midpointSizeFunc:"outerHeight",rowOffset:"left"},y:{midpointOffset:"left",midpointSizeFunc:"outerWidth",rowOffset:"top"}},closestItemDirectionProps:{"<":{step:-1,isNextRow:function(a,b){return a<b},isWrongDirection:function(a,b){return a>b}},">":{step:1,isNextRow:function(a,b){return a>b},isWrongDirection:function(a,b){return a<b}}}});Garnish.SelectMenu=Garnish.Menu.extend({init:function(a,b,e,d){"function"==typeof e&&(d=e,e={});e=c.extend({},Garnish.SelectMenu.defaults,e);this.base(a,b,e,d);this.selected=

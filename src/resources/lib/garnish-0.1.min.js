...
"mousedown","onMouseDown")},onMouseDown:function(a){a.which!=Garnish.PRIMARY_CLICK||a.metaKey||(a.preventDefault(),this.showingMenu?this.hideMenu():this.showMenu())},showMenu:function(){this.menu.show();this.$btn.addClass("active");this.showingMenu=!0;setTimeout(c.proxy(function(){this.addListener(Garnish.$doc,"mousedown","onMouseDown")},this),1);Garnish.isMobileBrowser()||this.addListener(Garnish.$win,"resize","hideMenu")},hideMenu:function(){this.menu.hide()},onMenuHide:function(){this.$btn.removeClass("active");
this.showingMenu=!1;this.removeListener(Garnish.$doc,"mousedown");Garnish.isMobileBrowser()||this.removeListener(Garnish.$doc,"resize")},onOptionSelect:function(a){this.settings.onOptionSelect(a)}},{defaults:{onOptionSelect:c.noop}});Garnish.MixedInput=Garnish.Base.extend({$container:null,elements:null,focussedElement:null,blurTimeout:null,init:function(a,b){this.$container=c(a);this.setSettings(b,Garnish.MixedInput.defaults);this.elements=[];this.$container.attr("tabindex",0);this.addListener(this.$container,
"focus","onFocus")},getElementIndex:function(a){return c.inArray(a,this.elements)},isText:function(a){return"INPUT"==a.prop("nodeName")},onFocus:function(a){this.elements.length?(a=this.elements[0],this.setFocus(a),this.setCarotPos(a,0)):this.addTextElement()},addTextElement:function(a){var b=new n(this);this.addElement(b.$input,a);return b},addElement:function(a,b){if("undefined"==typeof b)if(this.focussedElement){var d=this.focussedElement,e=this.getElementIndex(d);if(this.isText(d)){var f=d.prop("selectionStart"),
g=d.prop("selectionEnd"),k=d.val(),f=k.substring(0,f),g=k.substr(g);f&&g?(d.val(f).trigger("change"),d=new n(this),d.$input.val(g).trigger("change"),this.addElement(d.$input,e+1),b=e+1):b=f?e+1:e}else b=e+1}else b=this.elements.length;"undefined"!=typeof this.elements[b]?(a.insertBefore(this.elements[b]),this.elements.splice(b,0,a)):(b=this.elements.length,this.$container.append(a),this.elements.push(a));this.isText(a)||(0!=b&&this.isText(this.elements[b-1])||(this.addTextElement(b),b++),b!=this.elements.length-
...
"blur");this.focussedElement.attr("tabindex","-1")},focusPreviousElement:function(a){a=this.getElementIndex(a);if(0<a&&(a=this.elements[a-1],this.setFocus(a),this.isText(a))){var b=a.val().length;this.setCarotPos(a,b)}},focusNextElement:function(a){a=this.getElementIndex(a);a<this.elements.length-1&&(a=this.elements[a+1],this.setFocus(a),this.isText(a)&&this.setCarotPos(a,0))},setCarotPos:function(a,b){a.prop("selectionStart",b);a.prop("selectionEnd",b)}});var n=Garnish.Base.extend({parentInput:null,
$input:null,$stage:null,val:null,focussed:!1,interval:null,init:function(a){this.parentInput=a;this.$input=c('<input type="text"/>').appendTo(this.parentInput.$container);this.$input.css("margin-right",2-n.padding+"px");this.setWidth();this.addListener(this.$input,"focus","onFocus");this.addListener(this.$input,"blur","onBlur");this.addListener(this.$input,"keydown","onKeyDown");this.addListener(this.$input,"change","checkInput")},getIndex:function(){return this.parentInput.getElementIndex(this.$input)},
...
destroy:function(){this.base();this.dragger&&this.dragger.destroy();this.resizeDragger&&this.resizeDragger.destroy()}},{relativeElemPadding:8,defaults:{draggable:!1,dragHandleSelector:null,resizable:!1,onShow:c.noop,onHide:c.noop,onFadeIn:c.noop,onFadeOut:c.noop,closeOtherModals:!0},instances:[],visibleModal:null});Garnish.NiceText=Garnish.Base.extend({$input:null,$hint:null,$stage:null,autoHeight:null,focussed:!1,showingHint:!1,val:null,inputBoxSizing:"content-box",height:null,minHeight:null,interval:null,
initialized:!1,init:function(a,b){this.$input=c(a);this.settings=c.extend({},Garnish.NiceText.defaults,b);this.$input.data("nicetext")&&(Garnish.log("Double-instantiating a transparent text input on an element"),this.$input.data("nicetext").destroy());this.$input.data("nicetext",this);this.getVal();if(this.autoHeight=this.settings.autoHeight&&"TEXTAREA"==this.$input.prop("nodeName"))this.minHeight=this.getHeightForValue(""),this.updateHeight(),this.addListener(Garnish.$win,"resize","updateHeight");

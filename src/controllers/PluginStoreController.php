...
class PluginStoreController extends Controller
{
    ...
    public function actionDisconnect(): Response
    {
        ...
        try {
            ...
            $this->setSuccessFlash(Craft::t('app', 'Disconnected from console.craftcms.com.'));
        } catch (Throwable $e) {
            Craft::error('Couldn’t revoke token: ' . $e->getMessage());
            $this->setFailFlash(Craft::t('app', 'Disconnected from console.craftcms.com with errors, check the logs.'));
        }

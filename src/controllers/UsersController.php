...
class UsersController extends Controller
{
    ...
    public function actionEditUser($userId = null, ?User $user = null, ?array $errors = null): Response
    {
        ...
        $addressesHtml = $this->_addressCardsHtml($user->getAddresses());
...
JS,
     ...
     * @return string
     */
    public function actionRenderAddresses(): string
    {
        $namespace = Craft::$app->getRequest()->getParam('namespace');
     ...
     * @return Response|null
     */
    public function actionRenderAddress(): ?Response
    {
...
//                    'indicator' => sprintf('#%s', $view->namespaceInputId('address-card')),
            ...
            $html .= Html::tag('button', Craft::t('app', 'Add an address'),
                [
                    ...
                    'hx' => [
                        'get' => UrlHelper::actionUrl('users/add-address'),
                    ]
                ]);

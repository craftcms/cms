...
class UsersController extends Controller
{
    ...
    public function actionLoginWithPasskey(): ?Response
    {
        ...
        $duration = \CraftCms\Cms\Craft::generalConfig()->userSessionDuration;
    ...
    public function actionSessionInfo(): Response
    {
        ...
        if (\CraftCms\Cms\Craft::generalConfig()->enableCsrfProtection) {
            $return['csrfTokenName'] = \CraftCms\Cms\Craft::generalConfig()->csrfTokenName;
    ...
    public function actionLogout(): Response
    {
        ...
        return $this->asSuccess(
            data: $data,
            redirect: \CraftCms\Cms\Craft::generalConfig()->getPostLogoutRedirect()
        );
    }
    ...
    public function actionSendPasswordResetEmail(): ?Response
    {
        ...
        if (!isset($user)) {
            ...
            if (!$loginName) {
                ...
                $errors[] = \CraftCms\Cms\Craft::generalConfig()->useEmailAsUsername
        ...
        if (\CraftCms\Cms\Craft::generalConfig()->preventUserEnumeration) {
    ...
    public function actionSetPassword(): Response
    {
        ...
        if ($this->request->getAcceptsJson()) {
            ...
            if (!Craft::$app->getUser()->getIsGuest() && \CraftCms\Cms\Craft::generalConfig()->enableCsrfProtection) {
                $return['csrfTokenValue'] = $this->request->getCsrfToken();
            }
        ...
        if ($this->request->getIsCpRequest()) {
            ...
            $setPasswordSuccessPath = \CraftCms\Cms\Craft::generalConfig()->getSetPasswordSuccessPath();
    ...
    public function actionPreferences(): Response
    {
        ...
        if (
            ...
            $userLocale = \CraftCms\Cms\Craft::generalConfig()->defaultCpLocale;
        }
...
JS);
    ...
    public function actionAuthForm(): Response
    {
        ...
        if (!$user) {
            if ($this->request->getIsSiteRequest()) {
                $loginPath = \CraftCms\Cms\Craft::generalConfig()->getLoginPath();
                if (!$loginPath) {
        ...
        if (!$returnUrl) {
            if ($this->request->getIsCpRequest()) {
                ...
                $defaultReturnUrl = UrlHelper::cpUrl(\CraftCms\Cms\Craft::generalConfig()->getPostCpLoginRedirect());
            } else {
                $defaultReturnUrl = UrlHelper::siteUrl(\CraftCms\Cms\Craft::generalConfig()->getPostLoginRedirect());
            }
    ...
    private function _redirectUserToCp(User $user): ?Response
    {
        ...
        if ($user->can('accessCp')) {
            $postCpLoginRedirect = \CraftCms\Cms\Craft::generalConfig()->getPostCpLoginRedirect();
    ...
    {
        $activateAccountSuccessPath = \CraftCms\Cms\Craft::generalConfig()->getActivateAccountSuccessPath();
    ...
    {
        $verifyEmailSuccessPath = \CraftCms\Cms\Craft::generalConfig()->getVerifyEmailSuccessPath();

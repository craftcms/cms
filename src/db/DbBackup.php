...
class DbBackup
{
    ...
    private function _nukeDb()
    {
        ...
        $sql .= PHP_EOL.$db->getSchema()->getQueryBuilder()->checkIntegrity(true).PHP_EOL;
    ...
    private function _processHeader()
    {
        ...
        $header .= Craft::$app->getDb()->getSchema()->getQueryBuilder()->checkIntegrity(false).PHP_EOL;
    ...
    {
        Io::writeToFile($this->_filePath, PHP_EOL.Craft::$app->getDb()->getSchema()->getQueryBuilder()->checkIntegrity(true).PHP_EOL, true, true);
    }

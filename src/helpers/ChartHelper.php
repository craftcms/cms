...
class ChartHelper
{
	 ...
	 * @return array
	 */
	public static function getRunChartDataFromQuery(Query $query, DateTime $startDate, DateTime $endDate, $dateColumn, $options = array())
	{
		// Setup
	...
	{
		$dateRanges = array(
			'd7' => array('label' => Craft::t('app', 'Last 7 days'), 'startDate' => '-7 days', 'endDate' => null),
			'd30' => array('label' => Craft::t('app', 'Last 30 days'), 'startDate' => '-30 days', 'endDate' => null),
			'lastweek' => array('label' => Craft::t('app', 'Last Week'), 'startDate' => '-2 weeks', 'endDate' => '-1 week'),
			'lastmonth' => array('label' => Craft::t('app', 'Last Month'), 'startDate' => '-2 months', 'endDate' => '-1 month'),
		);

    ...
    public function getPreviewHtml(): string
    {
        ...
        try {
            ...
            $html = Html::tag('div',
                ...
                Html::tag(
                    'div',
                    ($previewable ? Html::tag('button', Craft::t('app', 'Preview'), ['class' => 'btn preview-btn', 'id' => 'preview-btn']) : '') .
                    ($editable ? Html::tag('button', Craft::t('app', 'Edit'), ['class' => 'btn edit-btn', 'id' => 'edit-btn']) : ''),
                    ['class' => 'buttons']
                ),
                [
                    'class' => array_filter([

...
interface ElementQueryInterface extends QueryInterface, ArrayAccess, Arrayable, Countable, IteratorAggregate
{
     ...
     *
     * @return ElementInterface|array|false The resulting element. False is returned if the query results in nothing.
     */
     ...
     *                            If this parameter is not given, the `db` application component will be used.
     *
     * @return ElementInterface|array|false The element or row of the query result. False is returned if the query
     * results in nothing.
     */

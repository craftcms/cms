...
class HttpRequest extends \CHttpRequest
{
	...
	public function getRequiredParam($name)
	{
		...
		if ($value === null)
			throw new Exception(Blocks::t(TranslationCategory::App, "Param “{$name}” doesn’t exist."));
	...
	public function getRequiredQuery($name)
	{
		...
		if ($value === null)
			throw new Exception(Blocks::t(TranslationCategory::App, "GET param “{$name}” doesn’t exist."));
	...
	public function getRequiredPost($name)
	{
		...
		if ($value === null)
			throw new Exception(Blocks::t(TranslationCategory::App, "POST Param “{$name}” doesn’t exist."));

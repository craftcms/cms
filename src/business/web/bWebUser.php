...
{
	const FLASH_KEY_PREFIX = 'Blocks.bWebUser.flash.';
	const FLASH_COUNTERS   = 'Blocks.bWebUser.flashcounters';
	...
	{
		$this->authTimeout = bConfigHelper::getTimeInSeconds('sessionTimeout');
		parent::init();
	}
	...
	*/
	...
	public function setMessage($status, $value, $persistent = false, $key = null, $defaultValue = null)
	{
		...
		$message = new bMessage($status, $key, $value, $persistent);

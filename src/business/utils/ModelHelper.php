...
class ModelHelper
{
	...
	public static function createRules($properties, $indexes = array())
	{
		...
		$numberTypes = array(PropertyType::Number, PropertyType::TinyInt, PropertyType::SmallInt, PropertyType::MediumInt, PropertyType::Int, PropertyType::BigInt, PropertyType::Decimal);

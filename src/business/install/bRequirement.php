 ...
 *
 */
class bRequirement extends CComponent
{
	private $_name;
	private $_condition;
	private $_requiredBy;
	private $_notes;
	private $_required;
	private $_result = bRequirementResult::Success;
	...
	private function _calculateResult()
	{
		...
		{
			$this->_result = bRequirementResult::Failed;
		}
		else
		{
			if (!$this->_required && !$this->_condition)
			{
				$this->_result = bRequirementResult::Warning;
			}
		}
	}

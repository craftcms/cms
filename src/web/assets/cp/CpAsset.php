...
JS;
    ...
    private function _craftData(): array
    {
        ...
        $data = [
            ...
            'manuallyCloseNotifications' => (bool)($currentUser->getPreference('manuallyCloseNotifications') ?? $generalConfig->accessibilityDefaults['manuallyCloseNotifications']),
            'maxUploadSize' => Assets::getMaxUploadSize(),
            'modifiedDeltaNames' => $request->getBodyParam('modifiedDeltaNames', []),
            'notificationDuration' => (int)($currentUser->getPreference('notificationDuration') ?? $generalConfig->accessibilityDefaults['notificationDuration']),

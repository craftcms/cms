...
JS;
    ...
    private function _craftData(): array
    {
        ...
        $data = [
            ...
            'manuallyCloseNotifications' => (bool)(($currentUser ? $currentUser->getPreference('manuallyCloseNotifications') : null) ?? $generalConfig->accessibilityDefaults['manuallyCloseNotifications']),
            'maxUploadSize' => Assets::getMaxUploadSize(),
            'modifiedDeltaNames' => $request->getBodyParam('modifiedDeltaNames', []),
            'notificationDuration' => (int)(($currentUser ? $currentUser->getPreference('notificationDuration') : null) ?? $generalConfig->accessibilityDefaults['notificationDuration']),

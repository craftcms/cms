    ...
    updateButton: function() {
        ...
        if (this.editableGroups.length) {
            ...
            if (selectedGroup) {
                ...
                this.$newCategoryBtn = $('<button class="btn submit add icon" ' + href + ' aria-label="' + Craft.escapeHtml(label) + '">' + Craft.escapeHtml(label) + '</button>').appendTo(this.$newCategoryBtnGroup);

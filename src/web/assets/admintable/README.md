...
| search                    | Bool     | `false`                                      | Whether or not to show the search field. When in Data mode this performs filtering of rows in the table.                                                 |
| searchClear               | String   | `Clear`                                      | Search clear btn text.                                                                                                                                   |

<template>
  <div class="tw-border tw-border-blue-600 tw-text-blue-600 tw-rounded-full tw-w-5 tw-h-5 tw-p-[2px]">
...
export default {
  components: {CraftVerifiedIcon, CraftCommerceVerifiedIcon, EnterpriseVerifiedIcon},
  props: {
    kind: {
      type: String,
      required: true

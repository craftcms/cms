<template>
    <div class="cms-editions-edition">
        <div class="description">
            ...
            <p v-if="edition.price && edition.price > 0" class="-mt-8 py-6 text-gray-600">
...
<style lang="scss">
    .cms-editions-edition {
        @apply border border-gray-400 border-solid p-8 rounded text-center flex flex-col;

        .description {
            @apply flex-1;

            .edition-name {
                @apply border-b border-gray-400 border-solid text-gray-600 inline-block py-1 uppercase text-lg font-bold;
            }

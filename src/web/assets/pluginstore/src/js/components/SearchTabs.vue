      ...
      >
        <button
          :class="{
            ...
            'tw-border-transparent hover:tw-border-separator hover:tw-border-gray-200': tab.handle !== activeTab,
            'tw-text-blue-600 tw-border-blue-600 tw-text-opacity-100': tab.handle === activeTab,
          }"
          @click="$emit('tab-click', tab.handle)"
        >
          {{ tab.name }}
        </button>
      </li>

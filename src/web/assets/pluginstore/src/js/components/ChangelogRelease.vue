...
<style lang="scss">
    ...
    .changelog-release {
        @apply pt-2 pb-4 border-b border-gray-400 border-solid;
        ...
        .version {
            ...
            .critical {
                @apply uppercase text-red-500 border border-red-500 border-solid inline-block px-1 py-0 rounded text-sm mt-2;
            }
        }

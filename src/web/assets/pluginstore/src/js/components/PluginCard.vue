<template>
    <router-link v-if="plugin" :to="'/' + plugin.handle" :title="plugin.name"
                 class="plugin-card relative tw-flex flex-no-wrap items-start py-6 border-b border-gray-400 border-solid no-underline hover:no-underline text-gray-600est">

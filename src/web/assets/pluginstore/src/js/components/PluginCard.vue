<template>
    <router-link v-if="plugin" :to="'/' + plugin.handle" :title="plugin.name"
                 class="plugin-card tw-relative tw-flex tw-flex-no-wrap tw-items-start tw-py-6 tw-border-b tw-border-gray-400 tw-border-solid tw-no-underline hover:tw-no-underline tw-text-gray-800">

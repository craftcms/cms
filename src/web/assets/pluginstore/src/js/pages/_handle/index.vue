<template>
    <div class="plugin-details ps-container">
        <template v-if="!loading && plugin">
            <!-- header -->
            <div class="plugin-details-header tw-border-b tw-border-solid tw-border-gray-300 tw-flex tw-mb-6 tw-pb-6 tw-items-center">
                ...
                <div class="description tw-flex-1">
                    <h1 class="ttw-ext-lg tw-font-bold tw-mb-2">{{ plugin.name }}</h1>
                    <p class="tw-mb-2 tw-text-gray-600">{{ plugin.shortDescription }}</p>
                    <p class="tw-mb-2"><router-link :to="'/developer/' + plugin.developerId" :title="plugin.developerName">{{ plugin.developerName }}</router-link></p>
                </div>
            ...
            <div class="plugin-details-body">
                <template v-if="!loading">
                    <template v-if="plugin.abandoned">
                        <div class="error tw-mb-6 tw-px-4 tw-py-3 tw-rounded tw-border tw-border-solid tw-border-red-500 tw-flex tw-flex-nowrap tw-text-base">
                    ...
                    <div class="tw-py-8">
                        ...
                        <div v-if="licenseMismatched" class="tw-mx-auto tw-max-w-sm tw-px-8">
                            <div class="tw-flex tw-items-center">
                                <svg version="1.1"
                                     xmlns="http://www.w3.org/2000/svg"
                                     x="0px" y="0px" viewBox="0 0 256 448"
                                     xml:space="preserve"
                                     class="tw-text-blue-500 tw-fill-current tw-w-8 tw-h-8 tw-mr-4 tw-flex tw-items-center">
...
<style lang="scss">
    ...
    ul.plugin-meta {
        ...
        li {
            @apply tw-mb-8 tw-px-4 tw-flex-shrink-0 tw-flex-grow-0;
            flex-basis: 50%;

        ...
        <template v-if="!loading && plugin">
            ...
            <div class="plugin-details-header border-b border-solid border-gray-300 tw-flex mb-6 pb-6 items-center">
                ...
                <div class="description flex-1">
                    ...
                    <p class="mb-2 text-gray-600">{{ plugin.shortDescription }}</p>
            ...
            <div class="plugin-details-body">
                <template v-if="!loading">
                    <template v-if="plugin.abandoned">
                        <div class="error mb-6 px-4 py-3 rounded border border-solid border-red-500 flex flex-nowrap text-base">
                            <svg class="w-8 h-8">
                        ...
                        <div v-if="licenseMismatched" class="mx-auto max-w-sm px-8">
                            <div class="tw-flex items-center">
                                <svg version="1.1"
                                     ...
                                     xml:space="preserve"
                                     class="text-blue-500 fill-current w-8 h-8 mr-4 flex items-center">
...
<style lang="scss">
    ...
    ul.plugin-meta {
        ...
        li {
            @apply mb-8 px-4 flex-shrink-0 flex-grow-0;
            flex-basis: 50%;

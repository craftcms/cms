...
class View extends \yii\web\View
{
     ...
     * @since 3.7.47
     */
    const PH_DEFAULT_HEAD = '<![CDATA[CRAFT-BLOCK-DEFAULT-HEAD]]>';
     ...
     * @since 3.7.47
     */
    const PH_DEFAULT_BODY_BEGIN = '<![CDATA[CRAFT-BLOCK-DEFAULT-BODY-BEGIN]]>';
     ...
     * @since 3.7.47
     */
    const PH_DEFAULT_BODY_END = '<![CDATA[CRAFT-BLOCK-DEFAULT-BODY-END]]>';
    ...
    public function renderTemplateMacro(string $template, string $macro, array $args = [], string $templateMode = null): string
    {
        ...
        try {
            return (string)call_user_func_array([$twigTemplate, 'macro_' . $macro], $args);
        } finally {
            $this->_renderingTemplate = $renderingTemplate;
            $this->setTemplateMode($oldTemplateMode);
        }

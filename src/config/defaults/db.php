...
return [
     ...
     * parameters than the default, you can override that here. You can use `{filePath}` as
     * a placeholder for any arguments that require the path to the backup file, since it
     * is dynamically generated by Craft.
     */
    'backupCommand' => ''
];

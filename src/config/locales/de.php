...
return [
	...
	'localeDisplayNames' => [
		...
		'bem' => 'Bemba-Sprache',
		'bem-ZM' => 'Bemba-Sprache (Sambia)',
		'bez' => 'Bena',
		'bez-TZ' => 'Bena (Tansania)',
		'bg' => 'Bulgarisch',
		'bg-BG' => 'Bulgarisch (Bulgarien)',
		'bm' => 'Bambara-Sprache',
		'bm-ML' => 'Bambara-Sprache (Mali)',
		'bn' => 'Bengalisch',
		...
		'dz' => 'Bhutanisch',
		'dz-BT' => 'Bhutanisch (Bhutan)',
		'ebu' => 'Kiembu',
		'ebu-KE' => 'Kiembu (Kenia)',
		'ee' => 'Ewe-Sprache',
		'ee-GH' => 'Ewe-Sprache (Ghana)',
		'ee-TG' => 'Ewe-Sprache (Togo)',
		'el' => 'Griechisch',
		...
		'en-MO' => 'Englisch (Sonderverwaltungszone Macao)',
		...
		'en-UM' => 'Englisch (Amerikanisch-Ozeanien)',
		...
		'ha-Latn-GH' => 'Hausa (Lateinisch, Ghana)',
		'ha-Latn-NE' => 'Hausa (Lateinisch, Niger)',
		'ha-Latn-NG' => 'Hausa (Lateinisch, Nigeria)',
		'haw' => 'Hawaiisch',
		...
		'ki' => 'Kikuyu-Sprache',
		'ki-KE' => 'Kikuyu-Sprache (Kenia)',
		'kk' => 'Kasachisch',
		'kk-Cyrl' => 'Kasachisch (Kyrillisch)',
		'kk-Cyrl-KZ' => 'Kasachisch (Kyrillisch, Kasachstan)',
		'kkj' => 'Kako',
		'kkj-CM' => 'Kako (Kamerun)',
		'kl' => 'Grönländisch',
		...
		'ko' => 'Koreanisch',
		'ko-KP' => 'Koreanisch (Demokratische Volksrepublik Korea)',
		'ko-KR' => 'Koreanisch (Republik Korea)',
		'kok' => 'Konkani',
		'kok-IN' => 'Konkani (Indien)',
		'ks' => 'Kaschmirisch',
		'ks-Arab' => 'Kaschmirisch (Arabisch)',
		'ks-Arab-IN' => 'Kaschmirisch (Arabisch, Indien)',
		'ksb' => 'Shambala',
		...
		'ky' => 'Kirgisisch',
		'ky-Cyrl' => 'Kirgisisch (Kyrillisch)',
		'ky-Cyrl-KG' => 'Kirgisisch (Kyrillisch, Kirgisistan)',
		'lag' => 'Langi',
		'lag-TZ' => 'Langi (Tansania)',
		'lg' => 'Ganda-Sprache',
		'lg-UG' => 'Ganda-Sprache (Uganda)',
		'lkt' => 'lkt',
		'lkt-US' => 'lkt (Vereinigte Staaten)',
		'ln' => 'Lingala',
		...
		'mas' => 'Massai-Sprache',
		'mas-KE' => 'Massai-Sprache (Kenia)',
		'mas-TZ' => 'Massai-Sprache (Tansania)',
		'mer' => 'Meru',
		'mer-KE' => 'Meru (Kenia)',
		'mfe' => 'Morisyen',
		'mfe-MU' => 'Morisyen (Mauritius)',
		'mg' => 'Malagassi-Sprache',
		'mg-MG' => 'Malagassi-Sprache (Madagaskar)',
		'mgh' => 'Makhuwa-Meetto',
		...
		'mn-Cyrl-MN' => 'Mongolisch (Kyrillisch, Mongolei)',
		'mr' => 'Marathi',
		'mr-IN' => 'Marathi (Indien)',
		'ms' => 'Malaiisch',
		'ms-Latn' => 'Malaiisch (Lateinisch)',
		'ms-Latn-BN' => 'Malaiisch (Lateinisch, Brunei Darussalam)',
		'ms-Latn-MY' => 'Malaiisch (Lateinisch, Malaysia)',
		'ms-Latn-SG' => 'Malaiisch (Lateinisch, Singapur)',
		'mt' => 'Maltesisch',
		...
		'nd-ZW' => 'Nord-Ndebele-Sprache (Simbabwe)',
		'ne' => 'Nepalesisch',
		...
		'pa-Arab-PK' => 'Pandschabisch (Arabisch, Pakistan)',
		'pa-Guru' => 'Pandschabisch (Gurmukhi)',
		'pa-Guru-IN' => 'Pandschabisch (Gurmukhi, Indien)',
		'pl' => 'Polnisch',
		...
		'pt-MO' => 'Portugiesisch (Sonderverwaltungszone Macao)',
		...
		'swc' => 'Kongo-Suaheli',
		'swc-CD' => 'Kongo-Suaheli (Kongo-Kinshasa)',
		'ta' => 'Tamilisch',
		'ta-IN' => 'Tamilisch (Indien)',
		'ta-LK' => 'Tamilisch (Sri Lanka)',
		'ta-MY' => 'Tamilisch (Malaysia)',
		'ta-SG' => 'Tamilisch (Singapur)',
		'te' => 'Telugu',
		'te-IN' => 'Telugu (Indien)',
		'teo' => 'Teso',
		'teo-KE' => 'Teso (Kenia)',
		...
		'tzm-Latn' => 'Zentralatlas-Tamazight (Lateinisch)',
		'tzm-Latn-MA' => 'Zentralatlas-Tamazight (Lateinisch, Marokko)',
		'uk' => 'Ukrainisch',
		...
		'vai' => 'Vai-Sprache',
		'vai-Latn' => 'Vai-Sprache (Lateinisch)',
		'vai-Latn-LR' => 'Vai-Sprache (Lateinisch, Liberia)',
		'vai-Vaii' => 'Vai-Sprache (Vai)',
		'vai-Vaii-LR' => 'Vai-Sprache (Vai, Liberia)',
		'vi' => 'Vietnamesisch',
		...
		'zh-Hans-MO' => 'Chinesisch (Vereinfacht, Sonderverwaltungszone Macao)',
		...
		'zh-Hant-MO' => 'Chinesisch (Traditionell, Sonderverwaltungszone Macao)',

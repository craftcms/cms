...
return [
	...
	'localeDisplayNames' => [
		...
		'ha' => '豪萨文',
		'ha-Latn' => '豪萨文（拉丁文）',
		'ha-Latn-GH' => '豪萨文（拉丁文、加纳）',
		'ha-Latn-NE' => '豪萨文（拉丁文、尼日尔）',
		'ha-Latn-NG' => '豪萨文（拉丁文、尼日利亚）',
		'haw' => '夏威夷文',
		'haw-US' => '夏威夷文（美国）',
		'he' => '希伯来文',
		'he-IL' => '希伯来文（以色列）',
		...
		'mn' => '蒙古文',
		'mn-Cyrl' => '蒙古文（西里尔文）',
		'mn-Cyrl-MN' => '蒙古文（西里尔文、蒙古）',
		'mr' => '马拉地文',
		'mr-IN' => '马拉地文（印度）',
		'ms' => '马来文',
		'ms-Latn' => '马来文（拉丁文）',
		'ms-Latn-BN' => '马来文（拉丁文、文莱）',
		'ms-Latn-MY' => '马来文（拉丁文、马来西亚）',
		'ms-Latn-SG' => '马来文（拉丁文、新加坡）',
		'mt' => '马耳他文',
		'mt-MT' => '马耳他文（马耳他）',
		'mua' => '蒙当文',
		'mua-CM' => '蒙当文（喀麦隆）',
		...
		'zh-Hans-HK' => '中文（简体中文、中国香港特别行政区）',
		'zh-Hans-MO' => '中文（简体中文、中国澳门特别行政区）',
		'zh-Hans-SG' => '中文（简体中文、新加坡）',
		'zh-Hant' => '中文（繁体中文）',
		'zh-Hant-HK' => '中文（繁体中文、中国香港特别行政区）',
		'zh-Hant-MO' => '中文（繁体中文、中国澳门特别行政区）',
		'zh-Hant-TW' => '中文（繁体中文、台湾）',
		'zu' => '祖鲁文',
		'zu-ZA' => '祖鲁文（南非）',
	],
];

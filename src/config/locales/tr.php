...
return [
    ...
    'localeDisplayNames' => [
        ...
        'ee-TG' => 'Ewe (Togo)',
        'el' => 'Yunanca',
        'el-CY' => 'Yunanca (Güney Kıbrıs Rum Kesimi)',
        ...
        'ha' => 'Hausa',
        'ha-Latn' => 'Hausa (Latin)',
        'ha-Latn-GH' => 'Hausa (Latin, Gana)',
        'ha-Latn-NE' => 'Hausa (Latin, Nijer)',
        'ha-Latn-NG' => 'Hausa (Latin, Nijerya)',
        'haw' => 'Hawaii Dili',
        ...
        'kk-Cyrl-KZ' => 'Kazakça (Kiril, Kazakistan)',
        'kkj' => 'Kako',
        'kkj-CM' => 'Kako (Kamerun)',
        'kl' => 'Grönland Dili',
        ...
        'ks' => 'Keşmirce',
        'ks-Arab' => 'Keşmirce (Arap)',
        'ks-Arab-IN' => 'Keşmirce (Arap, Hindistan)',
        'ksb' => 'Shambala',
        ...
        'ky' => 'Kırgızca',
        'ky-Cyrl' => 'Kırgızca (Kiril)',
        'ky-Cyrl-KG' => 'Kırgızca (Kiril, Kırgızistan)',
        'lag' => 'Langi',
        ...
        'mn-Cyrl-MN' => 'Moğolca (Kiril, Moğolistan)',
        'mr' => 'Marathi',
        'mr-IN' => 'Marathi (Hindistan)',
        'ms' => 'Malayca',
        'ms-Latn' => 'Malayca (Latin)',
        'ms-Latn-BN' => 'Malayca (Latin, Brunei)',
        'ms-Latn-MY' => 'Malayca (Latin, Malezya)',
        'ms-Latn-SG' => 'Malayca (Latin, Singapur)',
        'mt' => 'Maltaca',
        'mt-MT' => 'Maltaca (Malta)',
        'mua' => 'Mundang',
        ...
        'to-TO' => 'Tongaca (Tonga)',
        'tr' => 'Türkçe',
        'tr-CY' => 'Türkçe (Güney Kıbrıs Rum Kesimi)',
        'tr-TR' => 'Türkçe (Türkiye)',
        'twq' => 'Tasawaq',
        'twq-NE' => 'Tasawaq (Nijer)',
        'tzm' => 'Orta Fas Tamazigti',
        'tzm-Latn' => 'Orta Fas Tamazigti (Latin)',
        'tzm-Latn-MA' => 'Orta Fas Tamazigti (Latin, Fas)',
        'ug' => 'Uygurca',
        'ug-Arab' => 'Uygurca (Arap)',
        'ug-Arab-CN' => 'Uygurca (Arap, Çin)',
        'uk' => 'Ukraynaca',

...
interface TemplateRendererInterface
{
    ...
    public function renderTemplate(string $template, array $variables, ?TemplateMode $templateMode = null, ?string $resolvedTemplate = null): string;

    public function renderPageTemplate(string $template, array $variables, ?TemplateMode $templateMode = null, ?string $resolvedTemplate = null): string;

...
class Images extends Component
{
     ...
     * @return bool
     */
    public function getIsImagickAtLeast(string $requiredVersion)
    {
     ...
     * @return Image
     */
    public function loadImage(string $path, bool $rasterize = false, int $svgSize = 1000)
    {
     ...
     * @return bool
     */
    public function checkMemoryForImage(string $filePath, bool $toTheMax = false)
    {
     ...
     * @return bool
     */
    public function rotateImageByExifData(string $filePath)
    {
     ...
     * @return bool
     */
    public function stripOrientationFromExifData(string $filePath)
    {
        if (!ImageHelper::canHaveExifData($filePath)) {
            return false;
        }

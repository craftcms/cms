...
إذا لم تكن تتوقع هذه الرسالة، ما عليك سوى تجاهلها.',
    ...
    'Use YAML files' => 'استخدم ملفات YAML',
    'Your project config YAML files are expecting different versions to be installed for the following:' => 'تتوقع ملفات تكون المشروع YAML تثبيت إصدارات مختلفة لما يلي:',
    'The loaded project config has more recent changes than your project config YAML files.' => 'هناك تغييرات أحدث في تكوين المشروع الذي تم تحميله مقارنة بملفات تكوين مشروع YAML الخاصة بك.',
    'ON Label' => 'ON Label',
    'Review' => 'Review',

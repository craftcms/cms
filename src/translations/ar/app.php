...
إذا لم تكن تتوقع هذه الرسالة، ما عليك سوى تجاهلها.',
    ...
    'Show all' => 'إظهار الكل',
    'Configure the product types’s site-specific settings.' => 'قم بتكوين الإعدادات الخاصة بموقع أنواع المنتجات.',
    'Composer was unable to install the updates.' => 'تعذر على أداة Composer تثبيت التحديثات.',
    'No Address' => 'لا توجد عناوين',
    ...
    'State' => 'الدولة',
    'Status change message' => 'رسالة تغيير الحالة',
    'User Photo Location' => 'موقع صورة المستخدم',
    'Add a variant' => 'إضافة متغير',
    'Abort the update' => 'إيقاف التحديث',
    'Add variant above' => 'إضافة متغير بالأعلى',
    ...
    'Are you sure you want to delete the selected variants?' => 'هل تريد بالفعل حذف المتغيرات المحددة؟',
    ...
    'Alternative Phone' => 'رقم الهاتف البديل',
    'Installing update (this may take a minute)…' => 'جارٍ تثبيت التحديث (قد يستغرق ذلك دقيقة)...',
    'New product' => 'منتج جديد',
    'Set as the default variant' => 'إعداد كمتغير افتراضي',
    'Couldn’t save product.' => 'تعذر حفظ المنتج.',
    'Business Tax ID' => 'مُعرف الضريبة التجارية',
    'Error:' => 'خطأ:',
    'Phone (Alt)' => 'رقم الهاتف (البديل)',
    ...
    'Address Line 1' => 'العنوان 1',
    'Address Line 2' => 'العنوان 2',
    'New {productType} product' => 'منتج {productType} جديد',
    'Clear caches' => 'مسح التخزين المؤقت',

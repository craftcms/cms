...
إذا لم تكن تتوقع هذه الرسالة، ما عليك سوى تجاهلها.',
    ...
    'The number of seconds that the `Retry-After` HTTP header should be set to for 503 responses when the system is offline.' => 'عدد الثواني التي يجب تعيين رأس HTTP فيها "إعادة المحاولة بعد" لاستجابات 503 عندما يكون النظام غير متصل بالإنترنت.',
    ...
    'not an existing translation23131321313' => 'ليست ترجمة موجودة 23131321313',

...
إذا لم تكن تتوقع هذه الرسالة، ما عليك سوى تجاهلها.',
    ...
    'or <a>send to Developer Support</a>' => 'أو <a dir="rtl">إرسال إلى دعم من المطور Craft</a>',
    ...
    'Reverted to revision {num}.' => 'تم الإرجاع لمراجعة {num}.',
    'Elements' => 'العناصر',
    'MM / YY' => 'MM / YY',
    'Suffix Text' => 'نص اللاحقة',
    'Business Name' => 'اسم العمل التجاري',
    'More Resources' => 'المزيد من المصادر',
    'Propagating {type}' => 'جار انتشار {type}',
    ...
    'Propagation Method' => 'طريقة الانتشار',
    'Learn how' => 'تعرف كيف',
    ...
    'Save {type}' => 'حفظ {type}',
    'Save entries to other sites in the same site group' => 'حفظ الإدخالات إلى مواقع أخرى في نفس مجموعة امواقع',
    ...
    'Less' => 'أقل',
    'Resaving {type}' => 'جار إعادة حفظ {type}',
    'Meet the Craft community' => 'تعرف على مجتمع Craft',
    'Total Price' => 'إجمالي السعر',
    'Temp Uploads Location' => 'موقع تحميل القوالب',
    ...
    'Prefix Text' => 'نص البادئة',
    'Your `project.yaml` file was created for different versions of Craft and/or plugins than what’s currently installed.' => 'تم إنشاء ملف `project.yaml` الخاص بك ليصلح لإصدارات مختلفة من Craft و/أو الملحقات عن ما هو مثبت حاليًا.',

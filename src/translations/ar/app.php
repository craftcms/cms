...
return [
    ...
    '1 week' => '1 أسبوع',
    '1 year' => '1 سنة',
    '<strong>Your license has expired!</strong> Renew your {name} license for another year of amazing updates.' => '<strong>لقد انتهت صلاحية ترخيصك!</strong> جدد ترخيص {name} لعام آخر من التحديثات المذهلة.',
    '<strong>You’ve reached a breakpoint!</strong> More updates will become available after you install {update}.</p>' => '<strong>لقد وصلت إلى نقطة توقف!</strong> ستتوافر المزيد من التحديثات بعد تثبيت {update}.</p>',
    ...
    'Connect your Craft ID account to improve your experience.' => 'قم بربط حساب معرف Craft الخاص بك لتحسين تجربتك.',
    ...
    'Where do you want to store user photos? Note that the subfolder path can contain variables like <code>{username}</code>.' => 'أين تريد تخزين صور المستخدم؟ لاحظ أن مسار المجلد الفرعي يمكن أن يحتوي على متغيرات مثل <code>{username}</code>.',

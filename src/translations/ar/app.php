...
return [
    ...
    'Amber' => 'عنبري',
    'An elevated session is required to change a user’s email.' => 'يلزم وجود جلسة بصلاحيات إدارية لتغيير بريد المستخدم الإلكتروني.',
    ...
    'Generating image transform for {file}' => 'جارٍ إنشاء تحويل الصور لـ{file}',

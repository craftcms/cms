...
إذا لم تكن تتوقع هذه الرسالة، ما عليك سوى تجاهلها.',
    ...
    'Looks like you are trying to load a template outside the template folder: {template}.' => 'يبدو أنك تقوم بمحاولة تحميل قالب خارج مجلد القالب: {template}.',
    'Low' => 'منخفضة',
...
إذا لم تكن تتوقع هذه الرسالة، ما عليك سوى تجاهلها.',
    ...
    'One Admin account' => 'حساب مسؤول واحد',
    ...
    'Your system isn’t set up to save content for the language “{language}”.' => 'لم يتم إعداد النظام لديك على حفظ المحتوى للغة "{language}".',
    ...
    'Available Transforms' => 'التحويلات المتاحة',
    ...
    'Available Volumes' => 'وحدات التخزين المتاحة',
    ...
    'Transfer it to this domain?' => 'هل تريد نقله إلى هذا المجال؟',
    ...
    'The volumes that should be available when selecting assets (if the selected config has an Image or File button).' => 'وحدات التخزين التي يجب أن تكون متوفرة عند تحديد الأصول (إذا كان التكوين المحدد يحتوي على زر "صورة" أو "ملف").',
    ...
    'The Transforms that should be available for Image selection.' => 'عمليات التحويل التي يجب أن تكون متاحة لتحديد الصور.',
    ...
    'Craft is unable to determine if any updates are available at this time.' => 'تعذر على Craft تحديد ما إذا كانت توجد أية تحديثات متاحة في الوقت الحالي.',
    ...
    'For sites built by and for the developer.' => 'للمواقع التي تم إنشاؤها بواسطة المطور ولأجله.',
    'Character Limit' => 'حد الحروف',
    'Database Connection Exception' => 'استثناء في اتصال قاعدة البيانات',
    ...
    'No options selected.' => 'لم يتم تحديد أي خيارات.',
    ...
    'One-Time Price' => 'سعر لمرة واحدة',
    'Redactor Config' => 'تكوين Redactor',
    ...
    'HTML Purifier Config' => 'تكوين إعدادات HTML Purifier',
    'Go to Craft CMS' => 'انتقال إلى Craft CMS',
    'The base URL to the assets in this volume. An absolute URL ({ex1}) or protocol-relative URL ({ex2}) is recommended.' => 'عنوان URL الأساسي للأصول الموجودة في وحدة التخزين هذه. يوصى باستخدام عنوان URL مطلق ({ex1}) أو عنوان URL مرتبط ببروتوكول ({ex2}).',
    ...
    'or <a>send to Craft Support</a>' => 'أو <a>إرسال إلى دعم Craft</a>',
    ...
    'The path to the volume’s directory on the file system. An absolute path ({ex}) is recommended.' => 'المسار إلى دليل وحدة التخزين في نظام الملفات. يوصى باستخدام مسار مطلق ({ex}).',
    'An error occurred when duplicating the category.' => 'حدث خطأ عند عمل نسخة مماثلة من الفئة.',
    'Original' => 'الأصلي',
    'You can save custom {name} configs as {ext} files in {path}.' => 'يمكن حفظ إعدادات تكوين {name} المخصصة كملفات {ext} في {path}.',
    ...
    'Update to {version}' => 'تحديث إلى {version}',
    ...
    'Installing update (this may take a minute)…' => 'جارٍ تثبيت التحديث (قد يستغرق ذلك دقيقة)...',
    'Error:' => 'خطأ:',
    'Optimizing installation…' => 'جارٍ تحسين التثبيت...',
    ...
    'Find Text' => 'بحث عن نص',
    'OK' => 'موافق',
    'Could not load the image editor.' => 'تعذر تحميل محرر الصور.',

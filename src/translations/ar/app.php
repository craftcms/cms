...
return [
    ...
    'Could not suspend all users.' => 'تعذَّر تعليق جميع المستخدمين.',
    'Could not unsuspend all users.' => 'تعذَّر إلغاء تعليق جميع المستخدمين.',
    ...
    'Couldn’t create entry.' => 'تعذرإنشاء الإدخال.',
    ...
    'Create a new entry after' => 'إنشاء إدخال جديد بعده',
    'Create a new entry before' => 'إنشاء إدخال جديد قبله',
    ...
    'Done' => 'تم',
    'Double-click entries and other editable elements to try the new editor slideout interface.' => 'انقر نقرًا مزدوجًا فوق المدخلات والعناصر الأخرى القابلة للتحرير لتجربة واجهة تحرير المحرر الجديدة.',
    ...
    'Streamlined Entry Publishing Flow' => 'تدفق نشر الدخول المنظم',
    ...
    'The entry publishing workflow is now [simpler and more intuitive]({url}).' => 'أصبح سير عمل نشر الإدخال الآن [أبسط وأكثر سهولة] ({url}).',
    ...
    'There was a problem processing your credit card.' => 'هناك مشكلة في معالجة بطاقتك الائتمانية.',
    ...
    'Unable to use the selected directory for the volume.' => 'يتعذَّر استخدام الدليل المحدَّد لوحدة التخزين.',
    ...
    'seven' => 'سبعة',
    'six' => 'ستة',
    'stripe_error_approve_with_id' => 'لا يمكن السماح بالدفع.',
    'stripe_error_authentication_required' => 'تم رفض البطاقة لأن المعاملة تتطلب المصادقة.',
    'stripe_error_call_issuer' => 'تم رفض البطاقة لسبب غير معروف.',
    'stripe_error_card_not_supported' => 'لا تدعم البطاقة هذا النوع من الشراء.',
    'stripe_error_card_velocity_exceeded' => 'تجاوز العميل الرصيد المتاح أو حد الائتمان المتاح على بطاقته.',
    'stripe_error_currency_not_supported' => 'لا تدعم البطاقة العملة المحددة.',
    'stripe_error_do_not_honor' => 'تم رفض البطاقة لسبب غير معروف.',
    'stripe_error_do_not_try_again' => 'تم رفض البطاقة لسبب غير معروف.',
    'stripe_error_duplicate_transaction' => 'تم تقديم معاملة بنفس المبلغ ومعلومات بطاقة الائتمان مؤخرًا.',
    'stripe_error_expired_card' => 'انتهت صلاحية البطاقة.',
    'stripe_error_fraudulent' => 'تم رفض الدفع لأن Stripe يشتبه في أنه احتيالي.',
    'stripe_error_generic_decline' => 'تم رفض البطاقة لسبب غير معروف.',
    'stripe_error_incorrect_cvc' => 'رقم CVC غير صحيح.',
    'stripe_error_incorrect_number' => 'رقم البطاقة غير صحيح.',
    'stripe_error_incorrect_pin' => 'رمز PIN الذي تم إدخاله غير صحيح. ينطبق رمز الرفض هذا فقط على المدفوعات التي تتم باستخدام قارئ البطاقة.',
    'stripe_error_incorrect_zip' => 'الرمز البريدي / رمز المنطقة غير صحيح.',
    'stripe_error_insufficient_funds' => 'لا تحتوي البطاقة على أموال كافية لإتمام عملية الشراء.',
    'stripe_error_invalid_account' => 'البطاقة أو الحساب المربوط بالبطاقة غير صالح.',
    'stripe_error_invalid_amount' => 'مبلغ الدفع غير صالح أو يتجاوز المبلغ المسموح به.',
    'stripe_error_invalid_cvc' => 'رقم CVC غير صحيح.',
    'stripe_error_invalid_expiry_month' => 'شهر انتهاء الصلاحية غير صالح.',
    'stripe_error_invalid_expiry_year' => 'سنة انتهاء الصلاحية غير صالحة.',
    'stripe_error_invalid_number' => 'رقم البطاقة غير صحيح.',
    'stripe_error_invalid_pin' => 'رمز PIN الذي تم إدخاله غير صحيح. ينطبق رمز الرفض هذا فقط على المدفوعات التي تتم باستخدام قارئ البطاقة.',
    'stripe_error_issuer_not_available' => 'تعذر الوصول إلى جهة إصدار البطاقة، لذلك لا يمكن السماح الدفع.',
    'stripe_error_lost_card' => 'تم رفض الدفع بسبب الإبلاغ عن فقدان البطاقة.',
    'stripe_error_merchant_blacklist' => 'تم رفض الدفع لأنه يطابق قيمة موجودة في قائمة الحظر الخاصة بمستخدم Stripe.',
    'stripe_error_new_account_information_available' => 'البطاقة أو الحساب المربوط بالبطاقة غير صالح.',
    'stripe_error_no_action_taken' => 'تم رفض البطاقة لسبب غير معروف.',
    'stripe_error_not_permitted' => 'الدفع غير مسموح به.',
    'stripe_error_offline_pin_required' => 'تم رفض البطاقة لأنها تتطلب رمز PIN.',
    'stripe_error_online_or_offline_pin_required' => 'تم رفض البطاقة لأنها تتطلب رمز PIN.',
    'stripe_error_pickup_card' => 'لا يمكن استخدام البطاقة لإجراء هذا الدفع (من الممكن أن يكون قد تم الإبلاغ عن فقدها أو سرقتها).',
    'stripe_error_pin_try_exceeded' => 'تم تجاوز العدد المسموح به من محاولات إدخال رمز PIN.',
    'stripe_error_processing_error' => 'حدث خطأ أثناء معالجة البطاقة.',
    'stripe_error_reenter_transaction' => 'لا يمكن لجهة إصدار البطاقة معالجة الدفع لسبب غير معروف.',
    'stripe_error_restricted_card' => 'لا يمكن استخدام البطاقة لإجراء هذا الدفع (من الممكن أن يكون قد تم الإبلاغ عن فقدها أو سرقتها).',
    'stripe_error_revocation_of_all_authorizations' => 'تم رفض البطاقة لسبب غير معروف.',
    'stripe_error_revocation_of_authorization' => 'تم رفض البطاقة لسبب غير معروف.',
    'stripe_error_security_violation' => 'تم رفض البطاقة لسبب غير معروف.',
    'stripe_error_service_not_allowed' => 'تم رفض البطاقة لسبب غير معروف.',
    'stripe_error_stolen_card' => 'تم رفض الدفع بسبب الإبلاغ عن سرقة البطاقة.',
    'stripe_error_stop_payment_order' => 'تم رفض البطاقة لسبب غير معروف.',
    'stripe_error_testmode_decline' => 'تم استخدام رقم بطاقة اختبار Stripe.',
    'stripe_error_transaction_not_allowed' => 'تم رفض البطاقة لسبب غير معروف.',
    'stripe_error_try_again_later' => 'تم رفض البطاقة لسبب غير معروف.',
    'stripe_error_withdrawal_count_limit_exceeded' => 'تجاوز العميل الرصيد المتاح أو حد الائتمان المتاح على بطاقته.',
    'tag' => 'علامة',
    'tags' => 'العلامات',

...
return [
    ...
    'Restrict assets to a single folder' => 'تقييد الوصول إلى مجلد منفرد',
    ...
    'Save and edit entry types' => 'حفظ وتحرير أنواع الإدخال',
    ...
    'Save the loaded project config data to YAML files in your <code>{folder}</code> folder.' => 'احفظ بيانات تهيئة المشروع المحملة في ملفات YAML في المجلد <code>{folder}</code>.',
    'Save' => 'حفظ',
    'Saving' => 'جار الحفظ',
    ...
    'This update requires PHP {v1}, but your environment is currently running PHP {v2}.' => 'يتطلب هذا التحديث PHP {v1}، ولكن البيئة يعمل حاليًا على PHP {v2}.',
    ...
    'Update your project config YAML files to reflect the latest changes in the loaded project config.' => 'قم بتحديث ملفات YAML لتهيئة مشروعك لتعكس أحدث التغييرات في تهيئة المشروع المحملة.',
    ...
    'Upgrade to Craft Pro' => 'ترقية إلى Craft Pro',
    ...
    'Where assets should be stored when they are uploaded directly to the field, or via a front-end form.' => 'حيث يجب تخزين الأصول عند تحميلها مباشرة إلى الحقل، أو عبر نموذج الواجهة الأمامية.',
    ...
    'Where selected assets should be stored.' => 'أين يجب تخزين الأصول المختارة.',

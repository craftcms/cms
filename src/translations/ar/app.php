...
return [
    ...
    'Propagating {class} elements' => 'نشر عناصر {class}',
    'Edit Category' => 'تحرير الفئة',
    ...
    'Your `project.yaml` file was created for more recent versions of Craft and/or plugins than what’s currently installed.' => 'تم إنشاء ملف `project.yaml` الخاص بك ليصلح مع الإصدارات الأخيرة من Craft و/أو الملحقات مقارنة بما هو مثبت حاليًا.',

...
إذا لم تكن تتوقع هذه الرسالة، ما عليك سوى تجاهلها.',
    ...
    'Additional locations that should be available for previewing entries in this section.' => 'المواقع الإضافية التي يجب أن تكون متاحة لمعاينة الإدخالات في هذا القسم.',

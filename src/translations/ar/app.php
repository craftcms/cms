...
return [
    ...
    'Active trials added to the cart.' => 'تمت إضافة التجارب النشطة إلى سلة التسوق.',
    'Active' => 'نشط',
    ...
    'Entry deleted for site.' => 'تم حذف مدخل هذا الموقع.',
    ...
    'Make sure you’re not overwriting changes in the YAML files that were made on another environment.' => 'تأكد من عدم قيامك بالكتابة فوق التغييرات في ملفات YAML التي تم إجراؤها على بيئة أخرى.',
    ...
    'Plugin trials are not allowed on this domain.' => 'غير مسموح بتجارب البرنامج المساعد في هذا المجال.',
    ...
    'Template that defines the Title field’s custom “translation key” format. {type} titles will be copied to all sites that produce the same key. For example, to make titles translatable based on the first two characters of the site handle, you could enter `{site.handle[:2]}`.' => 'نموذج يحدد تنسيق "مفتاح الترجمة" المخصص لحقل العنوان. {type} سيتم نسخ العناوين إلى كافة المواقع التي تنتج نفس المفتاح. على سبيل المثال، لجعل العناوين قابلة للترجمة بناءً على أول حرفين من عنوان الموقع، يمكنك إدخال "{site.handle [: 2]}`.',
    'Template' => 'القالب',
    'Templates' => 'القوالب',
    ...
    'There are license trials that require payment.' => 'هناك تجارب ترخيص تتطلب الدفع.',
    ...
    'Whether authors should be able to upload files directly to the field, rather than requiring them to select/upload assets via the selection modal.' => 'ما إذا كان يجب أن يكون المؤلفون قادرين على تحميل الملفات مباشرة إلى الحقل، بدلاً من مطالبتهم بتحديد / تحميل الأصول عبر طريقة الاختيار.',
    ...
    '{attribute} must be a date.' => 'يجب أن يكون {attribute} تاريخًا.',
    '{attribute} must be a time.' => 'يجب أن يكون {attribute} وقتًا.',

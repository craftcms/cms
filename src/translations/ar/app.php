...
return [
    ...
    'Craft Pro and {trialPluginCount, plural, =1{{name}} other{# plugins}} are installed as trials.' => 'تم تثبيت Craft Pro و{trialPluginCount, plural, =1{{name}} other{# من الملحقات}} كإصدارات تجريبية.',
    'Craft Pro is installed as a trial.' => 'تم تثبيت Craft Pro كإصدار تجريبي.',
    ...
    'Purchase {total, plural, =1{license} other{licenses}}' => 'شراء {total, plural, zero {0 ترخيص} one {ترخيص واحد} two {ترخيصَين} few {تراخيص} many {ترخيصًا}=1{ترخيص واحد} other{ترخيص}}',
    ...
    'The following licensing issues can be resolved with a single purchase on Craft Console.' => 'يمكن حل مشكلات الترخيص التالية بإجراء عملية شراء واحدة على Craft Console.',
    ...
    '{trialPluginCount, plural, =1{{name} is installed as a trial} other{# plugins are installed as trials}}.' => '{trialPluginCount, plural, =1{تم تثبيت {name} كإصدار تجريبي} other{تم تثبيت # من الملحقات كإصدارات تجريبية}}.',

...
إذا لم تكن تتوقع هذه الرسالة، ما عليك سوى تجاهلها.',
    ...
    'Includes Sections, Global sets, Category groups, Tag groups, Asset volumes, Custom fields, Entry versioning, and Entry drafts' => 'يشمل الأقسام، والمجموعات العمومية، ومجموعات الفئات، ومجموعات العلامات، ووحدات تخزين الأصول، والحقول المخصصة، وعمل الإصدارات للإدخالات، ومسودات الإدخال',
    'Export' => 'تصدير',
    ...
    'Includes Multiple locales, Section and entry locale targeting, Content translations' => 'يتضمن لغات متعددة، وقسم واستهداف لغة الإدخال والأقسام، وترجمات المحتوى',
    'Optgroup?' => 'Optgroup؟',
    ...
    'Information' => 'معلومات',
    'Make this the primary site?' => 'هل تريد أن تجعل هذا الموقع الأساسي؟',
    ...
    'Includes Custom login screen logo, Custom site icon, Custom HTML email template, Custom email message wording' => 'يتضمن شعار شاشة تسجيل الدخول مخصص، وأيقونة موقع مخصصة، وقالب بريد إلكتروني بتنسيق HTML، وصياغة رسائل البريد الإلكتروني مخصصة',
    'Guides' => 'أدلة',
    ...
    'Export…' => 'تصدير…',
    'Includes User accounts, User groups, User permissions, Public user registration' => 'يشمل حسابات المستخدم، ومجموعات المستخدم، وأذونات المستخدم، وتسجيل المستخدم العام',
    ...
    'Your `project.yaml` file was created for different versions of Craft and/or plugins than what’s currently installed.' => 'تم إنشاء ملف `project.yaml` الخاص بك ليصلح لإصدارات Craft و/أو الملحقات مختلفة عن الإصدار المثبت حاليًا.',
    ...
    'View entry type - {entryType}' => 'عرض نوع الإدخال - {entryType}',
    ...
    'View section - {section}' => 'عرض القسم - {section}',
    ...
    'Choose which content should be available with this schema:' => 'اختر المحتوى الذي يجب أن يتوفر مع هذا المخطط:',
    'To {date}' => 'حتى {date}',
    ...
    'Your {file} file isn’t writable.' => 'ملف {file} الخاص بك غير قابل للكتابة فوقه.',
    ...
    'Caches generated by `{% cache %}` template tags' => 'ذاكرة التخزين المؤقت التي تم إنشاؤها بواسطة علامات القالب `{% cache %}`',
    'Finished' => 'انتهى',
    'Progress' => 'التقدم',

...
return [
    ...
    'Add an address' => 'Bættu við heimilisfangi',
    ...
    'Allow listing element drafts' => 'Leyfa drög að skráningareiningum',
    'Allow listing element revisions' => 'Leyfa endurskoðun skráningareininga',
    'Allow listing non-live and otherwise inactive elements.' => 'Leyfa skráningu óvirkra og annars óvirkra þátta.',
    'Allow public registration' => 'Leyfa almenna skráningu',
    'Allow querying elements from the “{site}” site.' => 'Leyfa fyrirspurnaþætti frá „{site}“ síðunni.',
    ...
    'Allowed URL Types' => 'Leyfðar gerðir vefslóða',
    ...
    'Applying new propagation method to Matrix blocks' => 'Að beita nýrri fjölgunaraðferð á Matrix blokkir',
    'Applying new propagation method to elements' => 'Að beita nýrri fjölgunaraðferð á frumefni',
    'Applying new propagation method to {section} entries' => 'Notar nýja útbreiðsluaðferð á {section} færslur',
    'Applying this change to existing blocks can take some time.' => 'Það getur tekið nokkurn tíma að nota þessa breytingu á núverandi blokkir.',
    ...
    'Are you sure you want to delete the selected blocks?' => 'Ertu viss um að þú viljir eyða völdum kubbum?',
    ...
    'Are you sure you want to delete this block type?' => 'Ertu viss um að þú viljir eyða þessari blokkartegund?',
    'Are you sure you want to delete this field?' => 'Ertu viss um að þú viljir eyða þessum reit?',
    'Are you sure you want to delete this group and all its fields?' => 'Ertu viss um að þú viljir eyða þessum hópi og öllum reitum hans?',
    ...
    'Asset settings saved.' => 'Eignastillingar vistaðar.',
    ...
    'Before…' => 'Áður en…',
    'Block Types' => 'Tegundir blokka',
    'Blocks will be saved across all sites in the {group} site group.' => 'Blokkir verða vistaðar á öllum vefsvæðum í {group} vefsvæðishópnum.',
    'Blocks will be saved across all {language}-language sites.' => 'Blokkir verða vistaðir á öllum {language} tungumálasíðum.',
    'Blocks will only be saved in the {site} site.' => 'Blokkir verða aðeins vistaðir á {site} síðunni.',
    'Body' => 'Líkami',
    ...
    'Choose colors which should be recommended by the color picker.' => 'Veldu liti sem litavalinn ætti að mæla með.',
    ...
    'Couldn’t send activation email.' => 'Gat ekki sent virkjunarpóst.',
    ...
    'Create a new {section} entry type' => 'Búðu til nýja {section} færslutegund',
    ...
    'Create entries with the “{entryType}” entry type' => 'Búðu til færslur með „{entryType}“ færslutegundinni',
    ...
    'Default Color' => 'Sjálfgefinn litur',
    ...
    'Define the types of blocks that can be created within this Matrix field, as well as the fields each block type is made up of.' => 'Skilgreindu gerðir kubba sem hægt er að búa til innan þessa fylkisreits, sem og reiti sem hver kubbagerð er gerð úr.',
    'Delayed' => 'Seinkað',
    ...
    'Delete entries with the “{entryType}” entry type' => 'Eyða færslum með „{entryType}“ færslutegundinni',
    ...
    'Edit entries with the “{entryType}” entry type' => 'Breyttu færslum með „{entryType}“ færslugerðinni',
    'Edit entry type' => 'Breyta gerð færslu',
    ...
    'Edit “{entryType}”' => 'Breyta „{entryType}“',
    ...
    'Enter the text you want to appear on the {type} selection input.' => 'Sláðu inn textann sem þú vilt að birtist á {tegund} valinntakinu.',
    'Enter your password to continue.' => 'Sláðu inn lykilorðið þitt til að halda áfram.',
    ...
    'Field Limit is too big for your chosen Column Type.' => 'Svæðistakmörk eru of stór fyrir þá dálkategund sem þú valdir.',
    'Field Limit' => 'Svæðismörk',
    'Field Settings' => 'Svæðisstillingar',
    ...
    'Folder' => 'Mappa',
    'For when you’re building a website for yourself or a friend.' => 'Fyrir þegar þú ert að byggja vefsíðu fyrir þig eða vin.',
    'For when you’re building something professionally for a client or team.' => 'Fyrir þegar þú ert að byggja eitthvað fagmannlega fyrir viðskiptavin eða teymi.',
    ...
    'Hide nested sources' => 'Fela hreiður heimildir',
    ...
    'How should {type} slugs be translated?' => 'Hvernig ætti að þýða {type} snigla?',
    'How should {type} titles be translated?' => 'Hvernig ætti að þýða {type} titla?',
    ...
    'How you’ll refer to this block type in the templates.' => 'Hvernig þú munt vísa til þessarar blokkartegundar í sniðmátunum.',
    ...
    'In the local temp folder' => 'Í staðbundnu temp möppunni',
    'Inactive' => 'Óvirkt',
    ...
    'Manage relations on a per-site basis' => 'Stjórna samskiptum á hverjum stað',
    ...
    'Matrix Block' => 'Matrix Blokk',
    'Matrix Blocks' => 'Matrix blokkir',
    'Matrix block could not be added. Maximum number of blocks reached.' => 'Ekki var hægt að bæta fylkisblokk við. Hámarksfjölda blokka náð.',
    'Matrix block' => 'Matrix blokk',
    'Matrix blocks' => 'Matrix blokkir',
    'Matrix' => 'Fylki',
    'Max Blocks' => 'Max blokkir',
    ...
    'Only save blocks to the site they were created in' => 'Vistaðu bara blokkir á síðunni sem þær voru búnar til',
    ...
    'Oops!' => 'Úps!',
    'Open PRs' => 'Opin PR',
    'Open the full edit page in a new tab' => 'Opnaðu alla breytingasíðuna í nýjum flipa',
    ...
    'Plane' => 'Flugvél',
    'Please enter your current password.' => 'Vinsamlegast sláðu inn núverandi lykilorð.',
    'Please enter your password.' => 'Vinsamlegast sláðu inn lykilorðið þitt.',
    ...
    'Post Town' => 'Póstbær',
    'Post a new {section} entry' => 'Birta nýja {section} færslu',
    ...
    'Resaving {section} entries' => 'Endurvistar {section} færslur',
    ...
    'Save and edit entry types' => 'Vista og breyta gerðum færslu',
    'Save as a new {type}' => 'Vista sem ný {type}',
    'Save assets uploaded by other users' => 'Vista skrár sem aðrir notendur hafa hlaðið upp',
    'Save blocks to all sites the owner element is saved in' => 'Vistaðu blokkir á öllum síðum sem eigandaþátturinn er vistaður á',
    'Save blocks to other sites in the same site group' => 'Vistaðu blokkir á öðrum síðum í sama vefhópi',
    'Save blocks to other sites with the same language' => 'Vistaðu blokkir á öðrum síðum með sama tungumáli',
    ...
    'Save entries with the “{entryType}” entry type' => 'Vistaðu færslur með „{entryType}“ færslutegundinni',
    ...
    'Selection Label' => 'Valmerki',
    'Send activation email' => 'Sendu virkjunarpóst',
    'Send an activation email now' => 'Sendu virkjunarpóst núna',
    ...
    'Show the Title field' => 'Sýndu Titill reitinn',
    ...
    'Temp Uploads Location' => 'Staðsetning tímaupphleðslu',
    'Temp files' => 'Temp skrár',
    'Template caches' => 'Sniðmáts skyndiminni',
    'Template that defines the Slug field’s custom “translation key” format. {type} slugs will be copied to all sites that produce the same key. For example, to make slugs translatable based on the first two characters of the site handle, you could enter `{site.handle[:2]}`.' => 'Sniðmát sem skilgreinir sérsniðið „þýðingarlykill“ snið Slug reitsins. {type} sniglar verða afritaðir á allar síður sem framleiða sama lykil. Til dæmis, til að gera snigla þýðanlega út frá fyrstu tveimur stöfum vefhandfangsins, gætirðu slegið inn `{site.handle[:2]}`.',
    'Template that defines the Title field’s custom “translation key” format. {type} titles will be copied to all sites that produce the same key. For example, to make titles translatable based on the first two characters of the site handle, you could enter `{site.handle[:2]}`.' => 'Sniðmát sem skilgreinir sérsniðið „þýðingarlykill“ snið titilreitsins. {type} titlar verða afritaðir á allar síður sem framleiða sama lykil. Til dæmis, til að gera titla þýðanlega út frá fyrstu tveimur stöfum vefhandfangsins gætirðu slegið inn `{site.handle[:2]}`.',
    'Template that defines the field’s custom “propagation key” format. Blocks will be saved to all sites that produce the same key.' => 'Sniðmát sem skilgreinir sérsniðið „útbreiðslulykill“ snið reitsins. Blokkir verða vistaðir á öllum síðum sem framleiða sama lykil.',
    'Template' => 'Sniðmát',
    'Templates' => 'Sniðmát',
    'Temporary Uploads' => 'Tímabundin upphleðsla',
    'Temporary filesystem' => 'Tímabundið skráarkerfi',
    'Temporary volume' => 'Tímabundið bindi',
    ...
    'The field type “{type}” could not be found.' => 'Svæðisgerðin „{type}“ fannst ekki.',
    ...
    'The maximum number of blocks the field is allowed to have.' => 'Hámarksfjöldi blokka sem reiturinn má hafa.',
    ...
    'The minimum number of blocks the field is allowed to have.' => 'Lágmarksfjöldi blokka sem reiturinn má hafa.',
    ...
    'The type of column this field should get in the database.' => 'Tegund dálks sem þessi reitur ætti að fá í gagnagrunninum.',
    ...
    'There was a problem activating the user.' => 'Vandamál kom upp við að virkja notandann.',
    ...
    'This group doesn’t have any fields yet.' => 'Þessi hópur hefur enga reiti ennþá.',
    ...
    'Untitled entry' => 'Ónefndur færsla',
    ...
    'View all users' => 'Skoða alla notendur',
    'View assets uploaded by other users' => 'Skoða skrár sem aðrir notendur hafa hlaðið upp',
    'View category group - {categoryGroup}' => 'Skoða flokkahóp - {categoryGroup}',
    'View entries with the “{entryType}” entry type' => 'Skoðaðu færslur með „{entryType}“ færslutegundinni',
    'View global set - {globalSet}' => 'Skoða alþjóðlegt sett - {globalSet}',
    'View other users’ {type}' => 'Skoða {type} annarra notenda',
    'View site' => 'Skoða síðuna',
    'View tag group - {tagGroup}' => 'Skoða merkjahóp - {tagGroup}',
    'View the <a>upgrade guide</a>' => 'Skoðaðu <a>uppfærsluhandbókina</a>',
    'View user group - {userGroup}' => 'Skoða notendahóp - {userGroup}',
    'View volume - {volume}' => 'Skoða hljóðstyrk - {volume}',
    ...
    'What the auto-generated entry titles should look like. You can include tags that output entry properties, such as {ex}.' => 'Hvernig sjálfvirku færslutitlarnir ættu að líta út. Þú getur látið fylgja með merki sem gefa út færslueiginleika, eins og {ex}.',
    ...
    'What this block type will be called in the control panel.' => 'Hvað verður þessi blokkartegund kölluð í stjórnborðinu.',
    ...
    'Where do you want to store temporary asset uploads?' => 'Hvar viltu geyma tímabundnar eignaupphleðslur?',
    ...
    'Which fields should be visible in the widget?' => 'Hvaða reitir ættu að vera sýnilegir í græjunni?',
    'Which group should this field be displayed in?' => 'Í hvaða hópi á að birta þennan reit?',
    ...
    'Which sites should blocks be saved to?' => 'Á hvaða síður ætti að vista blokkir?',
    ...
    '{attribute} should contain at least {min, number} {min, plural, one{block} other{blocks}}.' => '{attribute} ætti að innihalda að minnsta kosti {min, number} {min, plural, one{blokk} other{blokkir}}.',
    ...
    '{attribute} should contain at most {max, number} {max, plural, one{block} other{blocks}}.' => '{attribute} ætti að innihalda í mesta lagi {max, number} {max, plural, one{blokk} other{blokkir}}.',
    ...
    '{attribute} “{value}” has already been taken.' => '{attribute} „{value}“ hefur þegar verið tekið.',
    ...
    '{renewalPrice}/year per site for updates after that.' => '{renewalPrice}/ár á síðu fyrir uppfærslur eftir það.',
    '{section} Entry Types' => '{section} Færslugerðir',
    ...
    '{user}’s Account' => 'Reikningur {user}',

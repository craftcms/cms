...
return [
    '"{filename}" is not allowed in this field.' => 'To "{filename}" δεν επιτρέπεται σε αυτό το πεδίο.',
    '(blank)' => '(κενό)',
    '/path/to/folder/' => '/διαδρομή/προς/φάκελο/',
    '1 column' => '1 στήλη',
    '1 update available' => '1 διαθέσιμη ενημέρωση',
    'A client account already exists.' => 'Υπάρχει ήδη ένας λογαριασμός χρήστη.',
    'A fatal error has occurred:' => 'A fatal error has occurred:',
    'A folder already exists with that name!' => 'Υπάρχει ήδη φάκελος με αυτό το όνομα!',
    'A suitable replacement name cannot be found for “{filename}”' => 'A suitable replacement name cannot be found for “{filename}”',
    'A template name cannot contain NUL bytes.' => 'Το όνομα ενός template δεν μπορεί να περιέχει NUL bytes.',
    'A verification email will be sent automatically.' => 'Ένα email επικύρωσης θα σταλεί αυτόματα.',
    'Access' => 'Πρόσβαση',
    'Access Key ID' => 'ID Κλειδιού Πρόσβασης',
    'Access the CP' => 'Πρόσβαση στο CP',
    'Access the CP when the system is off' => 'Πρόσβαση στο CP όταν το σύστημα είναι απενεργοποιημένο',
    'Access the site when the system is off' => 'Πρόσβαση στο site όταν το σύστημα είναι απενεργοποιημένο',
    'Access {plugin}' => 'Πρόσβαση {plugin}',
    'Account' => 'Λογαριασμός',
    'Account has not been activated.' => 'Account has not been activated.',
    'Account locked.' => 'Κλειδωμένος λογαριασμός.',
    'Account locked. Try again in {time}.' => 'Κλειδωμένος λογαριασμός. Προσπαθήστε ξανά σε {time}.',
    'Account Status' => 'Κατάσταση λογαριασμού',
    'Account suspended.' => 'Λογαριασμός σε αναστολή.',
...
If you weren\'t expecting this email, just ignore it.',
    ...
    'Active' => 'Ενεργό',
    'Add a block' => 'Προσθέστε ένα μπλοκ',
    'Add a category' => 'Προσθέσετε μια κατηγορία',
    'Add a column' => 'Προσθέσετε μία στήλη',
    'Add a new locale…' => 'Προσθέστε μια νέα τοποθεσία...',
    'Add a row' => 'Προσθέσετε μία σειρά',
    'Add a tag' => 'Προσθέστε μια ετικέτα',
    'Add a token' => 'Προσθέστε ένα token',
    'Add a user' => 'Προσθέστε ένα χρήστη',
    'Add an asset' => 'Προσθέστε ένα στοιχείο',
    'Add an entry' => 'Προσθέστε μια καταχώρηση',
    'Add an option' => 'Προσθέσετε μία επιλογή',
    'Add head' => 'Add head',
    'Add {type}' => 'Προσθέστε {type}',
    'Add {type} above' => 'Προσθέστε {type} επάνω',
    'Additional user accounts' => 'Πρόσθετoι λογαριασμοί χρηστών',
    ...
    'All' => 'Όλα',
    'All done!' => 'Έγιναν όλα!',
    'All entries' => 'Όλες οι καταχωρήσεις',
    'All Fields' => 'Όλα τα πεδία',
    'All users' => 'Όλοι οι χρήστες',
    'Allow line breaks' => 'Να επιτρέπεται αλλαγή γραμμής',
    'Allow public registration?' => 'Να επιτρέπεται δημόσια εγγραφή;',
    'Amazon S3 support' => 'Υποστήριξη Amazon S3',
    'An error occurred when rendering a template.' => 'An error occurred when rendering a template.',
    'An error occurred while processing your card.' => 'Ένα σφάλμα προέκυψε κατά την επεξεργασία της κάρτας σας.',
    'An error occurred while processing your request.' => 'Ένα σφάλμα προέκυψε κατά την επεξεργασία του αιτήματος σας.',
    'An error occurred while saving this Matrix block type.' => 'An error occurred while saving this Matrix block type.',
    'An error was encountered. Rolling back…' => 'Παρουσιάστηκε ένα σφάλμα. Επιστροφή ...',
    'An unknown error occurred.' => 'Ένα άγνωστο λάθος προέκυψε.',
    'Any changes will be lost if you leave this page.' => 'Οποιεσδήποτε αλλαγές θα χαθούν αν φύγετε από αυτήν τη σελίδα.',
    'API Key' => 'Κλειδί ΑΡΙ',
    'Apply' => 'Εφαρμογή',
    ...
    'Are you sure you want to delete this block type?' => 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτόν τον τύπο μπλοκ;',
    'Are you sure you want to delete this category?' => 'Are you sure you want to delete this category?',
    'Are you sure you want to delete this draft?' => 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτό το προσχέδιο;',
    'Are you sure you want to delete this entry?' => 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτή την καταχώρηση;',
    'Are you sure you want to delete this field?' => 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτό το πεδίο;',
    'Are you sure you want to delete this group and all its fields?' => 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτή την ομάδα και όλα τα πεδία της;',
    'Are you sure you want to delete this photo?' => 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτή τη φωτογραφία;',
    'Are you sure you want to delete this route?' => 'Are you sure you want to delete this route?',
    'Are you sure you want to delete “{name}” and all entries that use it?' => 'Είστε σίγουροι ότι θέλετε να διαγράψετε το “{name}” και όλες τις καταχωρήσεις που το χρησιμοποιούν;',
    'Are you sure you want to delete “{name}” and all its categories?' => 'Are you sure you want to delete “{name}” and all its categories?',
    'Are you sure you want to delete “{name}” and all its entries?' => 'Είστε σίγουροι ότι θέλετε να διαγράψετε “{name}” και όλες τις καταχωρήσεις του;',
    ...
    'Asset Settings' => 'Ρυθμίσεις αντικειμένων',
    ...
    'Attribute “with” not set.' => 'Το χαρακτηριστικό “με” δεν είναι ορισμένο.',
    'Audio' => 'Ήχος',
    'Author' => 'Συγγραφέας',
    'Auto' => 'Αυτόματα',
    'Auto-updating is disabled on this system.' => 'Η αυτόματη ενημέρωση είναι απενεργοποιημένη σε αυτό το σύστημα.',
    'Available Asset Sources' => 'Available Asset Sources',
    'Available Image Transforms' => 'Available Image Transforms',
    'Backing-up database…' => 'Δημιουργία εφεδρικού αντιγράφου βάσης δεδομένων...',
    'Backing-up files…' => 'Δημιουργία εφεδρικού αντιγράφου αρχείων...',
    'Backup Database' => 'Δημιουργία αντίγραφου ασφαλείας βάσης δεδομένων',
    'Bad Request' => 'Εσφαλμένη Αίτηση',
    'Begin' => 'Ξεκινήστε',
    'Block Types' => 'Τύποι Μπλόκ',
    'Body' => 'Body',
    ...
    'Cache Duration' => 'Διάρκεια Cache',
    'Cancel' => 'Ακύρωση',
    'Cancel the folder move.' => 'Ακυρώστε την μετακίνηση του φακέλου.',
    'Cannot find an enabled plugin with the handle {handle}.' => 'Δεν μπορεί να βρεθεί ενεργοποιημένο πρόσθετο με το χειρισμό {handle}.',
    'Cannot overwrite an existing license.key file.' => 'Δεν μπορεί να  αντικατασταθεί  ένα ήδη υπάρχον license.key αρχείο.',
    'Cannot rename folder “{folder}”!' => 'Ο φάκελος “{folder}” δεν μπορεί να μετονομαστεί!',
    'Cannot save the content of an unsaved element.' => 'Το περιεχόμενο ενός μη-αποθηκευμένου στοιχείου δεν μπορεί να σωθεί.',
    'Can’t find the folder to rename!' => 'Δεν μπορεί να βρεθεί ο φάκελος για μετονομασία!',
    'Can’t find the folder!' => 'Ο φάκελος δεν μπορεί να βρεθεί!',
    'Can’t find the parent folder!' => 'Δεν μπορεί να βρεθεί ο γονικός φάκελος!',
    'Can’t find the transform with ID “{id}”.' => 'Can’t find the transform with ID “{id}”.',
    'Can’t run Craft CMS' => 'Το Craft CMS δεν μπορεί να τρέξει',
    'Card number' => 'Card number',
    'Careful—changing this may result in data loss.' => 'Προσοχή - αλλάζοντας αυτό μπορεί να προκαλέσει απώλεια δεδομένων.',
    'Categories' => 'Κατηγορίες',
    'Categories deleted.' => 'Categories deleted.',
    'Categories in this group have their own URLs' => 'Oι κατηγορίες σε αυτή την ομάδα έχουν τα δικά τους URLs',
    'Category deleted.' => 'Category deleted.',
    'Category group saved.' => 'Category group saved.',
    'Category Groups' => 'Ομάδες Κατηγορίας',
    'Category saved.' => 'Category saved.',
    'Category Template' => 'Πρότυπο Κατηγορίας',
    'Category URL Formats' => 'Category URL Formats',
    'Center' => 'Κέντρο',
    'Center-Center' => 'Κέντρο - Κέντρο',
    'Center-Left' => 'Κέντρο - Αριστερά',
    'Center-Right' => 'Κέντρο - Δεξιά',
    'Change icon' => 'Αλλάξτε εικονίδιο',
    'Change logo' => 'Αλλάξτε λογότυπο',
    'Change photo' => 'Αλλάξτε φωτογραφία',
    ...
    'Check for updates' => 'Ελέγξτε για ενημερώσεις',
    'Check your email for instructions to reset your password.' => 'Ελέγξτε το email σας για οδηγίες επαναφοράς του κωδικού σας.',
    'Checkbox' => 'Checkbox',
    'Checkbox Options' => 'Επιλογές Checkbox',
    'Checkboxes' => 'Checkboxes',
    'Checking for updates…' => 'Ελέγχοντας για ενημερώσεις...',
    'Choose' => 'Choose',
    'Choose a new password' => 'Επιλέξτε ένα καινούργιο κωδικό',
    'Choose a password' => 'Επιλέξτε ένα κωδικό',
    ...
    'City/town' => 'City/town',
    'Clean up HTML?' => 'Να καθαριστεί η HTML?',
    'Cleaning up…' => 'Καθαρισμός...',
    'Clear' => 'Καθαρισμός',
    'Clear All' => 'Καθαρισμός Όλων',
    'Clear Caches' => 'Καθαρισμός Cache',
    'Clear!' => 'Καθαρισμός!',
    'Client’s Account' => 'Λογαριασμός Πελάτη',
    ...
    'Connection information not found!' => 'Δεν βρέθηκαν πληροφορίες σύνδεσης!',
    'Container' => 'Container',
    'Content' => 'Περιεχόμενο',
    'Content Locales' => 'Τοποθεσίες Περιεχομένου',
    ...
    'Could not copy file to target destination' => 'Δεν ήταν δυνατή η αντιγραφή του αρχείου στον προορισμό',
    'Could not create the group:' => 'Could not create the group:',
    'Could not fetch available updates at this time.' => 'Δεν μπόρεσε να γίνει λήψη των διαθέσιμων ενημερώσεων αυτή τη στιγμή.',
    'Could not find a unique URI for this element.' => 'Could not find a unique URI for this element.',
    'Could not find a user with Id of {userId}.' => 'Δεν βρέθηκε χρήστης με το Id {userid}.',
    'Could not find any update information for the plugin with handle “{handle}”.' => 'Δεν βρέθηκαν πληροφορίες ενημέρωσης για το πρόσθετο με το χειρισμό “{handle}”.',
    'Could not find the requested migration file.' => 'Could not find the requested migration file.',
    'Could not find the SQL file to restore: {filePath}' => 'Δεν βρέθηκε το αρχείο SQL για ανάκτηση: {filepath}',
    ...
    'Could not save the file' => 'Δεν μπόρεσε να αποθηκευτεί το αρχείο',
    ...
    'Couldn’t disable plugin.' => 'Δεν μπόρεσε να απενεργοποιηθεί το πρόσθετο.',
    'Couldn’t enable plugin.' => 'Δεν μπόρεσε να ενεργοποιηθεί το πρόσθετο.',
    'Couldn’t install plugin.' => 'Δεν μπόρεσε να εγκατασταθεί το πρόσθετο.',
    'Couldn’t publish draft.' => 'Δεν μπόρεσε να δημοσιευτεί το προσχέδιο.',
    'Couldn’t revert entry to past version.' => 'Couldn’t revert entry to past version.',
    'Couldn’t save category.' => 'Couldn’t save category.',
    'Couldn’t save draft.' => 'Δεν μπόρεσε να αποθηκευτεί το προσχέδιο.',
    'Couldn’t save email settings.' => 'Δεν μπόρεσαν να αποθεκευτούν οι ρυθμίσεις email.',
    'Couldn’t save entry type.' => 'Couldn’t save entry type.',
    'Couldn’t save entry.' => 'Δεν μπόρεσε να αποθηκευτεί η καταχώρηση.',
    'Couldn’t save field.' => 'Δεν μπόρεσε να αποθηκευτεί το πεδίο.',
    'Couldn’t save general settings.' => 'Δεν μπόρεσαν να αποθηκευτούν οι γενικές ρυθμίσεις.',
    'Couldn’t save global set.' => 'Couldn’t save global set.',
    'Couldn’t save globals.' => 'Couldn’t save globals.',
    'Couldn’t save group.' => 'Δεν μπόρεσε να αποθηκευτεί η ομάδα.',
    'Couldn’t save new order.' => 'Couldn’t save new order.',
    'Couldn’t save new route order.' => 'Couldn’t save new route order.',
    'Couldn’t save plugin settings.' => 'Δεν μπόρεσαν να αποθηκευτούν οι ρυθμίσεις του προσθέτου.',
    'Couldn’t save route.' => 'Couldn’t save route.',
    'Couldn’t save section.' => 'Δεν μπόρεσε να αποθηκευτεί η ενότητα.',
    'Couldn’t save source.' => 'Δεν μπόρεσε να αποθηκευτεί η πηγή.',
    'Couldn’t save the category group.' => 'Couldn’t save the category group.',
    'Couldn’t save the tag group.' => 'Couldn’t save the tag group.',
    'Couldn’t save user fields.' => 'Δεν μπόρεσαν να αποθηκευτούν τα πεδία χρήστη.',
    'Couldn’t save user settings.' => 'Δεν μπόρεσαν να αποθηκευτούν οι ρυθμίσεις χρήστη.',
    'Couldn’t save user.' => 'Δεν μπόρεσε να αποθηκευτεί ο χρήστης.',
    ...
    'Couldn’t send your message. Please email it to {email} instead.' => 'Δεν μπόρεσε να σταλεί το μύνημά σας. Παρακαλούμε στείλτε το στο {email}.',
    'Couldn’t suspend user.' => 'Couldn’t suspend user.',
    'Couldn’t uninstall plugin.' => 'Δεν μπόρεσε να απεγκατασταθεί το πρόσθετο.',
    'Couldn’t unsuspended user.' => 'Couldn’t unsuspended user.',
    'Couldn’t update password.' => 'Δεν μπόρεσε να ανανεωθεί ο κωδικός.',
    'Country' => 'Country',
    'COUPON' => 'COUPON',
    'Craft appears to be installed but the info table is empty.' => 'To Craft φαίνεται να είναι εγκατεστημένο, αλλά ο πίνακας info είναι κενός.',
    ...
    'Craft is unable to determine if an update is available at this time.' => 'Το Craft δεν μπορεί να προσδιορίσει αν υπάρχει κάποια διαθέσιμη ενημέρωση αυτή τη στιγμή.',
    ...
    'Craft is unable to transfer your license to this domain at this time.' => 'Το Craft δεν μπορεί να μεταφέρει την άδεια σας σε αυτό το domain αυτή τη στιγμή.',
    'Craft requires the PDO extension to operate.' => 'Το Craft απαιτεί την επέκταση PDO για να λειτουργήσει.',
    'Craft requires the PDO_MYSQL driver to operate.' => 'Το Craft απαιτεί τον οδηγό PDO_MYSQL για να λειτουργήσει.',
    ...
    'Create a new entry' => 'Δημιουργήστε μια νέα καταχώρηση',
    'Create a new field' => 'Δημιουργήστε ένα νέο πεδίο',
    'Create a new global set' => 'Create a new global set',
    'Create a new image transform' => 'Δημιουργήστε ένα νέο μετασχηματισμό εικόνας',
    'Create a new route' => 'Create a new route',
    'Create a new section' => 'Δημιουργήστε μια νέα ενότητα',
    'Create a new tag group' => 'Create a new tag group',
    'Create a new user group' => 'Δημιουργήστε μια νέα ομάδα χρηστών',
    'Create a new {section} entry type' => 'Create a new {section} entry type',
    'Create entries' => 'Δημιουργήστε καταχωρήσεις',
...
If you weren\'t expecting this email, just ignore it.',
    ...
    'IsNullOrEmpty requires a string.' => 'IsNullOrEmpty απαιτεί ένα string.',
    ...
    'Last Week' => 'Last Week',
    'Left' => 'Left',
    'less than a minute' => 'λιγότερο απο ένα λεπτό',
    ...
    'New locale added.' => 'Προστέθηκε νέα τοποθεσία.',
    ...
    'Preferred Locale' => 'Προτιμώμενη Τοποθεσία',
    ...
    'Quality' => 'Quality',
    'Quality must be a number between 1 and 100 (included).' => 'Η ποιότητα πρέπει να είναι ένας αριθμός μεταξύ 1 και 100 (περιλαμβάνεται).',
...
{% endfor %}',
    ...
    'The maximum length of a URI is 255 characters.' => 'Το μέγιστο μήκος ενός URI είναι 255 χαρακτήρες.',
    ...
    'There was a problem activating the user.' => 'Υπήρξε ένα πρόβλημα ενεργοποίησης του χρήστη.',
    'There was a problem backing up your database.' => 'There was a problem backing up your database.',
    'There was a problem backing up your files for the update.' => 'Υπήρξε ένα πρόβλημα δημιουργίας αντιγράφων ασφαλείας των αρχείων σας για την ενημέρωση.',
    ...
    'There was a problem saving your message.' => 'Υπήρξε πρόβλημα στην αποθήκευση του μηνύματός σας.',
    ...
    'There was a problem updating your database.' => 'Υπήρξε πρόβλημα ενημέρωσης της βάσης δεδομένων σας.',
    'There was a problem updating your files.' => 'Υπήρξε πρόβλημα ενημέρωσης των αρχείων σας.',
    ...
    'Upload a photo' => 'Ανεβάστε μια φωτογραφία',
...
If you weren\'t expecting this email, just ignore it.',
    ...
    'You must specify a port in your email settings.' => 'Πρέπει να ορίσετε μια θύρα στις ρυθμίσεις του e-mail σας.',

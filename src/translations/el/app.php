...
return [
    ...
    'Craft Pro and {trialPluginCount, plural, =1{{name}} other{# plugins}} are installed as trials.' => 'Craft Pro και {trialPluginCount, plural, one {}=1{{name}} other{# plugins}} έχουν εγκατασταθεί ως δοκιμαστικές εκδόσεις.',
    'Craft Pro is installed as a trial.' => 'Το Craft Pro έχει εγκατασταθεί ως δοκιμαστική έκδοση.',
    ...
    'Found {num, number} {num, plural, =1{error} other{errors}}' => 'Βρέθηκαν: {num, number} {num, plural, one {}=1{σφάλμα} other{σφάλματα}}',
    'Free' => 'Free',
    'From {date}' => 'Από {date}',
    'From' => 'Από',
    'Full Name' => 'Full Name',
    ...
    'How should {type} slugs be translated?' => 'Πώς να μεταφράζονται τα URL {type};',
    ...
    'License' => 'License',
    'Licensed' => 'Licensed',
    'Licensing Issues' => 'Προβλήματα αδειοδότησης',
    ...
    'Local volumes cannot be located within system directories.' => 'Οι τοπικοί τόμοι δεν μπορούν να βρίσκονται μέσα σε καταλόγους του συστήματος.',
    ...
    'Please fix on an environment where administrative changes are allowed.' => 'Διορθώστε το πρόβλημα σε ένα περιβάλλον όπου επιτρέπονται οι διαχειριστικές αλλαγές.',
    ...
    'Please notify one of your site’s admins.' => 'Ειδοποιήστε έναν από τους διαχειριστές του ιστότοπού σας.',
    ...
    'Purchase {total, plural, =1{license} other{licenses}}' => 'Αγορά {total, plural, one {}=1{άδειας} other{αδειών}}',
    ...
    'Show the Status field' => 'Εμφάνιση του πεδίου «Κατάσταση»',
    ...
    'Slug Translation Key Format' => 'Μορφή κλειδιού μετάφρασης URL',
    'Slug Translation Method' => 'Μέθοδος μετάφρασης URL',
    'Slug' => 'Slug',
    ...
    'Template that defines the Slug field’s custom “translation key” format. {type} slugs will be copied to all sites that produce the same key. For example, to make slugs translatable based on the first two characters of the site handle, you could enter `{site.handle[:2]}`.' => 'Πρότυπο που ορίζει την προσαρμοσμένη μορφή "κλειδιού μετάφρασης" του πεδίου URL. Οι διευθύνσεις URL {type} θα αντιγραφούν σε όλες τις τοποθεσίες που παράγουν το ίδιο κλειδί. Για παράδειγμα, για να κάνετε τις διευθύνσεις URL μεταφράσιμες με βάση τους δύο πρώτους χαρακτήρες του αναγνωριστικού γλώσσας του ιστότοπου, θα μπορούσατε να εισαγάγετε `{site.handle[:2]}`.',
    ...
    'The following licensing issues can be resolved with a single purchase on Craft Console.' => 'Τα ακόλουθα προβλήματα αδειοδότησης μπορούν να επιλυθούν με μία μόνο αγορά στην Craft Console.',
    ...
    'This {type} has been updated.' => 'Αυτό το στοιχείο: {type} έχει ενημερωθεί.',
    'Time Zone' => 'Time Zone',
    ...
    'Validation errors found in {attribute} {type}; please fix them.' => 'Υπάρχουν σφάλματα επικύρωσης στο εξής: {attribute} {type}. Διορθώστε τα',
    ...
    'Whether the table rows should be restricted to those defined by the “Default Values” setting.' => 'Εάν οι γραμμές του πίνακα θα πρέπει να περιορίζονται σε αυτές που ορίζονται από τη ρύθμιση "Προεπιλεγμένες τιμές".',
    ...
    '{name} active, more info' => 'Χρήστης {name} ενεργός, περισσότερες πληροφορίες',
    ...
    '{trialPluginCount, plural, =1{{name} is installed as a trial} other{# plugins are installed as trials}}.' => '{trialPluginCount, plural, one {}=1{{name} έχει εγκατασταθεί ως δοκιμαστική έκδοση} other{# πρόσθετα έχουν εγκατασταθεί ως δοκιμαστικές εκδόσεις}}.',
    ...
    '{user} is editing a draft of this {type}.' => 'Ο χρήστης {user} επεξεργάζεται ένα πρόχειρο του τύπου: {type}.',
    '{user} is editing this {type}.' => 'Ο χρήστης {user} επεξεργάζεται το εξής: {type}.',
    '{user} is viewing a draft of this {type}.' => 'Ο χρήστης {user} προβάλει ένα πρόχειρο του τύπου: {type}.',
    '{user} is viewing this {type}.' => 'Ο χρήστης {user} προβάλει το εξής: {type}.',

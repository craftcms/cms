...
如果您无法识别此邮件，请忽略它。',
    ...
    'Your system isn’t set up to save content for the site “{site}”.' => '站点“{site}”的系统尚未设置完毕，暂不能保存内容。',
    'Temp Folder' => '临时目录',
    ...
    'Close' => '关闭',
    'Buy {name}' => '购买 {name}',
    'Folder “{folder}” cannot be found on the volume.' => '在指定的存储卷中无法找到目录 “{folder}” 。',
    ...
    'The destination folder does not exist' => '目标目录不存在',

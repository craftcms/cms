...
Si vous n’attendiez aucun courriel de ce type, ignorez-le, tout simplement.',
    ...
    'Enable the [Intl extension]({link1}) or install additional [locale data files]({link2}) for more language options.' => 'Activez l’[extension Intl]({link1}) ou installez des [fichiers des paramètres régionaux]({link2}) additionnels pour obtenir plus d’options de langue.',

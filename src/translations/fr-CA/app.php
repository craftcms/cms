...
return [
    ...
    'Access the CP when the system is off' => 'Accéder au panneau de configuration lorsque le système est désactivé',
    ...
    'The path to the volume’s directory on the file system. An absolute path ({ex1}) is recommended. It can begin with an alias, such as {ex2}.' => 'Le chemin vers le répertoire du volume dans le système de fichiers. Un chemin absolu ({ex1}) est recommandé. Il peut commencer par un alias comme {ex2}.',
    ...
    'The “From” name Craft CMS will use when sending email.' => 'Le nom de l’expéditeur que Craft CMS utilisera quand il enverra un courriel.',

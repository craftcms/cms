...
Si vous n’attendiez aucun courriel de ce type, ignorez-le, tout simplement.',
    ...
    'Includes Sections, Global sets, Category groups, Tag groups, Asset volumes, Custom fields, Entry versioning, and Entry drafts' => 'Inclut les sections, les ensembles globaux, les groupes de catégories, les groupes de balises, les volumes d\'actifs, les champs personnalisés, le contrôle de version des entrées et les brouillons d\'entrée',
    'Export' => 'Exporter',
    ...
    'Includes Multiple locales, Section and entry locale targeting, Content translations' => 'Comprend de multiples lieux, ciblage de Section et de saisie de lieu, traductions de contenu',
    ...
    'Export…' => 'Exportation…',
    'Includes User accounts, User groups, User permissions, Public user registration' => 'Inclut les comptes Utilisateur, les groupes utilisateurs, les permissions de l\'utilisateur, l\'inscription en tant qu\'utilisateur public',
    ...
    'Your `project.yaml` file was created for different versions of Craft and/or plugins than what’s currently installed.' => 'Votre fichier « project.yaml » a été créé pour d\'autres versions de Craft ou de plugiciels que ce qui est actuellement installé.',
    ...
    'Tokens' => 'Jetons',
    'Modified in source {type}' => '{type} d’origine modifié',
    'Expanded' => 'Expanded',
    ...
    'All option values must be unique.' => 'Tous les valeurs d’option doivent être uniques.',
    'Copy' => 'Copier',
    'Couldn’t load active trials.' => 'Impossible de charger les essais en vigueur.',
    'The source {type} has been updated recently.' => 'Le {type} d’origine a été mis à jour récemment.',
    ...
    'Applying new propagation method to Matrix blocks' => 'Application de la nouvelle méthode de propagation aux blocs Matrix',
    'No results.' => 'Aucun résultat.',
    ...
    'To {date}' => 'Au {date}',
    'Remove files uploaded by other users' => 'Retirer les fichiers téléversés par d’autres utilisateurs',
    'From' => 'From',
    ...
    'Are you sure you want to release the job “{description}”?' => 'Voulez-vous vraiment publier la tâche « {description} »?',

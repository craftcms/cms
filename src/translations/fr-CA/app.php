...
return [
    ...
    '<strong>You’ve reached a breakpoint!</strong> More updates will become available after you install {update}.</p>' => '<strong>Vous avez atteint un point d’interruption!</strong> Des mises à jour supplémentaires seront disponibles une fois que vous aurez installé {update}.</p>',

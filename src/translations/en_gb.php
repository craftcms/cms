...
return array(
	...
	'Can’t install Craft' => 'Can’t install Craft',
	...
	'Craft needs to be able to write to the follow paths, but can’t: {files}' => 'Craft needs to be able to write to the follow paths, but can’t: {files}',
	...
	'Disabled' => 'Disabled',
	'Display files as thumbnails' => 'Display files as thumbnails',
	'Display files in a list' => 'Display files in a list',
	...
	'List multiple tags separated by commas.' => 'List multiple tags separated by commas.',
	...
	'Search' => 'Search',
	'Search nested folders' => 'Search nested folders',
	...
	'Sources' => 'Sources',
	'Start your 30-day {package} trial?' => 'Start your 30-day {package} trial?',
	'Status' => 'Status',
	'Status:' => 'Status:',
	'Stretch' => 'Stretch',
	...
	'The file "{path}" does not appear to be a valid GIF image.' => 'The file "{path}" does not appear to be a valid GIF image.',
	'The file "{path}" does not appear to be a valid JPEG image.' => 'The file "{path}" does not appear to be a valid JPEG image.',
	'The file "{path}" does not appear to be a valid PNG image.' => 'The file "{path}" does not appear to be a valid PNG image.',
	...
	'The update can’t be installed because Craft requires MySQL version “{requiredMySqlVersion}” or higher and you have MySQL version “{installedMySqlVersion}” installed.' => 'The update can’t be installed because Craft requires MySQL version “{requiredMySqlVersion}” or higher and you have MySQL version “{installedMySqlVersion}” installed.',
	'The update can’t be installed because Craft requires PHP version “{requiredPhpVersion}” or higher and MySQL version “{requiredMySqlVersion}” or higher.  You have PHP version “{installedPhpVersion}” and MySQL version “{installedMySqlVersion}” installed.' => 'The update can’t be installed because Craft requires PHP version “{requiredPhpVersion}” or higher and MySQL version “{requiredMySqlVersion}” or higher. You have PHP version “{installedPhpVersion}” and MySQL version “{installedMySqlVersion}” installed.',
	'The update can’t be installed because Craft requires PHP version “{requiredPhpVersion}” or higher and you have PHP version “{installedPhpVersion}” installed.' => 'The update can’t be installed because Craft requires PHP version “{requiredPhpVersion}” or higher and you have PHP version “{installedPhpVersion}” installed.',
	...
	'Tried to create the migration folder at “{folder}”, but could not.' => 'Tried to create the migration folder at “{folder}”, but could not.',
	'Try' => 'Try',
	'Type' => 'Type',
	'URL' => 'URL',
	...
	'Unknown' => 'Unknown',
	'Unknown indexing command!' => 'Unknown indexing command!',
	...
	'Your server doesn’t meet the following requirements to install Craft:' => 'Your server doesn’t meet the following requirements to install Craft:',

...
return [
    ...
    'Craft Pro and {trialPluginCount, plural, =1{{name}} other{# plugins}} are installed as trials.' => 'Craft Pro ו- {trialPluginCount, plural, =1{{name}} other{מס\' תוספים}} מותקנים לניסיון.',
    'Craft Pro is installed as a trial.' => 'Craft Pro הותקנה לניסיון.',

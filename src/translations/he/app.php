...
return [
    ...
    'Are you sure you want to delete the draft for this site?' => 'בטוח שברצונך למחוק את הטיוטה לאתר הזה?',
    ...
    'Could not suspend all users.' => 'לא ניתן להשעות את כל המשתמשים.',
    'Could not unsuspend all users.' => 'לא ניתן לבטל השעיה של כל המשתמשים.',
    ...
    'Couldn’t create entry.' => 'לא ניתן ליצור רשומה.',
    ...
    'Create a new entry after' => 'צור רשומה חדשה אחרי',
    'Create a new entry before' => 'צור רשומה חדשה לפני',
    ...
    'Delete draft for this site' => 'מחק טיוטה עבור האתר הזה',
    ...
    'Documentation' => 'תיעוד',
    'Done' => 'בוצע',
    'Double-click entries and other editable elements to try the new editor slideout interface.' => 'לחץ לחיצה כפולה על רשומות ותגיות אחרות שניתנות לעריכה כדי לנסות את ממשק ה-slideout החדש של העורך.',
    'Download backup' => 'הורד גיבוי',
    'Download' => 'הורד',
    'Draft Name' => 'שם הטיוטא',
    'Draft applied.' => 'הטיוטה הוחלה.',
    'Draft deleted for site.' => 'הטיוטה נמחקה עבור האתר הזה.',
    ...
    'Edit' => 'עריכה',
    'Edited' => 'ערוך',
    'Editor Slideouts' => 'ה-Slideouts של מעבד התמלילים',
    'Element' => 'רכיב',
    ...
    'Entry created.' => 'הרשומה נוצרה.',
    'Entry deleted for site.' => 'הרשומה נמחקה עבור האתר הזה.',
    ...
    'Go to Dashboard' => 'עבור ללוח המחוונים',
    ...
    'Streamlined Entry Publishing Flow' => 'תזרים פרסום רשומות מפושט',
    ...
    'The entry publishing workflow is now [simpler and more intuitive]({url}).' => 'מהלך העבודה של פרסום רשומות הפך להיות [יותר פשוט ויותר אינטואיטיבי]({url}).',
    ...
    'There was a problem processing your credit card.' => 'הייתה בעיה בעיבוד כרטיס האשראי שלך.',
    ...
    'Unable to use the selected directory for the volume.' => 'לא ניתן להשתמש בתיקיה שנבחרה עבור אמצעי האחסון.',
    ...
    'seven' => 'שבע',
    'six' => 'שש',
    'stripe_error_approve_with_id' => 'לא ניתן לאשר את התשלום.',
    'stripe_error_authentication_required' => 'הכרטיס נדחה מכיוון שהעסקה דורשת אימות.',
    'stripe_error_call_issuer' => 'הכרטיס נדחה מסיבה לא ידועה.',
    'stripe_error_card_not_supported' => 'הכרטיס לא תומך ברכישה מסוג זה.',
    'stripe_error_card_velocity_exceeded' => 'הלקוח חרג מהיתרה או מגבלת האשראי שזמינה בכרטיס.',
    'stripe_error_currency_not_supported' => 'הכרטיס לא תומך במטבע המצוין.',
    'stripe_error_do_not_honor' => 'הכרטיס נדחה מסיבה לא ידועה.',
    'stripe_error_do_not_try_again' => 'הכרטיס נדחה מסיבה לא ידועה.',
    'stripe_error_duplicate_transaction' => 'עסקה בסכום זהה עם אותו כרטיס אשראי הוגשה לפני כמה רגעים.',
    'stripe_error_expired_card' => 'פג תוקף הכרטיס.',
    'stripe_error_fraudulent' => 'התשלום נדחה מכיוון ש-Stripe חושדת שמקורו בהונאה.',
    'stripe_error_generic_decline' => 'הכרטיס נדחה מסיבה לא ידועה.',
    'stripe_error_incorrect_cvc' => 'קוד האבטחה שגוי.',
    'stripe_error_incorrect_number' => 'מספר הכרטיס שגוי.',
    'stripe_error_incorrect_pin' => 'ה-PIN שהוזן שגוי. קוד דחייה זה חל רק על תשלומים שנעשים בעזרת קורא כרטיסים.',
    'stripe_error_incorrect_zip' => 'המיקוד שגוי.',
    'stripe_error_insufficient_funds' => 'הכסף בכרטיס לא מספיק להשלמת הרכישה.',
    'stripe_error_invalid_account' => 'הכרטיס, או החשבון שמשויך לכרטיס אינו תקף.',
    'stripe_error_invalid_amount' => 'סכום התשלום אינו תקף או חורג מהסכום המורשה.',
    'stripe_error_invalid_cvc' => 'קוד האבטחה שגוי.',
    'stripe_error_invalid_expiry_month' => 'חודש התפוגה אינו תקף.',
    'stripe_error_invalid_expiry_year' => 'שנת התפוגה אינה תקפה.',
    'stripe_error_invalid_number' => 'מספר הכרטיס שגוי.',
    'stripe_error_invalid_pin' => 'ה-PIN שהוזן שגוי. קוד דחייה זה חל רק על תשלומים שנעשים בעזרת קורא כרטיסים.',
    'stripe_error_issuer_not_available' => 'לא ניתן לאשר את התשלום מכיוון שלא ניתן ליצור קשר עם מנפיק הכרטיס.',
    'stripe_error_lost_card' => 'התשלום נדחה מכיוון שהכרטיס דווח כאבוד.',
    'stripe_error_merchant_blacklist' => 'התשלום נדחה מכיוון שהוא מתאים לערך ברשימת המשתמשים החסומים ב-Stripe.',
    'stripe_error_new_account_information_available' => 'הכרטיס, או החשבון שמשויך לכרטיס אינו תקף.',
    'stripe_error_no_action_taken' => 'הכרטיס נדחה מסיבה לא ידועה.',
    'stripe_error_not_permitted' => 'התשלום לא מאושר.',
    'stripe_error_offline_pin_required' => 'הכרטיס נדחה מכיוון שהוא דורש קוד PIN.',
    'stripe_error_online_or_offline_pin_required' => 'הכרטיס נדחה מכיוון שהוא דורש קוד PIN.',
    'stripe_error_pickup_card' => 'לא ניתן להשתמש בכרטיס הזה לביצוע התשלום (יתכן שהוא דווח כאבוד או כגנוב).',
    'stripe_error_pin_try_exceeded' => 'חריגה מהמספר המותר של נסיונות הזנת קוד PIN.',
    'stripe_error_processing_error' => 'אירעה שגיאה בעת עיבוד הכרטיס.',
    'stripe_error_reenter_transaction' => 'לא ניתן לעבד את התשלום על ידי מנפיק הכרטיס מסיבה לא ידועה.',
    'stripe_error_restricted_card' => 'לא ניתן להשתמש בכרטיס הזה לביצוע התשלום (יתכן שהוא דווח כאבוד או כגנוב).',
    'stripe_error_revocation_of_all_authorizations' => 'הכרטיס נדחה מסיבה לא ידועה.',
    'stripe_error_revocation_of_authorization' => 'הכרטיס נדחה מסיבה לא ידועה.',
    'stripe_error_security_violation' => 'הכרטיס נדחה מסיבה לא ידועה.',
    'stripe_error_service_not_allowed' => 'הכרטיס נדחה מסיבה לא ידועה.',
    'stripe_error_stolen_card' => 'התשלום נדחה מכיוון שהכרטיס דווח כגנוב.',
    'stripe_error_stop_payment_order' => 'הכרטיס נדחה מסיבה לא ידועה.',
    'stripe_error_testmode_decline' => 'נעשה שימוש במספר כרטיס בדיקה של Stripe.',
    'stripe_error_transaction_not_allowed' => 'הכרטיס נדחה מסיבה לא ידועה.',
    'stripe_error_try_again_later' => 'הכרטיס נדחה מסיבה לא ידועה.',
    'stripe_error_withdrawal_count_limit_exceeded' => 'הלקוח חרג מהיתרה או מגבלת האשראי שזמינה בכרטיס.',
    'tag' => 'תג',
    'tags' => 'תגיות',

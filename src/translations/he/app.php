...
אם לא ציפית לקבל את האימייל הזה, פשוט התעלם ממנו.',
    ...
    'Additional locations that should be available for previewing entries in this section.' => 'מיקומים נוספים שצריכים להיות זמינים לתצוגה מקדימה של רשומות בסקשן הזה.',

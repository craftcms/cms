...
return [
    ...
    'Passkeys are an easy and secure way to identify yourself, using your fingerprint or facial recognition.' => 'מפתחות גישה הן דרך קלה ובטוחה להות את עצמך, באמצעות טביעת אצבעות או זיהוי פנים.',
    ...
    'Query for the “{name}” entry' => 'שאילתה של הרשומה "{name}"',
    'Query for the “{name}” global set' => 'שאילתה של הסט הגלובלי "{name}"',
    ...
    'The following licensing {total, plural, =1{issue} other{issues}} can be resolved with a single purchase on Craft Console:' => 'ה {total, plural, =1{בעיה} other{בעיות}} הבאות של הרישוי באמצעות רכישה בודדת ב-Craft Console:',
    ...
    'The maximum number of authors entries in this section can have.' => 'המספר המקסימלי של יוצרים שהסקשן הזה יכול להכיל.',
    ...
    'This can be set to an environment variable with a valid language ID ({examples}).' => 'ניתן להגדיר את זה על פי מזהה שפה תקף ({examples}).',
    ...
    'This field is included in element cards' => 'השדה כלול בכרטיסי האלמנטים',
    ...
    'This field provides thumbnails for elements' => 'השדה מספק תמונות ממוזערות לאלמנטים',
    ...
    'Where assets should be stored on the filesystem.' => 'היכן הנכסים צריכים להיות מאוחסנים במערכת הקבצים.',
    ...
    'Whether the element index should allow viewing nested {type} in a table.' => 'האם אינדקס האלמנטים צריך לאפשר {type} מקונן בטבלה.',
    ...
    'Your account requires two-step verification. Please enable one of these methods before proceeding.' => 'החשבון שלך דורש אימות דו-שלבי. נא לאפשר את אחת השיטות האלה בטרם תוכל להמשיך.',
    ...
    'You’re not permitted to edit any of this section’s sites.' => 'אינך מורשה לערוך אף אחד מהאתרים של סקשן הזה.',
    ...
    '{total, number} {total, plural, =1{error} other{errors}} found in {num, number} {num, plural, =1{tab} other{tabs}}.' => '{total, number} {total, plural, =1{שגיאה} other{שגיאות}} נמצאה/ו {num, number} {num, plural, =1{כרטיסייה} other{כרטיסיות}}.',
    ...
    '{type} will be saved across all {language}-language sites.' => '{type} יישמר בכל האתרים בשפה {language}.',

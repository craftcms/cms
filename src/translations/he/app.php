...
אם לא ציפית לקבל את האימייל הזה, פשוט התעלם ממנו.',
    ...
    'ON Label' => 'תווית ON',
    'Review' => 'ביקורת',
    'Apply changes in your project config YAML files to the loaded project config.' => 'החל שינויים בקובצי ה-YAML של תצורת הפרויקט שלך לתצורת הפרויקט הטעונה.',
    'Your project config YAML files are expecting the following plugins to be installed:' => 'קבצי ה-YAML שלך בתצורת הפרויקט מצפים להתקנה של התוספים הבאים:',
    ...
    'OFF Label' => 'תווית OFF',
    'Project config YAML changes discarded.' => 'שינויי YAML של תצורת הפרויקט נפסלו.',
    'Are you sure you want to discard the pending project config YAML changes?' => 'האם אתה בטוח שברצונך לפסול את שינויי ה-YAML הממתינים של תצורת הפרויקט?',
    'Regenerating project config YAML files from the loaded project config…' => 'יוצר מחדש את קובצי YAML של תצורת הפרויקט מתצורת הפרויקט שנטענה…',
    'Your project config YAML files contain pending changes.' => 'קובצי ה-YAML של תצורת הפרויקט שלך מכילים שינויים בהמתנה.',
    'Show all changes' => 'הצג את כל השינויים',
    'Offline' => 'לא מקוון',
    'Applying changes from the project config YAML files…' => 'מחיל שינויים מקובצי ה-YAML של תצורת הפרויקט…',

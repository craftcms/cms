...
אם לא ציפית לקבל את האימייל הזה, פשוט התעלם ממנו.',
    ...
    'Your are currently using the {currentEdition} edition, and your licensed edition is {licensedEdition}.' => 'אתה משתמש כעת בגרסה ה{currentEdition}, והגרסה המורשה שלך היא {licensedEdition}.',
    'Card number' => 'מסםר כרטיס',
    'Updates until {date} ({sign}{price})' => 'עדכונים עד ({date} ({sign}{price}',
    'Recent Revisions' => 'תיקונים אחרונים',
    'Save blocks to other sites in the same site group' => 'שמור בלוקים לאתרים אחרים באותה קבוצת אתרים',
    'This can be set to an environment variable, or begin with an alias.' => 'ניתן להגדיר את זה כמשתני סביבה או התחל עם כינויים.',
    'Unknown' => 'לא ידוע',
    ...
    'Module does not exist in the manifest: {moduleName}' => 'המודולים לא קיימים ברשימה: {moduleName}',
    'Saving' => 'שומר',
    ...
    'Save blocks to other sites with the same language' => 'שמור בלוקים לאתרים אחרים באותה שפה',
    ...
    'Save {type}' => 'שמור {type}',
    'Save entries to other sites in the same site group' => 'שמור טיוטות לאתרים אחרים באותה קבוצת אתרים',
    ...
    'This can be set to an environment variable.' => 'ניתן להגדיר את זה למשתני סביבה.',
    ...
    'Text that should be shown after the input.' => 'הטקסט שצריך להופיע אחרי הכניסה.',
    'Primary {type} page' => 'עמוד {type} ראשי',
    'Payment' => 'תשלום',
    'Save entries to all sites enabled for this section' => 'שמור רשומות לכל האתרים המאופשרים עבור סקשן זה',
    ...
    'Applied “{name}”' => 'ה"{name}" שהוחל',
    'Information' => 'מידע',
    'Make this the primary site?' => 'הםוך את זה לאתר הראשי?',
    'Clearing cache:' => 'מנקה מטמון:',
    'In the local temp folder' => 'בתיקיה מקומית זמנית',
    ...
    'Save entries to other sites with the same language' => 'שמור רשומות באתרים אחרים עם אותה השפה',
    'Export…' => 'ייבא…',

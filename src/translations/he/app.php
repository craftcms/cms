...
return [
    ...
    'stripe_error_pickup_card' => 'לא ניתן להשתמש בכרטיס הזה לביצוע התשלום (יתכן שהוא דווח כאבוד או גנוב).',
    ...
    'stripe_error_restricted_card' => 'לא ניתן להשתמש בכרטיס הזה לביצוע התשלום (יתכן שהוא דווח כאבוד או גנוב).',

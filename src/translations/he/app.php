...
return [
    ...
    'Are you sure you want to delete {numElements, plural, =1{this} other{these}} {type}?' => 'בטוח/ה שברצונך למחוק {type} {numElements, plural, =1{זה} other{אלה}}?',
    ...
    'Are you sure you want to permanently delete {numElements, plural, =1{this} other{these}} {type}?' => 'בטוח/ה שברצונך למחוק לצמיתות {type} {numElements, plural, =1{זה} other{אלה}}?',
    ...
    'Before deleting {label}, please address the following {numBlockers, plural, =1{issue} other{issues}}:' => 'לפני מחיקת {label}, יש לטפל {numBlockers, plural, =1{בבעיה הבאה} other{בבעיות הבאות}}:',
    ...
    'Choose a new author' => 'בחר יוצר חדש',
    'Choose a new password' => 'בחר סיסמה חדשה',
    'Choose a new {type}' => 'בחר {type} חדש',
    ...
    'Disable selected {type}' => 'השבת את ה{type} שנבחר',
    'Disable' => 'השבת',
    'Disabled' => 'מושבת',
    ...
    'Enable selected {type}' => 'הפעל את ה{type} שנבחר',
    ...
    'Filesystem settings' => 'הגדרות מערכת הקבצים',
    ...
    'Move to next group' => 'עבור לקבוצה הבאה',
    'Move to page…' => 'עבור לעמוד…',
    'Move to previous group' => 'עבור לקבוצה הקודמת',
    ...
    'No new author selected.' => 'לא נבחר יוצר חדש.',
    'No new {type} selected.' => 'לא נבחר {type} חדש.',
    ...
    'Paste {type} above' => 'הדבק {type} למעלה',
    'Paste {type} before' => 'הדבק {type} לפני',
    ...
    'Reassign {numEntries, plural, =1{entry} other{entries}}' => 'הקצה מחדש {numEntries, plural, =1{רשומה} other{רשומות}}',
    'Reassign' => 'להקצות מחדש',
    ...
    'Remove {numRelations, plural, =1{relation} other{relations}}' => 'להסיר {numRelations, plural, =1{קשר} other{קשרים}}',
    'Remove {numUsers, plural, =1{author} other {authors}} from {numEntries, plural, =1{entry} other{entries}}' => 'להסיר {numUsers, plural, =1{יוצר} other {יוצרים}} מה{numEntries, plural, =1{רשומה} other{רשומות}}',
    'Remove' => 'הסר',
    ...
    'Replace {numRelations, plural, =1{relation} other{relations}}' => 'להחליף {numRelations, plural, =1{קשר} other{קשרים}}',
    'Replace' => 'החלף',
    'Replacing {type} relations' => 'מחליף קשרים של {type}',
    ...
    'System time zone ({abbr})' => 'אזור זמן מערכת ({abbr})',
    'System' => 'מערכת',
    ...
    'The minimum number of authors that entries in this section can have.' => 'המספר המינימלי של יוצרים שרשומות בסקשן הזה יכולות להכיל.',
    ...
    'The {numEntries, plural, =1{entry} other {entries}} will be updated once the {numUsers, plural, =1{user is} other{users are}} deleted.' => 'ה{numEntries, plural, =1{רשומה תעודכן} other {רשומות יעודכנו}} לאחר שה{numUsers, plural, =1{משתמש יימחק} other{משתמשים יימחקו}}.',
    'The {numRelations, plural, =1{relation} other {relations}} will be removed once the {numTargets, plural, =1{{targetTypeSingular} is} other{{targetTypePlural} are}} deleted.' => 'ה{numRelations, plural, =1{קשר יוסר} other {קשרים יוסרו}} לאחר שה-{numTargets, plural, =1{{targetTypeSingular} יימחק} other{{targetTypePlural} יימחקו}}.',
    'The {numTargets, plural, =1{{targetTypeSingular} is} other{{targetTypePlural} are}} related by {numRelations, number} other {numRelations, plural, =1{{sourceTypeSingular}} other{{sourceTypePlural}}}.' => 'ה{numTargets, plural, =1{{targetTypeSingular} קשור/ה} other{{targetTypePlural} קשורים/ות}} על ידי {numRelations, number} {numRelations, plural, =1{{sourceTypeSingular}} other{{sourceTypePlural}}} אחר/אחרת/אחרים.',
    ...
    'Volume settings' => 'הגדרות אמצעי אחסון',
    'Volume' => 'אמצעי אחסון',
    'Volumes' => 'אמצעי אחסון',
    'Warning' => 'אזהרה',
    'Warning:' => 'אזהרה:',
    ...
    'five' => 'חמש',
    'folders' => 'תיקיות',
    'forgot_password_body' => "שלום {{user.friendlyName|e}},\n\nעל מנת לשחזר את הסיסמא שלך ל{{systemName}}, לחץ על הלינק:\n\n<{{link}}>\n\nאם לא ציפית לקבל את האימייל הזה, פשוט התעלם ממנו.",
    ...
    '{attribute} must be between {min} and {max}.' => '{attribute} חייב להיות בין {min} ל-{max}.',
    ...
    '{numEntries, number} {numEntries, plural, =1{entry has} other{entries have}} the {numUsers, plural, =1{user} other{users}} assigned as an author.' => 'ל{numEntries, plural, =1{רשומה {numEntries, number} יש} other{-{numEntries, number} רשומות יש}} את ה{numUsers, plural, =1{משתמש מוקצה כיוצר} other{משתמשים מוקצים כיוצרים}}.',
    '{numRelations, plural, =1{Relation} other{Relations}} queued to be replaced.' => '{numRelations, plural, =1{קשר הממתין} other{קשרים הממתינים}} בתור להחלפה.',
    ...
    '{type} entries are no longer allowed in this field. Please choose a different entry type.' => 'רשומות {type} אינן מותרות עוד בשדה הזה. בחר סוג רשומה אחר.',
    ...
    '{type} reassigned.' => '{type} הוקצה מחדש.',

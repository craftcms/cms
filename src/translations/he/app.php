...
return [
    ...
    '{name} is licensed for the {licenseEdition} edition, but the {currentEdition} is installed.' => '{name} מורשה עבור המהדורה {licenseEdition}, אבל מותקנת המהדורה {currentEdition}.',

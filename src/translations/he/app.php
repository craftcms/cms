...
אם לא ציפית לקבל את האימייל הזה, פשוט התעלם ממנו.',
    ...
    'The Craft CMS control panel requires a newer web browser.' => 'לוח הבקרה של Craft CMS דורש דפדפן אינטרנט יותר חדש.',
    ...
    'Share' => 'שתף',
    'None' => 'כלום',
    'Allow self relations' => 'אפשק קשרים עצמיים',
    ...
    'Layout element types' => 'תבנית סוגי הרכיבים',
    ...
    'Rebuild the project config based on the data stored throughout the database.' => 'בנה מחדש את תצורת הפרויקט על סמך הנתונים שמאוחסנים בכל בסיס הנתונים.',

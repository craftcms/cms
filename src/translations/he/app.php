...
אם לא ציפית לקבל את האימייל הזה, פשוט התעלם ממנו.',
    ...
    'Includes Multiple locales, Section and entry locale targeting, Content translations' => 'כולל מיקומים מרובים, מיקוד לפי מיקום הסקשן או הרשומה ותרגומי תוכן',
    'Optgroup?' => 'Optgroup?',
    ...
    'Includes Custom login screen logo, Custom site icon, Custom HTML email template, Custom email message wording' => 'כולל לוגו מסך כניסה מותאם אישית, סמל אתר מותאם אישית, תבנית HTML מותאמת אישית לדוא"ל, ניסוח הודעת דוא"ל מותאם אישית',
    'Guides' => 'מדריכים',
    ...
    'Your `project.yaml` file was created for different versions of Craft and/or plugins than what’s currently installed.' => 'קובץ ה-\'project.yaml\' שלך נוצר עבור גרסאות שונות של Craft ו/או תוספים שונים מהמותקנים כעת.',
    ...
    'View entry type - {entryType}' => 'הצג סוג רשומה - {entryType}',
    ...
    'View section - {section}' => 'הצג סקשן - {section}',
    ...
    'Past {num} days' => '{num} הימים שחלפו',
    'Show unpermitted files' => 'הצג קבצים שאינם מותרים',
    'Guest Required' => 'אורח נדרש',
    'Matrix block' => 'בלוק מטריצה',
    'This month' => 'החודש',
    'Only up to {version} is compatible with your version of Craft.' => 'רק עד ל-{version} תואמת לגרשת ה-Craft שלך.',
    'Past year' => 'שנה שעברה',
    'Show unpermitted volumes' => 'הצג אמצעי אחסון שאינם מותרים',
    'Choose which content should be available with this schema:' => 'בחר איזה תוכן צריך להיות זמין עם הסכימה הזאת:',
    'To {date}' => 'עד {date}',
    'Remove files uploaded by other users' => 'הסר קבצים שהועלו על ידי משתמשים אחרים',
    'From' => 'מ-',
    'Raw data (fastest)' => 'נתונים גולמיים (מהיר ביותר)',
    'Copied to clipboard.' => 'הועת ללוח גזירים.',
    ...
    'Your {file} file isn’t writable.' => 'הקובץ {file} שלך אינו מורשה לכתיבה.',
    'Time to reserve' => 'שעה להזמנה',
    ...
    'Caches generated by `{% cache %}` template tags' => 'מטמונים נוצרו על ידי תגי תבנית \'{% cache %}\'',
    'Finished' => 'סיים',
    'Progress' => 'התקדמות',

...
return [
    ...
    'Whether authors should be able to upload files directly to the field, rather than requiring them to select/upload assets via the selection modal.' => 'במידה שיוצרי תוכן יהיו מסוגלים להעלות קבצים ישירות לשדה, במקום לדרוש מהם לבחור/להעלות נכסים דרך מודול הבחירה.',

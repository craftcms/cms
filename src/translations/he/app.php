...
אם לא ציפית לקבל את האימייל הזה, פשוט התעלם ממנו.',
    ...
    'Your are currently using the {currentEdition} edition, and your licensed edition is {licensedEdition}.' => 'אתה משתמש כעת במהדורה ה{currentEdition}, והמהדורה המורשה שלך היא {licensedEdition}.',
    'Card number' => 'מסםר כרטיס',
    'Updates until {date} ({sign}{price})' => 'עדכונים עד ({date} ({sign}{price}',
    'Recent Revisions' => 'גרסאות אחרונות',
    ...
    'Licensed' => 'Licensed',
    'The maximum length (in bytes) the field can hold.' => 'האורך המרבי (בבייטים) שהתוכן יכול להכיל.',
    'Find an official Craft Partner' => 'מצא שותף רשמי למערכת ניהול התוכן',
    'Less' => 'פחות',
    ...
    'Clearing cache:' => 'ניקוי מטמון:',
    'In the local temp folder' => 'בתיקיה זמנית מקומית',
    ...
    'Text that should be shown before the input.' => 'הטקסט שצריך להופיע אחרי הכניסה.',
    'Next Page' => 'Next Page',

...
return [
    ...
    'JavaScript must be enabled to access the Craft CMS Control Panel.' => 'يجب تمكين الجافاسكربت للوصول إلى لوحة تحكم Craft.',
...
إذا لم تكن تتوقع هذه الرسالة، ما عليك سوى تجاهلها.',
    ...
    'Position' => 'الموضع',
    'Disabled Globally' => 'معطل بشكل عام',
    ...
    'The following plugins are listed in `project.yaml`, but appear to be missing or installed at the wrong version:' => 'تم إدراج الملحقات التالية في قائمة `project.yaml`، ولكنها تبدو غير موجودة أو تم تثبيت الإصدار الخاطئ منها:',
    ...
    'Regenerating `project.yaml` from the loaded project config…' => 'إنشاء `project.yaml` من تكوين المشروع الذي تم تحميله...',
    ...
    'Use project.yaml' => 'استخدام project.yaml',
    ...
    'Changes to `project.yaml` must be applied to the loaded project config.' => 'إن التغييرات التي أجريت في `project.yaml` يجب تطبيقها على تكوين المشروع الذي تم تحميله.',
    'Edit Category' => 'تحرير الفئة',
    ...
    'Enabled Globally' => 'ممكَّن بشكل عام',
    ...
    'The loaded project config has more recent changes than `project.yaml`.' => 'هناك تغييرات أحدث في تكوين المشروع الذي تم تحميله مقارنة بمشروع `project.yaml`.',
    'Access the CP when the system is offline' => 'الوصول إلى لوحة التحكم عندما يكون النظام غير متصل بالإنترنت',
    'Control Panel resources' => 'مصادر لوحة التحكم',
    'Disabled for Site' => 'معطل للموقع',
    ...
    'Unable to apply project.yaml changes' => 'تعذر تطبيق تغييرات project.yaml',
    'Duplicate' => 'تكرار',

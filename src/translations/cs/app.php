...
return [
    ...
    'Is this the primary site?' => 'האם זהו האתר הראשי?',
    ...
    'Propagate entries across all enabled sites?' => 'להפיץ רשומות בכל האתרים המופעלים?',
    ...
    'Resaving {section} entries ({site})' => 'שומר מחדש ערכי {section} ({site})',
    'Resaving {type} entries' => 'שומר מחדש {type} ערכים',
    'Resaving {type} entries ({site})' => 'שומר מחדש ערכי {type} ({site})',
    ...
    'Revert entry to this version' => 'החזר את הרשומה לגרסה זו',
    ...
    'Save as a new entry' => 'שמור כרשומה חדשה',
    ...
    'Whether entries should be propagated across all the sites the section is enabled in. If this is disabled, each entry will only belong to the site it was created in.' => 'האם יש להזין רשומות בכל האתרים שבהם הקטע מופעל. אם זה מושבת, כל רשומה תהיה שייכת רק לאתר שבו היא נוצרה.',
...
אם לא ציפית לקבל את האימייל הזה, פשוט התעלם ממנו.',
    ...
    'nine' => 'תשע',
    'one' => 'אחד',
    'or <a>send to Craft Support</a>' => 'או <a dir="rtl">שלח לתמיכת Craft</a>',
...
אם לא ציפית לקבל את האימייל הזה, פשוט התעלם ממנו.',
    ...
    'Propagating {class} elements' => 'מפיץ {class} רכיבים',
    'Edit Category' => 'ערוך קטגוריה',
    ...
    'Your `project.yaml` file was created for more recent versions of Craft and/or plugins than what’s currently installed.' => 'הקובץ \'project.yaml\' נוצר עבור גרסאות חדשות יותר של Craft ו/או תוספים מהגרסאות המותקנות כעת.',

...
Si vous n’attendiez aucun email de ce type, ignorez-le, tout simplement.',
    ...
    'Whether validation errors on the related {type} should prevent the source element from being saved.' => 'Si valider les erreurs quant au {type} concerné devait empêcher l\'élément source d\'être sauvegardé ou pas.',
    ...
    'Save entries to other sites in the same site group' => 'Enregistrer les entrées sur d\'autres sites dans le même groupe de site',

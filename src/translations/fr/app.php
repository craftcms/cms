...
return [
    ...
    'Are you sure you want to delete the selected {type} for this site?' => 'Êtes-vous sûr(e) de vouloir supprimer le {type} sélectionné pour ce site ?',
    ...
    'Whether the site menu should be shown for {type} selection modals.' => 'Le menu de sélection du site doit-il être affiché dans les fenêtres de sélection {type,select,entrée{d’} other{de }}{type} ?',
    ...
    'Whether validation errors on the related {type} should prevent the source element from being saved.' => 'Les erreurs de validation des {type} {type,select, utilisateurs{référencées} other{référencées}} doivent-elles empêcher l’élément source d’être enregistré ?',

...
Si vous n’attendiez aucun email de ce type, ignorez-le, tout simplement.',
    ...
    'Additional locations that should be available for previewing entries in this section.' => 'Emplacements additionnels à proposer pour la prévisualisation des entrées de cette section.',
    ...
    'The token that must be provided with GraphQL requests to access this schema.' => 'Jeton à fournir avec les requêtes GraphQL pour accéder à ce schéma.',
    ...
    'Schema name' => 'Nom du schéma',
    'View category group - {categoryGroup}' => 'Voir le groupe de catégorie - {categoryGroup}',
    'Delete them' => 'Les supprimer',
    'Keep them' => 'Les garder',
    'View tag group - {tagGroup}' => 'Voir le groupe d\'étiquette - {tagGroup}'
];

...
Si vous n’attendiez aucun email de ce type, ignorez-le, tout simplement.',
    ...
    'Trashed' => 'Détruite(s)',
    'Could not create a Live Preview token.' => 'Impossible de créer un jeton Live Preview.',
    ...
    'Propagating {class} elements' => 'Diffusion des éléments {class}',
    'Edit Category' => 'Modifier la catégorie',
    ...
    'Your `project.yaml` file was created for more recent versions of Craft and/or plugins than what’s currently installed.' => 'Votre fichier `project.yaml` a été créé pour des versions de Craft et/ou des plug-ins plus récentes que celle qui est actuellement installée.',

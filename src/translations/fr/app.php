...
Si vous n’attendiez aucun email de ce type, ignorez-le, tout simplement.',
    ...
    'Composer was unable to install the updates.' => 'Composer nʼa pas pu installer les mises à jour.',
    'A critical update is available.' => 'Une mise à jour critique est disponible.',
    'The server doesn’t meet Craft’s new requirements:' => 'Le serveur ne répond pas aux nouvelles spécifications de Craft :',
    ...
    'Composer was unable to optimize the autoloader.' => 'Composer nʼa pas pu optimiser lʼautochargeur.',
    ...
    'Composer was unable to revert the updates.' => 'Composer nʼa pas pu annuler les mises à jour.',
    ...
    'One of {name}’s migrations failed.' => 'L’une des migrations de {name} a échoué.',
    ...
    'There was a problem with uploading the file.' => 'Un problème s’est produit avec le téléchargement du fichier.',
    'Checking…' => 'Vérification…',
    'It looks like someone is currently performing a system update.<br>Only continue if you’re sure that’s not the case.' => 'Il semble que quelqu’un effectue une mise à jour du système.<br>Continuez uniquement si vous êtes certain que ce n’est pas le cas.',
    'The update was reverted successfully.' => 'La mise à jour a été annulée.',
    'Revert update' => 'Annuler la mise à jour',
    'Your composer.json file could not be located. Try setting the CRAFT_COMPOSER_PATH constant in index.php to its location on the server.' => 'Votre fichier composer.json n’a pas pu être localisé. Essayez de définir la constante CRAFT_COMPOSER_PATH (du fichier index.php) sur son emplacement sur le serveur.',
    'Installing update (this may take a minute)…' => 'Installation de la mise à jour (cela peut durer une minute)…',
    ...
    'Error:' => 'Erreur :',
    'Optimizing installation…' => 'Optimisation de l’installation…',
    'Update aborted.' => 'Mise à jour interrompue.',
    'Download file' => 'Télécharger le fichier',
    'Output:' => 'Sortie :',
    'Reverting update (this may take a minute)…' => 'Annulation de la mise à jour (cela peut durer une minute)…',
    ...
    'Backup' => 'Sauvegarder',
    'Assign user groups' => 'Affecter les groupes utilisateurs',
    ...
    'Merge the folder (any conflicting files will be replaced)' => 'Fusionner le dossier (tous les fichiers en conflit seront remplacés)',
    'Edit Image' => 'Modifier l’image',
    'Are you sure you want to delete this image?' => 'Souhaitez-vous réellement supprimer cette image ?',
    'Show nav' => 'Afficher nav',
    'Assign user permissions' => 'Affecter les autorisations utilisateurs',
    'Clear all' => 'Tout effacer',
    'Find Text' => 'Rechercher le texte',
    'Could not load the image editor.' => 'Impossible de charger l’éditeur d’images.',

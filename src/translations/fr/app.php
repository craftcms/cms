...
return [
    ...
    'Regenerating project config YAML files from the loaded project config…' => 'Regénération des fichiers de configuration YAML du projet à partir de la configuration du projet chargée…',

...
Si vous n’attendiez aucun email de ce type, ignorez-le, tout simplement.',
    ...
    'Configure the product types’s site-specific settings.' => 'Configurez les paramètres spécifiques au site pour les types de produit.',
    ...
    'Where do you want to use to store user photos? Note that the subfolder path can contain variables like <code>{username}</code>.' => 'Où voulez-vous stocker les photographies de l’utilisateur ? Veuillez noter que le chemin du sous-dossier peut contenir des variables du type <code>{username}</code>.',
    ...
    'Backup' => 'Sauvegarder',
    'Resaving all elements' => 'Réenregistrement de tous les éléments',
    'Assign user groups' => 'Affecter les groupes utilisateurs',
    'Resaving all localizable elements' => 'Réenregistrement de tous les éléments localisables',
    'Keep both' => 'Conserver les deux',
    'Working in Matrix field “{field}”' => 'Action dans le champ « {field} » de Matrix',

...
return [
    ...
    'Active' => 'Actif',
    'Add Row Label' => 'Texte "Ajouter une ligne"',
    ...
    'Insert the button label for adding a new row to the table.' => 'Insérer le texte du bouton pour ajouter une nouvelle ligne au tableau.',

...
return [
    ...
    'Revert {type} to this revision' => 'Restaurer {type,select,entrée{l‘} ressource{la } catégorie{la } other{le }}{type} à cette révision',
    ...
    'Whether {type} should be allowed to relate themselves.' => 'Les {type} peuvent-{type,select,entrées{elles} catégories{elles} ressources{elles} other{ils}} se référencer {type,select,utilisateurs{eux} other{elles}}-mêmes ?',

...
return [
    ...
    'At least one currently-enabled site must remain enabled.' => 'Au moins un site qui est actuellement actif doit rester activé.',
    ...
    'Connect your Craft ID account to improve your experience.' => 'Connectez votre compte ID Craft pour améliorer votre expérience.',
    ...
    'Craft CMS does not support backtracking to this version. Please update to Craft CMS {version} or later.' => 'Craft CMS ne peut pas revenir vers cette version. Merci de mettre à jour vers Craft CMS {version} ou plus récent.',
    ...
    'Define the columns your table should have.' => 'Définir les colonnes de votre tableau.',
    ...
    'Disconnected from id.craftcms.com with errors, check the logs.' => 'Déconnecté de id.craftcms.com avec des erreurs, merci de vérifier les journaux.',
    'Disconnected from id.craftcms.com.' => 'Déconnecté de id.craftcms.com.',
    ...
    'Encryption Method' => 'Méthode de chiffrement',
    'Enter slug' => 'Insérer l’identificateur',
    'Enter the name of the folder' => 'Entrez le nom du dossier',
    'Enter the new filename' => 'Entrez le nouveau nom de fichier',
    ...
    'Loading Plugin Store…' => 'Chargement de la boutique des plugins…',
    ...
    'Propagate entries across all enabled sites?' => 'Propager les entrées dans tous les sites activés ?',
    ...
    'Resaving {type} entries ({site})' => 'Ré-enregistrement des entrées {type} ({site})',
    ...
    'State/province' => 'État/Province/Région',
    'Status' => 'Statut',
    ...
    'The Plugin Store is not available, please try again later.' => 'La boutique des plugins nʼest pas accessible, merci de réessayer ultérieurement.',
    'The base URL for the site. It can begin with an alias, such as {ex}.' => 'LʼURL de base pour le site. Elle peut commencer par un alias, comme {ex}.',
    'The base URL to the assets in this volume. An absolute URL ({ex1}) or protocol-relative URL ({ex2}) is recommended. It can begin with an alias, such as {ex3}.' => 'LʼURL de base pour accéder uax ressources sur ce volume. Une URL absolue ({ex1}) ou une URL relative à un protocol donné ({ex2}) est recommandée. Elle peut commencer par un alias, comme {ex3}.',
    ...
    'The path to the volume’s directory on the file system. An absolute path ({ex1}) is recommended. It can begin with an alias, such as {ex2}.' => 'Le chemin vers le répertoire de volume dans le système de fichiers. Un chemin absolu ({ex1}) est recommandé. Il peut commencer par un alias, comme {ex2}.',
    ...
    'Trial' => 'Essai',
    'Tried to detect the appropriate image format for a non-image!' => 'Nous avons essayé de détecter le format d’image approprié pour un fichier qui nʼétait pas une image !',
    ...
    'Whether entries should be propagated across all the sites the section is enabled in. If this is disabled, each entry will only belong to the site it was created in.' => 'Si les entrées doivent être propagées (ou non) dans tous les sites dans lesquels cette section est activée. Si ce paramètre est désactivé, les entrées n’appartiendront qu’au site dans lequel elles auront été créées.',
    ...
    'You need to be on at least Craft CMS {version} before you can manually update to Craft CMS {targetVersion}.' => 'Vous devez d’abord être au moins sur Craft CMS {version} avant de pouvoir effectuer une mise à jour manuelle vers Craft CMS {targetVersion}.',
    'You need to reset your password, but an error was encountered when sending the password reset email.' => 'Vous devez réinitialiser votre mot de passe, mais une erreur est survenue lors de l’envoi de l’email de réinitialisation de votre mot de passe.',
    ...
    'Your server doesn’t meet the following requirements to run Craft CMS:' => 'Votre serveur ne respecte pas les pré-requis suivants pour faire fonctionner Craft CMS :',
...
Si vous n’attendiez aucun email de ce type, ignorez-le, tout simplement.',
    ...
    '{attribute} should contain at least {min, number} {min, plural, one{block} other{blocks}}.' => '{attribute} devrait contenir au moins {min, number} {min, plural, un{block} autres{blocks}}.',
    ...
    '{attribute} should contain {count, number} {count, plural, one{item} other{items}}.' => '{attribute} devrait contenir {count, number} {count, plural, un{item} autres{items}}.',

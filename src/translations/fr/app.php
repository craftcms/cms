...
return [
    ...
    'Fit' => 'Ajuster',
    'Fix validation errors on the related {type}.' => 'Corriger les erreurs de validation sur {type,select,entrée{l‘} ressource{la } catégorie{la } utilisateur{l‘} other{le }}{type} associé.',

...
return [
    ...
    'Asset settings saved.' => 'Paramètres des ressources enregistrés.',
    ...
    'Couldn’t send activation email.' => 'Impossible d\'envoyer l\'e-mail d\'activation.',
    ...
    'How should {type} titles be translated?' => 'Comment les titres des {type}s devraient-ils être traduits ?',
    ...
    'In the local temp folder' => 'Dans le fichier temporaire local',
    'Inactive' => 'Inactif',
    ...
    'Matrix block could not be added. Maximum number of blocks reached.' => 'Le bloc Matrix ne peut pas être ajouté. Le nombre maximum de blocs est atteint.',
    'Matrix block' => 'Bloc Matrix',
    'Matrix blocks' => 'Blocs Matrix',
    'Matrix' => 'Matrice',
    ...
    'Save blocks to other sites in the same site group' => 'Enregistrer les blocs sur les autres sites du même groupe de sites',
    'Save blocks to other sites with the same language' => 'Enregistrer les blocs sur les autres sites ayant la même langue',
    ...
    'Selection Label' => 'Libellé du bouton de sélection',
    ...
    'There was a problem activating the user.' => 'Une erreur est survenue lors de l\'activation de l\'utilisateur.',
    ...
    'View tag group - {tagGroup}' => 'Voir le groupe de tags - {tagGroup}',

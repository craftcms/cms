...
return [
    ...
    'Craft Pro and {trialPluginCount, plural, =1{{name}} other{# plugins}} are installed as trials.' => 'Craft Pro et {trialPluginCount, plural, one {}=1{{name}} other{# plug-ins}} sont installés en tant qu\'essai.',
    'Craft Pro is installed as a trial.' => 'Craft Pro est installé en tant qu’essai.',
    ...
    'Purchase {total, plural, =1{license} other{licenses}}' => 'Acheter {total, plural, one {}=1{licence} other{licences}}',
    ...
    '{trialPluginCount, plural, =1{{name} is installed as a trial} other{# plugins are installed as trials}}.' => '{trialPluginCount, plural, one {}=1{{name} est installé en tant qu\'essai} other{# plug-ins sont installés en tant qu\'essais}}.',

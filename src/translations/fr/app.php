...
Si vous n’attendiez aucun email de ce type, ignorez-le, tout simplement.',
    ...
    'Use this field’s values as search keywords?' => 'Utiliser les valeurs de ce champ comme des mots clés pour la recherche ?',
    'This field is translated for each language.' => 'Ce champ est traduit pour chaque langue.',
    'The following plugins are listed in `project.yaml`, but appear to be missing or installed at the wrong version:' => 'Les plug-in suivants sont listés dans `project.yaml`, mais semblent manquer ou être installés dans une version erronée :',
    ...
    'Regenerating `project.yaml` from the loaded project config…' => 'Générer à nouveau `project.yaml`à partir de la config. du projet chargée...',
    ...
    'Changes to `project.yaml` must be applied to the loaded project config.' => 'Les modifications apportées à `project.yaml` doivent être appliquées à la config. du projet chargée',
    'Edit Category' => 'Modifier la catégorie',
    ...
    'The loaded project config has more recent changes than `project.yaml`.' => 'La config. du projet chargée comporte plus de modifications que `project.yaml`.',
    ...
    'Unable to apply project.yaml changes' => 'Impossible d’appliquer les modifications sur project.yaml',
    'Duplicate' => 'Dupliquer',
    ...
    'Includes Sections, Global sets, Category groups, Tag groups, Asset volumes, Custom fields, Entry versioning, and Entry drafts' => 'Inclut les sections, les ensembles globaux, les groupes de catégories, les groupes de balises, les volumes de ressources, les champs personnalisés, le contrôle de version des entrées et les brouillons d\'entrée',
    'Export' => 'Exporter',
    ...
    'Includes Multiple locales, Section and entry locale targeting, Content translations' => 'Comprend de multiples localisations, le ciblage des sections et des localisations d\'entrée, les traductions de contenu',
    'Optgroup?' => 'Optgroup ?',
    ...
    'Includes Custom login screen logo, Custom site icon, Custom HTML email template, Custom email message wording' => 'Comprend un logo d\'écran de connexion personnalisé, une icône de site personnalisée, un modèle de courriel HTML personnalisé, un libellé de message électronique personnalisé',
    'Guides' => 'Guides',
    ...
    'Export…' => 'Exporter…',
    'Includes User accounts, User groups, User permissions, Public user registration' => 'Inclut les comptes utilisateur, les groupes utilisateurs, les permissions des utilisateurs, l\'inscription en tant qu\'utilisateur public',
    ...
    'Your `project.yaml` file was created for different versions of Craft and/or plugins than what’s currently installed.' => 'Votre fichier `project.yaml` a été créé pour des versions de Craft et/ou des plug-ins différente que celle qui est actuellement installée.',
    ...
    'View entry type - {entryType}' => 'Voir le type d’entrée - {entryType}',
    ...
    'View section - {section}' => 'Voir la section - {section}',
    ...
    'The `Authorization` header that should be sent with GraphQL API requests to use this token.' => 'L\'en-tête « autorisation » qui doit être envoyée avec les requêtes d\'API GraphQL pour utiliser ce jeton.',
    ...
    'Choose which content should be available with this schema:' => 'Choisissez le contenu disponible pour ce schéma :',
    'To {date}' => 'Au {date}',
    ...
    'Your {file} file isn’t writable.' => 'Votre fichier {file} n’est pas accessible en écriture.',
    ...
    'Caches generated by `{% cache %}` template tags' => 'Caches générés par les étiquettes de modèle `{% cache %}`',
    'Finished' => 'Terminée',

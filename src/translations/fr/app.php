...
return [
    ...
    'Changelog' => 'Changelog',
    'Changes discarded' => 'Changements abandonnés',
    ...
    'Copy the package’s name for this plugin.' => 'Copier le nom de paquet pour ce plugin.',
    ...
    'Could not suspend all users.' => 'Impossible de suspendre tous les utilisateurs.',
    'Could not unsuspend all users.' => 'Impossible de rétablir tous les utilisateurs.',
    ...
    'Couldn’t create entry.' => 'Impossible de créer une entrée.',
    ...
    'Done' => 'Terminé',
    'Double-click entries and other editable elements to try the new editor slideout interface.' => 'Double-cliquer sur les entrées et autres éléments modifiables pour essayer le nouveau volet d‘édition.',
    ...
    'Edit' => 'Modifier',
    'Edited' => 'Modifié',
    'Editor Slideouts' => 'Volets d‘édition',
    'Element' => 'Élément',
    ...
    'Header Column Heading' => 'Titre de la colonne d‘en-tête',
    'Heading' => 'Titre',
    'Height' => 'Hauteur',
    ...
    'Limit the number of selectable {type}.' => 'Limiter le nombre {type,select,entrées{d‘} utilisateurs{d‘} other{de }}{type} sélectionnables.',
    'Limit' => 'Limite',
    'Line' => 'Ligne',
    'Link' => 'Lien',
    ...
    'Project config YAML changes discarded.' => 'Modifications de la configuration du projet présentes dans les fichiers YAML annulées.',
    ...
    'Recent {type} changes merged.' => 'Modifications récentes {type,select,entrée{de l‘} ressource{de la } catégorie{de la } other{du }}{type} fusionnées.',
    ...
    'Should users who register their own accounts be suspended by default? This will prevent them from receiving an activation email.' => 'Les utilisateurs qui s’inscrivent doivent-ils être suspendus par défaut ? Cela les empêchera de recevoir un e-mail d’activation.',
    ...
    'Streamlined Entry Publishing Flow' => 'Flux de publication d’entrée simplifié',
    ...
    'Support' => 'Support',
    'Suspend users by default' => 'Suspendre les utilisateurs nouvellement inscrits',
    'Suspend' => 'Suspendre',
    'Suspended' => 'Suspendu',
    'Switch' => 'Basculer',
    ...
    'The entry publishing workflow is now [simpler and more intuitive]({url}).' => 'Le processus de publication des entrées est désormais [plus simple et plus intuitif] ({url}).',
    ...
    'There was a problem processing your credit card.' => 'Une erreur est survenue lors du paiement.',
    ...
    'This license is tied to another Craft install. Purchase a license for this install.' => 'Cette licence est liée à une autre installation de Craft. Achetez une licence pour cette installation.',
    ...
    'Unable to use the selected directory for the volume.' => 'Dossier sélectionné introuvable pour le volume.',
    ...
    'seven' => 'sept',
    'six' => 'six',
    'stripe_error_approve_with_id' => 'Le paiement ne peut pas être autorisé.',
    'stripe_error_authentication_required' => 'La carte a été refusée car la transaction nécessite une authentification.',
    'stripe_error_call_issuer' => 'La carte a été refusée pour une raison inconnue.',
    'stripe_error_card_not_supported' => 'La carte ne permet pas ce type d’achat.',
    'stripe_error_card_velocity_exceeded' => 'Le client a dépassé le solde ou la limite de crédit disponible de sa carte.',
    'stripe_error_currency_not_supported' => 'La carte ne prend pas en charge la devise indiquée.',
    'stripe_error_do_not_honor' => 'La carte a été refusée pour une raison inconnue.',
    'stripe_error_do_not_try_again' => 'La carte a été refusée pour une raison inconnue.',
    'stripe_error_duplicate_transaction' => 'Une transaction avec un montant et des informations de carte de crédit identiques a été soumise très récemment.',
    'stripe_error_expired_card' => 'La carte a expiré.',
    'stripe_error_fraudulent' => 'Le paiement a été refusé car Stripe le soupçonne d’être frauduleux.',
    'stripe_error_generic_decline' => 'La carte a été refusée pour une raison inconnue.',
    'stripe_error_incorrect_cvc' => 'Le numéro CVC est incorrect.',
    'stripe_error_incorrect_number' => 'Le numéro de la carte est incorrect.',
    'stripe_error_incorrect_pin' => 'Le code NIP saisi est incorrect. Ce code de refus s’applique uniquement aux paiements effectués avec un lecteur de carte.',
    'stripe_error_incorrect_zip' => 'Le code postal est incorrect.',
    'stripe_error_insufficient_funds' => 'La carte ne dispose pas de fonds suffisants pour effectuer l’achat.',
    'stripe_error_invalid_account' => 'La carte, ou le compte auquel la carte est connectée, n’est pas valide.',
    'stripe_error_invalid_amount' => 'Le montant du paiement n’est pas valide, ou dépasse le montant autorisé.',
    'stripe_error_invalid_cvc' => 'Le numéro CVC est incorrect.',
    'stripe_error_invalid_expiry_month' => 'Le mois d’expiration n’est pas valide.',
    'stripe_error_invalid_expiry_year' => 'L’année d’expiration n’est pas valide.',
    'stripe_error_invalid_number' => 'Le numéro de la carte est incorrect.',
    'stripe_error_invalid_pin' => 'Le code NIP saisi est incorrect. Ce code de refus s’applique uniquement aux paiements effectués avec un lecteur de carte.',
    'stripe_error_issuer_not_available' => 'L’émetteur de la carte n’a pas pu être joint, le paiement n’a donc pas pu être autorisé.',
    'stripe_error_lost_card' => 'Le paiement a été refusé car la carte a été déclarée perdue.',
    'stripe_error_merchant_blacklist' => 'Le paiement a été refusé car il correspond à une valeur figurant sur la liste de blocage d’utilisateurs de Stripe.',
    'stripe_error_new_account_information_available' => 'La carte, ou le compte auquel la carte est connectée, n’est pas valide.',
    'stripe_error_no_action_taken' => 'La carte a été refusée pour une raison inconnue.',
    'stripe_error_not_permitted' => 'Le paiement n’est pas autorisé.',
    'stripe_error_offline_pin_required' => 'La carte a été refusée car elle nécessite un NIP.',
    'stripe_error_online_or_offline_pin_required' => 'La carte a été refusée car elle nécessite un NIP.',
    'stripe_error_pickup_card' => 'La carte ne peut pas être utilisée pour effectuer ce paiement (il est possible qu’elle ait été déclarée perdue ou volée).',
    'stripe_error_pin_try_exceeded' => 'Le nombre autorisé d’essais du NIP a été dépassé.',
    'stripe_error_processing_error' => 'Une erreur est survenue lors du traitement de la carte.',
    'stripe_error_reenter_transaction' => 'Le paiement n’a pas pu être traité par l’émetteur pour une raison inconnue.',
    'stripe_error_restricted_card' => 'La carte ne peut pas être utilisée pour effectuer ce paiement (il est possible qu’elle ait été déclarée perdue ou volée).',
    'stripe_error_revocation_of_all_authorizations' => 'La carte a été refusée pour une raison inconnue.',
    'stripe_error_revocation_of_authorization' => 'La carte a été refusée pour une raison inconnue.',
    'stripe_error_security_violation' => 'La carte a été refusée pour une raison inconnue.',
    'stripe_error_service_not_allowed' => 'La carte a été refusée pour une raison inconnue.',
    'stripe_error_stolen_card' => 'Le paiement a été refusé car la carte a été déclarée volée.',
    'stripe_error_stop_payment_order' => 'La carte a été refusée pour une raison inconnue.',
    'stripe_error_testmode_decline' => 'Un numéro de carte de test Stripe a été utilisé.',
    'stripe_error_transaction_not_allowed' => 'La carte a été refusée pour une raison inconnue.',
    'stripe_error_try_again_later' => 'La carte a été refusée pour une raison inconnue.',
    'stripe_error_withdrawal_count_limit_exceeded' => 'Le client a dépassé le solde ou la limite de crédit disponible de sa carte.',
    'tag' => 'etiquette',
    'tags' => 'étiquettes',

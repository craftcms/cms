...
return [
    ...
    'Filesystem Subpath' => 'Filesystem Subpath',
    ...
    'If you want to use a subfolder of the filesystem, specify the path to use here.' => 'If you want to use a subfolder of the filesystem, specify the path to use here.',
    'If you want to use this filesystem, you have to provide a subpath.' => 'If you want to use this filesystem, you have to provide a subpath.',

...
return [
    ...
    'Failed' => 'Failed',
    'Faster login with WebAuthn (e.g. TouchID, FaceID, Windows Hello, fingerprint). You can set up and manage your security keys from your account page.' => 'Faster login with WebAuthn (e.g. TouchID, FaceID, Windows Hello, fingerprint). You can set up and manage your security keys from your account page.',
    'Feed' => 'Feed',

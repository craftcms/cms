...
{
	exit('Blocks runtime path "'.($runtimePath === false ? BLOCKS_STORAGE_PATH.'runtime/' : $runtimePath).'" isn&rsquo;t valid. Please make sure it is a folder writable by your web server process.');
}

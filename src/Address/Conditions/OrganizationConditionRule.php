...
class OrganizationConditionRule extends BaseTextConditionRule implements ElementConditionRuleInterface, ElementQueryConditionRuleInterface
{
    ...
    {
        AddressQuery::applyOrganization($query, $this->paramValue());
    }

...
//		return $this->_translations[$language];
    ...
    private function _processFrameworkData($localeId)
    {
        ...
        $formattedFrameworkData = array_merge($formattedFrameworkData,
            array_combine($wideMonthKeys,
                $locale->getMonthNames(Locale::FORMAT_FULL)));
        $formattedFrameworkData = array_merge($formattedFrameworkData,
            array_combine($abbreviatedMonthKeys,
                $locale->getMonthNames(Locale::FORMAT_MEDIUM)));
        $formattedFrameworkData = array_merge($formattedFrameworkData,
            array_combine($wideWeekdayNameKeys,
                $locale->getWeekDayNames(Locale::FORMAT_FULL)));
        $formattedFrameworkData = array_merge($formattedFrameworkData,
            array_combine($abbreviatedWeekdayNameKeys,
                $locale->getWeekDayNames(Locale::FORMAT_MEDIUM)));

 ...
 *                                 Note, this is a temporary file which will be
 *                                 automatically deleted by PHP after the current
 *                                 request is processed.
 * @property string $type          The MIME-type of the uploaded file (such as
 *                                 "image/gif"). Since this MIME type is not
 *                                 checked on the server side, do not take this
 *                                 value for granted. Instead, use {@link CFileHelper::getMimeType}
 ...
 *                                 Check {@link error} for the detailed error code information.
 * @property string $extensionName The file extension name for {@link name}. The
 *                                 extension name does not include the dot character.
 *                                 An empty string is returned if {@link name} does
 *                                 not have an extension name.
 *
...
class UploadedFile extends \CUploadedFile
{
	 ...
	 *
	 * @return UploadedFile|null The instance of the uploaded file. null is returned
	 *                           if no file is uploaded for the specified name.
	 */
	 ...
	 * @param bool   $lookForSingleInstance If set to true, will look for a single
	 *                                      instance of the given name.
     *
	 * @return UploadedFile[] The array of UploadedFile objects. Empty array is
	 *                        returned if no adequate upload was found. Please note
	 *                        that this array will contain all files from all subarrays
	 *                        regardless how deeply nested they are.
	 */

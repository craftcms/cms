 ...
 * @property string $tempName      The path of the uploaded file on the server. Note, this is a temporary file which will be
 *                                 automatically deleted by PHP after the current request is processed.
 ...
 * @property bool   $hasError      Whether there is an error with the uploaded file. Check {@link error} for the detailed
 *                                 error code information.
 * @property string $extensionName The file extension name for {@link name}. The extension name does not include the dot
 *                                 character. An empty string is returned if {@link name} does not have an extension name.
 *
...
class UploadedFile extends \CUploadedFile
{
	 ...
	 *
	 * @return UploadedFile|null The instance of the uploaded file. null is returned if no file is uploaded for the specified name.
	 */
     ...
     *
	 * @return UploadedFile[] The array of UploadedFile objects. Empty array is returned if no adequate upload was found.
	 *                        Please note that this array will contain all files from all subarrays regardless how deeply
	 *                        nested they are.
	 */

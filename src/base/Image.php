...
abstract class Image extends BaseObject
{
     ...
     * @return static Self reference
     */
    abstract public function scaleToFit(int $targetWidth = null, ?int $targetHeight = null, bool $scaleIfSmaller = true): self;
     ...
     * @return static Self reference
     */
    abstract public function scaleAndCrop(int $targetWidth = null, ?int $targetHeight = null, bool $scaleIfSmaller = true, $cropPosition = 'center-center'): self;
     ...
     * @return static Self reference
     */
    abstract public function resize(int $targetWidth = null, ?int $targetHeight = null): self;

    ...
    Actionable
{
     ...
     *
     * Each blocker is defined by an array with the following keys:
     *
     * - `key` – a unique key for the blocker
     * - `summary` – a text summary of the blocker
     * - `details` _(optional)_ – a detailed view of the blocker, e.g. an embedded element index listing elements affecting the blocker
     * - `actions` – an array of action buttons that can be taken to resolve the blocker
     *
     ...
     * ```
     *
     * @param self[] $elements The elements to be deleted
     * @param bool $hardDelete Whether the elements will be hard-deleted
     * @return array{key:string,summary:string,details?:string,actions:array[]}[]
     * @since 5.10.0
     */

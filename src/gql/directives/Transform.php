...
class Transform extends Directive
{
    ...
    public static function create(): GqlDirective
    {
        ...
        return GqlEntityRegistry::createEntity(static::name(), new self([
            ...
            'description' => 'Returns a URL for an [asset transform](https://craftcms.com/docs/3.x/image-transforms.html). Accepts the same arguments you would use for a transform in Craft.',
        ]));
    }

...
<?php echo BlocksHtml::beginForm('coreupdate'); ?>
	...
	<tr>
		<td colspan="3">
			...
			<table border="1" cellpadding="0" cellspacing="0">
				...
				<tr>
					<td><?php echo $blocksReleaseInfo['Version'] ?>.<?php echo $blocksReleaseInfo['BuildNumber']; ?></td>
					<td><?php echo BlocksHtml::UnixTimeToPrettyDate($blocksReleaseInfo['ReleaseDate']); ?></td>
					<td><?php echo nl2br($blocksReleaseInfo['ReleaseNotes']); ?></td>

 ...
 * @method static array<array-key, mixed> getUserPreferences(int $userId)
 * @method static void saveUserPreferences(\CraftCms\Cms\User\Contracts\CraftUser $user, array<array-key, mixed> $preferences)

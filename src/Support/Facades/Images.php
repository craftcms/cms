 ...
 * @method static bool supportsFormat(string|\Intervention\Image\Format|\Intervention\Image\FileExtension $format)
 * @method static bool canDecodeFormat(string|\Intervention\Image\Format|\Intervention\Image\FileExtension $format)

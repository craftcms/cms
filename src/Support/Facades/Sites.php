 ...
 * @method static \Illuminate\Support\Collection<array-key, mixed> getAllSiteIds(bool|null $withDisabled = null)
 ...
 * @method static \Illuminate\Support\Collection<array-key, mixed> getEditableSiteIds()
 * @method static \Illuminate\Support\Collection<array-key, mixed> getEditableSiteIdsForSection(\CraftCms\Cms\Section\Data\Section $section)
 * @method static \Illuminate\Support\Collection<array-key, mixed> getAllSites(bool|null $withDisabled = null)
 * @method static \Illuminate\Support\Collection<array-key, mixed> getEditableSites()
 * @method static \Illuminate\Support\Collection<array-key, mixed> getSitesByGroupId(int $groupId, bool|null $withDisabled = null)
 * @method static \Illuminate\Support\Collection<array-key, mixed> getEditableSitesByGroupId(int $groupId, bool|null $withDisabled = null)
 ...
 * @method static \Illuminate\Support\Collection<array-key, mixed> getSitesByLanguage(string $language, bool|null $withDisabled = null)

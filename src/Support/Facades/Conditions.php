...
/**
 * @method static \CraftCms\Cms\Condition\Contracts\ConditionInterface createCondition(array|class-string<\CraftCms\Cms\Condition\Contracts\ConditionInterface> $config)

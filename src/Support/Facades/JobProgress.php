 ...
 * @method static \Illuminate\Support\Collection<array-key, mixed> getJobInfo(int|null $limit = null)
 * @method static \Illuminate\Database\Eloquent\Builder<\CraftCms\Cms\Queue\Models\JobProgress> jobsQuery()
 * @method static \Illuminate\Support\Collection<array-key, mixed> getAll()
 * @method static \CraftCms\Cms\Queue\Models\JobProgress|null getDisplayedJob()
 * @method static \Illuminate\Support\Collection<array-key, mixed> getActive()
 * @method static \Illuminate\Support\Collection<array-key, mixed> getByStatus(\CraftCms\Cms\Queue\Enums\JobStatus $status)
 * @method static \Illuminate\Support\Collection<array-key, mixed> getFailed()

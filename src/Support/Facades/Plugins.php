 ...
 * @method static bool savePluginSettings(\CraftCms\Cms\Plugin\Contracts\PluginInterface $plugin, array<array-key, mixed> $settings)
 ...
 * @method static array<array-key, mixed>|null getStoredPluginInfo(string $handle)
 * @method static void updatePluginVersionInfo(\CraftCms\Cms\Plugin\Contracts\PluginInterface $plugin)
 * @method static array<array-key, mixed>|null getComposerPluginInfo(string|null $handle = null)
 * @method static \CraftCms\Cms\Plugin\Contracts\PluginInterface|null createPlugin(string $handle, array<array-key, mixed>|null $info = null)
 * @method static \Illuminate\Support\Collection<array-key, mixed> getAllPluginInfo()
 * @method static array<array-key, mixed> getPluginInfo(string $handle)
 ...
 * @method static void addViteConfig(string $handle, array<array-key, mixed> $config)

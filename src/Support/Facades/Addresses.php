 ...
 * @method static array<array-key, mixed> defineAddressSubdivisions(array<array-key, mixed> $parents, array<array-key, mixed> $options = [])
 * @method static array<array-key, mixed> getCountryList(string|null $locale = null)
 ...
 * @method static string formatAddress(\CraftCms\Cms\Address\Elements\Address $address, array<array-key, mixed> $options = [], \CommerceGuys\Addressing\Formatter\FormatterInterface|null $formatter = null)

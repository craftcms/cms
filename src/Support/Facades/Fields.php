 ...
 * @method static \Illuminate\Support\Collection<int, class-string<\CraftCms\Cms\Field\Contracts\FieldInterface>> getAllFieldTypes()
 * @method static \Illuminate\Support\Collection getFieldTypesWithContent()
 * @method static \Illuminate\Support\Collection<int, class-string<\CraftCms\Cms\Field\Contracts\FieldInterface>> getCompatibleFieldTypes(\CraftCms\Cms\Field\Contracts\FieldInterface $field, bool $includeCurrent = true)
 * @method static bool areFieldTypesCompatible(class-string<\CraftCms\Cms\Field\Contracts\FieldInterface> $fieldA, class-string<\CraftCms\Cms\Field\Contracts\FieldInterface> $fieldB)
 * @method static \Illuminate\Support\Collection<int, class-string<\CraftCms\Cms\Field\Contracts\ElementContainerFieldInterface>> getNestedEntryFieldTypes()
 * @method static \Illuminate\Support\Collection<int, class-string<\CraftCms\Cms\Field\BaseRelationField>> getRelationalFieldTypes()
 * @method static \CraftCms\Cms\Field\Contracts\FieldInterface createField(class-string<\CraftCms\Cms\Field\Contracts\FieldInterface>|array $config)
 ...
 * @method static \Illuminate\Support\Collection<\CraftCms\Cms\Field\Contracts\FieldInterface> getFieldsByType(class-string<\CraftCms\Cms\Field\Contracts\FieldInterface> $type, string|string[]|false|null $context = null)

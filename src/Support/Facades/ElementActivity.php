...
/**
 * @method static \Illuminate\Support\Collection<int, \CraftCms\Cms\Element\Data\ElementActivity> getRecentActivity(\CraftCms\Cms\Element\Contracts\ElementInterface $element, int|null $excludeUserId = null)

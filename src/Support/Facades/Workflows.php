 ...
 * @method static void handleDeletedWorkflow(\CraftCms\Cms\ProjectConfig\Events\ConfigEvent $event)
 ...
 * @method static bool requiresApproval(\CraftCms\Cms\Element\Contracts\ElementInterface $element)
 ...
 * @method static \CraftCms\Cms\Workflow\Models\WorkflowRun addComment(\CraftCms\Cms\Element\Contracts\ElementInterface $draft, int $runId, string|int $stage, string $note)

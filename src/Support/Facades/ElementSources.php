 ...
 * @method static \Illuminate\Support\Collection<array> getTableAttributes(class-string<\craft\base\ElementInterface> $elementType, string $sourceKey, string[]|null $customAttributes = null, \CraftCms\Cms\FieldLayout\FieldLayout[]|null $fieldLayouts = null)

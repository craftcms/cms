 ...
 * @method static \Illuminate\Support\Collection<array> getSources(class-string<\CraftCms\Cms\Element\Contracts\ElementInterface> $elementType, string $context = 'index', bool $withDisabled = false, string|null $page = null)
 ...
 * @method static \Illuminate\Support\Collection<string> getPages(class-string<\CraftCms\Cms\Element\Contracts\ElementInterface> $elementType)
 ...
 * @method static \Illuminate\Support\Collection<array> getAvailableTableAttributes(class-string<\CraftCms\Cms\Element\Contracts\ElementInterface> $elementType)
 * @method static \Illuminate\Support\Collection<array> getTableAttributes(class-string<\CraftCms\Cms\Element\Contracts\ElementInterface> $elementType, string $sourceKey, string[]|null $customAttributes = null, \CraftCms\Cms\FieldLayout\FieldLayout[]|null $fieldLayouts = null)
 ...
 * @method static \Illuminate\Support\Collection<array> getSourceSortOptions(class-string<\CraftCms\Cms\Element\Contracts\ElementInterface> $elementType, string $sourceKey)
 ...
 * @method static \Illuminate\Support\Collection<array> getSourceTableAttributes(class-string<\CraftCms\Cms\Element\Contracts\ElementInterface> $elementType, string $sourceKey)

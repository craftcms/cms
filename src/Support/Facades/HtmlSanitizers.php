 ...
 * @method static \CraftCms\Cms\Support\HtmlSanitizer\HtmlSanitizerManager extend(string $driver, \Closure|\Symfony\Component\HtmlSanitizer\HtmlSanitizerInterface|array<array-key, mixed> $definition)
 * @method static \CraftCms\Cms\Support\HtmlSanitizer\HtmlSanitizerManager defaults(\Closure $callback)
 * @method static bool has(string $name)
 * @method static array<array-key, mixed> names()
 * @method static \Illuminate\Support\Collection<array-key, mixed> all()

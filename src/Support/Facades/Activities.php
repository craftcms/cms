...
/**
 * @method static \CraftCms\Cms\Activity\Models\ActivityEvent record(\CraftCms\Cms\Activity\Contracts\ActivityEventTypeInterface $event, int|null $rootEventId = null)

 ...
 * @method static \Illuminate\Support\Collection<array-key, mixed> findFolders(mixed $criteria = [])
 * @method static \CraftCms\Cms\Asset\Data\VolumeFolder|null findFolder(mixed $criteria = [])
 * @method static array<array-key, mixed> getAllDescendantFolders(\CraftCms\Cms\Asset\Data\VolumeFolder $parentFolder, string $orderBy = 'path', bool $withParent = true, bool $asTree = false)
 ...
 * @method static void deleteFoldersByIds(array<array-key, mixed>|int $folderIds, bool $deleteDir = true)

...
/**
 * @method static int createRevision(\CraftCms\Cms\Element\Contracts\ElementInterface $canonical, int|null $creatorId = null, string|null $notes = null, array<array-key, mixed> $newAttributes = [], bool $force = false)

 ...
 * @method static array getOrSetContentArguments(string<\craft\base\ElementInterface> $elementType, callable $setter)
 * @method static array getFieldLayoutArguments(\CraftCms\Cms\FieldLayout\FieldLayout $fieldLayout)
 * @method static array defineContentArgumentsForFieldLayouts(string<\craft\base\ElementInterface> $elementType, \CraftCms\Cms\FieldLayout\FieldLayout[] $fieldLayouts)
 * @method static array defineContentArgumentsForFields(string<\craft\base\ElementInterface> $elementType, \CraftCms\Cms\Field\Contracts\FieldInterface[] $fields)
 * @method static array defineContentArgumentsForGeneratedFields(string<\craft\base\ElementInterface> $elementType, array $fields)
 * @method static array getContentArguments(array $contexts, string<\craft\base\ElementInterface> $elementType)

 ...
 * @method static \CraftCms\Cms\Element\Contracts\ElementInterface createElement(string|array<array-key, mixed> $config)
 * @method static \CraftCms\Cms\Element\Queries\Contracts\ElementQueryInterface createElementQuery(string $elementType)
 * @method static \CraftCms\Cms\Element\Contracts\ElementInterface|null getElementById(int $elementId, string|null $elementType = null, int|string|int[]|null $siteId = null, array<array-key, mixed> $criteria = [])
 * @method static \CraftCms\Cms\Element\Contracts\ElementInterface|null getElementByUid(string $uid, string|null $elementType = null, int|string|int[]|null $siteId = null, array<array-key, mixed> $criteria = [])
 ...
 * @method static \CraftCms\Cms\Element\Contracts\ElementInterface updateCanonicalElement(\CraftCms\Cms\Element\Contracts\ElementInterface $element, array<array-key, mixed> $newAttributes = [])
 ...
 * @method static \CraftCms\Cms\Element\Contracts\ElementInterface duplicateElement(\CraftCms\Cms\Element\Contracts\ElementInterface $element, array<array-key, mixed> $newAttributes = [], bool $placeInStructure = true, bool $asUnpublishedDraft = false, bool $checkAuthorization = false, bool $copyModifiedFields = false)
 ...
 * @method static \CraftCms\Cms\Element\Data\EagerLoadPlan[] createEagerLoadingPlans(array<array-key, mixed>|string $with)
 * @method static void eagerLoadElements(string $elementType, \CraftCms\Cms\Element\Contracts\ElementInterface[] $elements, array<array-key, mixed>|string $with)
 *

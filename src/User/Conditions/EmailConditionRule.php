...
class EmailConditionRule extends BaseTextConditionRule implements ElementConditionRuleInterface, ElementQueryConditionRuleInterface
{
    ...
    {
        UserQuery::applyEmail($query, $this->paramValue());
    }

...
class Install extends Migration
{
    ...
    protected function createTables()
    {
        $this->createTable('{{%assetindexdata}}', [
            ...
            'volumeId' => $this->integer(10)->notNull(),
            'offset' => $this->integer(10)->notNull(),
            'uri' => $this->string(),
            'size' => $this->bigInteger()->unsigned(),
            'timestamp' => $this->dateTime(),
            'recordId' => $this->integer(10),
        ...
        $this->createTable('{{%assettransforms}}', [
            ...
            'height' => $this->integer(10),
            'width' => $this->integer(10),
            'format' => $this->string(),
        ...
        $this->createTable('{{%entrytypes}}', [
            ...
            'sortOrder' => $this->smallInteger(4)->unsigned(),
            'dateCreated' => $this->dateTime()->notNull(),
            'dateUpdated' => $this->dateTime()->notNull(),
            'uid' => $this->char(36)->notNull()->defaultValue('0'),
        ], null, false, false);
        ...
        $this->createTable('{{%structureelements}}', [
            ...
            'root' => $this->integer(10)->unsigned(),
            'lft' => $this->integer(10)->notNull()->unsigned(),
            'rgt' => $this->integer(10)->notNull()->unsigned(),
        ...
        $this->createTable('{{%tokens}}', [
            ...
            'route' => $this->text(),
            'usageLimit' => $this->smallInteger(3)->unsigned(),
            'usageCount' => $this->smallInteger(3)->unsigned(),
            'expiryDate' => $this->dateTime()->notNull(),
            'dateCreated' => $this->dateTime()->notNull(),
            'dateUpdated' => $this->dateTime()->notNull(),
            'uid' => $this->char(36)->notNull()->defaultValue('0'),
        ...
        $this->createTable('{{%users}}', [
            ...
            'invalidLoginCount' => $this->smallInteger(4)->unsigned(),

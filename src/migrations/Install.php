...
class Install extends Migration
{
    ...
    protected function createIndexes()
    {
        ...
        $this->createIndex($this->db->getIndexName('{{%assetindexdata}}', 'volumeId', false, true), '{{%assetindexdata}}', 'volumeId', false, true);
        $this->createIndex($this->db->getIndexName('{{%assets}}', 'filename,folderId', true), '{{%assets}}', 'filename,folderId', true);
        $this->createIndex($this->db->getIndexName('{{%assets}}', 'folderId', false, true), '{{%assets}}', 'folderId', false, true);
        $this->createIndex($this->db->getIndexName('{{%assets}}', 'volumeId', false, true), '{{%assets}}', 'volumeId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%categories}}', 'groupId', false, true), '{{%categories}}', 'groupId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%categorygroups}}', 'structureId', false, true), '{{%categorygroups}}', 'structureId', false, true);
        $this->createIndex($this->db->getIndexName('{{%categorygroups}}', 'fieldLayoutId', false, true), '{{%categorygroups}}', 'fieldLayoutId', false, true);
        $this->createIndex($this->db->getIndexName('{{%categorygroups_i18n}}', 'groupId,siteId', true), '{{%categorygroups_i18n}}', 'groupId,siteId', true);
        $this->createIndex($this->db->getIndexName('{{%categorygroups_i18n}}', 'siteId', false, true), '{{%categorygroups_i18n}}', 'siteId', false, true);
        $this->createIndex($this->db->getIndexName('{{%content}}', 'elementId,siteId', true), '{{%content}}', 'elementId,siteId', true);
        $this->createIndex($this->db->getIndexName('{{%content}}', 'siteId', false, true), '{{%content}}', 'siteId', false, true);
        $this->createIndex($this->db->getIndexName('{{%content}}', 'title', false, true), '{{%content}}', 'title', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%elements_i18n}}', 'siteId', false, true), '{{%elements_i18n}}', 'siteId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%entries}}', 'authorId', false, true), '{{%entries}}', 'authorId', false, true);
        $this->createIndex($this->db->getIndexName('{{%entries}}', 'sectionId', false, true), '{{%entries}}', 'sectionId', false, true);
        $this->createIndex($this->db->getIndexName('{{%entries}}', 'typeId', false, true), '{{%entries}}', 'typeId', false, true);
        $this->createIndex($this->db->getIndexName('{{%entrydrafts}}', 'sectionId', false, true), '{{%entrydrafts}}', 'sectionId', false, true);
        $this->createIndex($this->db->getIndexName('{{%entrydrafts}}', 'entryId,siteId', false), '{{%entrydrafts}}', 'entryId,siteId', false);
        $this->createIndex($this->db->getIndexName('{{%entrydrafts}}', 'siteId', false, true), '{{%entrydrafts}}', 'siteId', false, true);
        $this->createIndex($this->db->getIndexName('{{%entrydrafts}}', 'creatorId', false, true), '{{%entrydrafts}}', 'creatorId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%entrytypes}}', 'sectionId', false, true), '{{%entrytypes}}', 'sectionId', false, true);
        $this->createIndex($this->db->getIndexName('{{%entrytypes}}', 'fieldLayoutId', false, true), '{{%entrytypes}}', 'fieldLayoutId', false, true);
        $this->createIndex($this->db->getIndexName('{{%entryversions}}', 'sectionId', false, true), '{{%entryversions}}', 'sectionId', false, true);
        $this->createIndex($this->db->getIndexName('{{%entryversions}}', 'entryId,siteId', false), '{{%entryversions}}', 'entryId,siteId', false);
        $this->createIndex($this->db->getIndexName('{{%entryversions}}', 'siteId', false, true), '{{%entryversions}}', 'siteId', false, true);
        $this->createIndex($this->db->getIndexName('{{%entryversions}}', 'creatorId', false, true), '{{%entryversions}}', 'creatorId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%fieldlayoutfields}}', 'tabId', false, true), '{{%fieldlayoutfields}}', 'tabId', false, true);
        $this->createIndex($this->db->getIndexName('{{%fieldlayoutfields}}', 'fieldId', false, true), '{{%fieldlayoutfields}}', 'fieldId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%fieldlayouttabs}}', 'layoutId', false, true), '{{%fieldlayouttabs}}', 'layoutId', false, true);
        $this->createIndex($this->db->getIndexName('{{%fields}}', 'handle,context', true), '{{%fields}}', 'handle,context', true);
        $this->createIndex($this->db->getIndexName('{{%fields}}', 'groupId', false, true), '{{%fields}}', 'groupId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%globalsets}}', 'fieldLayoutId', false, true), '{{%globalsets}}', 'fieldLayoutId', false, true);
        $this->createIndex($this->db->getIndexName('{{%matrixblocks}}', 'ownerId', false, true), '{{%matrixblocks}}', 'ownerId', false, true);
        $this->createIndex($this->db->getIndexName('{{%matrixblocks}}', 'fieldId', false, true), '{{%matrixblocks}}', 'fieldId', false, true);
        $this->createIndex($this->db->getIndexName('{{%matrixblocks}}', 'typeId', false, true), '{{%matrixblocks}}', 'typeId', false, true);
        $this->createIndex($this->db->getIndexName('{{%matrixblocks}}', 'sortOrder', false), '{{%matrixblocks}}', 'sortOrder', false);
        $this->createIndex($this->db->getIndexName('{{%matrixblocks}}', 'ownerSiteId', false, true), '{{%matrixblocks}}', 'ownerSiteId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%matrixblocktypes}}', 'fieldId', false, true), '{{%matrixblocktypes}}', 'fieldId', false, true);
        $this->createIndex($this->db->getIndexName('{{%matrixblocktypes}}', 'fieldLayoutId', false, true), '{{%matrixblocktypes}}', 'fieldLayoutId', false, true);
        $this->createIndex($this->db->getIndexName('{{%migrations}}', 'pluginId', false, true), '{{%migrations}}', 'pluginId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%relations}}', 'sourceId', false, true), '{{%relations}}', 'sourceId', false, true);
        $this->createIndex($this->db->getIndexName('{{%relations}}', 'targetId', false, true), '{{%relations}}', 'targetId', false, true);
        $this->createIndex($this->db->getIndexName('{{%relations}}', 'sourceSiteId', false, true), '{{%relations}}', 'sourceSiteId', false, true);
        $this->createIndex($this->db->getIndexName('{{%routes}}', 'uriPattern', true), '{{%routes}}', 'uriPattern', true);
        $this->createIndex($this->db->getIndexName('{{%routes}}', 'siteId', false, true), '{{%routes}}', 'siteId', false, true) ;
        ...
        $this->createIndex($this->db->getIndexName('{{%sections}}', 'structureId', false, true), '{{%sections}}', 'structureId', false, true);
        $this->createIndex($this->db->getIndexName('{{%sections_i18n}}', 'sectionId,siteId', true), '{{%sections_i18n}}', 'sectionId,siteId', true);
        $this->createIndex($this->db->getIndexName('{{%sections_i18n}}', 'siteId', false, true), '{{%sections_i18n}}', 'siteId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%sessions}}', 'userId', false, true), '{{%sessions}}', 'userId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%structureelements}}', 'elementId', false, true), '{{%structureelements}}', 'elementId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%tags}}', 'groupId', false, true), '{{%tags}}', 'groupId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%templatecacheelements}}', 'cacheId', false, true), '{{%templatecacheelements}}', 'cacheId', false, true);
        $this->createIndex($this->db->getIndexName('{{%templatecacheelements}}', 'elementId', false, true), '{{%templatecacheelements}}', 'elementId', false, true);
        $this->createIndex($this->db->getIndexName('{{%templatecachequeries}}', 'cacheId', false, true), '{{%templatecachequeries}}', 'cacheId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%templatecaches}}', 'siteId', false, true), '{{%templatecaches}}', 'siteId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%usergroups_users}}', 'userId', false, true), '{{%usergroups_users}}', 'userId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%userpermissions_usergroups}}', 'groupId', false, true), '{{%userpermissions_usergroups}}', 'groupId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%userpermissions_users}}', 'userId', false, true), '{{%userpermissions_users}}', 'userId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%volumefolders}}', 'parentId', false, true), '{{%volumefolders}}', 'parentId', false, true);
        $this->createIndex($this->db->getIndexName('{{%volumefolders}}', 'volumeId', false, true), '{{%volumefolders}}', 'volumeId', false, true);
        ...
        $this->createIndex($this->db->getIndexName('{{%volumes}}', 'fieldLayoutId', false, true), '{{%volumes}}', 'fieldLayoutId', false, true);
        $this->createIndex($this->db->getIndexName('{{%widgets}}', 'userId', false, true), '{{%widgets}}', 'userId', false, true);

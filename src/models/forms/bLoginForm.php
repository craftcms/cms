...
/**
 * bLoginForm class.
 * bLoginForm is the data structure for keeping user login form data.
 * It is used by the 'login' action of 'bSessionController'.
 */
class bLoginForm extends CFormModel
{
	public $loginName;
	public $password;

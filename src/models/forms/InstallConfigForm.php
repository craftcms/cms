...
class InstallConfigForm extends \CFormModel
{
	...
	public function rules()
	{
		return array(
			...
			//array('adminEmail', 'unique', 'allowEmpty' => false, 'className' => 'User', 'attributeName' => 'email', 'caseSensitive' => false),
			//array('adminUserName', 'unique', 'allowEmpty' => false, 'className' => 'User', 'attributeName' => 'username', 'caseSensitive' => false),
		);
	}

...
/**
 * @event ClearCachesTagOptionsResolving The event that is triggered when registering cache tag invalidation options.
 *
 * Each option added to {@see ClearCachesTagOptionsResolving::$options} should be an array that has the following keys:
 *
 ...
 */
class ClearCachesTagOptionsResolving
{

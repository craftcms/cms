...
class Uploads
{
    ...
    {
        return $this->withSession($request, $id, function (UploadSession $session, Uploader $uploader) use ($part) {
    ...
    {
        $this->withSession($request, $id, function (UploadSession $session, Uploader $uploader) use ($request, $part) {

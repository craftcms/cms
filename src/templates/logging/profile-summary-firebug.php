...
if (typeof(console) == 'object' && typeof console.groupCollapsed == 'function')
{
	...
	console.log("Time:   <?php echo sprintf('%0.5f', craft\app\Craft::getLogger()->getExecutionTime()); ?>s\n");
	console.log("Memory: <?php echo number_format(craft\app\Craft::getLogger()->getMemoryUsage() / 1024); ?>Kb\n");

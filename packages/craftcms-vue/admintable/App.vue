...
<style lang="scss">
  ...
  .vue-admin-tablepane + .vue-admin-table-footer {
    margin-left: calc(var(--pane-padding, var(--padding) - 2px) * -1);
    margin-right: calc(var(--pane-padding, var(--padding) - 2px) * -1);
    padding-left: calc(var(--pane-padding, var(--padding) - 2px));
    padding-right: calc(var(--pane-padding, var(--padding) - 2px));
  }

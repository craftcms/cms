...
- `filled` — Solid colored background. The highest-emphasis style. Use for the single most important action in a given context.
- `outline` — Transparent background with a colored border. Medium emphasis. Use for secondary actions alongside a filled button.

/**
 * @link https://github.com/SalmenBejaoui/selectize-plugin-a11y/blob/master/selectize-plugin-a11y.js
 * @copyright Copyright (c) Salmen Bejaoui.
 * @license https://github.com/SalmenBejaoui/selectize-plugin-a11y/blob/master/LICENSE
 */
/* global Selectize */
          ...
          if ($target.hasClass('items')) {
            ...
            if ($target.hasClass('active')) {
              if (!!$target.attr('data-value')) {
                // oxlint-disable-line no-extra-boolean-cast

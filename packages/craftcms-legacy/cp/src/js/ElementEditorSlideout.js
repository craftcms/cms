...
Object.defineProperty(Craft, 'ElementEditorSlideout', {
  configurable: true,
  get() {
    const ElementEditorSlideout = Craft.CpScreenSlideout.extend(
      {
        $element: null,
        elementEditor: null,
        ...
        handleSubmit: async function (ev) {
          if (
            ev.type !== 'submit' &&
            this.elementEditor.settings.canCreateDrafts
          ) {
        ...
        handleSubmitError: function (e) {
          ...
          if (e?.response?.data?.invalidNestedElementIds) {
            ...
            $cards
              .find(
                'craft-element-label > span[data-icon="triangle-exclamation"]'
              )
              .remove();
    ...
    Object.defineProperty(Craft, 'ElementEditorSlideout', {
      configurable: true,
      writable: true,
      value: ElementEditorSlideout,
    });

    return ElementEditorSlideout;
  },
});

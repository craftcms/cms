!(function (e) {
  ...
  e.defineMode('javascript', function (t, r) {
    ...
    function k(e, t) {
        ...
        return (
          (t.tokenize =
            ...
            function (e, t) {
              var n,
                a = !1;
              if (c && '@' == e.peek() && e.match(m))
                return (t.tokenize = k), v('jsonld-keyword', 'meta');
              for (; null != (n = e.next()) && (n != r || a); )
                a = !a && '\\' == n;
              return a || (t.tokenize = k), v('string', 'string');
            })),
          t.tokenize(e, t)
        );
      ...
      if ('#' == n && e.eatWhile(l)) return v('variable', 'property');
      if (
        ('<' == n && e.match('!--')) ||
      ...
      if (l.test(n)) {
        ...
        if ('.' != t.lastType) {
          if (d.propertyIsEnumerable(a)) {
            var i = d[a];
            return v(i.type, i.style, a);
          }
          if (
            'async' == a &&
            e.match(/^(\s|\/\*([^*]|\*(?!\/))*?\*\/)*[\[\(\w]/, !1)
          )
            return v('async', 'keyword', a);
        }
        return v('variable', 'variable', a);
      }
    }
    function y(e, t) {
      ...
      if (((M.marked = 'def'), u)) {
        if (t.context)
          if ('var' == t.lexical.info && t.context && t.context.block) {
            ...
            return void (t.localVars = new q(e, t.localVars));
        r.globalVars &&
          !E(e, t.globalVars) &&
          (t.globalVars = new q(e, t.globalVars));
      }
    }
    function I(e, t) {
      if (t) {
        if (t.block) {
          var r = I(e, t.prev);
          return r ? (r == t.prev ? t : new $(r, t.vars, !0)) : null;
        }
        return E(e, t.vars) ? t : new $(t.prev, new q(e, t.vars), !1);
      }
      return null;
    }
    function T(e) {
    ...
    var C = new q('this', new q('arguments', null));
    function S() {
      (M.state.context = new $(M.state.context, M.state.localVars, !1)),
        (M.state.localVars = C);
    }
    function _() {
      (M.state.context = new $(M.state.context, M.state.localVars, !0)),
      ...
      var r = function () {
        ...
        if ('stat' == r.lexical.type) n = r.lexical.indented;
          ...
          for (var a = r.lexical; a && ')' == a.type && a.align; a = a.prev)
            n = a.indented;
        r.lexical = new h(n, M.stream.column(), e, null, r.lexical, t);
      };
      return (r.lex = !0), r;
    }
    function N() {
                  ...
                  : ';' == e
                    ...
                    : 'if' == e
                      ? ('else' == M.state.lexical.info &&
                          M.state.cc[M.state.cc.length - 1] == N &&
                          M.state.cc.pop()(),
                        V(P('form'), D, W, N, Te))
                      : 'function' == e
                        ? V(Se)
                        : 'for' == e
                          ? V(P('form'), _, $e, W, O, N)
                          : 'class' == e || (f && 'interface' == t)
                            ? ((M.marked = 'keyword'),
                              V(P('form', 'class' == e ? e : t), Ue, N))
                            : 'variable' == e
                              ? f && 'declare' == t
                                ? ((M.marked = 'keyword'), V(W))
                                : f &&
                                    ('module' == t ||
                                      'enum' == t ||
                                      'type' == t) &&
    ...
    function D(e) {
      return '(' != e ? A() : V(P(')'), J, U(')'), N);
    }
    function G(e, t, r) {
      if (M.state.fatArrowAt == M.stream.start) {
        var n = r ? Y : X;
        if ('(' == e) return V(S, P(')'), oe(Pe, ')'), N, U('=>'), n, O);
        if ('variable' == e) return A(S, Ae, U('=>'), n, O);
      }
      var a = r ? L : K;
      return x.hasOwnProperty(e)
        ...
        : 'function' == e
          ? V(Se, a)
          : 'class' == e || (f && 'interface' == t)
            ? ((M.marked = 'keyword'), V(P('form'), Ne, N))
            : 'keyword c' == e || 'async' == e
              ? V(r ? H : F)
              : '(' == e
                ? V(P(')'), J, U(')'), N, a)
    ...
    function J(e) {
      return e.match(/[;\}\)\],]/) ? A() : A(F);
    }
    function K(e, t) {
      return ',' == e ? V(J) : L(e, t, !1);
    }
    function L(e, t, r) {
      var n = 0 == r ? K : L,
        a = 0 == r ? F : H;
    ...
    function R(e) {
      if ('}' == e)
        return (M.marked = 'string-2'), (M.state.tokenize = w), V(Q);
    }
    function X(e) {
      return b(M.stream, M.state), A('{' == e ? W : F);
    }
    function Y(e) {
      return b(M.stream, M.state), A('{' == e ? W : H);
    }
    function Z(e, t) {
      if ('target' == t) return (M.marked = 'keyword'), V(K);
    }
    function ee(e, t) {
      if ('target' == t) return (M.marked = 'keyword'), V(L);
    }
    function te(e) {
      return ':' == e ? V(N, W) : A(K, U(';'), N);
    }
    function re(e) {
      if ('variable' == e) return (M.marked = 'property'), V();
    }
    function ne(e, t) {
      return 'async' == e
        ? ((M.marked = 'property'), V(ne))
          ...
          ? ((M.marked = 'property'),
            'get' == t || 'set' == t
              ...
              : (f &&
                ...
                V(ie)))
          : 'number' == e || 'string' == e
            ? ((M.marked = c ? 'property' : M.style + ' property'), V(ie))
            : 'jsonld-keyword' == e
              ? V(ie)
              : f && T(t)
                ? ((M.marked = 'keyword'), V(ne))
                : '[' == e
                  ? V(F, ue, U(']'), ie)
                  : 'spread' == e
                    ? V(H, ie)
    ...
    function ae(e) {
      return 'variable' != e ? A(ie) : ((M.marked = 'property'), V(Se));
    }
    function ie(e) {
      return ':' == e ? V(H) : '(' == e ? A(Se) : void 0;
    }
    function oe(e, t, r) {
      function n(a, i) {
    ...
    function fe(e, t) {
      if (f && (':' == e || 'in' == t)) return V(pe);
    }
    function le(e) {
      if (f && ':' == e)
        return M.stream.match(/^\s*\w+\s+is\b/, !1) ? V(F, de, pe) : V(pe);
    }
    function de(e, t) {
      if ('is' == t) return (M.marked = 'keyword'), V();
    }
    function pe(e, t) {
      return 'keyof' == t || 'typeof' == t || 'infer' == t || 'readonly' == t
        ? ((M.marked = 'keyword'), V('typeof' == t ? H : pe))
        : 'variable' == e || 'void' == t
          ? ((M.marked = 'type'), V(xe))
          : '|' == t || '&' == t
            ? V(pe)
    ...
    function ke(e, t) {
      return 'variable' == e || 'keyword' == M.style
        ? ((M.marked = 'property'), V(ke))
        : '?' == t || 'number' == e || 'string' == e
          ? V(ke)
          : ':' == e
            ? V(pe)
            : '[' == e
              ? V(U('variable'), fe, U(']'), ke)
              : '(' == e
                ? A(_e, ke)
                : e.match(/[;\}\)\],]/)
                  ? void 0
    ...
    function we(e) {
      if ('}' == e)
        return (M.marked = 'string-2'), (M.state.tokenize = w), V(ye);
    }
    function be(e, t) {
        ...
        : '|' == t || '.' == e || '&' == t
          ...
          : '[' == e
            ...
            : 'extends' == t || 'implements' == t
              ? ((M.marked = 'keyword'), V(pe))
              : '?' == t
                ? V(pe, U(':'), pe)
                : void 0;
    }
    function he(e, t) {
      if ('<' == t) return V(P('>'), oe(pe, '>'), N, xe);
    }
    function ge() {
      return A(pe, je);
    }
    ...
    function Me(e, t) {
      return 'enum' == t ? ((M.marked = 'keyword'), V(Xe)) : A(Ae, ue, ze, Ie);
    }
    function Ae(e, t) {
      return f && T(t)
        ? ((M.marked = 'keyword'), V(Ae))
        : 'variable' == e
          ? (z(t), V())
          : 'spread' == e
            ? V(Ae)
    ...
    function Te(e, t) {
      if ('keyword b' == e && 'else' == t) return V(P('form', 'else'), W, N);
    }
    function $e(e, t) {
      return 'await' == t ? V($e) : '(' == e ? V(P(')'), qe, N) : void 0;
    }
    function qe(e) {
      return 'var' == e ? V(Me, Ce) : 'variable' == e ? V(Ce) : A(Ce);
    }
    function Ce(e, t) {
      return ')' == e
        ? V()
        : ';' == e
          ? V(Ce)
          : 'in' == t || 'of' == t
            ? ((M.marked = 'keyword'), V(F, Ce))
            : A(F, Ce);
    }
    function Se(e, t) {
      return '*' == t
        ? ((M.marked = 'keyword'), V(Se))
        : 'variable' == e
          ? (z(t), V(Se))
          : '(' == e
            ? V(S, P(')'), oe(Pe, ')'), N, le, W, O)
            : f && '<' == t
              ? V(P('>'), oe(ge, '>'), N, Se)
              : void 0;
    }
    ...
    function Ne(e, t) {
      return 'variable' == e ? Ue(e, t) : We(e, t);
    }
    function Ue(e, t) {
      if ('variable' == e) return z(t), V(We);
    }
    function We(e, t) {
      return '<' == t
        ? V(P('>'), oe(ge, '>'), N, We)
        : 'extends' == t || 'implements' == t || (f && ',' == e)
          ? ('implements' == t && (M.marked = 'keyword'), V(f ? pe : F, We))
          : '{' == e
            ? V(P('}'), Be, N)
            : void 0;
    }
    function Be(e, t) {
      return 'async' == e ||
        ('variable' == e &&
          ('static' == t || 'get' == t || 'set' == t || (f && T(t))) &&
          M.stream.match(/^\s+#?[\w$\xa1-\uffff]/, !1))
        ? ((M.marked = 'keyword'), V(Be))
        : 'variable' == e || 'keyword' == M.style
          ? ((M.marked = 'property'), V(Fe, Be))
          : 'number' == e || 'string' == e
            ? V(Fe, Be)
            : '[' == e
              ? V(F, ue, U(']'), Fe, Be)
    ...
    function Fe(e, t) {
      ...
      return A(r && 'interface' == r.info ? _e : Se);
    }
    function He(e, t) {
      return '*' == t
        ? ((M.marked = 'keyword'), V(Qe, U(';')))
        : 'default' == t
          ? ((M.marked = 'keyword'), V(F, U(';')))
          : '{' == e
            ? V(oe(De, '}'), Qe, U(';'))
            : A(W);
    }
    ...
    function Je(e, t) {
      return '{' == e
        ? ce(Je, '}')
        : ('variable' == e && z(t), '*' == t && (M.marked = 'keyword'), V(Le));
    }
    function Ke(e) {
      if (',' == e) return V(Je, Ke);
    }
    function Le(e, t) {
      if ('as' == t) return (M.marked = 'keyword'), V(Je);
    }
    function Qe(e, t) {
      if ('from' == t) return (M.marked = 'keyword'), V(F);
    }
    function Re(e) {
      return ']' == e ? V() : A(oe(H, ']'));
    }
    function Xe() {
      return A(P('form'), Ae, U('{'), P('}'), oe(Ye, '}'), N, N);
    }
    function Ye() {
      return A(Ae, ze);
    }
      ...
      (N.lex = !0),
      {
        startState: function (e) {
          var t = {
            ...
            lastType: 'sof',
            cc: [],
            lexical: new h((e || 0) - i, 0, 'block', !1),
            localVars: r.localVars,
            context: r.localVars && new $(null, null, !1),
            indented: e || 0,
          };
          return (
            r.globalVars &&
        ...
        token: function (e, t) {
          ...
          return 'comment' == n
            ? r
            : ((t.lastType =
                'operator' != n || ('++' != a && '--' != a) ? n : 'incdec'),
              j(t, r, n, a, e));
        },
        indent: function (t, n) {
          if (t.tokenize == y || t.tokenize == w) return e.Pass;
          if (t.tokenize != k) return 0;
          var a,
            c = n && n.charAt(0),
            s = t.lexical;
          if (!/^\s*else\b/.test(n))
          ...
          for (
            ...
            s = s.prev;
          o && ')' == s.type && 'stat' == s.prev.type && (s = s.prev);
          var l = s.type,
            d = c == l;
          return 'vardef' == l
            ? s.indented +
                ...
                : 'stat' == l
                  ...
                  : 'switch' != s.info || d || 0 == r.doubleIndentSwitch
                    ? s.align
                      ? s.column + (d ? 0 : 1)
                      : s.indented + (d ? 0 : i)
                    : s.indented + (/^(?:case|default)\b/.test(n) ? i : 2 * i);
        },
        ...
        skipExpression: function (t) {
          j(t, 'atom', 'atom', 'true', new e.StringStream('', 2, null));
        },
      }
    );
  }),

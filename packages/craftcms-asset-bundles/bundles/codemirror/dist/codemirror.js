!(function (e, t) {
  ...
  function ie(e) {
    return (
      /\w/.test(e) ||
      (e > '' && (e.toUpperCase() != e.toLowerCase() || ne.test(e)))
    );
  }
  function oe(e, t) {
  ...
  function ae(e) {
    return e.charCodeAt(0) >= 768 && se.test(e);
  }
  function ue(e, t, r) {
    for (; (r < 0 ? t > 0 : t < e.length) && ae(e.charAt(t)); ) t += r;
    return t;
  }
  function ce(e, t, r) {
    for (var n = t > r ? -1 : 1; ; ) {
  ...
  function fe(e, t, r) {
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      o.to == t && (o.from != o.to && 'before' == r ? (n = i) : (he = i)),
  ...
  var de = (function () {
    ...
    return function (l, s) {
      ...
      for (var v = 0, m = a; v < c; ++v) {
        ...
        '1' == y && 'r' == m
          ? (h[v] = 'n')
          : r.test(y) && ((m = y), 'r' == y && (h[v] = 'R'));
      }
      for (var b = 1, w = h[0]; b < c - 1; ++b) {
        var x = h[b];
        '+' == x && '1' == w && '1' == h[b + 1]
          ? (h[b] = '1')
          : ',' != x || w != h[b + 1] || ('1' != w && 'n' != w) || (h[b] = w),
          (w = x);
      }
      for (var C = 0; C < c; ++C) {
        var S = h[C];
      ...
      for (var P, E = [], R = 0; R < c; )
        if (n.test(h[R])) {
          ...
          for (var U = I; U < R; )
            if (i.test(h[U])) {
              I < U && (E.splice(B, 0, new o(1, I, U)), (B += G));
              var V = U;
              for (++U; U < R && i.test(h[U]); ++U);
              E.splice(B, 0, new o(2, V, U)), (B += G), (I = U);
            } else ++U;
          I < R && E.splice(B, 0, new o(1, I, R));
        }
      return (
        'ltr' == s &&
          (1 == E[0].level &&
          ...
          1 == J(E).level &&
            (P = l.match(/\s+$/)) &&
            ((J(E).to -= P[0].length), E.push(new o(0, c - P[0].length, c)))),
        'rtl' == s ? E.reverse() : E
      );
    };
  })();
    ...
    if (null == Ae) {
      ...
      O(e, A('span', [t, document.createTextNode('x')])),
        0 != e.firstChild.offsetHeight &&
          (Ae = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(l && s < 8));
    }
    var r = Ae
      ? A('span', '​')
      : A(
  ...
  function Fe(e) {
    ...
    return N(e), !(!r || r.left == r.right) && (De = n.right - r.right < 3);
  }
  var Pe,
    Ee =
      3 != '\n\nb'.split(/\n/).length
    ...
    ze =
      'oncopy' in (Pe = A('div')) ||
      (Pe.setAttribute('oncopy', 'return;'), 'function' == typeof Pe.oncopy),
    Ie = null,
    Be = {},
    Ge = {};
  function Ue(e, t) {
  ...
  function Ve(e) {
    if ('string' == typeof e && Ge.hasOwnProperty(e)) e = Ge[e];
    else if (e && 'string' == typeof e.name && Ge.hasOwnProperty(e.name)) {
      var t = Ge[e.name];
      'string' == typeof t && (t = {name: t}), ((e = re(t, e)).name = t.name);
    } else {
  ...
  var je = {};
  function Xe(e, t) {
    U(t, je.hasOwnProperty(e) ? je[e] : (je[e] = {}));
  }
  function Ye(e, t) {
    if (!0 === t) return t;
  ...
  function ot(e, t, r) {
    if ((void 0 === r && (r = null), !(this instanceof ot)))
      return new ot(e, t, r);
    ...
    (qe.prototype.column = function () {
      return (
        this.lastColumnPos < this.start &&
          ...
          (this.lastColumnPos = this.start)),
        this.lastColumnValue -
          (this.lineStart ? V(this.string, this.lineStart, this.tabSize) : 0)
      );
    }),
    (qe.prototype.indentation = function () {
      return (
        V(this.string, null, this.tabSize) -
        (this.lineStart ? V(this.string, this.lineStart, this.tabSize) : 0)
      );
    }),
  ...
  (gt.prototype.lookAhead = function (e) {
    ...
    (gt.fromSaved = function (e, t, r) {
      return t instanceof pt
        ? new gt(e, Ye(e.mode, t.state), r, t.lookAhead)
        : new gt(e, Ye(e.mode, t), r);
    }),
  ...
  function St(e, t, r, n) {
    ...
    for (n && (o = []); (n || c.pos < t.ch) && !c.eol(); )
      (c.start = c.pos),
        (i = xt(s, c, u.state)),
        n && o.push(new Ct(c, i, Ye(l.mode, u.state)));
    ...
    for ('' == t && Lt(wt(r, n.state), o); !h.eol(); ) {
      if (
        (h.pos > e.options.maxHighlightLength
          ? ((s = !1), l && bt(e, t, n, h.pos), (h.pos = t.length), (a = null))
  ...
  function Dt(e, t) {
        ...
        if (e)
          for (var i = 0; i < e.length; ++i) {
            ...
            if (
              ...
              (n || (n = [])).push(new Nt(l, o.from, s ? null : o.to));
            }
          }
        return n;
      })(r, i, l),
        ...
        if (e)
          for (var i = 0; i < e.length; ++i) {
            ...
            if (
              ...
              (n || (n = [])).push(
                new Nt(l, s ? null : o.from - t, null == o.to ? null : o.to - t)
              );
            }
          }
        return n;
    ...
    if (a)
      for (var p = 0; p < a.length; ++p) {
        ...
        null != g.to && (g.to += c),
          null == g.from
            ? Ot(s, g.marker) || ((g.from = c), u && (s || (s = [])).push(g))
            : ((g.from += c), u && (s || (s = [])).push(g));
      }
    s && (s = Wt(s)), a && a != s && (a = Wt(a));
    var v = [s];
    if (!u) {
      var m,
        y = t.text.length - 2;
      if (y > 0 && s)
        for (var b = 0; b < s.length; ++b)
          null == s[b].to &&
            (m || (m = [])).push(new Nt(s[b].marker, null, null));
  ...
  function Rt(e, t) {
    ...
    var n = e.find(),
      i = t.find(),
      o = lt(n.from, i.from) || Pt(e) - Pt(t);
    return o ? -o : lt(n.to, i.to) || Et(e) - Et(t) || t.id - e.id;
  }
  function zt(e, t) {
    var r,
      n = Mt && e.markedSpans;
      ...
      for (var s = 0; s < l.length; ++s) {
        ...
        if (a.marker.collapsed) {
          var u = a.marker.find(0),
            c = lt(u.from, r) || Pt(a.marker) - Pt(i),
            h = lt(u.to, n) || Et(a.marker) - Et(i);
          if (
            !((c >= 0 && h <= 0) || (c <= 0 && h >= 0)) &&
            ((c <= 0 &&
  ...
  function Yt(e, t, r) {
    if (null == r.to) {
      ...
      return Yt(e, n.line, Ot(n.line.markedSpans, r.marker));
    }
  ...
  function $t(e) {
    for (var t = 0, r = (e = Vt(e)).parent, n = 0; n < r.lines.length; ++n) {
      var i = r.lines[n];
      if (i == e) break;
      t += i.height;
    }
  ...
  function _t(e) {
    ...
    for (var t, r = e.text.length, n = e; (t = It(n)); ) {
      var i = t.find(0, !0);
  ...
  function qt(e) {
    var t = e.display,
      r = e.doc;
    (t.maxLine = Ze(r, r.first)),
      (t.maxLineLength = _t(t.maxLine)),
      (t.maxLineChanged = !0),
      r.iter(function (e) {
        var r = _t(e);
  ...
  var Zt = function (e, t, r) {
    (this.text = e), Ft(this, t), (this.height = r ? r(this) : 1);
  };
  function Qt(e) {
    (e.parent = null), Ht(e);
  }
  ...
  function rr(e, t) {
    ...
    for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
      ...
      (n.pos = 0),
        (n.addToken = ir),
        Fe(e.display.measure) &&
          (l = pe(o, e.doc.direction)) &&
          (n.addToken = or(n.addToken, l)),
        (n.map = []),
        sr(o, n, mt(e, o, t != e.display.externalMeasured && tt(o))),
        o.styleClasses &&
        ...
        0 == n.map.length &&
          n.map.push(0, 0, n.content.appendChild(He(e.display.measure))),
        0 == i
    ...
    return (
      be(e, 'renderLine', e, t.line, n.pre),
        ...
        for (var d = 0; ; ) {
          ...
          if ('\t' == p[0]) {
            var y = e.cm.options.tabSize,
              b = y - (e.col % y);
            (m = u.appendChild(A('span', Q(b), 'cm-tab'))).setAttribute(
              'role',
              'presentation'
            ),
    ...
    if (n)
      for (
        ...
        if (m == p) {
          ...
          for (var y = [], b = void 0, w = 0; w < n.length; ++w) {
            ...
            if ('bookmark' == C.type && x.from == p && C.widgetNode) y.push(C);
              ...
              C.collapsed && (!h || Rt(h.marker, C) < 0) && (h = x);
          ...
          if (b)
            for (var L = 0; L < b.length; L += 2)
              b[L + 1] == m && (u += ' ' + b[L]);
          if (!h || h.from == p)
            for (var k = 0; k < y.length; ++k) lr(t, 0, y[k]);
          if (h && (h.from || 0) == p) {
            if (
              (lr(
                t,
        ...
        for (var T = Math.min(d, m); ; ) {
          ...
          (v = i.slice(o, (o = r[g++]))), (l = tr(r[g++], t.cm.options));
        }
      }
    else
      for (var O = 1; O < r.length; O += 2)
        t.addToken(t, i.slice(o, (o = r[O])), tr(r[O + 1], t.cm.options));
  }
  function ar(e, t, r) {
    (this.line = t),
      ...
      (this.size = this.rest ? tt(J(this.rest)) - r + 1 : 1),
      (this.node = this.text = null),
      (this.hidden = Xt(e, t));
  }
  function ur(e, t, r) {
    for (var n, i = [], o = t; o < r; o = n) {
      var l = new ar(e.doc, Ze(e.doc, o), o);
      (n = o + l.size), i.push(l);
    }
    return i;
  }
  ...
  function mr(e, t) {
    ...
    t.text == t.node && (t.node = n.pre),
      ...
      n.bgClass != t.bgClass || n.textClass != t.textClass
        ? ((t.bgClass = n.bgClass), (t.textClass = n.textClass), yr(e, t))
  ...
  function yr(e, t) {
    !(function (e, t) {
      ...
      t.line.wrapClass
        ? (gr(t).className = t.line.wrapClass)
  ...
  function wr(e, t, r) {
    ...
    for (
      var n = k('CodeMirror-linewidget'), i = t.node.firstChild, o = void 0;
      i;
      i = o
    )
  ...
  function Sr(e, t, r, n, i) {
    if (t.widgets)
      for (var o = gr(r), l = 0, s = t.widgets; l < s.length; ++l) {
        var a = s[l],
          u = A(
            'div',
            [a.node],
  ...
  function Tr(e, t) {
    for (var r = Ne(t); r != e.wrapper; r = r.parentNode)
      if (
        !r ||
  ...
  function Wr(e) {
    return e.display.scroller.clientHeight - Ar(e) - e.display.barHeight;
  }
  function Hr(e, t, r) {
  ...
  function Er(e, t) {
    ...
    n && !n.text
      ? (n = null)
      : n && n.changes && (pr(e, n, r, cn(e)), (e.curOp.forceUpdate = !0)),
      n ||
        (n = (function (e, t) {
          var r = tt((t = Vt(t))),
                ...
                if (
                  (i =
                    l && s < 9 && 0 == u && c == o.coverEnd - o.coverStart
                      ...
                      : Gr(T(a, u, c).getClientRects(), n)).left ||
                  i.right ||
                  0 == u
                )
                  break;
  ...
  function Yr(e) {
    var t = Vt(e).widgets,
      r = 0;
    if (t) for (var n = 0; n < t.length; ++n) t[n].above && (r += kr(t[n]));
    return r;
  }
  function $r(e, t, r, n, i) {
    ...
    var l = $t(t);
    if (
      ('local' == n ? (l += Mr(e.display)) : (l -= e.display.viewOffset),
      'page' == n || 'window' == n)
    ) {
      var s = e.display.lineSpace.getBoundingClientRect();
      l += s.top + ('window' == n ? 0 : Xr(R(e)));
      var a = s.left + ('window' == n ? 0 : jr(R(e)));
      (r.left += a), (r.right += a);
    }
  ...
  function qr(e, t, r, n, i) {
    return n || (n = Ze(e.doc, t.line)), $r(e, n, Fr(e, n, t.ch, i), r);
  }
  function Zr(e, t, r, n, i, o) {
    function l(t, l) {
      var s = Rr(e, i, t, l ? 'right' : 'left', o);
      return l ? (s.left = s.right) : (s.right = s.left), $r(e, n, s, r);
    }
    (n = n || Ze(e.doc, t.line)), i || (i = Er(e, n));
    var s = pe(n, e.doc.direction),
      a = t.ch,
      u = t.sticky;
    if (
      (a >= n.text.length
  ...
  function Qr(e, t) {
    var r = 0;
    (t = ft(e.doc, t)), e.options.lineWrapping || (r = un(e.display) * t.ch);
  ...
  function en(e, t, r) {
    ...
    var i = rt(n, r),
      o = n.first + n.size - 1;
    if (i > o)
      return Jr(n.first + n.size - 1, Ze(n, o).text.length, null, 1, 1);
    t < 0 && (t = 0);
    for (var l = Ze(n, i); ; ) {
      var s = on(e, l, i, t, r),
        a = Gt(l, s.ch + (s.xRel > 0 || s.outside > 0 ? 1 : 0));
      if (!a) return s;
      var u = a.find(1);
  ...
  function rn(e, t, r, n) {
    return r || (r = Er(e, t)), tn(e, t, r, $r(e, t, Rr(e, r, n), 'line').top);
  }
  function nn(e, t, r, n) {
  ...
  function on(e, t, r, n, i) {
    ...
    var o = Er(e, t),
      ...
      a = t.text.length,
      u = !0,
      c = pe(t, e.doc.direction);
    if (c) {
      var h = (e.options.lineWrapping ? sn : ln)(e, t, r, o, c, n, i);
      ...
      u || (v != a && v != s) || v++,
        (d =
          0 == v
            ...
            : v == t.text.length
              ? 'before'
              : Rr(e, o, v - (u ? 1 : 0)).bottom + l <= i == u
                ? 'after'
                : 'before');
      var w = Zr(e, ot(r, v, d), 'line', t, o);
      (f = w.left), (m = i < w.top ? -1 : i >= w.bottom ? 1 : 0);
    }
    return Jr(r, (v = ue(t.text, v, 1)), d, m, n - f);
  }
  function ln(e, t, r, n, i, o, l) {
    var s = ce(
        function (s) {
          ...
          return nn(
            Zr(
              e,
              ot(r, u ? a.to : a.from, u ? 'before' : 'after'),
              'line',
              t,
              n
            ),
    ...
    if (s > 0) {
      var u = 1 != a.level,
        c = Zr(
          e,
          ot(r, u ? a.from : a.to, u ? 'after' : 'before'),
          'line',
          t,
          n
        );
      nn(c, o, l, !0) && c.top > l && (a = i[s - 1]);
    }
    return a;
  }
  function sn(e, t, r, n, i, o, l) {
    var s = tn(e, t, n, l),
      a = s.begin,
      u = s.end;
  ...
  function an(e) {
    ...
    if (null == zr) {
      ...
      for (var t = 0; t < 49; ++t)
        zr.appendChild(document.createTextNode('x')), zr.appendChild(A('br'));
  ...
  function fn(e) {
    var t = an(e.display),
      ...
      n = r && Math.max(5, e.display.scroller.clientWidth / un(e.display) - 3);
    return function (i) {
      if (Xt(e.doc, i)) return 0;
      var o = 0;
      if (i.widgets)
  ...
  function pn(e, t, r, n) {
    ...
    if (n && u.xRel > 0 && (a = Ze(e.doc, u.line).text).length == u.ch) {
      ...
      u = ot(
        u.line,
        Math.max(0, Math.round((o - Or(e.display).left) / un(e.display)) - c)
      );
    }
    return u;
  }
  ...
  function vn(e, t, r, n) {
    ...
    if (
      ...
      Mt && Kt(e.doc, t) < i.viewTo && yn(e);
    else if (r <= i.viewFrom)
      Mt && jt(e.doc, r + n) > i.viewFrom
        ? yn(e)
      ...
      if (t || s != r.sel.primIndex) {
        ...
        if (
          ...
          if (l) {
            var c = l(e, a);
            c && Sn(e, c, i);
          } else (u || e.options.showCursorWhenSelecting) && Sn(e, a.head, i);
          u || kn(e, a, o);
        }
      }
    return n;
  ...
  function Sn(e, t, r) {
    var n = Zr(e, t, 'div', null, null, !e.options.singleCursorHeightPerLine),
  ...
  function kn(e, t, r) {
    var n = e.display,
      ...
      l = Or(e.display),
      s = l.left,
      a = Math.max(n.sizerWidth, Dr(e) - n.sizer.offsetLeft) - l.right,
      u = 'ltr' == i.direction;
    function c(e, t, r, n) {
      t < 0 && (t = 0),
        (t = Math.round(t)),
  ...
  function Mn(e) {
    e.hasFocus() || (e.display.input.focus(), e.state.focused || On(e));
  }
  function Nn(e) {
    (e.state.delayingBlurEvent = !0),
      setTimeout(function () {
        e.state.delayingBlurEvent &&
          ((e.state.delayingBlurEvent = !1), e.state.focused && An(e));
      }, 100);
  }
  function On(e, t) {
    e.state.delayingBlurEvent &&
        ...
        if (((i += u.line.height), l && s < 8)) {
          ...
          (h = p.bottom - p.top),
            !c &&
              u.text.firstChild &&
              (f =
                u.text.firstChild.getBoundingClientRect().right - p.left - 1);
        }
        var g = u.line.height - h;
        if (
          (g > 0.005 || g < -0.005) &&
          (i < n && (o -= g), et(u.line, h), Wn(u.line), u.rest)
        )
          for (var v = 0; v < u.rest.length; v++) Wn(u.rest[v]);
        if (f > e.display.sizerWidth) {
          var m = Math.ceil(f / un(e.display));
  ...
  function Hn(e, t, r) {
    ...
    if (r && r.ensure) {
      var s = r.ensure.from.line,
        a = r.ensure.to.line;
      s < o
        ? ((o = s), (l = rt(t, $t(Ze(t, s)) + e.wrapper.clientHeight)))
        : Math.min(a, t.lastLine()) >= l &&
          ((o = rt(t, $t(Ze(t, a)) - e.wrapper.clientHeight)), (l = a));
    }
  ...
  function zn(e) {
    ...
    t &&
      ...
      In(e, Qr(e, t.from), Qr(e, t.to), t.margin));
  }
  function In(e, t, r, n) {
    var i = Fn(e, {
  ...
  function Bn(e, t) {
    Math.abs(e.doc.scrollTop - t) < 2 ||
      (r || di(e, {top: t}), Gn(e, t, !0), r && di(e), ai(e, 100));
  }
  function Gn(e, t, r) {
    (t = Math.max(
      0,
  ...
  function Vn(e) {
    var t = e.display,
      ...
      n = Math.round(e.doc.height + Nr(e.display));
    return {
      ...
      docHeight: n,
      scrollHeight: n + Ar(e) + t.barHeight,
  ...
  (Kn.prototype.update = function (e) {
    ...
    (Kn.prototype.enableZeroWidthBar = function (e, t, r) {
      (e.style.visibility = ''),
  ...
  function _n(e) {
    e.display.scrollbars &&
      ...
      (e.display.scrollbars = new $n[e.options.scrollbarStyle](
        function (t) {
  ...
  function Zn(e) {
    ...
    (e.curOp = {
      ...
      cr
        ? cr.ops.push(t)
        : (t.ownsGroup = cr = {ops: [t], delayedCallbacks: []});
  }
  function Qn(e) {
    var t = e.curOp;
    t &&
  ...
  function Jn(e) {
    ...
    !(function (e) {
      ...
      !t.scrollbarsClipped &&
        ...
        (t.heightForcer.style.height = Ar(e) + 'px'),
        (t.sizer.style.marginBottom = -t.nativeBarWidth + 'px'),
        (t.sizer.style.borderRightWidth = Ar(e) + 'px'),
  ...
  function ti(e) {
    ...
    e.updatedDisplay && Dn(t),
      ...
      r.maxLineChanged &&
        ...
        ((e.adjustWidthTo = Fr(t, r.maxLine, r.maxLine.text.length).left + 3),
        (t.display.sizerWidth = e.adjustWidthTo),
        (e.barMeasure.scrollWidth = Math.max(
          r.scroller.clientWidth,
          r.sizer.offsetLeft + e.adjustWidthTo + Ar(t) + t.display.barWidth
        )),
        (e.maxScrollLeft = Math.max(
          0,
          r.sizer.offsetLeft + e.adjustWidthTo - Dr(t)
        ))),
  ...
  function ni(e) {
    var t = e.cm,
      ...
      n = t.doc;
    if (
      (e.updatedDisplay && fi(t, e.update),
      null == r.wheelStartX ||
      ...
      var i = (function (e, t, r, n) {
        ...
        null == n && (n = 0),
          e.options.lineWrapping ||
            t != r ||
            ((r = 'before' == t.sticky ? ot(t.line, t.ch + 1, 'before') : t),
            (t = t.ch
              ? ot(t.line, 'before' == t.sticky ? t.ch - 1 : t.ch, 'after')
              : t));
        for (var o = 0; o < 5; o++) {
          var l = !1,
            s = Zr(e, t),
        ...
        t,
        ft(n, e.scrollToPos.from),
        ft(n, e.scrollToPos.to),
        ...
        if (!we(e, 'scrollCursorIntoView')) {
          ...
          if (
            ...
            var l = A(
              ...
              null,
              'position: absolute;\n                         top: ' +
                (t.top - r.viewOffset - Mr(e.display)) +
                'px;\n                         height: ' +
                (t.bottom - t.top + Ar(e) + r.barHeight) +
                'px;\n                         left: ' +
                t.left +
                'px; width: ' +
    ...
    if (o)
      for (var s = 0; s < o.length; ++s) o[s].lines.length || be(o[s], 'hide');
    if (l)
  ...
  function ai(e, t) {
    e.doc.highlightFrontier < e.display.viewTo &&
      e.state.highlight.set(t, G(ui, e));
  }
  function ui(e) {
    var t = e.doc;
    if (!(t.highlightFrontier >= e.display.viewTo)) {
      ...
      t.iter(
        ...
        i.length &&
          ii(e, function () {
            for (var t = 0; t < i.length; t++) mn(e, i[t], 'text');
          });
    }
  }
  ...
  function hi(e, t) {
    ...
    !(function (e, t, r) {
      ...
      0 == n.view.length || t >= n.viewTo || r <= n.viewFrom
        ? ((n.view = ur(e, t, r)), (n.viewFrom = t))
        : (n.viewFrom > t
            ? (n.view = ur(e, t, n.viewFrom).concat(n.view))
            : n.viewFrom < t && (n.view = n.view.slice(gn(e, t))),
          (n.viewFrom = t),
          n.viewTo < r
            ? (n.view = n.view.concat(ur(e, n.viewTo, r)))
            : n.viewTo > r && (n.view = n.view.slice(0, gn(e, r)))),
        (n.viewTo = r);
    })(e, o, l),
      (r.viewOffset = $t(Ze(e.doc, r.viewFrom))),
    ...
    return (
      ...
      (function (e, t, r) {
        ...
        function s(t) {
          var r = t.nextSibling;
          return (
            a && b && e.display.currentWheelTarget == t
        ...
        for (var u = n.view, c = n.viewFrom, h = 0; h < u.length; h++) {
          ...
          if (f.hidden);
            ...
            f.changes &&
              (j(f.changes, 'gutter') > -1 && (d = !1), pr(e, f, c, r)),
              d &&
                (N(f.lineNumber),
                f.lineNumber.appendChild(
                  document.createTextNode(it(e.options, c))
                )),
  ...
  function fi(e, t) {
    for (var r = t.viewport, n = !0; ; n = !1) {
      if (n && e.options.lineWrapping && t.oldDisplayWidth != Dr(e))
        n && (t.visible = Hn(e.display, e.doc, r));
      else if (
        (r &&
          null != r.top &&
          (r = {top: Math.min(e.doc.height + Nr(e.display) - Wr(e), r.top)}),
  ...
  function di(e, t) {
    ...
    if (hi(e, r)) {
      Dn(e), fi(e, r);
      var n = Vn(e);
      xn(e), Xn(e, n), gi(e, n), r.finish();
    }
  }
  function pi(e) {
    var t = e.gutters.offsetWidth;
    (e.sizer.style.marginLeft = t + 'px'), fr(e, 'gutterChanged', e);
  }
  function gi(e, t) {
    (e.display.sizer.style.minHeight = t.docHeight + 'px'),
      (e.display.heightForcer.style.top = t.docHeight + 'px'),
      (e.display.gutters.style.height =
        t.docHeight + e.display.barHeight + Ar(e) + 'px');
  }
  function vi(e) {
    var t = e.display,
      r = t.view;
  ...
  function bi(e) {
    ...
    (t.style.display = r.length ? '' : 'none'), pi(e);
  }
  function wi(e) {
    bi(e.display), vn(e), vi(e);
  }
  function xi(e, t, n, i) {
    var o = this;
    (this.input = n),
  ...
  (ci.prototype.signal = function (e, t) {
    Ce(e, t) && this.events.push(arguments);
  }),
    (ci.prototype.finish = function () {
  ...
  function Ti(e, t) {
    ...
    if ((i && d) || (o && p)) {
      ...
      if (i && !r && !f && null != l)
        return (
          o && p && Bn(e, Math.max(0, u.scrollTop + o * l)),
          Un(e, Math.max(0, u.scrollLeft + i * l)),
          (!o || (o && p)) && Le(t),
            ...
            setTimeout(function () {
              if (null != s.wheelStartX) {
                ...
                (s.wheelStartX = s.wheelStartY = null),
                  r && ((Si = (Si * Ci + r) / (Ci + 1)), ++Ci);
              }
            }, 200))
          : ((s.wheelDX += i), (s.wheelDY += o)));
    }
  }
  l ? (Si = -0.53) : r ? (Si = 15) : c ? (Si = -0.7) : d && (Si = -1 / 3);
  var Mi = function (e, t) {
  ...
  (Mi.prototype.primary = function () {
    ...
    (Mi.prototype.deepCopy = function () {
      for (var e = [], t = 0; t < this.ranges.length; t++)
        e[t] = new Ni(at(this.ranges[t].anchor), at(this.ranges[t].head));
  ...
  function Oi(e, t, r) {
    ...
    for (var o = 1; o < t.length; o++) {
      ...
      if (n && !l.empty() ? a > 0 : a >= 0) {
        ...
        o <= r && --r, t.splice(--o, 2, new Ni(h ? c : u, h ? u : c));
      }
    }
    return new Mi(t, r);
  }
  function Ai(e, t) {
    return new Mi([new Ni(e, t || e)], 0);
  }
  function Di(e) {
    return e.text
      ? ot(
  ...
  function Wi(e, t) {
    ...
    if (lt(e, t.to) <= 0) return Di(t);
    var r = e.line + t.text.length - (t.to.line - t.from.line) - 1,
      n = e.ch;
    return e.line == t.to.line && (n += Di(t).ch - t.to.ch), ot(r, n);
  }
  function Hi(e, t) {
    for (var r = [], n = 0; n < e.sel.ranges.length; n++) {
      var i = e.sel.ranges[n];
      r.push(new Ni(Wi(i.anchor, t), Wi(i.head, t)));
    }
    return Oi(e.cm, r, e.sel.primIndex);
  }
  function Fi(e, t, r) {
    return e.line == t.line
      ? ot(r.line, e.ch - t.ch + r.ch)
      : ot(r.line + (e.line - t.line), e.ch);
  }
  function Pi(e) {
    (e.doc.mode = Ke(e.options, e.doc.modeOption)), Ei(e);
  }
  function Ei(e) {
  ...
  function zi(e, t, r, n) {
    ...
    function l(e, t) {
      for (var r = [], o = e; o < t; ++o) r.push(new Zt(u[o], i(o), n));
      return r;
    }
    var s = t.from,
      a = t.to,
    ...
    if (t.full)
      ...
      if (1 == u.length)
        ...
        v.push(new Zt(f + c.text.slice(a.ch), d, n)),
  ...
  function Vi(e, t) {
    var r = {from: at(t.from), to: Di(t), text: Qe(e, t.from, t.to)};
    return (
  ...
  function ji(e, t, r, n) {
    ...
    if (
      ...
      (l = J(o.changes)),
        0 == lt(t.from, t.to) && 0 == lt(t.from, l.to)
          ? (l.to = Di(t))
          : o.changes.push(Vi(e, t));
    else {
      var a = J(i.done);
      for (
        (a && a.ranges) || Xi(e.sel, i.done),
          o = {changes: [Vi(e, t)], generation: i.generation},
          i.done.push(o);
  ...
  function Qi(e, t, r, n, i) {
    null == i && (i = e.cm && (e.cm.display.shift || e.extend)),
      no(e, new Mi([Zi(e.sel.primary(), t, r, i)], 0), n);
  }
  function Ji(e, t, r) {
    for (
    ...
    no(e, Oi(e.cm, n, e.sel.primIndex), r);
  }
  function eo(e, t, r, n) {
    var i = e.sel.ranges.slice(0);
    (i[t] = r), no(e, Oi(e.cm, i, e.sel.primIndex), n);
  }
  function to(e, t, r, n) {
    no(e, Ai(t, r), n);
  }
        ...
        var n = {
          ...
          update: function (t) {
            ...
            for (var r = 0; r < t.length; r++)
              this.ranges[r] = new Ni(ft(e, t[r].anchor), ft(e, t[r].head));
          },
          origin: r && r.origin,
        };
        return (
          be(e, 'beforeSelectionChange', e, n),
          e.cm && be(e.cm, 'beforeSelectionChange', e.cm, n),
          n.ranges != t.ranges ? Oi(e.cm, n.ranges, n.ranges.length - 1) : t
        );
      })(e, t, r));
    var n =
      (r && r.bias) ||
      (lt(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
    oo(e, so(e, t, n, !0)),
      (r && !1 === r.scroll) ||
        !e.cm ||
  ...
  function so(e, t, r, n) {
    for (var i, o = 0; o < t.ranges.length; o++) {
      var l = t.ranges[o],
        ...
        u = l.head == l.anchor ? a : uo(e, l.head, s && s.head, r, n);
      (i || a != l.anchor || u != l.head) &&
        (i || (i = t.ranges.slice(0, o)), (i[o] = new Ni(a, u)));
    }
    return i ? Oi(e.cm, i, t.primIndex) : t;
  }
  ...
  function co(e, t, r, n) {
    return r < 0 && 0 == t.ch
      ? t.line > e.first
        ? ft(e, ot(t.line - 1))
        : null
      : r > 0 && t.ch == (n || Ze(e, t.line)).text.length
        ? t.line < e.first + e.size - 1
          ? ot(t.line + 1, 0)
          : null
        : new ot(t.line, t.ch + r);
  }
  function ho(e) {
    e.setSelection(ot(e.firstLine(), 0), ot(e.lastLine()), Y);
  }
  function fo(e, t, r) {
    var n = {
      canceled: !1,
    ...
    return (
      ...
      be(e, 'beforeChange', e, n),
      e.cm && be(e.cm, 'beforeChange', e.cm, n),
      n.canceled
  ...
  function po(e, t, r) {
    if (e.cm) {
      if (!e.cm.curOp) return oi(e.cm, po)(e, t, r);
  ...
  function go(e, t) {
    if (1 != t.text.length || '' != t.text[0] || 0 != lt(t.from, t.to)) {
      var r = Hi(e, t);
      ji(e, t, r, e.cm ? e.cm.curOp.id : NaN), yo(e, t, r, Dt(e, t));
      var n = [];
      Ii(e, function (e, r) {
        r || -1 != j(n, e.history) || (Co(e.history, t), n.push(e.history)),
          yo(e, t, null, Dt(e, t));
      });
    }
  }
    ...
    if (!n || r) {
      ...
      if (u != s.length) {
        for (o.lastOrigin = o.lastSelOrigin = null; ; ) {
          ...
          if ((Xi(i, a), r && !i.equals(e.sel)))
            return void no(e, i, {clearRedo: !1});
          l = i;
        }
        var c = [];
        Xi(l, a),
        ...
        for (
          var h = Ce(e, 'beforeChange') || (e.cm && Ce(e.cm, 'beforeChange')),
            f = function (r) {
              var n = i.changes[r];
              if (((n.origin = t), h && !fo(e, n, !1)))
                return (s.length = 0), {};
              c.push(Vi(e, n));
              var o = r ? Hi(e, n) : J(s);
              yo(e, n, o, _i(e, n)),
                !r && e.cm && e.cm.scrollIntoView({from: n.from, to: Di(n)});
              var l = [];
              Ii(e, function (e, t) {
                t ||
                  -1 != j(l, e.history) ||
                  (Co(e.history, n), l.push(e.history)),
                  yo(e, n, null, _i(e, n));
              });
            },
  ...
  function mo(e, t) {
    if (
      ...
      ((e.first += t),
      (e.sel = new Mi(
        ee(e.sel.ranges, function (e) {
          return new Ni(
            ot(e.anchor.line + t, e.anchor.ch),
            ot(e.head.line + t, e.head.ch)
          );
        }),
        e.sel.primIndex
      )),
  ...
  function yo(e, t, r, n) {
    if (e.cm && !e.cm.curOp) return oi(e.cm, yo)(e, t, r, n);
        ...
        e.cm
          ? (function (e, t, r) {
              ...
              e.options.lineWrapping ||
                ...
                n.sel.contains(t.from, t.to) > -1 && xe(e),
                zi(n, t, r, fn(e)),
                e.options.lineWrapping ||
              ...
              t.full
                ? vn(e)
                : o.line != l.line || 1 != t.text.length || Ri(e.doc, t)
          ...
          : zi(e, t, n),
        io(e, r, Y),
        e.cantEdit && uo(e, ot(e.firstLine(), 0)) && (e.cantEdit = !1);
    }
  }
  function bo(e, t, r, n, i) {
    var o;
    n || (n = r),
      lt(n, r) < 0 && ((r = (o = [n, r])[0]), (n = o[1])),
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      if (o.ranges) {
        ...
        for (var a = 0; a < o.changes.length; ++a) {
          var u = o.changes[a];
          if (r < u.from.line)
            (u.from = ot(u.from.line + n, u.from.ch)),
              (u.to = ot(u.to.line + n, u.to.ch));
          else if (t <= u.to.line) {
            l = !1;
            break;
          }
  ...
  function So(e, t, r, n) {
    var i = t,
      o = t;
    return (
      'number' == typeof t ? (o = Ze(e, ht(e, t))) : (i = tt(t)),
  ...
  (Ni.prototype.from = function () {
    return ct(this.anchor, this.head);
  }),
    (Ni.prototype.to = function () {
      return ut(this.anchor, this.head);
    }),
    (Ni.prototype.empty = function () {
      return (
    ...
    (Lo.prototype = {
      ...
      removeInner: function (e, t) {
        for (var r = e, n = e + t; r < n; ++r) {
          var i = this.lines[r];
          (this.height -= i.height), Qt(i), fr(i, 'delete');
        }
    ...
    (ko.prototype = {
      ...
      removeInner: function (e, t) {
        ...
        if (
          this.size - t < 25 &&
          (this.children.length > 1 || !(this.children[0] instanceof Lo))
        ) {
          var s = [];
          this.collapse(s),
  ...
  function Mo(e, t, r) {
    $t(t) < ((e.curOp && e.curOp.scrollTop) || e.doc.scrollTop) && Pn(e, r);
  }
  (To.prototype.clear = function () {
    ...
    if (null != n && t) {
      ...
      var o = kr(this);
      et(r, Math.max(0, r.height - o)),
        e &&
          (ii(e, function () {
            Mo(e, r, -o), mn(e, n, 'widget');
          }),
          fr(e, 'lineWidgetCleared', e, this, n));
    }
  }),
    (To.prototype.changed = function () {
      ...
      var i = kr(this) - t;
      i &&
        (Xt(this.doc, n) || et(n, n.height + i),
        r &&
          ii(r, function () {
            (r.curOp.forceUpdate = !0),
              Mo(r, n, i),
              fr(r, 'lineWidgetChanged', r, e, tt(n));
          }));
    }),
    Se(To);
  var No = 0,
  ...
  function Ao(e, t, r, n, i) {
    ...
    if (e.cm && !e.cm.curOp) return oi(e.cm, Ao)(e, t, r, n, i);
    var o = new Oo(e, i),
      l = lt(t, r);
    if ((n && U(n, o, !1), l > 0 || (0 == l && !1 !== o.clearWhenEmpty)))
      return o;
    if (
      (o.replacedWith &&
        ((o.collapsed = !0),
      ...
      if (
        Ut(e, t.line, t, r, o) ||
        (t.line != r.line && Ut(e, r.line, t, r, o))
      )
        throw new Error(
    ...
    o.addToHistory && ji(e, {from: t, to: r, origin: 'markText'}, e.sel, NaN);
    var s,
      a = t.line,
      u = e.cm;
    if (
      (e.iter(a, r.line + 1, function (n) {
        u &&
          ...
          Vt(n) == u.display.maxLine &&
          (s = !0),
          o.collapsed && a != t.line && et(n, 0),
          (function (e, t, r) {
            var n =
              r &&
              window.WeakSet &&
            ...
            n,
            new Nt(o, a == t.line ? t.ch : null, a == r.line ? r.ch : null),
            e.cm && e.cm.curOp
          ),
          ++a;
      }),
      ...
      if ((s && (u.curOp.updateMaxLine = !0), o.collapsed))
        ...
        for (var c = t.line; c <= r.line; c++) mn(u, c, 'text');
      o.atomic && lo(u.doc), fr(u, 'markerAdded', u, o);
    }
    return o;
  }
  (Oo.prototype.clear = function () {
    if (!this.explicitlyCleared) {
      var e = this.doc.cm,
        t = e && !e.curOp;
      if ((t && Zn(e), Ce(this, 'clear'))) {
        var r = this.find();
        r && fr(this, 'clear', r.from, r.to);
      }
      for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
        var l = this.lines[o],
          s = Ot(l.markedSpans, this);
        e && !this.collapsed
          ? mn(e, tt(l), 'text')
          : e && (null != s.to && (i = tt(l)), null != s.from && (n = tt(l))),
      ...
      null != n && e && this.collapsed && vn(e, n, i + 1),
        ...
        e && fr(e, 'markerCleared', e, this, n, i),
        t && Qn(e),
    ...
    (Oo.prototype.find = function (e, t) {
      ...
      for (var i = 0; i < this.lines.length; ++i) {
        var o = this.lines[i],
          l = Ot(o.markedSpans, this);
        if (null != l.from && ((r = ot(t ? o : tt(o), l.from)), -1 == e))
          return r;
    ...
    (Oo.prototype.changed = function () {
      ...
      t &&
        ...
        ii(n, function () {
          ...
          if (
            (l &&
              (Ur(l), (n.curOp.selectionChanged = n.curOp.forceUpdate = !0)),
            (n.curOp.updateMaxLine = !0),
            !Xt(r.doc, i) && null != r.height)
          ) {
            var s = r.height;
            r.height = null;
            var a = kr(r) - s;
    ...
    for (
      var t = function (t) {
          ...
          for (var i = 0; i < r.markers.length; i++) {
            var o = r.markers[i];
            -1 == j(n, o.doc) && ((o.parent = null), r.markers.splice(i--, 1));
          }
        },
        r = 0;
      r < e.length;
  ...
  var Fo = 0,
    Po = function (e, t, r, n, i) {
      ...
      null == r && (r = 0),
        ko.call(this, [new Lo([new Zt('', null)])]),
        (this.first = r),
  ...
  (Po.prototype = re(ko.prototype, {
    ...
    replaceRange: function (e, t, r, n) {
      bo(this, e, (t = ft(this, t)), (r = r ? ft(this, r) : t), n);
    },
    ...
    getLineHandleVisualStart: function (e) {
      return 'number' == typeof e && (e = Ze(this, e)), Vt(e);
    },
    lineCount: function () {
      return this.size;
    },
    ...
    setCursor: si(function (e, t, r) {
      to(this, ft(this, 'number' == typeof e ? ot(e, t || 0) : e), null, r);
    }),
    setSelection: si(function (e, t, r) {
      to(this, ft(this, e), ft(this, t || e), r);
    }),
    extendSelection: si(function (e, t, r) {
      Qi(this, ft(this, e), t && ft(this, t), r);
    }),
    extendSelections: si(function (e, t) {
      Ji(this, dt(this, e), t);
    }),
    extendSelectionsBy: si(function (e, t) {
      Ji(this, dt(this, ee(this.sel.ranges, e)), t);
    }),
    setSelections: si(function (e, t, r) {
      if (e.length) {
        for (var n = [], i = 0; i < e.length; i++)
          n[i] = new Ni(
            ft(this, e[i].anchor),
            ft(this, e[i].head || e[i].anchor)
          );
        null == t && (t = Math.min(e.length - 1, this.sel.primIndex)),
          no(this, Oi(this.cm, n, t), r);
      }
    }),
    addSelection: si(function (e, t, r) {
      var n = this.sel.ranges.slice(0);
      n.push(new Ni(ft(this, e), ft(this, t || e))),
        no(this, Oi(this.cm, n, n.length - 1), r);
    }),
    ...
    replaceSelections: si(function (e, t, r) {
    ...
    clearHistory: function () {
      var e = this;
      (this.history = new Ui(this.history)),
        Ii(
          this,
          function (t) {
    ...
    clearGutter: si(function (e) {
      ...
      this.iter(function (r) {
        r.gutterMarkers &&
          r.gutterMarkers[e] &&
          So(t, r, 'gutter', function () {
            return (
              (r.gutterMarkers[e] = null),
              le(r.gutterMarkers) && (r.gutterMarkers = null),
              !0
            );
          });
      });
    ...
    addLineClass: si(function (e, t, r) {
    ...
    removeLineClass: si(function (e, t, r) {
      return So(this, e, 'gutter' == t ? 'gutter' : 'class', function (e) {
        var n =
            'text' == t
              ? 'textClass'
    ...
    addLineWidget: si(function (e, t, r) {
      return (function (e, t, r, n) {
        var i = new To(e, r, n),
          o = e.cm;
        return (
          o && i.noHScroll && (o.display.alignWidgets = !0),
          So(e, t, 'widget', function (t) {
          ...
          o && fr(o, 'lineWidgetAdded', o, i, 'number' == typeof t ? t : tt(t)),
          i
        );
      })(this, e, t, r);
    }),
    ...
    markText: function (e, t, r) {
      return Ao(this, ft(this, e), ft(this, t), r, (r && r.type) || 'range');
    },
    setBookmark: function (e, t) {
      ...
      return Ao(this, (e = ft(this, e)), e, r, 'bookmark');
    },
    ...
    unlinkDoc: function (e) {
      if ((e instanceof Al && (e = e.doc), this.linked))
              ...
              a = function () {
                ++s == i &&
                  oi(t, function () {
                    ...
                    po(t.doc, e), ro(t.doc, Ai(ft(t.doc, r), ft(t.doc, Di(e))));
                  })();
              },
              u = function (e, r) {
                if (
            ...
            if (h) {
              ...
              if (
                ...
                for (var d = 0; d < f.length; ++d)
                  bo(t.doc, '', f[d].anchor, f[d].head, 'drag');
  ...
  for (var jo = 1; jo <= 12; jo++) Uo[jo + 111] = Uo[jo + 63235] = 'F' + jo;
  var Xo = {};
  function Yo(e) {
    var t,
      r,
  ...
  function $o(e) {
    ...
    for (var r in e)
      if (e.hasOwnProperty(r)) {
        ...
        for (var i = ee(r.split(' '), Yo), o = 0; o < i.length; o++) {
          var l = void 0,
            s = void 0;
          o == i.length - 1
            ? ((s = i.join(' ')), (l = n))
  ...
  function _o(e, t, r, n) {
    ...
    if (t.fallthrough) {
      if ('[object Array]' != Object.prototype.toString.call(t.fallthrough))
        return _o(e, t.fallthrough, r, n);
      for (var o = 0; o < t.fallthrough.length; o++) {
        var l = _o(e, t.fallthrough[o], r, n);
        if (l) return l;
      }
    }
  }
  ...
  function Qo(e, t) {
    ...
    return (
      null != r &&
      !e.altGraphKey &&
      (3 == e.keyCode && e.code && (r = e.code), Zo(r, e, t))
    );
  }
  function Jo(e) {
  ...
  function el(e, t) {
    for (var r = e.doc.sel.ranges, n = [], i = 0; i < r.length; i++) {
      for (var o = t(r[i]); n.length && lt(o.from, J(n).to) <= 0; ) {
        var l = n.pop();
    ...
    ii(e, function () {
      for (var t = n.length - 1; t >= 0; t--)
        bo(e.doc, '', n[t].from, n[t].to, '+delete');
      En(e);
    });
  }
  function tl(e, t, r) {
    var n = ue(e.text, t + r, r);
  ...
  (Xo.basic = {
    ...
    (Xo.default = b ? Xo.macDefault : Xo.pcDefault);
  var il = {
    selectAll: ho,
      ...
      return el(e, function (t) {
        if (t.empty()) {
          ...
          return t.head.ch == r && t.head.line < e.lastLine()
            ...
            : {from: t.head, to: ot(t.head.line, r)};
        }
      ...
      return e.extendSelectionsBy(
        function (t) {
          return (function (e, t) {
            var r = Ze(e.doc, t),
              n = (function (e) {
                for (var t; (t = Bt(e)); ) e = t.find(1, !0).line;
                return e;
              })(r);
            return n != r && (t = tt(n)), nl(!0, e, r, t, -1);
          })(e, t.head.line);
        },
        {origin: '+move', bias: -1}
      );
    ...
    goLineLeftSmart: function (e) {
      return e.extendSelectionsBy(function (t) {
        ...
        return n.ch < e.getLine(n.line).search(/\S/) ? ll(e, t.head) : n;
      }, _);
    },
    goLineUp: function (e) {
      ...
      return ii(e, function () {
        for (var t = e.listSelections(), r = [], n = 0; n < t.length; n++)
          if (t[n].empty()) {
            ...
            if (o)
              if (
                (i.ch == o.length && (i = new ot(i.line, i.ch - 1)), i.ch > 0)
              )
  ...
  function ol(e, t) {
    var r = Ze(e.doc, t),
      n = Vt(r);
    return n != r && (t = tt(n)), nl(!0, e, n, t, 1);
  }
  function ll(e, t) {
    var r = ol(e, t.line),
      n = Ze(e.doc, r.line),
      i = pe(n, e.doc.direction);
    if (!i || 0 == i[0].level) {
  ...
  function sl(e, t, r) {
    if ('string' == typeof t && !(t = il[t])) return !1;
  ...
  function cl(e, t, r, n) {
    var i = (function (e, t, r) {
      for (var n = 0; n < e.state.keyMaps.length; n++) {
        var i = _o(t, e.state.keyMaps[n], r, e);
        if (i) return i;
      }
      return (
        (e.options.extraKeys && _o(t, e.options.extraKeys, r, e)) ||
        _o(t, e.options.keyMap, r, e)
      );
    })(e, t, n);
    return (
      'multi' == i && (e.state.keySeq = t),
      'handled' == i && fr(e, 'keyHandled', e, t, r),
      ('handled' != i && 'multi' != i) || (Le(r), Tn(e)),
      !!i
    );
  }
  function hl(e, t) {
  ...
  function gl(e) {
    ...
    if (
      ...
      var r = e.keyCode,
        n = e.charCode;
      if (f && r == fl) return (fl = null), void Le(e);
      if (!f || (e.which && !(e.which < 10)) || !hl(t, e)) {
        var i = String.fromCharCode(null == n ? r : n);
        '\b' != i &&
          ((function (e, t, r) {
            return ul(e, "'" + r + "'", t, function (t) {
              return sl(e, t, !0);
            });
          })(t, e, i) ||
  ...
  function bl(e) {
    var t = this,
      r = t.display;
    if (!(we(t, e) || (r.activeTouch && r.input.supportsTouch())))
      if ((r.input.ensurePolled(), (r.shift = e.shiftKey), Tr(r, e)))
        a ||
        ...
        var n = pn(t, e),
          ...
          o = n
            ? (function (e, t) {
                var r = +new Date();
                return ml && ml.compare(r, e, t)
                  ? ((vl = ml = null), 'triple')
                  : vl && vl.compare(r, e, t)
                    ? ((ml = new yl(r, e, t)), (vl = null), 'double')
                    : ((vl = new yl(r, e, t)), (ml = null), 'single');
              })(n, i)
            : 'single';
        B(t).focus(),
          ...
          (n &&
            ...
            (1 == i
              ? n
                ? (function (e, t, r, n) {
                    l ? setTimeout(G(Mn, e), 0) : (e.curOp.focus = H(z(e)));
                    var i,
                      o = (function (e, t, r) {
                    ...
                    'single' == r &&
                    (i = u.contains(t)) > -1 &&
                    (lt((i = u.ranges[i]).from(), t) < 0 || t.xRel > 0) &&
                    (lt(i.to(), t) > 0 || t.xRel < 0)
                      ? (function (e, t, r, n) {
                          var i = e.display,
                            o = !1,
                            u = oi(e, function (t) {
                              a && (i.scroller.draggable = !1),
                                ...
                                e.state.delayingBlurEvent &&
                                  (e.hasFocus()
                                    ? (e.state.delayingBlurEvent = !1)
                                    : Nn(e)),
                                ye(i.wrapper.ownerDocument, 'mouseup', u),
                                ye(i.wrapper.ownerDocument, 'mousemove', c),
                                ye(i.scroller, 'dragstart', h),
                                ye(i.scroller, 'drop', u),
                                o ||
                                  (Le(t),
                                  n.addNew ||
                                    Qi(e.doc, r, null, null, n.extend),
                                  (a && !d) || (l && 9 == s)
                                    ? setTimeout(function () {
                      ...
                      : (function (e, t, r, n) {
                          ...
                          if (
                            (n.addNew && !n.extend
                              ? ((a = o.sel.contains(r)),
                                (s = a > -1 ? c[a] : new Ni(r, r)))
                              : ((s = o.sel.primary()), (a = o.sel.primIndex)),
                            'rectangle' == n.unit)
                          )
                            n.addNew || (s = new Ni(r, r)),
                              (r = pn(e, t, !0, !0)),
                              (a = -1);
                          else {
                            var h = wl(e, r, n.unit);
                            s = n.extend
                              ? Zi(s, h.anchor, h.head, n.extend)
                              : h;
                          }
                          n.addNew
                            ? -1 == a
                              ? ((a = c.length),
                                no(o, Oi(e, c.concat([s]), a), {
                                  scroll: !1,
                                  origin: '*mouse',
                                }))
                              : c.length > 1 &&
                                ...
                                ? (no(
                                  ...
                                  (u = o.sel))
                                : eo(o, a, s, $)
                            : ((a = 0), no(o, new Mi([s], 0), $), (u = o.sel));
                          var f = r;
                          var d = i.wrapper.getBoundingClientRect(),
                            p = 0;
                          function g(t) {
                            var l = ++p,
                              c = pn(e, t, !0, 'rectangle' == n.unit);
                            if (c)
                              if (0 != lt(c, f)) {
                                (e.curOp.focus = H(z(e))),
                                  (function (t) {
                                    if (0 != lt(f, t))
                                      if (((f = t), 'rectangle' == n.unit)) {
                                        for (
                                          var i = [],
                                            l = e.options.tabSize,
                                            c = V(Ze(o, r.line).text, r.ch, l),
                                            h = V(Ze(o, t.line).text, t.ch, l),
                                            d = Math.min(c, h),
                                            p = Math.max(c, h),
                                        ...
                                        (S[a] = (function (e, t) {
                                          ...
                                          return r.ch == p && r.sticky == g
                                            ? t
                                            : new Ni(new ot(r.line, p, g), n);
                                        })(e, new Ni(ft(o, C), b))),
                                          no(o, Oi(e, S, a), $);
                                      }
                                  })(c);
                                var h = Hn(i, o);
                                (c.line >= h.to || c.line < h.from) &&
                                  setTimeout(
                                    oi(e, function () {
                                      p == l && g(t);
                                    }),
                          ...
                          function v(t) {
                            (e.state.selectingText = !1),
                              ...
                              ye(i.wrapper.ownerDocument, 'mousemove', m),
                              ye(i.wrapper.ownerDocument, 'mouseup', y),
                              (o.history.lastSelOrigin = null);
                          }
                          var m = oi(e, function (e) {
                              0 !== e.buttons && Oe(e) ? g(e) : v(e);
                            }),
                            y = oi(e, v);
                          (e.state.selectingText = y),
                            ve(i.wrapper.ownerDocument, 'mousemove', m),
                            ve(i.wrapper.ownerDocument, 'mouseup', y);
                        })(e, n, t, o);
                  })(t, n, o, e)
                : Ne(e) == r.scroller && Le(e)
              : 2 == i
                ? (n && Qi(t.doc, n),
                  setTimeout(function () {
                    return r.input.focus();
                  }, 20))
                : 3 == i && (L ? t.display.input.onContextMenu(e) : Nn(t)));
      }
  }
  function wl(e, t, r) {
    if ('char' == r) return new Ni(t, t);
    if ('word' == r) return e.findWordAt(t);
    if ('line' == r) return new Ni(ot(t.line, 0), ft(e.doc, ot(t.line + 1, 0)));
    var n = r(e, t);
    return new Ni(n.from, n.to);
  }
  function xl(e, t, r, n) {
    var i, o;
    ...
    if (o > s.bottom || !Ce(e, r)) return Te(t);
    o -= s.top - l.viewOffset;
    for (var a = 0; a < e.display.gutterSpecs.length; ++a) {
      var u = l.gutters.childNodes[a];
      if (u && u.getBoundingClientRect().right >= i)
        return (
          be(e, r, e, rt(e.doc, o), e.display.gutterSpecs[a].className, t),
          Te(t)
        );
    }
  }
  ...
  function Sl(e, t) {
    Tr(e.display, t) ||
      (function (e, t) {
        return (
          !!Ce(e, 'gutterContextMenu') && xl(e, t, 'gutterContextMenu', !1)
        );
      })(e, t) ||
      we(e, t, 'contextmenu') ||
      L ||
  ...
  yl.prototype.compare = function (e, t, r) {
    return this.time + 400 > e && 0 == lt(t, this.pos) && r == this.button;
  };
  var kl = {
      toString: function () {
  ...
  function Ol(e) {
    e.options.lineWrapping
      ...
      : (M(e.display.wrapper, 'CodeMirror-wrap'), qt(e)),
      dn(e),
      vn(e),
      Kr(e),
      setTimeout(function () {
  ...
  function Al(e, t) {
    var r = this;
    if (!(this instanceof Al)) return new Al(e, t);
    ...
    (function (e) {
      var t = e.display;
      ve(t.scroller, 'mousedown', oi(e, bl)),
        ve(
          t.scroller,
          'dblclick',
          l && s < 11
        ...
        ve(t.input.getField(), 'contextmenu', function (r) {
          t.scroller.contains(r.target) || Sl(e, r);
        });
      var r,
        n = {end: 0};
      function i() {
      ...
      ve(t.scroller, 'touchstart', function (i) {
        ...
        ve(t.scroller, 'touchend', function (r) {
          var n = t.activeTouch;
          if (
            n &&
            !Tr(t, r) &&
            ...
            (l =
              !n.prev || o(n, n.prev)
                ...
                : !n.prev.prev || o(n, n.prev.prev)
                  ? e.findWordAt(s)
                  : new Ni(ot(s.line, 0), ft(e.doc, ot(s.line + 1, 0)))),
        ...
        ve(t.scroller, 'scroll', function () {
          t.scroller.clientHeight &&
            (Bn(e, t.scroller.scrollTop),
            Un(e, t.scroller.scrollLeft, !0),
            be(e, 'scroll', e));
        }),
        ...
        (t.dragFunctions = {
          ...
          start: function (t) {
            return (function (e, t) {
              if (l && (!e.state.draggingText || +new Date() - Eo < 100)) Me(t);
              else if (
                !we(e, t) &&
                !Tr(e.display, t) &&
      ...
      ve(a, 'keyup', function (t) {
        return pl.call(e, t);
      }),
        ve(a, 'keydown', oi(e, dl)),
        ve(a, 'keypress', oi(e, gl)),
        ve(a, 'focus', function (t) {
          return On(e, t);
        }),
        ve(a, 'blur', function (t) {
          return An(e, t);
        });
    })(this),
    (function () {
    ...
    (t.autofocus && !y) || this.hasFocus()
      ...
      : An(this),
    Ml))
      Ml.hasOwnProperty(u) && Ml[u](this, t[u], kl);
    mi(this), t.finishInit && t.finishInit(this);
    for (var c = 0; c < Dl.length; ++c) Dl[c](this);
    Qn(this),
      a &&
        t.lineWrapping &&
  ...
  (Al.defaults = Tl), (Al.optionHandlers = Ml);
  var Dl = [];
  function Wl(e, t, r, n) {
    var i,
      o = e.doc;
    ...
    if (n || /\S/.test(s.text)) {
      if (
        'smart' == r &&
        ((u = o.mode.indent(i, s.text.slice(c.length), s.text)) == X || u > 150)
      ) {
        if (!n) return;
        r = 'prev';
      }
    ...
    'prev' == r
      ? (u = t > o.first ? V(Ze(o, t - 1).text, null, l) : 0)
      : 'add' == r
    ...
    if ((f < u && (h += Q(u - f)), h != c))
      return (
        bo(o, h, ot(t, 0), ot(t, c.length), '+input'), (s.stateAfter = null), !0
      );
      ...
      d.empty() &&
        (r && r > 0
          ...
          : e.state.overwrite && !s
            ? (g = ot(
                g.line,
                Math.min(Ze(o, g.line).text.length, g.ch + J(a).length)
              ))
            : s &&
              Hl &&
              Hl.lineWise &&
        ...
        if (
          ...
          if (o.electricChars) {
            ...
            o.electricInput &&
              ...
              (l = Wl(e, i.head.line, 'smart'));
          l && fr(e, 'electricInput', e, i.head.line);
        }
      }
  }
  function zl(e) {
    ...
    function u(o) {
      ...
      if ('codepoint' == n) {
        ...
        l = i
          ? (function (e, t, r, n) {
              ...
              var s,
                a = function (e, r) {
                  return tl(t, e instanceof ot ? e.ch : e, r);
                },
                u = function (r) {
                  return e.options.lineWrapping
                    ? ((s = s || Er(e, t)), rn(e, t, s, r))
              ...
              var p = function (e, t, n) {
                  for (
                    var o = function (e, t) {
                      return t
                        ? new ot(r.line, a(e, 1), 'before')
                        : new ot(r.line, e, 'after');
                    };
                    e >= 0 && e < i.length;
                    e += t
                  ) {
      ...
      if (null == l) {
        if (
          ...
          (u = t.line + a) < e.first ||
          u >= e.first + e.size ||
          ((t = new ot(u, t.ch, t.sticky)), !(s = Ze(e, u)))
        )
          return !1;
        t = nl(i, e.cm, s, t.line, a);
      } else t = l;
      return !0;
    }
  ...
  function Xl(e, t, r) {
    ...
    if (t == e.display.lineDiv) {
      if (!(n = e.display.lineDiv.childNodes[r]))
        return jl(e.clipPos(ot(e.display.viewTo - 1)), !0);
      (t = null), (r = 0);
    } else
    ...
    for (var i = 0; i < e.display.view.length; i++) {
      ...
      if (o.node == n) return Yl(o, t, r);
    }
  }
  function Yl(e, t, r) {
    var n = e.text.firstChild,
      i = !1;
    if (!t || !W(n, t)) return jl(ot(tt(e.line), 0), !0);
    if (t == n && ((i = !0), (t = n.childNodes[r]), (r = 0), !t)) {
      var o = e.rest ? J(e.rest) : e.line;
      return jl(ot(tt(o), o.text.length), i);
    }
    ...
    for (
      ...
      if ((h = c(f, f.firstChild, 0))) return jl(ot(h.line, h.ch - d), i);
      d += f.textContent.length;
    }
    for (var p = s.previousSibling, g = r; p; p = p.previousSibling) {
      if ((h = c(p, p.firstChild, -1))) return jl(ot(h.line, h.ch + g), i);
  ...
  (Vl.prototype.init = function (e) {
    ...
    function l(e) {
      if (o(e) && !we(n, e)) {
        if (n.somethingSelected())
          Fl({lineWise: !1, text: n.getSelections()}),
    ...
    (Vl.prototype.prepareSelection = function () {
      var e = Cn(this.cm, !1);
      return (e.focus = H(I(this.div)) == this.div), e;
    }),
    ...
    (Vl.prototype.showPrimarySelection = function () {
      ...
      if (
        ...
        var l = Xl(t, e.anchorNode, e.anchorOffset),
          s = Xl(t, e.focusNode, e.focusOffset);
        if (
          !l ||
          l.bad ||
          !s ||
          ...
          var a = t.display.view,
            u = (i.line >= t.display.viewFrom && Kl(t, i)) || {
              node: a[0].measure.map[2],
              offset: 0,
            },
            c = o.line < t.display.viewTo && Kl(t, o);
          if (!c) {
    ...
    (Vl.prototype.focus = function () {
      'nocursor' != this.cm.options.readOnly &&
        ((this.selectionInEditor() && H(I(this.div)) == this.div) ||
    ...
    (Vl.prototype.pollContent = function () {
      ...
      if (
        (0 == l.ch &&
          l.line > n.firstLine() &&
          (l = ot(l.line - 1, Ze(n.doc, l.line - 1).length)),
        s.ch == Ze(n.doc, s.line).text.length &&
          s.line < n.lastLine() &&
          (s = ot(s.line + 1, 0)),
      ...
      l.line == i.viewFrom || 0 == (e = gn(n, l.line))
        ? ((t = tt(i.view[0].line)), (r = i.view[0].node))
        : ((t = tt(i.view[e].line)), (r = i.view[e - 1].node.nextSibling));
      var a,
        u,
        c = gn(n, s.line);
      if (
      ...
      for (
        var h = n.doc.splitLines(
          ...
          f = Qe(n.doc, ot(t, 0), ot(a, Ze(n.doc, a).text.length));
        h.length > 1 && f.length > 1;

      )
        if (J(h) == J(f)) h.pop(), f.pop(), a--;
        else {
          if (h[0] != f[0]) break;
          h.shift(), f.shift(), t++;
        }
      ...
      var x = ot(t, d),
        C = ot(a, f.length ? J(f).length - p : 0);
      return h.length > 1 || h[0] || lt(x, C)
  ...
  ($l.prototype.init = function (e) {
    ...
    function o(e) {
      if (!we(n, e)) {
        if (n.somethingSelected()) Fl({lineWise: !1, text: n.getSelections()});
        else {
          if (!n.options.lineWiseCopyCut) return;
          var t = zl(n);
          Fl({lineWise: !0, text: t.text}),
            'cut' == e.type
              ? n.setSelections(t.ranges, null, Y)
    ...
    ($l.prototype.createField = function (e) {
      (this.wrapper = Bl()), (this.textarea = this.wrapper.firstChild);
      var t = this.cm.options;
      Il(this.textarea, t.spellcheck, t.autocorrect, t.autocapitalize);
    }),
    ($l.prototype.screenReaderLabelChanged = function (e) {
      e
    ...
    ($l.prototype.prepareSelection = function () {
      ...
      if (e.options.moveInputWithCursor) {
        var i = Zr(e, r.sel.primary().head, 'div'),
    ...
    ($l.prototype.focus = function () {
      if (
        'nocursor' != this.cm.options.readOnly &&
        (!y || H(I(this.textarea)) != this.textarea)
      )
        try {
          this.textarea.focus();
        } catch (e) {}
    ...
    ($l.prototype.onContextMenu = function (e) {
      ...
      if (o && !f) {
        ...
        if (
          ...
          a && (c = i.ownerDocument.defaultView.scrollY),
          n.input.focus(),
          a && i.ownerDocument.defaultView.scrollTo(null, c),
          n.input.reset(),
          ...
          Me(e);
          var g = function () {
            ye(window, 'mouseup', g), setTimeout(m, 20);
          };
          ve(window, 'mouseup', g);
    ...
    ($l.prototype.setUneditable = function () {}),
    ($l.prototype.needsContentAttribute = !1),
    (function (e) {
      ...
      (e.defineOption = r),
        ...
        r('lineSeparator', null, function (e, t) {
          if (((e.doc.lineSep = t), t)) {
            ...
            for (var i = r.length - 1; i >= 0; i--)
              bo(e.doc, t, r[i], ot(r[i].line, r[i].ch + t.length));
          }
        }),
        r(
          'specialChars',
        ...
        r('lineWrapping', !1, Ol, !0),
        r(
          'gutters',
          [],
          function (e, t) {
            (e.display.gutterSpecs = yi(t, e.options.lineNumbers)), wi(e);
          },
          !0
        ),
        r(
        ...
        r(
          ...
          !1,
          function (e, t) {
            (e.display.gutterSpecs = yi(e.options.gutters, t)), wi(e);
          },
          !0
        ),
        r('firstLineNumber', 1, wi, !0),
        r(
          'lineNumberFormatter',
          function (e) {
            return e;
        ...
        r('showCursorWhenSelecting', !1, xn, !0),
        ...
        r('cursorHeight', 1, xn, !0),
        r('singleCursorHeightPerLine', !0, xn, !0),
        r('workTime', 100),
        r('workDelay', 100),
    ...
    (function (e) {
      ...
      (e.prototype = {
        ...
        setOption: function (e, r) {
          ...
          (n[e] == r && 'mode' != e) ||
            ((n[e] = r),
            t.hasOwnProperty(e) && oi(this, t[e])(this, r, i),
        ...
        indentSelection: li(function (e) {
          for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
            ...
            if (i.empty())
              ...
              for (var a = s; a < r; ++a) Wl(this, a, e);
              var u = this.doc.sel.ranges;
              0 == o.ch &&
                t.length == u.length &&
                u[n].from().ch > 0 &&
                eo(this.doc, n, new Ni(o, u[n].to()), Y);
            }
          }
        }),
        ...
        getStateAfter: function (e, t) {
          ...
          return yt(
            this,
            (e = ht(r, null == e ? r.first + r.size - 1 : e)) + 1,
            t
          ).state;
        },
        ...
        charCoords: function (e, t) {
          return qr(this, ft(this.doc, e), t || 'page');
        },
        coordsChar: function (e, t) {
          return en(this, (e = _r(this, e, t || 'page')).left, e.top);
        },
        lineAtHeight: function (e, t) {
          return (
            (e = _r(this, {top: e, left: 0}, t || 'page').top),
        ...
        heightAtLine: function (e, t, r) {
          ...
          return (
            $r(this, n, {top: 0, left: 0}, t || 'page', r || i).top +
            (i ? this.doc.height - $t(n) : 0)
          );
        },
        ...
        addWidget: function (e, t, r, n, i) {
          var o,
            l,
            s = this.display,
            a = (e = Zr(this, ft(this.doc, e))).bottom,
            u = e.left;
          if (
            ...
            ('above' == n || e.bottom + t.offsetHeight > c) &&
            e.top > t.offsetHeight
              ? (a = e.top - t.offsetHeight)
              : e.bottom + t.offsetHeight <= c && (a = e.bottom),
          ...
          (t.style.top = a + 'px'),
            ...
            r &&
              (null !=
                ...
                })).scrollTop && Bn(o, l.scrollTop),
              null != l.scrollLeft && Un(o, l.scrollLeft));
        },
        triggerOnKeyDown: li(dl),
        triggerOnKeyPress: li(gl),
        triggerOnKeyUp: pl,
        triggerOnMouseDown: li(bl),
        execCommand: function (e) {
          if (il.hasOwnProperty(e)) return il[e].call(null, this);
        },
        ...
        findPosH: function (e, t, r, n) {
          ...
          t < 0 && ((i = -1), (t = -t));
          for (
            var o = ft(this.doc, e), l = 0;
            l < t && !(o = Gl(this.doc, o, i, r, n)).hitSide;
            ++l
          );
          return o;
        },
        moveH: li(function (e, t) {
          var r = this;
          this.extendSelectionsBy(function (n) {
            return r.display.shift || r.doc.extend || n.empty()
              ? Gl(r.doc, n.head, e, t, r.options.rtlMoveVisually)
              : e < 0
                ? n.from()
                : n.to();
          }, _);
        }),
        deleteH: li(function (e, t) {
          var r = this.doc.sel,
            n = this.doc;
          r.somethingSelected()
            ? n.replaceSelection('', null, '+delete')
            : el(this, function (r) {
                var i = Gl(n, r.head, e, t, !1);
        ...
        findWordAt: function (e) {
          ...
          return new Ni(ot(e.line, r), ot(e.line, n));
        },
        toggleOverwrite: function (e) {
        ...
        getScrollInfo: function () {
          ...
          return {
            left: e.scrollLeft,
            top: e.scrollTop,
            height: e.scrollHeight - Ar(this) - this.display.barHeight,
            width: e.scrollWidth - Ar(this) - this.display.barWidth,
        ...
        refresh: li(function () {
          ...
          vn(this),
            ...
            pi(this.display),
            (null == e ||
              Math.abs(e - an(this.display)) > 0.5 ||
  ...
  var _l = 'iter insert remove copy getEditor constructor'.split(' ');
  for (var ql in Po.prototype)
    Po.prototype.hasOwnProperty(ql) &&
      j(_l, ql) < 0 &&
      (Al.prototype[ql] = (function (e) {
        return function () {
  ...
  return (
    Se(Po),
    (Al.inputStyles = {textarea: $l, contenteditable: Vl}),
    ...
    (Al.fromTextArea = function (e, t) {
      ...
      var i;
      if (e.form && (ve(e.form, 'submit', n), !t.leaveSubmitMethodAlone)) {
        var o = e.form;
        i = o.submit;
        try {

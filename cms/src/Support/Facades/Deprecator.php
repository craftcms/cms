 ...
 * @method static \CraftCms\Cms\Deprecator\Models\DeprecationError[] getRequestLogs()
 * @method static int getTotalLogs()
 * @method static \CraftCms\Cms\Deprecator\Models\DeprecationError[] getLogs(int|null $limit = null)

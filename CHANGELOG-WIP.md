...
- Combobox fields throughout the control panel (time zone, language, and similar) now stay responsive with large option lists, and continue to support entering custom values in addition to selecting from the list. ([#XXXXX](https://github.com/craftcms/cms/pull/XXXXX))

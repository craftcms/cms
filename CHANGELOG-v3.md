...
- Fixed a bug where validation rules concerning string length for `varchar` columns were looking at total characters rather than total bytes. ([#3514](https://github.com/craftcms/cms/issues/3514))

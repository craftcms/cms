...
return [
    ...
    'Allow line breaks in titles' => 'Leyfa línuskil í titlum',
    ...
    'Amber' => 'Amber',
    'An elevated session is required to change a user’s email.' => 'Til að breyta netfangi notanda er aukinnar lotu krafist.',
    ...
    'Another page already has that name.' => 'Önnur síða hefur þetta nafn nú þegar.',
    'Any changes will be lost if you leave this page.' => 'Allar breytingar munu glatast ef þú yfirgefur þessa síðu.',
    'Anything cached with {method}' => 'Allt sem er í skyndiminni með {method}',
    ...
    'Are you sure you want to permanently delete {numElements, plural, =1{this} other{these}} {type}?' => 'Ertu viss um að þú viljir varanlega eyða {numElements, plural, =1{þessari} other{þessum}} {type}?',
    ...
    'Are you sure you want to remove the page “{name}”?' => 'Ertu viss um að þú viljir fjarlægja síðuna „{name}“?',
    'Are you sure you want to remove {name} verification?' => 'Ertu viss um að þú viljir fjarlægja {name} staðfestingu?',
    'Are you sure you want to remove {plugin}?' => 'Ertu viss um að þú viljir fjarlægja „{plugin}“?',
    ...
    'Attachment' => 'Viðhengi',
    'Attribute Name' => 'Nafn eiginleika',
    ...
    'Back to pages' => 'Aftur í síður',
    'Back to sign in' => 'Til baka til að skrá þig inn',
    'Back to sources' => 'Aftur í heimildir',
    'Back' => 'Til baka',
    ...
    'Base Path' => 'Grunnslóð',
    'Base URL' => 'Grunnslóð',
    'Before deleting {label}, please address the following {numBlockers, plural, =1{issue} other{issues}}:' => 'Áður en þú eyðir {label} skaltu taka á eftirfarandi {numBlockers, plural, =1{vandamáli} other{vandamálum}}:',
    ...
    'Can be exploited by DoS attacks.' => 'Getur verið nýtt með DoS árásum.',
    ...
    'Change the author of other users’ entries' => 'Breyta höfundi færslna annarra notenda',
    ...
    'Choose a new author' => 'Veldu nýjan höfund',
    'Choose a new password' => 'Veldu nýtt lykilorð',
    'Choose a new {type}' => 'Veldu nýja {type}',
    ...
    'Collapse selected blocks' => 'Fella saman valdar blokkir',
    'Collapse' => 'Hrun',
    ...
    'Copy attribute name' => 'Afrita nafn eiginleika',
    ...
    'Copy selected {type}' => 'Afrita valda {type}',
    ...
    'Could not delete the group.' => 'Ekki tókst að eyða hópnum.',
    ...
    'Delete selected {type}' => 'Eyða valinni {type}',
    ...
    'Disable selected {type}' => 'Óvirkja valda {type}',
    ...
    'Duplicate selected {type}' => 'Afrita valda {type}',
    'Duplicate' => 'Afrit',
    ...
    'Enable selected {type}' => 'Virkja valda {type}',
    ...
    'Expand selected blocks' => 'Stækka valdar blokkir',
    ...
    'Filesystem settings' => 'Stillingar skráarkerfis',
    ...
    'Generating image transform for {file}' => 'Búa til myndumbreytingu fyrir {file}',
    ...
    'Hostname' => 'Hostname',
    'Hours' => 'Klukkutímar',
    'How entries should be labeled within the control panel.' => 'Hvernig færslur ættu að vera merktar í stjórnborðinu.',
    ...
    'Includes one year of updates.' => 'Inniheldur eins árs uppfærslur.',
    ...
    'Including a Content Block field recursively is not allowed.' => 'Endurkvæm notkun reits fyrir efnisblokk er ekki leyfileg.',
    'Incorrect current password.' => 'Rangt núverandi lykilorð.',
    'Index' => 'Atriðaorðaskrá',
    'Indigo' => 'Indigo',
    'Information' => 'Upplýsingar',
    'Initial Rows' => 'Upphafsraðir',
    'Inline Only' => 'Inline Only',
    'Inline list' => 'Listi í línu',
    'Inline' => 'Í línu',
    ...
    'Last saved <time title="{timestampWithDate}">{timestamp}</time>' => 'Síðast vistað <time title="{timestampWithDate}">{timestamp}</time>',
    ...
    'Move to next group' => 'Færa í næsta hóp',
    'Move to page…' => 'Fara á síðu…',
    'Move to previous group' => 'Færa í fyrri hóp',
    'Move to the left' => 'Færðu til vinstri',
    'Move to the right' => 'Færðu til hægri',
    'Move to {page}' => 'Fara á {page}',
    'Move to' => 'Færa til',
    'Move to…' => 'Færa til…',
    ...
    'No new author selected.' => 'Enginn nýr höfundur valinn.',
    'No new {type} selected.' => 'Engin ný {type} valin.',
    ...
    'Only make editable when editing {type} that match the following rules:' => 'Gera aðeins breytanlegt þegar {type} er breytt sem passa við eftirfarandi reglur:',
    ...
    'Paste {type} above' => 'Líma {type} hér að ofan',
    'Paste {type} before' => 'Líma {type} á undan',
    ...
    'Reassign {numEntries, plural, =1{entry} other{entries}}' => 'Endurúthluta {numEntries, plural, one {}=1{færslu} other{færslum}}',
    ...
    'Remove heading' => 'Fjarlægja fyrirsögn',
    'Remove it' => 'Fjarlægðu það',
    'Remove page' => 'Fjarlægja síðu',
    'Remove {numRelations, plural, =1{relation} other{relations}}' => 'Fjarlægja {numRelations, plural, one {}=1{tengsl} other{tengsl}}',
    'Remove {numUsers, plural, =1{author} other {authors}} from {numEntries, plural, =1{entry} other{entries}}' => 'Fjarlægja {numUsers, plural, one {}=1{höfund} other {höfunda}} af {numEntries, plural, one {}=1{færslu} other{færslum}}',
    ...
    'Replace {numRelations, plural, =1{relation} other{relations}}' => 'Skipta út {numRelations, plural, one {}=1{tengslum} other{tengslum}}',
    'Replace' => 'Skipta um',
    'Replacing {type} relations' => 'Skiptir út {type} tengslum',
    ...
    'Save' => 'Vista',
    'Saved <time title="{timestampWithDate}">{timestamp}</time> by {creator}' => 'Vistað <time title="{timestampWithDate}">{timestamp}</time> af {creator}',
    'Saved <time title="{timestampWithDate}">{timestamp}</time>' => 'Vistað <time title="{timestampWithDate}">{timestamp}</time>',
    ...
    'Show ON/OFF labels in cards' => 'Sýna KVEIKT/SLÖKKT merkingar á kortum',
    ...
    'Slug Translation Key Format' => 'Slug þýðingarlyklasnið',
    'Slug Translation Method' => 'Slug þýðingaraðferð',
    'Slug' => 'Snigill',
    ...
    'System time zone ({abbr})' => 'Tímabelti kerfis ({abbr})',
    'System' => 'Kerfi',
    ...
    'The minimum number of authors that entries in this section can have.' => 'Lágmarksfjöldi höfunda sem færslur í þessu svæði mega hafa.',
    ...
    'The {numEntries, plural, =1{entry} other {entries}} will be updated once the {numUsers, plural, =1{user is} other{users are}} deleted.' => '{numEntries, plural, one {}=1{Færslan} other {Færslurnar}} verða uppfærðar þegar {numUsers, plural, one {}=1{notanda er} other{notendum er}} eytt.',
    'The {numRelations, plural, =1{relation} other {relations}} will be removed once the {numTargets, plural, =1{{targetTypeSingular} is} other{{targetTypePlural} are}} deleted.' => '{numRelations, plural, one {}=1{Tengslin} other {Tengslin}} verða fjarlægð þegar {numTargets, plural, one {}=1{{targetTypeSingular} er} other{{targetTypePlural} er}} eytt.',
    ...
    'The {numTargets, plural, =1{{targetTypeSingular} is} other{{targetTypePlural} are}} related by {numRelations, number} other {numRelations, plural, =1{{sourceTypeSingular}} other{{sourceTypePlural}}}.' => '{numTargets, plural, one {}=1{{targetTypeSingular} er} other{{targetTypePlural} eru}} tengd með {numRelations, number} other {numRelations, plural, one {}=1{{sourceTypeSingular}} other{{sourceTypePlural}}}.',
    ...
    'This user doesn’t have permission to author entries in this section.' => 'Þessi notandi hefur ekki heimild til að skrifa færslur í þessum hluta.',
    ...
    'Title Translation Key Format' => 'Titill þýðingar lykilsnið',
    'Title Translation Method' => 'Titill þýðingaraðferð',
    'Title' => 'Titill',
    ...
    'User group settings' => 'Stillingar flokkunar notenda',
    ...
    'Volume settings' => 'Stillingar safns',
    'Volume' => 'Safn',
    'Volumes' => 'Söfn',
    'Warning' => 'Viðvörun',
    'Warning:' => 'Viðvörun:',
    ...
    'Whether card views which include this field should show the custom ON/OFF labels, rather than the field name.' => 'Hvort kortasýnir sem innihalda þennan reit eigi að sýna sérsniðin KVEIKT/SLÖKKT merki frekar en nafn reitsins.',
    ...
    'account_activation_body' => 'Halló {{user.friendlyName|e}},\\n\\nÞakka þér fyrir að stofna reikning hjá {{systemName}}! Vinsamlegast smelltu á eftirfarandi tengil til að virkja reikninginn þinn:\\n\\n<{{link}}>\\n\\nEf þú áttir ekki von á þessum tölvupósti geturðu einfaldlega hunsað hann.',
    ...
    '{attribute} must be between {min} and {max}.' => '{attribute} verður að vera á milli {min} og {max}.',
    ...
    '{numEntries, number} {numEntries, plural, =1{entry has} other{entries have}} the {numUsers, plural, =1{user} other{users}} assigned as an author.' => '{numEntries, number} {numEntries, plural, one {}=1{færsla hefur} other{færslur hafa}} {numUsers, plural, one {}=1{notandann} other{notendurna}} úthlutaða(n) sem höfund(a).',
    ...
    '{numRelations, plural, =1{Relation} other{Relations}} queued to be replaced.' => '{numRelations, plural, one {}=1{Tengsl} other{Tengsl}} í biðröð til að vera skipt út.',
    ...
    '{type} entries are no longer allowed in this field. Please choose a different entry type.' => '{type} færslur eru ekki lengur leyfðar í þessum reit. Vinsamlegast veldu aðra færslutegund.',
    ...
    '{type} reassigned.' => '{type} endurúthlutuð.',

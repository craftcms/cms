...
return [
    ...
    'Allow custom URL schemes' => 'السماح بمخططات URL المُخصَّصة',
    'Allow custom colors' => 'السماح بالألوان المُخصَّصة',
    'Allow custom options' => 'السماح بالخيارات المخصَّصة',
    ...
    'Are you sure you want to delete {numElements, plural, =1{this} other{these}} {type}?' => 'هل أنت متأكد من رغبتك في حذف {numElements, plural, =1{هذا} other{هذه}} {type}؟',
    ...
    'Are you sure you want to move the selected items?' => 'هل تريد بالتأكيد نقل العناصر المُحدَّدة؟',
    'Are you sure you want to permanently delete the selected {type}?' => 'هل تريد بالتأكيد حذف {type} المحدد نهائيًا؟',
    'Are you sure you want to permanently delete {numElements, plural, =1{this} other{these}} {type}?' => 'هل أنت متأكد من رغبتك في حذف {numElements, plural, =1{هذا} other{هذه}} {type} بشكل دائم؟',
    ...
    'Before deleting {label}, please address the following {numBlockers, plural, =1{issue} other{issues}}:' => 'قبل حذف {label}، يرجى معالجة {numBlockers, plural, =1{المشكلة} other{المشكلات}} التالية:',
    ...
    'Changes to these settings aren’t permitted in this environment.' => 'غير مُصرَّح بإجراء تغييرات على هذه الإعدادات في هذه البيئة.',
    ...
    'Choose a new author' => 'اختيار كاتب جديد',
    'Choose a new password' => 'اختر كلمة مرور جديدة',
    'Choose a new {type}' => 'اختيار {type} جديد',
    ...
    'Constraints' => 'القيود',
    'Contact Developer Support' => 'التواصل مع دعم المطوِّرين',
    ...
    'Could not save due to validation errors.' => 'تعذَّر الحفظ بسبب أخطاء التحقق.',
    ...
    'Couldn’t change Craft CMS edition.' => 'تعذَّر تغيير إصدار Craft CMS.',
    'Couldn’t create {type}.' => 'تعذر إنشاء {type}.',
    'Couldn’t delete all {type}.' => 'تعذَّر حذف كل إدخالات {type}.',
    ...
    'Couldn’t find any sections that all selected elements could be moved to.' => 'تعذَّر العثور على أي أقسام يمكن نقل جميع العناصر المحدَّدة إليها.',
    'Couldn’t generate a password reset URL: {error}' => 'تعذَّر إنشاء عنوان URL لإعادة تعيين كلمة المرور: {error}',
    'Couldn’t generate an activation URL: {error}' => 'تعذَّر إنشاء عنوان URL للتنشيط: {error}',
    ...
    'Couldn’t move entries to the “{name}” section.' => 'تعذَّر نقل الإدخالات إلى قسم "{name}".',
    'Couldn’t reorder items.' => 'تعذَّرت إعادة ترتيب العناصر.',
    ...
    'Couldn’t save password.' => 'تعذَّر حفظ كلمة المرور.',
    ...
    'Couldn’t send the activation email: {error}' => 'تعذَّر إرسال رسالة البريد الإلكتروني للتنشيط: {error}',
    ...
    'Couldn’t update cart’s email.' => 'تعذَّر تحديث البريد الإلكتروني للعربة.',
    'Couldn’t update item in cart.' => 'تعذَّر تحديث العنصر في العربة.',
    ...
    'Custom Fields' => 'الحقول المخصَّصة',
    'Custom color:' => 'اللون المُخصَّص:',
    'Custom' => 'مخصص',
    'Custom:' => 'مُخصَّص:',
    ...
    'Default' => 'افتراضي',
    'Default?' => 'افتراضي؟',
    'Define any additional values that should be saved on your elements.' => 'حدِّد أي قيم إضافية ينبغي حفظها على عناصرك.',
    'Define the available colors to choose from.' => 'يُحدِّد الألوان المتاحة للاختيار منها.',
    ...
    'Disable selected {type}' => 'تعطيل {type} المحددة',
    'Disable' => 'تعطيل',
    'Disabled' => 'معطل',
    ...
    'Enable selected {type}' => 'تمكين {type} المحددة',
    ...
    'Entry could not be added. Maximum number of entries reached.' => 'تعذَّرت إضافة الإدخال. تم بلوغ الحد الأقصى لعدد الإدخالات.',
    ...
    'Filesystem settings' => 'إعدادات نظام الملفات',
    ...
    'For personal sites built for yourself or a friend.' => 'للمواقع الشخصية المصمَّمة لك أو لصديق.',
    ...
    'Includes read-only access to user data and most content, via element selector modals and other means.' => 'يتضمَّن وصولًا للقراءة فقط إلى بيانات المستخدم ومعظم المحتوى، عبر نماذج محدِّد العناصر ووسائل أخرى.',
    ...
    'Manage element thumbnails' => 'إدارة الصور المصغَّرة للعناصر',
    ...
    'More' => 'المزيد',
    'More…' => 'المزيد…',
    'Move backward' => 'الانتقال للخلف',
    'Move down' => 'التحريك لأسفل',
    'Move folder' => 'نقل المجلد',
    'Move forward' => 'الانتقال للأمام',
    'Move reverted.' => 'تم إرجاع الحركة.',
    'Move to next group' => 'الانتقال إلى المجموعة التالية',
    'Move to page…' => 'الانتقال إلى الصفحة…',
    'Move to previous group' => 'الانتقال إلى المجموعة السابقة',
    'Move to the left' => 'التحريك جهة اليسار',
    'Move to the right' => 'التحريك جهة اليمين',
    'Move to {page}' => 'الانتقال إلى {page}',
    'Move to' => 'نقل إلى',
    'Move to…' => 'النقل إلى…',
    ...
    'New field' => 'حقل جديد',
    'New file uploaded.' => 'تم تحميل ملف جديد.',
    ...
    'New {total, plural, =1{position} other{positions}} saved.' => 'تم حفظ {total, plural, zero {} one {موضع جديد} two {موضعَين جديدَين} few {مواضع جديدة} many {موضعًا جديدًا}=1{موضع جديد} other{موضع جديد}}.',
    'New {type}' => '{type} جديدة',
    'New' => 'جديد',
    ...
    'No entry types exist yet.' => 'لا توجد أنواع إدخالات موجودة بعد.',
    ...
    'No new author selected.' => 'لم يتم اختيار مؤلف جديد.',
    'No new {type} selected.' => 'لم يتم اختيار {type} جديد.',
    'No passkeys have been created yet.' => 'لم يتم إنشاء مفاتيح مرور بعد.',
    ...
    'Notification Position' => 'موضع الإشعار',
    ...
    'Only make editable for users who match the following rules:' => 'تمكين قابلية التعديل للمستخدمين الذين يطابقون القواعد التالية:',
    'Only make editable when editing {type} that match the following rules:' => 'اجعلها قابلة للتعديل فقط عند تعديل {type} الذي يطابق القواعد التالية:',
    ...
    'Open in Image Editor' => 'الفتح في محرر الصور',
    'Open in a new tab' => 'الفتح في علامة تبويب جديدة',
    'Open subnavigation' => 'فتح قائمة التنقل الفرعي',
    'Opens in a new window' => 'يفتح في نافذة جديدة',
    'Operator' => 'المشغل',
    'Optgroup?' => 'Optgroup؟',
    'Option Label' => 'تسمية الخيار',
    'Options' => 'خيارات',
    'Or use a password manager with built-in authentication support:' => 'أو استخدم مدير كلمات مرور مزوَّد بدعمٍ مدمج للمصادقة:',
    'Orange' => 'برتقالي',
    ...
    'Palette cannot be blank if custom colors aren’t allowed.' => 'لا يمكن ترك لوحة الألوان فارغة إذا كانت الألوان المُخصَّصة غير مسموح بها.',
    'Palette' => 'لوحة الألوان',
    'Parent {type} Title' => 'عنوان {type} الرئيسي',
    'Parent' => 'الأصل',
    'Parish' => 'حقل الاختصاص',
    'Partition' => 'قسم',
    'Passed with warning' => 'تم الاجتياز مع وجود تحذير',
    'Passed' => 'تم الاجتياز',
    'Passkey authentication failed.' => 'فشلت مصادقة مفتاح المرور.',
    'Passkey created.' => 'تم إنشاء مفتاح مرور.',
    'Passkey creation failed.' => 'فشل إنشاء مفتاح المرور.',
    'Passkey deleted.' => 'تم حذف مفتاح المرور.',
    'Passkeys are an easy and secure way to identify yourself, using your fingerprint or facial recognition.' => 'تُعد مفاتيح المرور طريقة سهلة وآمنة لتعريف نفسك باستخدام بصمة إصبعك أو ميزة التعرف على الوجه.',
    'Passkeys' => 'مفاتيح المرور',
    'Password & Verification' => 'كلمة المرور والتحقق',
    ...
    'Paste {type} above' => 'لصق {type} أعلاه',
    'Paste {type} before' => 'لصق {type} قبل',
    'Paste {type}' => 'نسخ {type}',
    ...
    'Plugin' => 'الملحق',
    'Plugins' => 'الملحقات',
    'Plus {renewalPrice}/year for updates after one year.' => 'بالإضافة إلى {renewalPrice}/العام لاستمرار التحديثات بعد عامٍ واحد.',
    'Popularity' => 'الانتشار',
    'Port' => 'المنفذ',
    'Portrait' => 'رأسي',
    'Position' => 'الموضع',
    'Post Date' => 'تاريخ النشر',
    'Post Town' => 'المدينة البريدية',
    ...
    'Primary' => 'أساسي',
    'Process complete' => 'اكتملت العملية',
    ...
    'Public Registration' => 'التسجيل العام',
    ...
    'Quality' => 'الجودة',
    'Query for assets in the “{name}” volume' => 'استعلام للأصول في وحدة التخزين "{name}"',
    'Query for categories in the “{name}” category group' => 'استعلام للفئات في مجموعة الفئات "{name}"',
    'Query for element drafts' => 'استعلام لمسودات العناصر',
    'Query for element revisions' => 'استعلام لمراجعات العناصر',
    'Query for elements in the “{site}” site' => 'استعلام للعناصر في الموقع "{site}"',
    'Query for entries in the “{name}” section' => 'استعلام للإدخالات في القسم "{name}"',
    'Query for entries in the “{name}” {type} field' => 'استعلام للإدخالات في الحقل {type} في "{name}"',
    'Query for non-enabled elements' => 'استعلام للعناصر غير الممكَّنة',
    'Query for tags in the “{name}” tag group' => 'استعلام للعلامات في مجموعة العلامات "{name}"',
    'Query for the “{name}” entry' => 'استعلام للإدخال "{name}"',
    'Query for the “{name}” global set' => 'استعلام للمجموعة العمومية "{name}"',
    'Query for users in the “{name}” user group' => 'استعلام للمستخدمين في مجموعة المستخدمين "{name}"',
    'Query for users' => 'استعلام للمستخدمين',
    'Query params (e.g. {ex1}) or a URI fragment (e.g. {ex2}) that should be appended to the URL.' => 'معلمات الاستعلام (مثل {ex1}) أو جزء من عنوان URI (مثل {ex2}) ينبغي إلحاقه بعنوان URL.',
    ...
    'Range…' => 'النطاق…',
    'Rating' => 'التقييم',
    'Rating: {rating} out of {max} stars' => 'التقييم: {rating} من {max} نجوم',
    ...
    'Reassign {numEntries, plural, =1{entry} other{entries}}' => 'إعادة تعيين {numEntries, plural, zero {} one {الإدخال} two {الإدخالين} few {الإدخالات} many {الإدخالات}=1{الإدخال} other{الإدخالات}}',
    ...
    'Related To' => 'متعلق بـ',
    'Related {type} Title' => 'عنوان {type} ذو الصلة',
    'Relation ({ex})' => 'الصلة ({ex})',
    ...
    'Remove page' => 'إزالة الصفحة',
    'Remove {label}' => 'إزالة {label}',
    'Remove {numRelations, plural, =1{relation} other{relations}}' => 'إزالة {numRelations, plural, zero {} one {العلاقات} two {العلاقتين} few {العلاقات} many {العلاقات}=1{العلاقة} other{العلاقات}}',
    'Remove {numUsers, plural, =1{author} other {authors}} from {numEntries, plural, =1{entry} other{entries}}' => 'إزالة {numUsers, plural, zero {} one {الكُتّاب} two {الكاتبين} few {الكُتّاب} many {الكُتّاب}=1{الكاتب} other {الكُتّاب}} من {numEntries, plural, zero {} one {الإدخال} two {الإدخالين} few {الإدخالات} many {الإدخالات}=1{الإدخال} other{الإدخالات}}',
    'Remove' => 'إزالة',
    ...
    'Replace {numRelations, plural, =1{relation} other{relations}}' => 'استبدال {numRelations, plural, zero {} one {العلاقات} two {العلاقتين} few {العلاقات} many {العلاقات}=1{العلاقة} other{العلاقات}}',
    'Replace' => 'الاستبدال',
    'Replacing {type} relations' => 'بجري استبدال علاقات {type}',
    ...
    'Require two-step verification' => 'طلب التحقق بخطوتين',
    'Required' => 'مطلوب',
    'Requirements' => 'المتطلبات',
    'Requires PHP {version}' => 'يتطلب إصدار PHP {version}',
    'Resaving {name} entries' => 'جارٍ إعادة حفظ إدخالات {name}',
    ...
    'Revision' => 'المراجعة',
    'Revisions for “{title}”' => 'المراجعات لـ "{title}"',
    'Revisions' => 'المراجعات',
    'Right Handle' => 'المؤشر الأيمن',
    'Right' => 'أيمن',
    'Rose' => 'زهري',
    ...
    'Save and send activation email' => 'الحفظ وإرسال رسالة التفعيل عبر البريد الإلكتروني',
    'Save as a new entry type' => 'الحفظ كنوع إدخال جديد',
    ...
    'Save entries in the “{section}” section' => 'حفظ الإدخالات في القسم "{section}"',
    'Save entries in the “{section}” {type} field' => 'حفظ الإدخالات في حقل {type} في قسم "{section}"',
    'Save entries to all sites enabled for this section' => 'حفظ الإدخالات على جميع المواقع الممكّنة لهذا القسم',
    'Save entries to all sites the owner element is saved in' => 'حفظ الإدخالات على جميع المواقع التي يتم حفظ عنصر المالك فيها',
    ...
    'Save the “{section}” entry' => 'حفظ إدخال القسم "{section}"',
    'Save {type}' => 'حفظ {type}',
    'Save' => 'حفظ',
    'Saved <time title="{timestampWithDate}">{timestamp}</time> by {creator}' => 'تم الحفظ في <time title="{timestampWithDate}">{timestamp}</time> بواسطة {creator}',
    'Saved <time title="{timestampWithDate}">{timestamp}</time>' => 'تم الحفظ <time title="{timestampWithDate}">{timestamp}</time>',
    ...
    'Section' => 'القسم',
    'Sections' => 'الأقسام',
    'Secure credential' => 'بيانات الاعتماد الآمنة',
    'Security' => 'الأمان',
    'See all' => 'عرض الكل',
    'See logs' => 'عرض السجلات',
    'Select All' => 'تحديد الكل',
    'Select Schema' => 'تحديد المُخطَّط',
    'Select a filesystem' => 'تحديد نظام ملفات',
    'Select a volume' => 'تحديد وحدة تخزين',
    'Select all' => 'تحديد الكل',
    'Select context' => 'تحديد السياق',
    'Select element' => 'تحديد العنصر',
    'Select section' => 'تحديد القسم',
    'Select site' => 'تحديد الموقع',
    'Select transform' => 'تحديد التحويل',
    'Select volume' => 'تحديد وحدة التخزين',
    'Select {element}' => 'تحديد {element}',
    'Select' => 'تحديد',
    'Selectable {type} Condition' => 'اختيار الحالة {type}',
    'Send activation email' => 'إرسال رسالة التنشيط',
    ...
    'Separate multiple values with spaces.' => 'قيم متعددة مفصولة بمسافات.',
    ...
    'Share' => 'مشاركة',
    'Should icons that are exclusive to Font Awesome Pro be selectable? (<a href="{url}">View pricing</a>)' => 'هل ينبغي أن تكون الأيقونات الحصرية لـ Font Awesome Pro قابلة للتحديد؟ (<a href="{url}">عرض الأسعار</a>)',
    ...
    'Should users who register their own accounts be deactivated by default? This will prevent them from receiving an activation email or logging in.' => 'هل يجب إلغاء تنشيط المستخدمين الذين يسجلون حساباتهم الخاصة بشكل افتراضي؟ سيمنعهم ذلك من تلقي بريد إلكتروني للتنشيط أو تسجيل الدخول.',
    'Show Currency' => 'إظهار العملة',
    'Show ON/OFF labels in cards' => 'إظهار تسميات تشغيل/إيقاف في البطاقات',
    ...
    'Show the “Label” field' => 'إظهار حقل "التسمية"',
    ...
    'Show unpermitted entries' => 'عرض الإدخالات غير المسموح بها',
    'Show unpermitted files' => 'عرض الملفات غير المسوح بها',
    'Show unpermitted sections' => 'عرض الأقسام غير المسموح بها',
    ...
    'Showing {first, number}-{last, number} of {total, number} {total, plural, =1{{item}} other{{items}}}' => 'يتم عرض {first, number}–{last, number} من {total, number} {total, plural, =1{{عنصر}} other{من {العناصر}}}',
    'Showing {total, number} {total, plural, =1{{item}} other{{items}}}' => 'يتم عرض {total, number} {total, plural, =1{{عنصر}} other{من {العناصر}}}',
    'Sign In' => 'تسجيل الدخول',
    'Sign back in to continue.' => 'سجِّل الدخول للمتابعة.',
    'Sign in as user' => 'تسجيل الدخول كمستخدم',
    'Sign in as {user}' => 'تسجيل الدخول باسم {user}',
    'Sign in unsuccessful' => 'فشل تسجيل الدخول',
    'Sign in with a passkey' => 'تسجيل الدخول باستخدام مفتاح مرور',
    'Sign in with {name}' => 'تسجيل الدخول باسم {name}',
    'Sign in' => 'تسجيل الدخول',
    ...
    'Singles' => 'الفرديات',
    'Site Group' => 'مجموع المواقع',
    'Site Icon' => 'أيقونة الموقع',
    'Site Name' => 'اسم الموقع',
    'Site Overrides' => 'تجاوز إعدادات الموقع',
    'Site Settings' => 'إعدادات الموقع',
    'Site saved.' => 'تم حفظ الموقع.',
    'Site' => 'الموقع',
    'Sites' => 'مواقع',
    'Size' => 'الحجم',
    'Skip to card view designer' => 'التخطي إلى مُصمِّم عرض البطاقات',
    'Skip to content' => 'التخطي إلى المحتوى',
    'Skip to footer' => 'التخطي إلى التذييل',
    'Skip to left sidebar' => 'التخطي إلى الشريط الجانبي',
    'Skip to main section' => 'التخطي إلى القسم الرئيسي',
    'Skip to right sidebar' => 'التخطي إلى الشريط الجانبي الأيمن',
    'Skip to top of preview' => 'التخطي إلى أعلى المعاينة',
    'Skip to {name}' => 'التخطي إلى {name}',
    'Sky' => 'سماوي',
    'Slideout Position' => 'موضع القائمة المنزلقة',
    'Slug' => 'الجزء المعرّف',
    'Some entries have been moved to the “{name}” section.' => 'تم نقل بعض الإدخالات إلى قسم "{name}".',
    ...
    'System time zone ({abbr})' => 'المنطقة الزمنية للنظام ({abbr})',
    'System' => 'النظام',
    ...
    'Target' => 'الهدف',
    'Teal' => 'تركوازي',
    'Team permissions can be managed from {link}.' => 'يمكن إدارة أذونات الفريق من {link}.',
    'Team permissions can be managed from {path} on a development environment.' => 'يمكن إدارة أذونات الفريق من {path} على بيئة تطوير.',
    'Temp files' => 'الملفات المؤقتة',
    'Template caches' => 'التخزينات المؤقتة للقوالب',
    'Template that defines the field’s custom “propagation key” format. Entries will be saved to all sites that produce the same key.' => 'قالب يحدِّد تنسيق "مفتاح النشر" المخصَّص للحقل. سيتم حفظ الإدخالات على جميع المواقع التي تُنشئ المفتاح نفسه.',
    'Template that defines the {name} field’s custom “translation key” format. Values will be copied to all sites that produce the same key.' => 'القالب الذي يحدِّد تنسيق "مفتاح الترجمة" المخصَّص للحقل {name}. سيتم نسخ القيم إلى جميع المواقع التي نُنشئ المفتاح نفسه.',
    'Template' => 'القالب',
    'Templates' => 'القوالب',
    ...
    'The `@web` alias is not recommended.' => 'لا يوصى بالاسم المستعار `@web`.',
    ...
    'The following content is for preview only.' => 'المحتوى التالي للمعاينة فقط.',
    'The following licensing {total, plural, =1{issue} other{issues}} can be resolved with a single purchase on Craft Console:' => 'يمكن حل {total, plural, zero {} one {مشكلة} two {مشكلتَي} few {مشاكل} many {مشاكل}=1{مشكلة} other{مشاكل}} الترخيص التالية بإجراء عملية شراء واحدة على Craft Console:',
    ...
    'The maximum number of authors that entries in this section can have.' => 'الحد الأقصى لعدد إدخالات المؤلفين المسموح بها في هذا القسم.',
    ...
    'The maximum number of levels this section can have.' => 'الحد الأقصى لعدد المستويات التي يمكن أن توجد في هذا القسم.',
    ...
    'The maximum number of {type} the field is allowed to have.' => 'الحد الأقصى لعدد {type} المسموح بها في الحقل.',
    'The minimum number of authors that entries in this section can have.' => 'الحد الأدنى لعدد إدخالات المؤلفين المسموح بها في هذا القسم.',
    ...
    'The minimum number of {type} the field is allowed to have.' => 'الحد الأدنى لعدد {type} المسموح بها في الحقل.',
    ...
    'The selected {relatedType} {count, plural, =1{contains} other{contain}} validation errors, preventing this {type} from being saved. Edit the {relatedType} to fix them.' => '{relatedType} {count, plural, zero {المُحدَّد} one {المُحدَّد} two {المُحدَّدان} few {المُحدَّدة} many {المُحدَّدة}=1{المُحدَّد} other{المُحدَّدة}} {count, plural, zero {يحتوي} one {يحتوي} two {يحتويان} few {تحتوي} many {تحتوي}=1{يحتوي} other{تحتوي}} على أخطاء في التحقُّق من الصحة، مما يحول دون حفظ {type} هذا. قُم بتعديل {relatedType} لإصلاحها.',
    'The server doesn’t meet Craft’s new requirements:' => 'الخادم لا يستوفي متطلبات Craft الجديدة.',
    'The subpath cannot overlap with any other volumes sharing the same filesystem.' => 'لا يمكن أن يتداخل المسار الفرعي مع أي وحدات تخزين أخرى تتشارك نظام الملفات نفسه.',
    ...
    'The text label for the entry creation button.' => 'التسمية النصية لزر إنشاء الإدخال.',
    'The text label for {type} selection buttons.' => 'التسمية النصية لأزرار تحديد {type}.',
    'The text that will be shown if the field doesn’t have a value.' => 'النص الذي سيتم إظهاره إذا لم يحتوي الحقل على أي قيمة.',
    'The total number of {type} to display per page within the element index.' => 'إجمالي عدد {type} للعرض في كل صفحة ضمن مؤشر العناصر.',
    ...
    'The {numEntries, plural, =1{entry} other {entries}} will be updated once the {numUsers, plural, =1{user is} other{users are}} deleted.' => 'سيتم تحديث {numEntries, plural, =1{الإدخال} other {الإدخالات}} بمجرد حذف {numUsers, plural, =1{المستخدم} other{المستخدمين}}.',
    'The {numRelations, plural, =1{relation} other {relations}} will be removed once the {numTargets, plural, =1{{targetTypeSingular} is} other{{targetTypePlural} are}} deleted.' => 'سيتم حذف {numRelations, plural, =1{العلاقة} other {العلاقات}} بمجرد حذف {numTargets, plural, =1{{targetTypeSingular}} other{{targetTypePlural}}}.',
    'The {numTargets, plural, =1{{targetTypeSingular} is} other{{targetTypePlural} are}} related by {numRelations, number} other {numRelations, plural, =1{{sourceTypeSingular}} other{{sourceTypePlural}}}.' => 'يرتبط {numTargets, plural, zero {} one {{targetTypePlural} } two {{targetTypePlural} } few {{targetTypePlural} } many {{targetTypePlural} }=1{{targetTypeSingular} } other{{targetTypePlural} }} بـ {numRelations, number} other {numRelations, plural, zero {} one {{sourceTypePlural}} two {{sourceTypePlural}} few {{sourceTypePlural}} many {{sourceTypePlural}}=1{{sourceTypeSingular}} other{{sourceTypePlural}}}.',
    'The {type} is invalid.' => '{type} غير صالح.',
    ...
    'There was a problem activating the user: {error}' => 'حدثت مشكلة في تنشيط المستخدم: {error}',
    ...
    'There was a problem indexing assets.' => 'حدثت مشكلة في فهرسة الأصول.',
    ...
    'This browser doesn’t support passkeys.' => 'هذا المتصفح لا يدعم مفاتيح المرور.',
    ...
    'This can be set to an environment variable with a valid language ID ({examples}).' => 'يمكن تعيين هذه القيمة على متغير بيئة ذي معرِّف لغة صالح ({examples}).',
    ...
    'This can be set to an environment variable, or a Twig template that outputs comma-separated IDs.' => 'يمكن تعيين هذا إلى متغير بيئة، أو قالب Twig يُنشئ مُعرِّفات مفصولة بفاصلة.',
    'This can begin with an environment variable or alias.' => 'يمكن أن يبدأ هذا بمتغير أو اسم مستعار لبيئة العمل.',
    'This can begin with an environment variable.' => 'يمكن أن يبدأ هذا بمتغير لبيئة العمل.',
    'This draft’s entry type is no longer available. You can still view it, but not apply it.' => 'لم يعُد نوع الإدخال في هذه المسودة متوفرًا. ما زال بإمكانك عرضها، ولكن لا يمكنك تطبيقها.',
    'This element is conditional' => 'هذا العنصر شرطي',
    'This entry type’s {attributes} {totalAttributes, plural, =1{has} other{have}} been overridden.' => 'تم تجاوز {attributes} {totalAttributes, plural, =1{} other{}} لهذا النوع من الإدخال.',
    'This field has a tip' => 'هناك تلميح لهذا الحقل',
    'This field has a warning' => 'هناك تحذير لهذا الحقل',
    ...
    'This field’s {attributes} {totalAttributes, plural, =1{has} other{have}} been overridden.' => 'تم تجاوز {attributes} لهذا الحقل.',
    'This filesystem has been reserved for temporary asset uploads. Please choose a different one for your volume.' => 'تم حجز نظام الملفات هذا لعمليات تحميل الأصول المؤقتة. يُرجى اختيار واحد آخر لوحدة التخزين الخاصة بك.',
    ...
    'This is a new {type}.' => 'هذا النوع "{type}" جديد.',
    ...
    'This plugin doesn’t have any reviews with comments.' => 'لا يملك هذا الملحق أي مراجعات تتضمَّن تعليقات.',
    'This plugin doesn’t have any reviews.' => 'لا يملك هذا الملحق أي مراجعات.',
    ...
    'This plugin requires Craft CMS {name} edition.' => 'يتطلب هذا الملحق إصدار {name} من Craft CMS.',
    ...
    'This revision’s entry type is no longer available. You can still view it, but not revert to it.' => 'لم يعُد نوع الإدخال في هذه المراجعة متوفرًا. ما زال بإمكانك عرضها، ولكن لا يمكنك الرجوع إليها.',
    ...
    'This {type} has been edited.' => 'تم تعديل هذا النوع "{type}".',
    'This {type} has been updated.' => 'تم تحديث هذا النوع {type}.',
    'Thumbnail Alignment' => 'محاذاة الصورة المُصغَّرة',
    'Thumbnail Source' => 'مصدر الصورة المُصغَّرة',
    'Thumbs' => 'صور مصغرة',
    ...
    'To' => 'حتى',
    'Today' => 'اليوم',
    'Toggle details sidebar' => 'تبديل الشريط الجانبي للتفاصيل',
    'Toggle explorer' => 'تشغيل المستكشف',
    'Toggle history' => 'تشغيل السجل',
    'Toggle sidebar' => 'تبديل الشريط الجانبي',
    'Tokens' => 'رموز مميزة',
    'Top Handle' => 'المؤشر العلوي',
    'Top-Center' => 'المنتصف الأعلى',
    'Top-Left Handle' => 'المؤشر العلوي الأيسر',
    'Top-Left' => 'أعلى لليسار',
    'Top-Right Handle' => 'المؤشر العلوي الأيمن',
    ...
    'Try another way' => 'تجربة طريقة أخرى',
    ...
    'Two-Step Verification Setup' => 'إعداد التحقق بخطوتين',
    'Two-Step Verification' => 'التحقق بخطوتين',
    'Type' => 'النوع',
    'UI Elements' => 'عناصر واجهة المستخدم',
    'UI Label Format' => 'تنسيق تسمية واجهة المستخدم',
    'UI Mode' => 'وضع واجهة المستخدم',
    'UID' => 'المعرّف العالمي',
    'URI Format' => 'تنسيق عنوان URI',
    'URI' => 'معرف URI',
    'URL Format' => 'تنسيق عنوان URL',
    'URL Suffix' => 'لاحقة عنوان URL',
    'URL only' => 'URL فقط',
    'URL type' => 'نوع URL',
    'URL' => 'عنوان URL',
    'Unable to fetch updates at this time.' => 'يتعذَّر إحضار التحديثات في الوقت الحالي.',
    ...
    'Unable to initiate an auth request.' => 'يتعذَّر بدء طلب مصادقة.',
    'Unauthorized' => 'غير مخول',
    'Uncheck for {offLabel}.' => 'عدم وضع علامة على {offLabel}.',
    'Unconstrained' => 'غير مقيَّد',
    ...
    'Use an authenticator app to verify your identity.' => 'استخدم تطبيق مصادقة للتحقق من هويتك.',
    ...
    'Use the arrow keys to change position, Tab or Spacebar to drop.' => 'استخدم مفاتيح الأسهم لتغيير الموضع. اضغط على زر Tab أو مفتاح المسافة للإسقاط.',
    ...
    'User Photos' => 'صور المستخدمين',
    'User Profile Fields' => 'حقول الملفات التعريفية للمستخدمين',
    'User Settings' => 'إعدادات المستخدمين',
    'User fields saved.' => 'تم حفظ حقول المستخدم.',
    'User group settings' => 'إعدادات مجموعات المستخدمين',
    ...
    'Validate {type}' => 'التحقُّق من صحة {type}',
    'Validation errors for site: “{siteName}“' => 'أخطاء التحقق من الصحة للموقع: "{siteName}"',
    'Validation errors found in {count, plural, =1{one address} other{{count, spellout} addresses}} within the *{fieldName}* field; please fix them.' => 'تم العثور على أخطاء في التحقق من صحة {count, plural, =1{عنوان واحد} other{{count, spellout} من العناوين}} في الحقل *{fieldName}*؛ يُرجى إصلاحها.',
    ...
    'Verify with an authentication code.' => 'قم بالتحقق باستخدام رمز مصادقة.',
    'Verify your email address' => 'التحقُّق من عنوان بريدك الإلكتروني',
    'Verify' => 'التحقق',
    ...
    'View in a new tab' => 'العرض في علامة تبويب جديدة',
    'View mode options' => 'خيارات وضع العرض',
    ...
    'Violet' => 'بنفسجي',
    'Visibility Conditions' => 'شروط قابلية الرؤية',
    ...
    'Volume settings' => 'إعدادات مستوى الصوت',
    'Volume' => 'وحدة التخزين',
    ...
    'What auto-generated entry titles should look like. You can include tags that output entry properties, such as {ex}.' => 'كيف ينبغي أن تبدو عناوين الإدخال التي تم إنشاؤها تلقائيًا. يمكنك تضمين العلامات التي تُخرِج خصائص الإدخال، مثل {ex}.',
    ...
    'Where assets should be stored on the filesystem.' => 'أين ينبغي تخزين الأصول في نظام الملفات.',
    ...
    'Where new {type} should be placed by default in the field.' => 'حيث يجب وضع {type} الجديد بشكلٍ افتراضي في الحقل.',
    ...
    'Whether buttons should only show their icons, hiding their text labels.' => 'ما إذا كانت الأزرار يجب أن تعرض أيقوناتها فقط وتخفي التسميات النصية.',
    'Whether card views which include this field should show the custom ON/OFF labels, rather than the field name.' => 'ما إذا كان ينبغي أن تعرض طرق عرض البطاقات التي تتضمن هذا الحقل تسميات تشغيل/إيقاف مخصصة، بدلاً من اسم الحقل.',
    ...
    'Whether the element index should allow viewing nested {type} in a table.' => 'ما إذا كان ينبغي لمؤشر العناصر السماح بعرض {type} المتداخلة في جدول.',
    ...
    'Whether the table rows should be restricted to those defined by the “Default Values” setting.' => 'ما إذا كان ينبغي تقييد صفوف الجدول إلى تلك التي يحددها إعداد "القيم الافتراضية".',
    ...
    'Whether to show entries that the user doesn’t have permission to view, per the “View other users’ entries” permission.' => 'ما إذا كان سيتم عرض الإدخالات التي لا يملك المستخدم إذنًا بعرضها، وفقًا لإذن "عرض إدخالات المستخدمين الآخرين".',
    ...
    'Whether to show sections that the user doesn’t have permission to view.' => 'ما إذا كان سيتم عرض الأقسام التي لا يملك المستخدم إذنًا بعرضها.',
    ...
    'Which sites should entries be saved to?' => 'ما المواقع التي ينبغي حفظ الإدخالات عليها؟',
    ...
    'Widget Title' => 'عنوان عنصر الواجهة',
    'Widget saved.' => 'تم حفظ عنصر الواجهة.',
    'Widget settings' => 'إعدادات الأداة',
    'Width unit' => 'وحدة العرض',
    'Width' => 'العرض',
    'Within the app, create a new time-based one-time password (TOTP) for this site. Scan the **QR code** or enter the **setup key** below when prompted.' => 'أنشئ كلمة مرور لمرة واحدة خلال وقت محدد (TOTP) جديدة لهذا الموقع. امسح **رمز QR** ضوئيًا أو أدخل **مفتاح الإعداد** أدناه عندما يُطلب منك ذلك.',
    'Years' => 'سنوات',
    'Yellow' => 'أصفر',
    'Yes' => 'نعم',
    'Yesterday' => 'أمس',
    ...
    'You must reverify your identity before proceeding.' => 'يجب عليك إعادة التحقق من هويتك قبل المتابعة.',
    ...
    'You need to reset your password.' => 'أنت بحاجة إلى إعادة تعيين كلمة مرورك.',
    ...
    'Your account requires two-step verification. Please enable one of these methods before proceeding.' => 'يتطلب حسابك التحقق بخطوتين. يُرجى تمكين إحدى هذه الطرق قبل المتابعة.',
    ...
    'You’re not permitted to edit any of this section’s sites.' => 'غير مسموح لك بتعديل أيٍ من مواقع هذا القسم.',
    'You’re viewing a revision. None of the {type}’s fields are editable.' => 'أنت تعرض مراجعة. لا يمكن تعديل أيٍّ من حقول {type}.',
    'Zip Code' => 'الرمز البريدي',
    '`sectionId` and `fieldId` cannot both be set on an entry.' => 'لا يمكن تعيين sectionId` و`fieldId` كليهما على أحد الإدخالات.',
    ...
    'address' => 'العنوان',
    'addresses' => 'العناوين',
    'all platforms and browsers' => 'كل المنصات والمتصفحات',
    'and' => 'و',
    'asset' => 'الأصل',
    'assets' => 'الأصول',
    'at {time}' => 'في {time}',
    ...
    'on {day}' => 'بتاريخ {day}',
    'one' => 'واحد',
    'or <a href="{url}">try before buying</a>' => 'or <a href="{url}">جرِّب قبل الشراء</a>',
    ...
    '{attribute} must be between {min} and {max}.' => '{attribute} يجب أن يكون بين {min} و{max}.',
    ...
    '{attribute} must be valid JSON.' => 'يجب أن تكون السمة {attribute} عنصر JSON صالحًا.',
    ...
    '{attribute} should contain at least {min, number} {min, plural, one{entry} other{entries}}.' => 'ينبغي أن تحتوي {attribute} على الأقل على {min, number} {min, plural, one{إدخال} other{من الإدخالات}}.',
    ...
    '{attribute} should contain at most {max, number} {max, plural, one{address} other{addresses}}.' => 'ينبغي أن تحتوي {attribute} على الأكثر على {max, number} {max, plural, one{عنوان} other{من العناوين}}.',
    '{attribute} should contain at most {max, number} {max, plural, one{entry} other{entries}}.' => 'ينبغي أن تحتوي {attribute} على الأكثر على {max, number} {max, plural, one{إدخال} other{من الإدخالات}}.',
    ...
    '{count, number} {count, plural, =1{layout} other{layouts}}' => '{count, plural, =1{مخطط واحد} other{{count, number} من المخططات}}',
    ...
    '{name} active, more info' => '{name} نشط، المزيد من المعلومات',
    '{name} added successfully.' => 'تمت إضافة {name} بنجاح.',
    ...
    '{name} is licensed for the {licenseEdition} edition, but the {currentEdition} edition is installed.' => '{name} مرخَّص لإصدار {licenseEdition}، لكن إصدار {currentEdition} هو الإصدار المثبَّت.',
    ...
    '{name} sorted by {attribute}, {direction}' => 'تم ترتيب {name} حسب {attribute}، {direction}',
    '{name} suggestions collapsed' => '{name} suggestions collapsed',
    '{nestedType} can only be created after the {ownerType} has been saved.' => 'لا يمكن إنشاء {nestedType} إلا بعد حفظ {ownerType}.',
    ...
    '{num, number} {num, plural, =1{result} other{results}}' => '{num, plural, =1{نتيجة واحدة} other{{num, number} من النتائج}}',
    ...
    '{num, number} {num, plural, =1{year} other{years}} of updates' => 'تحديثات لمدة {num, number} {num, plural, =1{عام} other{من الأعوام}}',
    ...
    '{num, plural, =1{Only one author is} other{Up to {num, number} authors are}} allowed.' => 'مسموح بعدد {num, plural, zero {0 مؤلف} one {مؤلف واحد فقط} two {يصل إلى مؤلفَين} few {يصل إلى {num, number} مؤلفين} many {يصل إلى {num, number} مؤلفًا} =1{مؤلف واحد فقط} other{يصل إلى {num, number} من المؤلفين}}.',
    '{numEntries, number} {numEntries, plural, =1{entry has} other{entries have}} the {numUsers, plural, =1{user} other{users}} assigned as an author.' => 'تم تعيين {numUsers, plural, zero {} one {مستخدمين} two {مستخدمين} few {مستخدمين} many {مستخدمين}=1{مستخدم} other{مستخدمين}} كمؤلف في {numEntries, number} {numEntries, plural, zero {} one {إدخالات} two {إدخالين} few {إدخالات} many {إدخالات}=1{إدخالات} other{إدخالات}}.',
    '{numRelations, plural, =1{Relation} other{Relations}} queued to be replaced.' => '{numRelations, plural, zero {} one {علاقات} two {علاقتان} few {علاقات} many {علاقات}=1{علاقة} other{علاقات}} في قائمة الانتظار للاستبدال.',
    '{num} percent complete' => 'اكتملت بنسبة {num}',
    '{pct} width' => 'عرض {pct}',
    '{plugin} requires Craft CMS {edition} edition.' => 'يتطلب {plugin} الإصدار {edition} من Craft CMS.',
    '{step, number} of {total, number}' => '{step, number} من {total, number}',
    '{title} ({site})' => '{title} ({site})',
    '{total, number} {total, plural, =1{error} other{errors}} found in {num, number} {num, plural, =1{tab} other{tabs}}.' => 'تم العثور على {total, number} {total, plural, =1{خطأ} other{من الأخطاء}} في {num, number} {num, plural, =1{علامة تبويب} other{من علامات التبويب}}.',
    ...
    '{total, number} {type} copied.' => 'تم نسخ {total, number} من {type}.',
    '{total, number} {type} {total, plural, =1{field layout} other{field layouts}}' => '{total, number} {total, plural, zero {مخطط حقول} one {مخطط حقول} two {مخططا حقول} few {مخططات حقول} many {مخططات حقول}=1{مخطط حقول} other{مخططات حقول}} لإدخالات {type}',
    ...
    '{totalReviews, plural, =1{# Review} other{# Reviews}}' => '{totalReviews, plural, =1{مراجعة واحدة} other{# من المراجعات}}',
    '{total} jobs' => '{total} المهام',
    '{total} updates available!' => '{total} تحديثات متاحة!',
    '{type} Condition' => 'حالة {type}',
    '{type} Criteria' => 'معايير {type}',
    '{type} ID' => 'معرف {type}',
    '{type} ID(s)' => 'مُعرِّف/مُعرِّفات {type}',
    '{type} Per Page' => '{type} في كل صفحة',
    '{type} Settings' => 'إعدادات {type}',
    '{type} Sources' => 'موارد {type}',
    '{type} copied.' => 'تم نسخ {type}.',
    ...
    '{type} entries are no longer allowed in this field. Please choose a different entry type.' => 'لم تعُد إدخالات {type} مسموح بها في هذا الحقل. يُرجى اختيار نوع إدخال مختلف.',
    ...
    '{type} reassigned.' => 'تم إعادة تعيين {type}.',
    '{type} restored.' => 'تمت استعادة {type}.',
    '{type} reverted to past revision.' => 'تمت إعادة {type} إلى النسخة السابقة.',
    '{type} saved.' => 'تم حفظ {type}.',
    '{type} validation failed.' => 'فشل التحقُّق من صحة {type}.',
    '{type} validation successful.' => 'نجح التحقُّق من صحة {type}.',
    '{type} will be saved across all sites in the {group} site group.' => 'سيتم حفظ {type} عبر جميع المواقع في مجموعة المواقع {group}.',
    '{type} will be saved across all {language}-language sites.' => 'سيتم حفظ {type} عبر جميع مواقع اللغة {language}.',
    '{type} will only be saved in the {site} site.' => 'سيتم حفظ {type} في موقع {site} فقط.',
    '{user} is editing a draft of this {type}.' => 'المستخدم {user} يحرر مسودة من هذا النوع {type}.',
    '{user} is editing this {type}.' => 'المستخدم {user} يحرر هذا النوع {type}.',
    '{user} is viewing a draft of this {type}.' => 'المستخدم {user} يعرض مسودة من هذا النوع {type}.',
    '{user} is viewing this {type}.' => 'المستخدم {user} يعرض هذا النوع {type}.',

...
`,w=Object.defineProperty,T=Object.getOwnPropertyDescriptor,E=Object.getOwnPropertySymbols,D=Object.prototype.hasOwnProperty,O=Object.prototype.propertyIsEnumerable,k=e=>{throw TypeError(e)},A=(e,t,n)=>t in e?w(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,j=(e,t)=>{for(var n in t||={})D.call(t,n)&&A(e,n,t[n]);if(E)for(var n of E(t))O.call(t,n)&&A(e,n,t[n]);return e},M=(e,t,n,r)=>{for(var i=r>1?void 0:r?T(t,n):t,a=e.length-1,o;a>=0;a--)(o=e[a])&&(i=(r?o(t,n,i):o(i))||i);return r&&i&&w(t,n,i),i},N=(e,t,n)=>t.has(e)||k(`Cannot `+n),P=(e,t,n)=>(N(e,t,`read from private field`),n?n.call(e):t.get(e)),F=(e,t,n)=>t.has(e)?k(`Cannot add the same private member more than once`):t instanceof WeakSet?t.add(e):t.set(e,n),I=(e,t,n,r)=>(N(e,t,`write to private field`),r?r.call(e,n):t.set(e,n),n),L,R=class extends a{constructor(){super(),F(this,L,!1),this.initialReflectedProperties=new Map,Object.entries(this.constructor.dependencies).forEach(([e,t])=>{this.constructor.define(e,t)})}emit(e,t){let n=new CustomEvent(e,j({bubbles:!0,cancelable:!1,composed:!0,detail:{}},t));return this.dispatchEvent(n),n}static define(e,t=this,n={}){let r=customElements.get(e);if(!r){try{customElements.define(e,t,n)}catch{customElements.define(e,class extends t{},n)}return}let i=` (unknown version)`,a=i;`version`in t&&t.version&&(i=` v`+t.version),`version`in r&&r.version&&(a=` v`+r.version),!(i&&a&&i===a)&&console.warn(`Attempted to register <${e}>${i}, but <${e}>${a} has already been registered.`)}attributeChangedCallback(e,t,n){P(this,L)||(this.constructor.elementProperties.forEach((e,t)=>{e.reflect&&this[t]!=null&&this.initialReflectedProperties.set(t,this[t])}),I(this,L,!0)),super.attributeChangedCallback(e,t,n)}willUpdate(e){super.willUpdate(e),this.initialReflectedProperties.forEach((t,n)=>{e.has(n)&&this[n]==null&&(this[n]=t)})}};L=new WeakMap,R.version=`2.20.1`,R.dependencies={},M([o()],R.prototype,`dir`,2),M([o()],R.prototype,`lang`,2);var z=class extends R{render(){return t` <slot></slot> `}};z.styles=[C,S],z.define(`sl-visually-hidden`);var B={};function V(e){let t=1,n,r,i=[...e];if((n=r=i.indexOf(`{`))===-1)return[e];let a=[i.slice(0,r).join(``)];for(;;){let e=i.indexOf(`{`,r+1),o=i.indexOf(`}`,r+1);if(e===-1&&o===-1||(e===-1&&(e=i.length),o!==-1&&o>e?(t++,r=e):o!==-1&&(t--,r=o),t===0&&(a.push(i.slice(n+1,r).join(``).split(`,`,3)),n=r+1,a.push(i.slice(n,e===-1?i.length:e).join(``)),n=e===-1?i.length:e),t!==0&&(e===-1||o===-1)))break}return t===0?a:!1}function H(e,t={}){let n=e[0]?.trim();if(!n||t[n]===void 0)return`{${e.join(`,`)}}`;let r=t[n],i=e[1]===void 0?`none`:e[1].trim();switch(i){case`number`:return(()=>{let t=e[2]===void 0?null:e[2].trim();if(t!==null&&t!==`integer`)throw`Message format 'number' is only supported for integer values.`;let n=_(r),i;return t===null&&(i=`${r}`.indexOf(`.`))!==-1&&(n+=`.${r.substring(i+1)}`),n})();case`none`:return r;case`select`:return(()=>{if(e[2]===void 0)return!1;let n=V(e[2]);if(n===!1)return!1;let i=n.length,a=!1;for(let e=0;e+1<i;e++){if(Array.isArray(n[e])||!Array.isArray(n[e+1]))return!1;let t=n[e++].trim();(a===!1&&t===`other`||t==r)&&(a=n[e].join(`,`))}return a===!1?!1:U(a,t)})();case`plural`:return(()=>{if(e[2]===void 0)return!1;let n=V(e[2]);if(n===!1)return!1;let i=n.length,a=!1,o=0;for(let e=0;e+1<i;e++){if(typeof n[e]==`object`||typeof n[e+1]!=`object`)return!1;let t=n[e++].trim(),i=[...t];if(e===1&&t.substring(0,7)===`offset:`){let e=[...t.replace(/[\n\r\t]/g,` `)].indexOf(` `,7);if(e===-1)throw Error(`Message pattern is invalid.`);o=parseInt(i.slice(7,e).join(``).trim()),t=i.slice(e+1,e+1+i.length).join(``).trim()}if(a===!1&&t===`other`||t[0]===`=`&&parseInt(i.slice(1,1+i.length).join(``))===r||t===`one`&&r-o===1){let t=n[e];a=(typeof t==`string`?[t]:t).map(e=>e.replace(`#`,String(r-o))).join(`,`)}}return a===!1?!1:U(a,t)})();default:throw Error(`Message format '${i}' is not supported.`)}}function U(e,t){let n;if((n=V(e))===!1)throw Error(`Message pattern is invalid.`);for(let e=0;e<n.length;e++){let r=n[e];if(typeof r==`object`){let i=H(r,t);if(i===!1)throw Error(`Message pattern is invalid.`);n[e]=String(i)}}return n.join(``)}function W(e){B=e}function G(e,t,n=`app`,r=B){if(r&&r[n]!==void 0&&r[n][e]!==void 0){let t=r?.[n]?.[e];t!==void 0&&(e=t)}return t?U(e,t):e}var K=n`
  .badge-indicator {
...
`,Q=class extends a{constructor(){super(),this.active=!1,this.external=!1,this.indicator=!1,this.iconOnly=!1,this.flush=!1,this.subnavState=`closed`,this.id=this.id||Math.random().toString(36).substring(2,6)}connectedCallback(){super.connectedCallback(),this.subnavState=this.active?`open`:`closed`}toggleSubnav(e){e.preventDefault(),e.stopPropagation(),this.subnavState=this.subnavState===`open`?`closed`:`open`}renderIconItem(e){let n=`item-${this.id}`;return t`
      <a
    ...
    `}};Q.styles=Z,e([o()],Q.prototype,`icon`,void 0),e([o()],Q.prototype,`href`,void 0),e([o({type:Boolean,reflect:!0})],Q.prototype,`active`,void 0),e([o({type:Boolean})],Q.prototype,`external`,void 0),e([o({type:Boolean})],Q.prototype,`indicator`,void 0),e([o()],Q.prototype,`id`,void 0),e([o({reflect:!0,type:Boolean,attribute:`icon-only`})],Q.prototype,`iconOnly`,void 0),e([o()],Q.prototype,`flush`,void 0),e([s()],Q.prototype,`subnavState`,void 0),customElements.get(`craft-nav-item`)||customElements.define(`craft-nav-item`,Q);export{x as a,v as c,G as i,X as n,y as o,W as r,b as s,Q as t};
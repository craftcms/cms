...
`,N=class extends r{constructor(t){if(super(t),this.it=u,t.type!==e.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===u||e==null)return this._t=void 0,this.it=e;if(e===l)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};N.directiveName=`unsafeHTML`,N.resultType=1;var P=n(N),F=class extends a{static{this.METHOD=`totp`}get endpoint(){return`auth/verify-totp`}renderInput(){return s`
    ...
    `}};g([f({type:Boolean,attribute:`use-email-as-username`})],R.prototype,`useEmailAsUsername`,void 0),g([f()],R.prototype,`username`,void 0),g([p()],R.prototype,`_busy`,void 0),g([p()],R.prototype,`_error`,void 0),g([p()],R.prototype,`_validateOnInput`,void 0),g([m(`.reset-username`)],R.prototype,`_input`,void 0),customElements.get(`craft-login-reset-password`)||customElements.define(`craft-login-reset-password`,R);var z=class extends d{constructor(...e){super(...e),this.showPasskeyBtn=!0,this.showResetPassword=!1,this.showRememberMe=!1,this.username=``,this.staticEmail=``,this.useEmailAsUsername=!1,this.minPasswordLength=6,this.maxPasswordLength=160,this.rememberMeLabel=``,this.initialError=``,this.action=``,this._view=`login`,this._error=``,this._loginBusy=!1,this._passkeyBusy=!1,this._canUsePasskey=!1,this._validateOnInput=!1,this._twoFactorData=null,this._resetUsername=``}static{this.styles=[o,M]}async connectedCallback(){super.connectedCallback(),this.initialError&&(this._error=this.initialError),this.showPasskeyBtn&&y()&&(this._canUsePasskey=await j())}#e(){return this.useEmailAsUsername?t(`Email`):t(`Username or Email`)}#t(){let e=this._usernameInput?.value??``;if(e.length===0)return this.useEmailAsUsername?t(`Invalid email.`):t(`Invalid username or email.`);if(this.useEmailAsUsername&&!e.match(/.+@.+\..+/))return t(`Invalid email.`);let n=this._passwordInput?.value.length??0;return n<this.minPasswordLength?t(`{attribute} should contain at least {min, number} {min, plural, one{character} other{characters}}.`,{attribute:t(`Password`),min:this.minPasswordLength},`yii`):n>this.maxPasswordLength?t(`{attribute} should contain at most {max, number} {max, plural, one{character} other{characters}}.`,{attribute:t(`Password`),max:this.maxPasswordLength},`yii`):!0}#n(){this._validateOnInput&&this.#t()===!0&&(this._error=``)}async#r(e){e.preventDefault();let n=this.#t();if(n!==!0){this.#l(n),this._validateOnInput=!0;return}this._error=``,this._loginBusy=!0;try{let e=await fetch(this.action,{method:`post`,headers:{Accept:`application/json`,"Content-Type":`application/json`},body:JSON.stringify({loginName:this._usernameInput.value,password:this._passwordInput.value,rememberMe:this._rememberMeInput?.checked?`1`:``})});if(!e.ok)throw Error(`Something went wrong.`);let t=await e.json();t.authMethod?(this._twoFactorData=t,this._view=`challenge`,this._loginBusy=!1):(this.#u(t.returnUrl),this._loginBusy=!1)}catch(e){console.log(e),this._loginBusy=!1,this.#l(e?.response?.data?.message??t(`A server error occurred.`))}}async#i(){if(!this._passkeyBusy){this._error=``,this._passkeyBusy=!0;try{let{data:e}=await i.post(`auth/passkey-request-options`),t=await A({optionsJSON:JSON.parse(e.options)}),{data:n}=await i.post(`users/login-with-passkey`,{requestOptions:e.options,authResponse:JSON.stringify(t)});this.#u(n.returnUrl),this._passkeyBusy=!1}catch(e){this._passkeyBusy=!1;let t=e?.response?.data?.message;t?this.#l(t):console.warn(e)}}}#a(){this._error=``,this._resetUsername=this._usernameInput?.value??``,this._view=`reset-password`}#o(e){let t=e.detail?.username??``;this._view=`login`,this.updateComplete.then(()=>{t&&this._usernameInput&&(this._usernameInput.value=t),this._usernameInput?.focus()})}#s(e){this.#u(e.detail.returnUrl)}#c(e){let t=e.detail.message,n=new CustomEvent(`craft:login:error`,{bubbles:!0,composed:!0,cancelable:!0,detail:{message:t}});this.dispatchEvent(n),n.defaultPrevented||this.#l(t)}#l(e){this._error=e.trim();let t=this.shadowRoot?.querySelector(`.cp-visually-hidden[role="status"]`);t&&(t.textContent=e)}#u(e){let t=new CustomEvent(`craft:login:success`,{bubbles:!0,composed:!0,cancelable:!0,detail:{returnUrl:e}});this.dispatchEvent(t),t.defaultPrevented||(window.location.href=e)}render(){return s`
      <div>
        ...
        ${this._view===`login`?this.#d():this._view===`reset-password`?s`
    ...
    `}#d(){let e=this._canUsePasskey||this.querySelector(`[slot="alternative-methods"]`);return s`
      <craft-pane>
        <form
          class="login-form"
          method="post"

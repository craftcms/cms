import{f as e}from"./cp-jJ3_BvRA.js";import{c as t,f as n,r,t as i}from"./lit-BpPOIUnZ.js";import{a,o}from"./decorators-BOwDFZC2.js";import{t as s}from"./decorate-Br3QM-yM.js";var c={Pending:1,Reserved:2,Done:3,Failed:4,Delayed:5,Cancelled:6},l=class extends i{constructor(...t){super(...t),this.displayedJob=null,this.hasReservedJobs=!1,this.hasWaitingJobs=!1,this.#e=e.getInstance(),this.#t=e=>{this.displayedJob=e.detail.displayedJob}}static{this.styles=n`
    :host {
      display: contents;
    }

...
`,M=class extends r{constructor(e){if(super(e),this.it=u,e.type!==o.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===u||e==null)return this._t=void 0,this.it=e;if(e===l)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};M.directiveName=`unsafeHTML`,M.resultType=1;var N=i(M),P=class extends t{static{this.METHOD=`totp`}get endpoint(){return`auth/verify-totp`}renderInput(){return s`
      <craft-input
        ...
        aria-required="true"
      ></craft-input>
    `}};h([m(`craft-input.totp-code`)],P.prototype,`_input`,void 0),t.register(`craft-totp-form`,P);var F=class extends t{static{this.METHOD=`recovery-codes`}get endpoint(){return`auth/verify-recovery-code`}renderInput(){return s`
      <craft-input

import {l as e} from './_plugin-vue_export-helper-g2tzphu6.js';
function t(e, t) {
  let n = new URL(e),
    r = t.startsWith(`/`) ? t.slice(1) : t;
  return ((n.pathname = `${n.pathname}/${r}`), n.toString());
}
function n() {
  let e = r();
  return {
    getActionUrl(n) {
      return t(e.actionUrl, n);
    },
    getCpUrl(t) {
      return `${e.cpUrl}${t}`;
    },
    getApiUrl(n) {
      return t(e.baseApiUrl, n);
    },
  };
}
function r() {
  ...
  return new Proxy(
    ...
    {
      get(e, n) {
        return t.props.craft?.[n];
      },
    }
  );
}
var i = () => ({}),
  a = (e) => (e === !0 ? `1` : e === !1 ? `0` : e.toString()),
  o = (e, t, n) => {
    Object.entries(e).forEach(([e, r]) => {
      if (r === void 0) return;
      let i = `${t}[${e}]`;
      Array.isArray(r)
        ? r.forEach((e) => n.append(`${i}[]`, a(e)))
        : typeof r == `object` && r
          ? o(r, i, n)
...
export {n as a, r as i, c as n, u as r, l as t};

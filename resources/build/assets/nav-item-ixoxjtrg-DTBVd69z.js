...
`,J=class extends i{constructor(){super(),this.altText=null,this.badgeCount=null,this.badgeCountSuffix=null,this.variant=`primary`,this.id=this.id||`badge-${Math.floor(Math.random()*1e9).toString()}`}showCount(){return this.badgeCount!==null&&this.badgeCount>0}truncatedNumber(){if(this.showCount)return this.badgeCount>99?`99+`:this.badgeCount.toString()}getBadgeRole(){return this.altText?`img`:r}getLabelId(){return`${this.id}-label`}renderBadgeContents(){return e`
    ...
    `}render(){return e`
      <div
        part="badge"
        id=${this.id}
        class="${O({"badge-indicator":!0,"badge-indicator--with-number":this.showCount(),"badge-indicator--secondary":this.variant===`secondary`,"badge-indicator--inverse":this.variant===`inverse`})}"
        role="${this.getBadgeRole()}"
        aria-labelledby="${this.altText?this.getLabelId():r}"
      >
        ${this.renderBadgeContents()}
      </div>
    `}};J.styles=[q],w([a()],J.prototype,`altText`,void 0),w([a()],J.prototype,`badgeCount`,void 0),w([a()],J.prototype,`badgeCountSuffix`,void 0),w([a()],J.prototype,`variant`,void 0),w([a()],J.prototype,`id`,void 0),customElements.get(`craft-badge-indicator`)||customElements.define(`craft-badge-indicator`,J);var Y=`important`,X=` !`+Y,Z=E(class extends D{constructor(e){if(super(e),e.type!==T.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`}),``)}update(e,[t]){let{style:r}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?r.removeProperty(e):r[e]=null);for(let e in t){let n=t[e];if(n!=null){this.ft.add(e);let t=typeof n==`string`&&n.endsWith(X);e.includes(`-`)||t?r.setProperty(e,t?n.slice(0,-11):n,t?Y:``):r[e]=n}}return n}}),Q=t`
  :host {
...
`,$=class extends i{constructor(){super(),this.active=!1,this.external=!1,this.indicator=!1,this.iconOnly=!1,this.flush=!1,this.subnavState=`closed`,this.id=this.id||Math.random().toString(36).substring(2,6)}connectedCallback(){super.connectedCallback(),this.subnavState=this.active?`open`:`closed`}toggleSubnav(e){e.preventDefault(),e.stopPropagation(),this.subnavState=this.subnavState===`open`?`closed`:`open`}renderIconItem(t){let n=`item-${this.id}`;return e`
      <a
    ...
    `}renderItem(t,n=!1){return e`
      <a
        class="${O({"nav-item":!0,"nav-item--prefixed":n,"nav-item--flush":this.flush})}"
        href="${this.href}"
        aria-current="${this.active?`page`:!1}"
      >
    ...
    `}};$.styles=Q,w([a()],$.prototype,`icon`,void 0),w([a()],$.prototype,`href`,void 0),w([a({type:Boolean,reflect:!0})],$.prototype,`active`,void 0),w([a({type:Boolean})],$.prototype,`external`,void 0),w([a({type:Boolean})],$.prototype,`indicator`,void 0),w([a()],$.prototype,`id`,void 0),w([a({reflect:!0,type:Boolean,attribute:`icon-only`})],$.prototype,`iconOnly`,void 0),w([a()],$.prototype,`flush`,void 0),w([o()],$.prototype,`subnavState`,void 0),customElements.get(`craft-nav-item`)||customElements.define(`craft-nav-item`,$);export{D as a,S as c,m as d,E as i,C as l,Z as n,T as o,O as r,w as s,$ as t,p as u};
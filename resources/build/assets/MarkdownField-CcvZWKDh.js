...
`)}function ee(e,t={},n={}){return{...e,colors:{...e.colors,...t},previewColors:{...e.previewColors,...n}}}function te(e={}){let{fontSize:t=`14px`,lineHeight:n=1.6,fontFamily:r=`"SF Mono", SFMono-Regular, Menlo, Monaco, "Cascadia Code", Consolas, "Roboto Mono", "Noto Sans Mono", "Droid Sans Mono", "Ubuntu Mono", "DejaVu Sans Mono", "Liberation Mono", "Courier New", Courier, monospace`,padding:i=`20px`,theme:a=null,mobile:o={}}=e,s=Object.keys(o).length>0?`
  ...
  `:``,c=a&&a.colors?y(a.colors,a.previewColors):``;return`
    ...
    ${s}
  `}var ne={};u(ne,{applyCustomFormat:()=>Ke,default:()=>qe,expandSelection:()=>Ge,getActiveFormats:()=>Ue,getDebugMode:()=>ue,hasFormat:()=>We,insertHeader:()=>O,insertLink:()=>Fe,preserveSelection:()=>be,setDebugMode:()=>le,setUndoMethod:()=>pe,toggleBold:()=>Me,toggleBulletList:()=>Ie,toggleCode:()=>Pe,toggleH1:()=>Be,toggleH2:()=>Ve,toggleH3:()=>He,toggleItalic:()=>Ne,toggleNumberedList:()=>Le,toggleQuote:()=>Re,toggleTaskList:()=>ze});var re=Object.defineProperty,b=Object.getOwnPropertySymbols,x=Object.prototype.hasOwnProperty,ie=Object.prototype.propertyIsEnumerable,ae=(e,t,n)=>t in e?re(e,t,{enumerable:!0,configurable:!0,writable:!0,value:n}):e[t]=n,oe=(e,t)=>{for(var n in t||={})x.call(t,n)&&ae(e,n,t[n]);if(b)for(var n of b(t))ie.call(t,n)&&ae(e,n,t[n]);return e},S={bold:{prefix:`**`,suffix:`**`,trimFirst:!0},italic:{prefix:`_`,suffix:`_`,trimFirst:!0},code:{prefix:"`",suffix:"`",blockPrefix:"```",blockSuffix:"```"},link:{prefix:`[`,suffix:`](url)`,replaceNext:`url`,scanFor:`https?://`},bulletList:{prefix:`- `,multiline:!0,unorderedList:!0},numberedList:{prefix:`1. `,multiline:!0,orderedList:!0},quote:{prefix:`> `,multiline:!0,surroundWithNewlines:!0},taskList:{prefix:`- [ ] `,multiline:!0,surroundWithNewlines:!0},header1:{prefix:`# `},header2:{prefix:`## `},header3:{prefix:`### `},header4:{prefix:`#### `},header5:{prefix:`##### `},header6:{prefix:`###### `}};function se(){return{prefix:``,suffix:``,blockPrefix:``,blockSuffix:``,multiline:!1,replaceNext:``,prefixSpace:!1,scanFor:``,surroundWithNewlines:!1,orderedList:!1,unorderedList:!1,trimFirst:!1}}function C(e){return oe(oe({},se()),e)}var ce=!1;function le(e){ce=e}function ue(){return ce}function w(e,t,n){ce&&(console.group(`\u{1F50D} ${e}`),console.log(t),n&&console.log(`Data:`,n),console.groupEnd())}function de(e,t){if(!ce)return;let n=e.value.slice(e.selectionStart,e.selectionEnd);console.group(`\u{1F4CD} Selection: ${t}`),console.log(`Position:`,`${e.selectionStart}-${e.selectionEnd}`),console.log(`Selected text:`,JSON.stringify(n)),console.log(`Length:`,n.length);let r=e.value.slice(Math.max(0,e.selectionStart-10),e.selectionStart),i=e.value.slice(e.selectionEnd,Math.min(e.value.length,e.selectionEnd+10));console.log(`Context:`,JSON.stringify(r)+`[SELECTION]`+JSON.stringify(i)),console.groupEnd()}function fe(e){ce&&(console.group(`📝 Result`),console.log(`Text to insert:`,JSON.stringify(e.text)),console.log(`New selection:`,`${e.selectionStart}-${e.selectionEnd}`),console.groupEnd())}var T=null;function E(e,{text:t,selectionStart:n,selectionEnd:r}){let i=ue();i&&(console.group(`🔧 insertText`),console.log(`Current selection:`,`${e.selectionStart}-${e.selectionEnd}`),console.log(`Text to insert:`,JSON.stringify(t)),console.log(`New selection to set:`,n,`-`,r)),e.focus();let a=e.selectionStart,o=e.selectionEnd,s=e.value.slice(0,a),c=e.value.slice(o);i&&(console.log(`Before text (last 20):`,JSON.stringify(s.slice(-20))),console.log(`After text (first 20):`,JSON.stringify(c.slice(0,20))),console.log(`Selected text being replaced:`,JSON.stringify(e.value.slice(a,o))));let l=e.value;if(T===null||T===!0){e.contentEditable=`true`;try{T=document.execCommand(`insertText`,!1,t),i&&console.log(`execCommand returned:`,T,`for text with`,t.split(`
`).length,`lines`)}catch(e){T=!1,i&&console.log(`execCommand threw error:`,e)}e.contentEditable=`false`}if(i&&(console.log(`canInsertText before:`,T),console.log(`execCommand result:`,T)),T){let n=s+t+c,r=e.value;i&&(console.log(`Expected length:`,n.length),console.log(`Actual length:`,r.length)),r!==n&&i&&(console.log(`execCommand changed the value but not as expected`),console.log(`Expected:`,JSON.stringify(n.slice(0,100))),console.log(`Actual:`,JSON.stringify(r.slice(0,100))))}if(!T)if(i&&console.log(`Using manual insertion`),e.value===l){i&&console.log(`Value unchanged, doing manual replacement`);try{document.execCommand(`ms-beginUndoUnit`)}catch{}e.value=s+t+c;try{document.execCommand(`ms-endUndoUnit`)}catch{}e.dispatchEvent(new CustomEvent(`input`,{bubbles:!0,cancelable:!0}))}else i&&console.log(`Value was changed by execCommand, skipping manual insertion`);i&&console.log(`Setting selection range:`,n,r),n!=null&&r!=null?e.setSelectionRange(n,r):e.setSelectionRange(a,e.selectionEnd),i&&(console.log(`Final value length:`,e.value.length),console.groupEnd())}function pe(e){switch(e){case`native`:T=!0;break;case`manual`:T=!1;break;case`auto`:T=null;break}}function me(e){return e.trim().split(`
`).length>1}function he(e,t){let n=t;for(;e[n]&&e[n-1]!=null&&!e[n-1].match(/\s/);)n--;return n}function ge(e,t,n){let r=t,i=n?/\n/:/\s/;for(;e[r]&&!e[r].match(i);)r++;return r}function _e(e){let t=e.value.split(`
`),n=0;for(let r=0;r<t.length;r++){let i=t[r].length+1;e.selectionStart>=n&&e.selectionStart<n+i&&(e.selectionStart=n),e.selectionEnd>=n&&e.selectionEnd<n+i&&(r===t.length-1?e.selectionEnd=Math.min(n+t[r].length,e.value.length):e.selectionEnd=n+i-1),n+=i}}function ve(e,t,n,r=!1){if(e.selectionStart===e.selectionEnd)e.selectionStart=he(e.value,e.selectionStart),e.selectionEnd=ge(e.value,e.selectionEnd,r);else{let r=e.selectionStart-t.length,i=e.selectionEnd+n.length,a=e.value.slice(r,e.selectionStart)===t,o=e.value.slice(e.selectionEnd,i)===n;a&&o&&(e.selectionStart=r,e.selectionEnd=i)}return e.value.slice(e.selectionStart,e.selectionEnd)}function ye(e){let t=e.value.slice(0,e.selectionStart),n=e.value.slice(e.selectionEnd),r=t.match(/\n*$/),i=n.match(/^\n*/),a=r?r[0].length:0,o=i?i[0].length:0,s=``,c=``;return t.match(/\S/)&&a<2&&(s=`
`.repeat(2-a)),n.match(/\S/)&&o<2&&(c=`
`.repeat(2-o)),{newlinesToAppend:s,newlinesToPrepend:c}}function be(e,t){let n=e.selectionStart,r=e.selectionEnd,i=e.scrollTop;t(),e.selectionStart=n,e.selectionEnd=r,e.scrollTop=i}function xe(e,t,n={}){let r=e.selectionStart,i=e.selectionEnd,a=r===i,o=e.value,s=r;for(;s>0&&o[s-1]!==`
`;)s--;if(a){let t=r;for(;t<o.length&&o[t]!==`
`;)t++;e.selectionStart=s,e.selectionEnd=t}else _e(e);let c=t(e);if(n.adjustSelection){let t=e.value.slice(e.selectionStart,e.selectionEnd).startsWith(n.prefix),a=n.adjustSelection(t,r,i,s);c.selectionStart=a.start,c.selectionEnd=a.end}else if(n.prefix){let t=e.value.slice(e.selectionStart,e.selectionEnd).startsWith(n.prefix);a?t?(c.selectionStart=Math.max(r-n.prefix.length,s),c.selectionEnd=c.selectionStart):(c.selectionStart=r+n.prefix.length,c.selectionEnd=c.selectionStart):t?(c.selectionStart=Math.max(r-n.prefix.length,s),c.selectionEnd=Math.max(i-n.prefix.length,s)):(c.selectionStart=r+n.prefix.length,c.selectionEnd=i+n.prefix.length)}return c}function Se(e,t){let n,r,{prefix:i,suffix:a,blockPrefix:o,blockSuffix:s,replaceNext:c,prefixSpace:l,scanFor:u,surroundWithNewlines:d,trimFirst:f}=t,p=e.selectionStart,m=e.selectionEnd,h=e.value.slice(e.selectionStart,e.selectionEnd),g=me(h)&&o&&o.length>0?`${o}
`:i,_=me(h)&&s&&s.length>0?`
${s}`:a;if(l){let t=e.value[e.selectionStart-1];e.selectionStart!==0&&t!=null&&!t.match(/\s/)&&(g=` ${g}`)}h=ve(e,g,_,t.multiline);let v=e.selectionStart,y=e.selectionEnd,ee=c&&c.length>0&&_.indexOf(c)>-1&&h.length>0;if(d){let t=ye(e);n=t.newlinesToAppend,r=t.newlinesToPrepend,g=n+i,_+=r}if(h.startsWith(g)&&h.endsWith(_)){let e=h.slice(g.length,h.length-_.length);if(p===m){let t=p-g.length;t=Math.max(t,v),t=Math.min(t,v+e.length),v=y=t}else y=v+e.length;return{text:e,selectionStart:v,selectionEnd:y}}else if(!ee){let e=g+h+_;v=p+g.length,y=m+g.length;let t=h.match(/^\s*|\s*$/g);if(f&&t){let n=t[0]||``,r=t[1]||``;e=n+g+h.trim()+_+r,v+=n.length,y-=r.length}return{text:e,selectionStart:v,selectionEnd:y}}else if(u&&u.length>0&&h.match(u)){_=_.replace(c,h);let e=g+_;return v=y=v+g.length,{text:e,selectionStart:v,selectionEnd:y}}else{let e=g+h+_;return v=v+g.length+h.length+_.indexOf(c),y=v+c.length,{text:e,selectionStart:v,selectionEnd:y}}}function Ce(e,t){let{prefix:n,suffix:r,surroundWithNewlines:i}=t,a=e.value.slice(e.selectionStart,e.selectionEnd),o=e.selectionStart,s=e.selectionEnd,c=a.split(`
...
`),i){let{newlinesToAppend:t,newlinesToPrepend:n}=ye(e);o+=t.length,s=o+a.length,a=t+a+n}return{text:a,selectionStart:o,selectionEnd:s}}function we(e){let t=e.split(`
`),n=/^\d+\.\s+/,r=t.every(e=>n.test(e)),i=t;return r&&(i=t.map(e=>e.replace(n,``))),{text:i.join(`
`),processed:r}}function Te(e){let t=e.split(`
`),n=t.every(e=>e.startsWith(`- `)),r=t;return n&&(r=t.map(e=>e.slice(2))),{text:r.join(`
`),processed:n}}function D(e,t){return t?`- `:`${e+1}. `}function Ee(e,t){let n,r,i;return e.orderedList?(n=we(t),r=Te(n.text),i=r.text):(n=Te(t),r=we(n.text),i=r.text),[n,r,i]}function De(e,t){let n=e.selectionStart===e.selectionEnd,r=e.selectionStart,i=e.selectionEnd;_e(e);let[a,o,s]=Ee(t,e.value.slice(e.selectionStart,e.selectionEnd)),c=s.split(`
`).map((e,n)=>`${D(n,t.unorderedList)}${e}`),l=c.reduce((e,n,r)=>e+D(r,t.unorderedList).length,0),u=c.reduce((e,n,r)=>e+D(r,!t.unorderedList).length,0);if(a.processed)return n?(r=Math.max(r-D(0,t.unorderedList).length,0),i=r):(r=e.selectionStart,i=e.selectionEnd-l),{text:s,selectionStart:r,selectionEnd:i};let{newlinesToAppend:d,newlinesToPrepend:f}=ye(e),p=d+c.join(`
`)+f;return n?(r=Math.max(r+D(0,t.unorderedList).length+d.length,0),i=r):o.processed?(r=Math.max(e.selectionStart+d.length,0),i=e.selectionEnd+d.length+l-u):(r=Math.max(e.selectionStart+d.length,0),i=e.selectionEnd+d.length+l),{text:p,selectionStart:r,selectionEnd:i}}function Oe(e,t){E(e,xe(e,e=>De(e,t),{adjustSelection:(n,r,i,a)=>{let o=e.value.slice(a,e.selectionEnd),s=/^\d+\.\s+/,c=/^- /,l=s.test(o),u=c.test(o),d=t.orderedList&&l||t.unorderedList&&u;if(r===i)if(d){let e=o.match(t.orderedList?s:c),n=e?e[0].length:0;return{start:Math.max(r-n,a),end:Math.max(r-n,a)}}else if(l||u){let e=o.match(l?s:c),n=e?e[0].length:0,i=(t.unorderedList?2:3)-n;return{start:r+i,end:r+i}}else{let e=t.unorderedList?2:3;return{start:r+e,end:r+e}}else if(d){let e=o.match(t.orderedList?s:c),n=e?e[0].length:0;return{start:Math.max(r-n,a),end:Math.max(i-n,a)}}else if(l||u){let e=o.match(l?s:c),n=e?e[0].length:0,a=(t.unorderedList?2:3)-n;return{start:r+a,end:i+a}}else{let e=t.unorderedList?2:3;return{start:r+e,end:i+e}}}}))}function ke(e){if(!e)return[];let t=[],{selectionStart:n,selectionEnd:r,value:i}=e,a=i.split(`
`),o=0,s=``;for(let e of a){if(n>=o&&n<=o+e.length){s=e;break}o+=e.length+1}s.startsWith(`- `)&&(s.startsWith(`- [ ] `)||s.startsWith(`- [x] `)?t.push(`task-list`):t.push(`bullet-list`)),/^\d+\.\s/.test(s)&&t.push(`numbered-list`),s.startsWith(`> `)&&t.push(`quote`),s.startsWith(`# `)&&t.push(`header`),s.startsWith(`## `)&&t.push(`header-2`),s.startsWith(`### `)&&t.push(`header-3`);let c=Math.max(0,n-10),l=Math.min(i.length,r+10),u=i.slice(c,l);if(u.includes(`**`)){let e=i.slice(Math.max(0,n-100),n),a=i.slice(r,Math.min(i.length,r+100)),o=e.lastIndexOf(`**`),s=a.indexOf(`**`);o!==-1&&s!==-1&&t.push(`bold`)}if(u.includes(`_`)){let e=i.slice(Math.max(0,n-100),n),a=i.slice(r,Math.min(i.length,r+100)),o=e.lastIndexOf(`_`),s=a.indexOf(`_`);o!==-1&&s!==-1&&t.push(`italic`)}if(u.includes("`")){let e=i.slice(Math.max(0,n-100),n),a=i.slice(r,Math.min(i.length,r+100));e.includes("`")&&a.includes("`")&&t.push(`code`)}if(u.includes(`[`)&&u.includes(`]`)){let e=i.slice(Math.max(0,n-100),n),a=i.slice(r,Math.min(i.length,r+100)),o=e.lastIndexOf(`[`),s=a.indexOf(`]`);o!==-1&&s!==-1&&i.slice(r+s+1,r+s+10).startsWith(`(`)&&t.push(`link`)}return t}function Ae(e,t){return ke(e).includes(t)}function je(e,t={}){if(!e)return;let{toWord:n,toLine:r,toFormat:i}=t,{selectionStart:a,selectionEnd:o,value:s}=e;if(r){let t=s.split(`
`),n=0,r=0,i=0;for(let e of t){if(a>=i&&a<=i+e.length){n=i,r=i+e.length;break}i+=e.length+1}e.selectionStart=n,e.selectionEnd=r}else if(n&&a===o){let t=a,n=o;for(;t>0&&!/\s/.test(s[t-1]);)t--;for(;n<s.length&&!/\s/.test(s[n]);)n++;e.selectionStart=t,e.selectionEnd=n}}function Me(e){if(!e||e.disabled||e.readOnly)return;w(`toggleBold`,`Starting`),de(e,`Before`);let t=Se(e,C(S.bold));fe(t),E(e,t),de(e,`After`)}function Ne(e){!e||e.disabled||e.readOnly||E(e,Se(e,C(S.italic)))}function Pe(e){!e||e.disabled||e.readOnly||E(e,Se(e,C(S.code)))}function Fe(e,t={}){if(!e||e.disabled||e.readOnly)return;let n=e.value.slice(e.selectionStart,e.selectionEnd),r=C(S.link);if(n&&n.match(/^https?:\/\//)&&!t.url?(r.suffix=`](${n})`,r.replaceNext=``):t.url&&(r.suffix=`](${t.url})`,r.replaceNext=``),t.text&&!n){let n=e.selectionStart;e.value=e.value.slice(0,n)+t.text+e.value.slice(n),e.selectionStart=n,e.selectionEnd=n+t.text.length}E(e,Se(e,r))}function Ie(e){!e||e.disabled||e.readOnly||Oe(e,C(S.bulletList))}function Le(e){!e||e.disabled||e.readOnly||Oe(e,C(S.numberedList))}function Re(e){if(!e||e.disabled||e.readOnly)return;w(`toggleQuote`,`Starting`),de(e,`Initial`);let t=C(S.quote),n=xe(e,e=>Ce(e,t),{prefix:t.prefix});fe(n),E(e,n),de(e,`Final`)}function ze(e){if(!e||e.disabled||e.readOnly)return;let t=C(S.taskList);E(e,xe(e,e=>Ce(e,t),{prefix:t.prefix}))}function O(e,t=1,n=!1){if(!e||e.disabled||e.readOnly)return;(t<1||t>6)&&(t=1),w(`insertHeader`,`============ START ============`),w(`insertHeader`,`Level: ${t}, Toggle: ${n}`),w(`insertHeader`,`Initial cursor: ${e.selectionStart}-${e.selectionEnd}`);let r=C(S[`header${t===1?`1`:t}`]||S.header1);w(`insertHeader`,`Style prefix: "${r.prefix}"`);let i=e.value,a=e.selectionStart,o=e.selectionEnd,s=a;for(;s>0&&i[s-1]!==`
`;)s--;let c=o;for(;c<i.length&&i[c]!==`
`;)c++;let l=i.slice(s,c);w(`insertHeader`,`Current line (before): "${l}"`);let u=l.match(/^(#{1,6})\s*/),d=u?u[1].length:0,f=u?u[0].length:0;w(`insertHeader`,`Existing header check:`),w(`insertHeader`,`  - Match: ${u?`"${u[0]}"`:`none`}`),w(`insertHeader`,`  - Existing level: ${d}`),w(`insertHeader`,`  - Existing prefix length: ${f}`),w(`insertHeader`,`  - Target level: ${t}`);let p=n&&d===t;w(`insertHeader`,`Should toggle OFF: ${p} (toggle=${n}, existingLevel=${d}, level=${t})`);let m=xe(e,e=>{let n=e.value.slice(e.selectionStart,e.selectionEnd);w(`insertHeader`,`Line in operation: "${n}"`);let i=n.replace(/^#{1,6}\s*/,``);w(`insertHeader`,`Cleaned line: "${i}"`);let a;return p?(w(`insertHeader`,`ACTION: Toggling OFF - removing header`),a=i):d>0?(w(`insertHeader`,`ACTION: Replacing H${d} with H${t}`),a=r.prefix+i):(w(`insertHeader`,`ACTION: Adding new header`),a=r.prefix+i),w(`insertHeader`,`New line: "${a}"`),{text:a,selectionStart:e.selectionStart,selectionEnd:e.selectionEnd}},{prefix:r.prefix,adjustSelection:(e,t,n,i)=>{if(w(`insertHeader`,`Adjusting selection:`),w(`insertHeader`,`  - isRemoving param: ${e}`),w(`insertHeader`,`  - shouldToggleOff: ${p}`),w(`insertHeader`,`  - selStart: ${t}, selEnd: ${n}`),w(`insertHeader`,`  - lineStartPos: ${i}`),p){let e=Math.max(t-f,i);return w(`insertHeader`,`  - Removing header, adjusting by -${f}`),{start:e,end:t===n?e:Math.max(n-f,i)}}else if(f>0){let e=r.prefix.length-f;return w(`insertHeader`,`  - Replacing header, adjusting by ${e}`),{start:t+e,end:n+e}}else return w(`insertHeader`,`  - Adding header, adjusting by +${r.prefix.length}`),{start:t+r.prefix.length,end:n+r.prefix.length}}});w(`insertHeader`,`Final result: text="${m.text}", cursor=${m.selectionStart}-${m.selectionEnd}`),w(`insertHeader`,`============ END ============`),E(e,m)}function Be(e){O(e,1,!0)}function Ve(e){O(e,2,!0)}function He(e){O(e,3,!0)}function Ue(e){return ke(e)}function We(e,t){return Ae(e,t)}function Ge(e,t={}){je(e,t)}function Ke(e,t){if(!e||e.disabled||e.readOnly)return;let n=C(t),r;r=n.multiline&&me(e.value.slice(e.selectionStart,e.selectionEnd))?Ce(e,n):Se(e,n),E(e,r)}var qe={toggleBold:Me,toggleItalic:Ne,toggleCode:Pe,insertLink:Fe,toggleBulletList:Ie,toggleNumberedList:Le,toggleQuote:Re,toggleTaskList:ze,insertHeader:O,toggleH1:Be,toggleH2:Ve,toggleH3:He,getActiveFormats:Ue,hasFormat:We,expandSelection:Ge,applyCustomFormat:Ke,preserveSelection:be,setUndoMethod:pe,setDebugMode:le,getDebugMode:ue},Je=class{constructor(e,t={}){this.editor=e,this.container=null,this.buttons={},this.toolbarButtons=t.toolbarButtons||[]}create(){this.container=document.createElement(`div`),this.container.className=`overtype-toolbar`,this.container.setAttribute(`role`,`toolbar`),this.container.setAttribute(`aria-label`,`Formatting toolbar`),this.toolbarButtons.forEach(e=>{if(e.name===`separator`){let e=this.createSeparator();this.container.appendChild(e)}else{let t=this.createButton(e);this.buttons[e.name]=t,this.container.appendChild(t)}}),this.editor.container.insertBefore(this.container,this.editor.wrapper)}createSeparator(){let e=document.createElement(`div`);return e.className=`overtype-toolbar-separator`,e.setAttribute(`role`,`separator`),e}createButton(e){let t=document.createElement(`button`);return t.className=`overtype-toolbar-button`,t.type=`button`,t.setAttribute(`data-button`,e.name),t.title=e.title||``,t.setAttribute(`aria-label`,e.title||e.name),t.innerHTML=this.sanitizeSVG(e.icon||``),e.name===`viewMode`?(t.classList.add(`has-dropdown`),t.dataset.dropdown=`true`,t.addEventListener(`click`,e=>{e.preventDefault(),this.toggleViewModeDropdown(t)}),t):(t._clickHandler=t=>{t.preventDefault();let n=e.actionId||e.name;this.editor.performAction(n,t)},t.addEventListener(`click`,t._clickHandler),t)}async handleAction(e){if(e&&typeof e==`object`&&typeof e.action==`function`){this.editor.textarea.focus();try{return await e.action({editor:this.editor,getValue:()=>this.editor.getValue(),setValue:e=>this.editor.setValue(e),event:null}),!0}catch(t){return console.error(`Action "${e.name}" error:`,t),this.editor.wrapper.dispatchEvent(new CustomEvent(`button-error`,{detail:{buttonName:e.name,error:t}})),!1}}return typeof e==`string`?this.editor.performAction(e,null):!1}sanitizeSVG(e){return typeof e==`string`?e.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,``).replace(/\son\w+\s*=\s*["'][^"']*["']/gi,``).replace(/\son\w+\s*=\s*[^\s>]*/gi,``):``}toggleViewModeDropdown(e){let t=document.querySelector(`.overtype-dropdown-menu`);if(t){t.remove(),e.classList.remove(`dropdown-active`);return}e.classList.add(`dropdown-active`);let n=this.createViewModeDropdown(e),r=e.getBoundingClientRect();n.style.position=`absolute`,n.style.top=`${r.bottom+5}px`,n.style.left=`${r.left}px`,document.body.appendChild(n),this.handleDocumentClick=t=>{!n.contains(t.target)&&!e.contains(t.target)&&(n.remove(),e.classList.remove(`dropdown-active`),document.removeEventListener(`click`,this.handleDocumentClick))},setTimeout(()=>{document.addEventListener(`click`,this.handleDocumentClick)},0)}createViewModeDropdown(e){let t=document.createElement(`div`);t.className=`overtype-dropdown-menu`;let n=[{id:`normal`,label:`Normal Edit`,icon:`✓`},{id:`plain`,label:`Plain Textarea`,icon:`✓`},{id:`preview`,label:`Preview Mode`,icon:`✓`}],r=this.editor.container.dataset.mode||`normal`;return n.forEach(n=>{let i=document.createElement(`button`);if(i.className=`overtype-dropdown-item`,i.type=`button`,i.textContent=n.label,n.id===r){i.classList.add(`active`),i.setAttribute(`aria-current`,`true`);let e=document.createElement(`span`);e.className=`overtype-dropdown-icon`,e.textContent=n.icon,i.prepend(e)}i.addEventListener(`click`,r=>{switch(r.preventDefault(),n.id){case`plain`:this.editor.showPlainTextarea();break;case`preview`:this.editor.showPreviewMode();break;default:this.editor.showNormalEditMode();break}t.remove(),e.classList.remove(`dropdown-active`),document.removeEventListener(`click`,this.handleDocumentClick)}),t.appendChild(i)}),t}updateButtonStates(){try{let e=Ue?.(this.editor.textarea,this.editor.textarea.selectionStart)||[];Object.entries(this.buttons).forEach(([t,n])=>{if(t===`viewMode`)return;let r=!1;switch(t){case`bold`:r=e.includes(`bold`);break;case`italic`:r=e.includes(`italic`);break;case`code`:r=!1;break;case`bulletList`:r=e.includes(`bullet-list`);break;case`orderedList`:r=e.includes(`numbered-list`);break;case`taskList`:r=e.includes(`task-list`);break;case`quote`:r=e.includes(`quote`);break;case`h1`:r=e.includes(`header`);break;case`h2`:r=e.includes(`header-2`);break;case`h3`:r=e.includes(`header-3`);break}n.classList.toggle(`active`,r),n.setAttribute(`aria-pressed`,r.toString())})}catch{}}show(){this.container&&this.container.classList.remove(`overtype-toolbar-hidden`)}hide(){this.container&&this.container.classList.add(`overtype-toolbar-hidden`)}destroy(){this.container&&(this.handleDocumentClick&&document.removeEventListener(`click`,this.handleDocumentClick),Object.values(this.buttons).forEach(e=>{e._clickHandler&&(e.removeEventListener(`click`,e._clickHandler),delete e._clickHandler)}),this.container.remove(),this.container=null,this.buttons={})}},Ye=Math.min,k=Math.max,Xe=Math.round,A=e=>({x:e,y:e}),Ze={left:`right`,right:`left`,bottom:`top`,top:`bottom`},Qe={start:`end`,end:`start`};function $e(e,t,n){return k(e,Ye(t,n))}function et(e,t){return typeof e==`function`?e(t):e}function j(e){return e.split(`-`)[0]}function tt(e){return e.split(`-`)[1]}function nt(e){return e===`x`?`y`:`x`}function rt(e){return e===`y`?`height`:`width`}var it=new Set([`top`,`bottom`]);function M(e){return it.has(j(e))?`y`:`x`}function at(e){return nt(M(e))}function ot(e,t,n){n===void 0&&(n=!1);let r=tt(e),i=at(e),a=rt(i),o=i===`x`?r===(n?`end`:`start`)?`right`:`left`:r===`start`?`bottom`:`top`;return t.reference[a]>t.floating[a]&&(o=ht(o)),[o,ht(o)]}function st(e){let t=ht(e);return[ct(e),t,ct(t)]}function ct(e){return e.replace(/start|end/g,e=>Qe[e])}var lt=[`left`,`right`],ut=[`right`,`left`],dt=[`top`,`bottom`],ft=[`bottom`,`top`];function pt(e,t,n){switch(e){case`top`:case`bottom`:return n?t?ut:lt:t?lt:ut;case`left`:case`right`:return t?dt:ft;default:return[]}}function mt(e,t,n,r){let i=tt(e),a=pt(j(e),n===`start`,r);return i&&(a=a.map(e=>e+`-`+i),t&&(a=a.concat(a.map(ct)))),a}function ht(e){return e.replace(/left|right|bottom|top/g,e=>Ze[e])}function gt(e){return{top:0,right:0,bottom:0,left:0,...e}}function _t(e){return typeof e==`number`?{top:e,right:e,bottom:e,left:e}:gt(e)}function vt(e){let{x:t,y:n,width:r,height:i}=e;return{width:r,height:i,top:n,left:t,right:t+r,bottom:n+i,x:t,y:n}}function yt(e,t,n){let{reference:r,floating:i}=e,a=M(t),o=at(t),s=rt(o),c=j(t),l=a===`y`,u=r.x+r.width/2-i.width/2,d=r.y+r.height/2-i.height/2,f=r[s]/2-i[s]/2,p;switch(c){case`top`:p={x:u,y:r.y-i.height};break;case`bottom`:p={x:u,y:r.y+r.height};break;case`right`:p={x:r.x+r.width,y:d};break;case`left`:p={x:r.x-i.width,y:d};break;default:p={x:r.x,y:r.y}}switch(tt(t)){case`start`:p[o]-=f*(n&&l?-1:1);break;case`end`:p[o]+=f*(n&&l?-1:1);break}return p}async function bt(e,t){t===void 0&&(t={});let{x:n,y:r,platform:i,rects:a,elements:o,strategy:s}=e,{boundary:c=`clippingAncestors`,rootBoundary:l=`viewport`,elementContext:u=`floating`,altBoundary:d=!1,padding:f=0}=et(t,e),p=_t(f),m=o[d?u===`floating`?`reference`:`floating`:u],h=vt(await i.getClippingRect({element:await(i.isElement==null?void 0:i.isElement(m))??!0?m:m.contextElement||await(i.getDocumentElement==null?void 0:i.getDocumentElement(o.floating)),boundary:c,rootBoundary:l,strategy:s})),g=u===`floating`?{x:n,y:r,width:a.floating.width,height:a.floating.height}:a.reference,_=await(i.getOffsetParent==null?void 0:i.getOffsetParent(o.floating)),v=await(i.isElement==null?void 0:i.isElement(_))&&await(i.getScale==null?void 0:i.getScale(_))||{x:1,y:1},y=vt(i.convertOffsetParentRelativeRectToViewportRelativeRect?await i.convertOffsetParentRelativeRectToViewportRelativeRect({elements:o,rect:g,offsetParent:_,strategy:s}):g);return{top:(h.top-y.top+p.top)/v.y,bottom:(y.bottom-h.bottom+p.bottom)/v.y,left:(h.left-y.left+p.left)/v.x,right:(y.right-h.right+p.right)/v.x}}var xt=async(e,t,n)=>{let{placement:r=`bottom`,strategy:i=`absolute`,middleware:a=[],platform:o}=n,s=a.filter(Boolean),c=await(o.isRTL==null?void 0:o.isRTL(t)),l=await o.getElementRects({reference:e,floating:t,strategy:i}),{x:u,y:d}=yt(l,r,c),f=r,p={},m=0;for(let n=0;n<s.length;n++){let{name:a,fn:h}=s[n],{x:g,y:_,data:v,reset:y}=await h({x:u,y:d,initialPlacement:r,placement:f,strategy:i,middlewareData:p,rects:l,platform:{...o,detectOverflow:o.detectOverflow??bt},elements:{reference:e,floating:t}});u=g??u,d=_??d,p={...p,[a]:{...p[a],...v}},y&&m<=50&&(m++,typeof y==`object`&&(y.placement&&(f=y.placement),y.rects&&(l=y.rects===!0?await o.getElementRects({reference:e,floating:t,strategy:i}):y.rects),{x:u,y:d}=yt(l,f,c)),n=-1)}return{x:u,y:d,placement:f,strategy:i,middlewareData:p}},St=function(e){return e===void 0&&(e={}),{name:`flip`,options:e,async fn(t){var n;let{placement:r,middlewareData:i,rects:a,initialPlacement:o,platform:s,elements:c}=t,{mainAxis:l=!0,crossAxis:u=!0,fallbackPlacements:d,fallbackStrategy:f=`bestFit`,fallbackAxisSideDirection:p=`none`,flipAlignment:m=!0,...h}=et(e,t);if((n=i.arrow)!=null&&n.alignmentOffset)return{};let g=j(r),_=M(o),v=j(o)===o,y=await(s.isRTL==null?void 0:s.isRTL(c.floating)),ee=d||(v||!m?[ht(o)]:st(o)),te=p!==`none`;!d&&te&&ee.push(...mt(o,m,p,y));let ne=[o,...ee],re=await s.detectOverflow(t,h),b=[],x=i.flip?.overflows||[];if(l&&b.push(re[g]),u){let e=ot(r,a,y);b.push(re[e[0]],re[e[1]])}if(x=[...x,{placement:r,overflows:b}],!b.every(e=>e<=0)){let e=(i.flip?.index||0)+1,t=ne[e];if(t&&(!(u===`alignment`&&_!==M(t))||x.every(e=>M(e.placement)===_?e.overflows[0]>0:!0)))return{data:{index:e,overflows:x},reset:{placement:t}};let n=x.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0]?.placement;if(!n)switch(f){case`bestFit`:{let e=x.filter(e=>{if(te){let t=M(e.placement);return t===_||t===`y`}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0]?.[0];e&&(n=e);break}case`initialPlacement`:n=o;break}if(r!==n)return{reset:{placement:n}}}return{}}}},Ct=new Set([`left`,`top`]);async function wt(e,t){let{placement:n,platform:r,elements:i}=e,a=await(r.isRTL==null?void 0:r.isRTL(i.floating)),o=j(n),s=tt(n),c=M(n)===`y`,l=Ct.has(o)?-1:1,u=a&&c?-1:1,d=et(t,e),{mainAxis:f,crossAxis:p,alignmentAxis:m}=typeof d==`number`?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return s&&typeof m==`number`&&(p=s===`end`?m*-1:m),c?{x:p*u,y:f*l}:{x:f*l,y:p*u}}var Tt=function(e){return e===void 0&&(e=0),{name:`offset`,options:e,async fn(t){var n;let{x:r,y:i,placement:a,middlewareData:o}=t,s=await wt(t,e);return a===o.offset?.placement&&(n=o.arrow)!=null&&n.alignmentOffset?{}:{x:r+s.x,y:i+s.y,data:{...s,placement:a}}}}},Et=function(e){return e===void 0&&(e={}),{name:`shift`,options:e,async fn(t){let{x:n,y:r,placement:i,platform:a}=t,{mainAxis:o=!0,crossAxis:s=!1,limiter:c={fn:e=>{let{x:t,y:n}=e;return{x:t,y:n}}},...l}=et(e,t),u={x:n,y:r},d=await a.detectOverflow(t,l),f=M(j(i)),p=nt(f),m=u[p],h=u[f];if(o){let e=p===`y`?`top`:`left`,t=p===`y`?`bottom`:`right`,n=m+d[e],r=m-d[t];m=$e(n,m,r)}if(s){let e=f===`y`?`top`:`left`,t=f===`y`?`bottom`:`right`,n=h+d[e],r=h-d[t];h=$e(n,h,r)}let g=c.fn({...t,[p]:m,[f]:h});return{...g,data:{x:g.x-n,y:g.y-r,enabled:{[p]:o,[f]:s}}}}}};function Dt(){return typeof window<`u`}function N(e){return Ot(e)?(e.nodeName||``).toLowerCase():`#document`}function P(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function F(e){return((Ot(e)?e.ownerDocument:e.document)||window.document)?.documentElement}function Ot(e){return Dt()?e instanceof Node||e instanceof P(e).Node:!1}function I(e){return Dt()?e instanceof Element||e instanceof P(e).Element:!1}function L(e){return Dt()?e instanceof HTMLElement||e instanceof P(e).HTMLElement:!1}function kt(e){return!Dt()||typeof ShadowRoot>`u`?!1:e instanceof ShadowRoot||e instanceof P(e).ShadowRoot}var At=new Set([`inline`,`contents`]);function jt(e){let{overflow:t,overflowX:n,overflowY:r,display:i}=z(e);return/auto|scroll|overlay|hidden|clip/.test(t+r+n)&&!At.has(i)}var Mt=new Set([`table`,`td`,`th`]);function Nt(e){return Mt.has(N(e))}var Pt=[`:popover-open`,`:modal`];function Ft(e){return Pt.some(t=>{try{return e.matches(t)}catch{return!1}})}var It=[`transform`,`translate`,`scale`,`rotate`,`perspective`],Lt=[`transform`,`translate`,`scale`,`rotate`,`perspective`,`filter`],Rt=[`paint`,`layout`,`strict`,`content`];function zt(e){let t=Vt(),n=I(e)?z(e):e;return It.some(e=>n[e]?n[e]!==`none`:!1)||(n.containerType?n.containerType!==`normal`:!1)||!t&&(n.backdropFilter?n.backdropFilter!==`none`:!1)||!t&&(n.filter?n.filter!==`none`:!1)||Lt.some(e=>(n.willChange||``).includes(e))||Rt.some(e=>(n.contain||``).includes(e))}function Bt(e){let t=B(e);for(;L(t)&&!R(t);){if(zt(t))return t;if(Ft(t))return null;t=B(t)}return null}function Vt(){return typeof CSS>`u`||!CSS.supports?!1:CSS.supports(`-webkit-backdrop-filter`,`none`)}var Ht=new Set([`html`,`body`,`#document`]);function R(e){return Ht.has(N(e))}function z(e){return P(e).getComputedStyle(e)}function Ut(e){return I(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function B(e){if(N(e)===`html`)return e;let t=e.assignedSlot||e.parentNode||kt(e)&&e.host||F(e);return kt(t)?t.host:t}function Wt(e){let t=B(e);return R(t)?e.ownerDocument?e.ownerDocument.body:e.body:L(t)&&jt(t)?t:Wt(t)}function Gt(e,t,n){t===void 0&&(t=[]),n===void 0&&(n=!0);let r=Wt(e),i=r===e.ownerDocument?.body,a=P(r);if(i){let e=Kt(a);return t.concat(a,a.visualViewport||[],jt(r)?r:[],e&&n?Gt(e):[])}return t.concat(r,Gt(r,[],n))}function Kt(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function qt(e){let t=z(e),n=parseFloat(t.width)||0,r=parseFloat(t.height)||0,i=L(e),a=i?e.offsetWidth:n,o=i?e.offsetHeight:r,s=Xe(n)!==a||Xe(r)!==o;return s&&(n=a,r=o),{width:n,height:r,$:s}}function Jt(e){return I(e)?e:e.contextElement}function V(e){let t=Jt(e);if(!L(t))return A(1);let n=t.getBoundingClientRect(),{width:r,height:i,$:a}=qt(t),o=(a?Xe(n.width):n.width)/r,s=(a?Xe(n.height):n.height)/i;return(!o||!Number.isFinite(o))&&(o=1),(!s||!Number.isFinite(s))&&(s=1),{x:o,y:s}}var Yt=A(0);function Xt(e){let t=P(e);return!Vt()||!t.visualViewport?Yt:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function Zt(e,t,n){return t===void 0&&(t=!1),!n||t&&n!==P(e)?!1:t}function H(e,t,n,r){t===void 0&&(t=!1),n===void 0&&(n=!1);let i=e.getBoundingClientRect(),a=Jt(e),o=A(1);t&&(r?I(r)&&(o=V(r)):o=V(e));let s=Zt(a,n,r)?Xt(a):A(0),c=(i.left+s.x)/o.x,l=(i.top+s.y)/o.y,u=i.width/o.x,d=i.height/o.y;if(a){let e=P(a),t=r&&I(r)?P(r):r,n=e,i=Kt(n);for(;i&&r&&t!==n;){let e=V(i),t=i.getBoundingClientRect(),r=z(i),a=t.left+(i.clientLeft+parseFloat(r.paddingLeft))*e.x,o=t.top+(i.clientTop+parseFloat(r.paddingTop))*e.y;c*=e.x,l*=e.y,u*=e.x,d*=e.y,c+=a,l+=o,n=P(i),i=Kt(n)}}return vt({width:u,height:d,x:c,y:l})}function Qt(e,t){let n=Ut(e).scrollLeft;return t?t.left+n:H(F(e)).left+n}function $t(e,t){let n=e.getBoundingClientRect();return{x:n.left+t.scrollLeft-Qt(e,n),y:n.top+t.scrollTop}}function en(e){let{elements:t,rect:n,offsetParent:r,strategy:i}=e,a=i===`fixed`,o=F(r),s=t?Ft(t.floating):!1;if(r===o||s&&a)return n;let c={scrollLeft:0,scrollTop:0},l=A(1),u=A(0),d=L(r);if((d||!d&&!a)&&((N(r)!==`body`||jt(o))&&(c=Ut(r)),L(r))){let e=H(r);l=V(r),u.x=e.x+r.clientLeft,u.y=e.y+r.clientTop}let f=o&&!d&&!a?$t(o,c):A(0);return{width:n.width*l.x,height:n.height*l.y,x:n.x*l.x-c.scrollLeft*l.x+u.x+f.x,y:n.y*l.y-c.scrollTop*l.y+u.y+f.y}}function tn(e){return Array.from(e.getClientRects())}function nn(e){let t=F(e),n=Ut(e),r=e.ownerDocument.body,i=k(t.scrollWidth,t.clientWidth,r.scrollWidth,r.clientWidth),a=k(t.scrollHeight,t.clientHeight,r.scrollHeight,r.clientHeight),o=-n.scrollLeft+Qt(e),s=-n.scrollTop;return z(r).direction===`rtl`&&(o+=k(t.clientWidth,r.clientWidth)-i),{width:i,height:a,x:o,y:s}}var rn=25;function an(e,t){let n=P(e),r=F(e),i=n.visualViewport,a=r.clientWidth,o=r.clientHeight,s=0,c=0;if(i){a=i.width,o=i.height;let e=Vt();(!e||e&&t===`fixed`)&&(s=i.offsetLeft,c=i.offsetTop)}let l=Qt(r);if(l<=0){let e=r.ownerDocument,t=e.body,n=getComputedStyle(t),i=e.compatMode===`CSS1Compat`&&parseFloat(n.marginLeft)+parseFloat(n.marginRight)||0,o=Math.abs(r.clientWidth-t.clientWidth-i);o<=rn&&(a-=o)}else l<=rn&&(a+=l);return{width:a,height:o,x:s,y:c}}var on=new Set([`absolute`,`fixed`]);function sn(e,t){let n=H(e,!0,t===`fixed`),r=n.top+e.clientTop,i=n.left+e.clientLeft,a=L(e)?V(e):A(1);return{width:e.clientWidth*a.x,height:e.clientHeight*a.y,x:i*a.x,y:r*a.y}}function cn(e,t,n){let r;if(t===`viewport`)r=an(e,n);else if(t===`document`)r=nn(F(e));else if(I(t))r=sn(t,n);else{let n=Xt(e);r={x:t.x-n.x,y:t.y-n.y,width:t.width,height:t.height}}return vt(r)}function ln(e,t){let n=B(e);return n===t||!I(n)||R(n)?!1:z(n).position===`fixed`||ln(n,t)}function un(e,t){let n=t.get(e);if(n)return n;let r=Gt(e,[],!1).filter(e=>I(e)&&N(e)!==`body`),i=null,a=z(e).position===`fixed`,o=a?B(e):e;for(;I(o)&&!R(o);){let t=z(o),n=zt(o);!n&&t.position===`fixed`&&(i=null),(a?!n&&!i:!n&&t.position===`static`&&i&&on.has(i.position)||jt(o)&&!n&&ln(e,o))?r=r.filter(e=>e!==o):i=t,o=B(o)}return t.set(e,r),r}function dn(e){let{element:t,boundary:n,rootBoundary:r,strategy:i}=e,a=[...n===`clippingAncestors`?Ft(t)?[]:un(t,this._c):[].concat(n),r],o=a[0],s=a.reduce((e,n)=>{let r=cn(t,n,i);return e.top=k(r.top,e.top),e.right=Ye(r.right,e.right),e.bottom=Ye(r.bottom,e.bottom),e.left=k(r.left,e.left),e},cn(t,o,i));return{width:s.right-s.left,height:s.bottom-s.top,x:s.left,y:s.top}}function fn(e){let{width:t,height:n}=qt(e);return{width:t,height:n}}function pn(e,t,n){let r=L(t),i=F(t),a=n===`fixed`,o=H(e,!0,a,t),s={scrollLeft:0,scrollTop:0},c=A(0);function l(){c.x=Qt(i)}if(r||!r&&!a)if((N(t)!==`body`||jt(i))&&(s=Ut(t)),r){let e=H(t,!0,a,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}else i&&l();a&&!r&&i&&l();let u=i&&!r&&!a?$t(i,s):A(0);return{x:o.left+s.scrollLeft-c.x-u.x,y:o.top+s.scrollTop-c.y-u.y,width:o.width,height:o.height}}function mn(e){return z(e).position===`static`}function hn(e,t){if(!L(e)||z(e).position===`fixed`)return null;if(t)return t(e);let n=e.offsetParent;return F(e)===n&&(n=n.ownerDocument.body),n}function gn(e,t){let n=P(e);if(Ft(e))return n;if(!L(e)){let t=B(e);for(;t&&!R(t);){if(I(t)&&!mn(t))return t;t=B(t)}return n}let r=hn(e,t);for(;r&&Nt(r)&&mn(r);)r=hn(r,t);return r&&R(r)&&mn(r)&&!zt(r)?n:r||Bt(e)||n}var _n=async function(e){let t=this.getOffsetParent||gn,n=this.getDimensions,r=await n(e.floating);return{reference:pn(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:r.width,height:r.height}}};function vn(e){return z(e).direction===`rtl`}var yn={convertOffsetParentRelativeRectToViewportRelativeRect:en,getDocumentElement:F,getClippingRect:dn,getOffsetParent:gn,getElementRects:_n,getClientRects:tn,getDimensions:fn,getScale:V,isElement:I,isRTL:vn},bn=Tt,xn=Et,Sn=St,Cn=(e,t,n)=>{let r=new Map,i={platform:yn,...n},a={...i.platform,_c:r};return xt(e,t,{...i,platform:a})},wn=class{constructor(e){this.editor=e,this.tooltip=null,this.currentLink=null,this.hideTimeout=null,this.visibilityChangeHandler=null,this.isTooltipHovered=!1,this.init()}init(){this.createTooltip(),this.editor.textarea.addEventListener(`selectionchange`,()=>this.checkCursorPosition()),this.editor.textarea.addEventListener(`keyup`,e=>{(e.key.includes(`Arrow`)||e.key===`Home`||e.key===`End`)&&this.checkCursorPosition()}),this.editor.textarea.addEventListener(`input`,()=>this.hide()),this.editor.textarea.addEventListener(`scroll`,()=>{this.currentLink&&this.positionTooltip(this.currentLink)}),this.editor.textarea.addEventListener(`blur`,()=>{this.isTooltipHovered||this.hide()}),this.visibilityChangeHandler=()=>{document.hidden&&this.hide()},document.addEventListener(`visibilitychange`,this.visibilityChangeHandler),this.tooltip.addEventListener(`mouseenter`,()=>{this.isTooltipHovered=!0,this.cancelHide()}),this.tooltip.addEventListener(`mouseleave`,()=>{this.isTooltipHovered=!1,this.scheduleHide()})}createTooltip(){this.tooltip=document.createElement(`div`),this.tooltip.className=`overtype-link-tooltip`,this.tooltip.innerHTML=`
...
</svg>`,title:`Bold (Ctrl+B)`,action:({editor:e})=>{Me(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},italic:{name:`italic`,actionId:`toggleItalic`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Italic (Ctrl+I)`,action:({editor:e})=>{Ne(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},code:{name:`code`,actionId:`toggleCode`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Inline Code`,action:({editor:e})=>{Pe(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},separator:{name:`separator`},link:{name:`link`,actionId:`insertLink`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Insert Link`,action:({editor:e})=>{Fe(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},h1:{name:`h1`,actionId:`toggleH1`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Heading 1`,action:({editor:e})=>{Be(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},h2:{name:`h2`,actionId:`toggleH2`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Heading 2`,action:({editor:e})=>{Ve(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},h3:{name:`h3`,actionId:`toggleH3`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Heading 3`,action:({editor:e})=>{He(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},bulletList:{name:`bulletList`,actionId:`toggleBulletList`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Bullet List`,action:({editor:e})=>{Ie(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},orderedList:{name:`orderedList`,actionId:`toggleNumberedList`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Numbered List`,action:({editor:e})=>{Le(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},taskList:{name:`taskList`,actionId:`toggleTaskList`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Task List`,action:({editor:e})=>{ze&&(ze(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0})))}},quote:{name:`quote`,actionId:`toggleQuote`,icon:`<svg viewBox="2 2 20 20">
...
</svg>`,title:`Quote`,action:({editor:e})=>{Re(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},upload:{name:`upload`,actionId:`uploadFile`,icon:`<svg viewBox="0 0 18 18">
...
`),o=a.length,s=a[a.length-1].length+1;this.options.statsFormatter?this.statsBar.innerHTML=this.options.statsFormatter({chars:n,words:r,lines:t.length,line:o,column:s}):this.statsBar.innerHTML=`
        ...
        `}_setupAutoResize(){this.container.classList.add(`overtype-auto-resize`),this.previousHeight=null,this._updateAutoHeight(),this.textarea.addEventListener(`input`,()=>this._updateAutoHeight()),window.addEventListener(`resize`,()=>this._updateAutoHeight())}_updateAutoHeight(){if(!this.options.autoResize)return;let e=this.textarea,t=this.preview,n=this.wrapper;if(this.container.dataset.mode===`preview`){n.style.removeProperty(`height`),t.style.removeProperty(`height`),t.style.removeProperty(`overflow-y`),e.style.removeProperty(`height`),e.style.removeProperty(`overflow-y`);return}let r=e.scrollTop;n.style.setProperty(`height`,`auto`,`important`),e.style.setProperty(`height`,`auto`,`important`);let i=e.scrollHeight;if(this.options.minHeight){let e=parseInt(this.options.minHeight);i=Math.max(i,e)}let a=`hidden`;if(this.options.maxHeight){let e=parseInt(this.options.maxHeight);i>e&&(i=e,a=`auto`)}let o=i+`px`;e.style.setProperty(`height`,o,`important`),e.style.setProperty(`overflow-y`,a,`important`),t.style.setProperty(`height`,o,`important`),t.style.setProperty(`overflow-y`,a,`important`),n.style.setProperty(`height`,o,`important`),e.scrollTop=r,t.scrollTop=r,this.previousHeight!==i&&(this.previousHeight=i)}showStats(e){this.options.showStats=e,e&&!this.statsBar?(this.statsBar=document.createElement(`div`),this.statsBar.className=`overtype-stats`,this.container.appendChild(this.statsBar),this._updateStats()):e&&this.statsBar?this._updateStats():!e&&this.statsBar&&(this.statsBar.remove(),this.statsBar=null)}showNormalEditMode(){return this.container.dataset.mode=`normal`,this.updatePreview(),this._updateAutoHeight(),requestAnimationFrame(()=>{this.textarea.scrollTop=this.preview.scrollTop,this.textarea.scrollLeft=this.preview.scrollLeft}),this}showPlainTextarea(){if(this.container.dataset.mode=`plain`,this._updateAutoHeight(),this.toolbar){let e=this.container.querySelector(`[data-action="toggle-plain"]`);e&&(e.classList.remove(`active`),e.title=`Show markdown preview`)}return this}showPreviewMode(){return this.container.dataset.mode=`preview`,this.updatePreview(),this._updateAutoHeight(),this}destroy(){if(e._autoInstances.delete(this),e._stopAutoListener(),this.fileUploadInitialized&&this._destroyFileUpload(),this.element.overTypeInstance=null,e.instances.delete(this.element),this.shortcuts&&this.shortcuts.destroy(),this.wrapper){let e=this.getValue();this.wrapper.remove(),this.element.textContent=e}this.initialized=!1}static init(t,n={}){return new e(t,n)}static initFromData(t,n={}){return e._resolveTargets(t).map(t=>{let r={...n};for(let n of t.attributes)if(n.name.startsWith(`data-ot-`)){let t=n.name.slice(8).replace(/-([a-z])/g,(e,t)=>t.toUpperCase());r[t]=e._parseDataValue(n.value)}return new e(t,r)[0]})}static _resolveTargets(e){if(e==null)throw Error(`Invalid target: must be selector string, Element, NodeList, or Array`);if(typeof e==`string`)return Array.from(document.querySelectorAll(e));if(e instanceof Element)return[e];if(e instanceof NodeList)return Array.from(e);if(Array.isArray(e))return e;if(typeof e.length==`number`)return Array.from(e);throw Error(`Invalid target: must be selector string, Element, NodeList, or Array`)}static _parseDataValue(e){return e===`true`?!0:e===`false`?!1:e===`null`?null:e!==``&&!isNaN(Number(e))?Number(e):e}static getInstance(t){let n;return n=t instanceof Element?t:e._resolveTargets(t)[0],n&&(n.overTypeInstance||e.instances.get(n))||null}static destroyAll(){document.querySelectorAll(`[data-overtype-instance]`).forEach(t=>{let n=e.getInstance(t);n&&n.destroy()})}static injectStyles(t=!1){if(e.stylesInjected&&!t)return;let n=document.querySelector(`style.overtype-styles`);n&&n.remove();let r=te({theme:e.currentTheme||m}),i=document.createElement(`style`);i.className=`overtype-styles`,i.textContent=r,document.head.appendChild(i),e.stylesInjected=!0}static setTheme(t,n=null){if(e._globalAutoTheme=!1,e._globalAutoCustomColors=null,t===`auto`){e._globalAutoTheme=!0,e._globalAutoCustomColors=n,e._startAutoListener(),e._applyGlobalTheme(v(`auto`),n);return}e._stopAutoListener(),e._applyGlobalTheme(t,n)}static _applyGlobalTheme(t,n=null){let r=typeof t==`string`?_(t):t;n&&(r=ee(r,n)),e.currentTheme=r,e.injectStyles(!0);let i=typeof r==`string`?r:r.name;document.querySelectorAll(`.overtype-container`).forEach(e=>{i&&e.setAttribute(`data-theme`,i)}),document.querySelectorAll(`.overtype-wrapper`).forEach(e=>{e.closest(`.overtype-container`)||i&&e.setAttribute(`data-theme`,i);let t=e._instance;t&&t.updatePreview()}),document.querySelectorAll(`overtype-editor`).forEach(e=>{i&&typeof e.setAttribute==`function`&&e.setAttribute(`theme`,i),typeof e.refreshTheme==`function`&&e.refreshTheme()})}static _startAutoListener(){e._autoMediaQuery||window.matchMedia&&(e._autoMediaQuery=window.matchMedia(`(prefers-color-scheme: dark)`),e._autoMediaListener=t=>{let n=t.matches?`cave`:`solar`;e._globalAutoTheme&&e._applyGlobalTheme(n,e._globalAutoCustomColors),e._autoInstances.forEach(e=>e._applyResolvedTheme(n))},e._autoMediaQuery.addEventListener(`change`,e._autoMediaListener))}static _stopAutoListener(){e._autoInstances.size>0||e._globalAutoTheme||e._autoMediaQuery&&(e._autoMediaQuery.removeEventListener(`change`,e._autoMediaListener),e._autoMediaQuery=null,e._autoMediaListener=null)}static setCodeHighlighter(e){f.setCodeHighlighter(e),document.querySelectorAll(`.overtype-wrapper`).forEach(e=>{let t=e._instance;t&&t.updatePreview&&t.updatePreview()}),document.querySelectorAll(`overtype-editor`).forEach(e=>{if(typeof e.getEditor==`function`){let t=e.getEditor();t&&t.updatePreview&&t.updatePreview()}})}static setCustomSyntax(e){f.setCustomSyntax(e),document.querySelectorAll(`.overtype-wrapper`).forEach(e=>{let t=e._instance;t&&t.updatePreview&&t.updatePreview()}),document.querySelectorAll(`overtype-editor`).forEach(e=>{if(typeof e.getEditor==`function`){let t=e.getEditor();t&&t.updatePreview&&t.updatePreview()}})}static initGlobalListeners(){e.globalListenersInitialized||=(document.addEventListener(`input`,e=>{if(e.target&&e.target.classList&&e.target.classList.contains(`overtype-input`)){let t=e.target.closest(`.overtype-wrapper`)?._instance;t&&t.handleInput(e)}}),document.addEventListener(`keydown`,e=>{if(e.target&&e.target.classList&&e.target.classList.contains(`overtype-input`)){let t=e.target.closest(`.overtype-wrapper`)?._instance;t&&t.handleKeydown(e)}}),document.addEventListener(`focus`,e=>{if(e.target&&e.target.classList&&e.target.classList.contains(`overtype-input`)){let t=e.target.closest(`.overtype-wrapper`)?._instance;t&&t.handleFocus(e)}},!0),document.addEventListener(`blur`,e=>{if(e.target&&e.target.classList&&e.target.classList.contains(`overtype-input`)){let t=e.target.closest(`.overtype-wrapper`)?._instance;t&&t.handleBlur(e)}},!0),document.addEventListener(`scroll`,e=>{if(e.target&&e.target.classList&&e.target.classList.contains(`overtype-input`)){let t=e.target.closest(`.overtype-wrapper`)?._instance;t&&t.handleScroll(e)}},!0),document.addEventListener(`selectionchange`,e=>{let t=document.activeElement;if(t&&t.classList.contains(`overtype-input`)){let e=t.closest(`.overtype-wrapper`)?._instance;e&&(e.options.showStats&&e.statsBar&&e._updateStats(),clearTimeout(e._selectionTimeout),e._selectionTimeout=setTimeout(()=>{e.updatePreview()},50))}}),!0)}};d(W,`instances`,new WeakMap),d(W,`stylesInjected`,!1),d(W,`globalListenersInitialized`,!1),d(W,`instanceCount`,0),d(W,`_autoMediaQuery`,null),d(W,`_autoMediaListener`,null),d(W,`_autoInstances`,new Set),d(W,`_globalAutoTheme`,!1),d(W,`_globalAutoCustomColors`,null);var G=W;G.MarkdownParser=f,G.ShortcutsManager=p,G.themes={solar:m,cave:_(`cave`)},G.getTheme=_,G.currentTheme=m;var kn=G;function An(e){return e.replace(/([\[\]\\])/g,`\\$1`)}function jn(e){return navigator.platform.toLowerCase().includes(`mac`)?e.metaKey:e.ctrlKey}var Mn=`CraftCms\\Cms\\Asset\\Elements\\Asset`,Nn=`asset`;function Pn(t,n,r,i){let a=null;function o(){if(!a){a=window.Craft.createElementSelectorModal(Mn,{closeOtherModals:!1,criteria:n,hideOnSelect:!0,modalTitle:e(`Choose an asset`),multiSelect:!1,onSelect:e=>{let[t]=e;t&&s(t)},sources:r});return}a.show()}function s(e){let n=e.siteId||e.$element?.data?.(`site-id`),r=`{${Nn}:${e.id}@${n}:url}`,a=An(String(e.$element?.data?.(`alt`)||e.label||``)),o=e.$element?.data?.(`kind`)===`image`?`![${a}](${r})`:`[${a||r}](${r})`;t.insertAtCursor(o),t.focus(),i.isActive()&&i.render(t.getValue())}return{open:o}}var Fn=[`http:`,`https:`,`mailto:`,`tel:`];function In(e,t){let n=!1,r=null;function i(){n=!1,r&&=(window.clearTimeout(r),null)}function a(){n=!0,r&&window.clearTimeout(r),r=window.setTimeout(()=>{n=!1,r=null},1e3)}function o(n){let{selectionEnd:r,selectionStart:i,value:a}=e.textarea,o=a.slice(i,r),s=`[${o}](${n})`;e.textarea.setRangeText(s,i,r,`end`),o||e.textarea.setSelectionRange(i+1,i+1),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0})),t.isActive()&&t.render(e.getValue())}function s(e){if(n){i();return}let t=e.clipboardData?.getData(`text/plain`).trim();!t||!l(t)||(e.preventDefault(),o(t))}function c(e){jn(e)&&e.key.toLowerCase()===`v`&&e.shiftKey&&a()}function l(e){try{let t=new URL(e);return Fn.includes(t.protocol)}catch{return!1}}return e.textarea.addEventListener(`keydown`,c),e.textarea.addEventListener(`paste`,s),()=>{i(),e.textarea.removeEventListener(`keydown`,c),e.textarea.removeEventListener(`paste`,s)}}var K=e=>({url:K.url(e),method:`post`});K.definition={methods:[`post`],url:`/admin/actions/app/render-elements`},K.url=e=>K.definition.url+a(e),K.post=e=>({url:K.url(e),method:`post`});var q=e=>({url:q.url(e),method:`post`});q.definition={methods:[`post`],url:`/admin/actions/app/render-components`},q.url=e=>q.definition.url+a(e),q.post=e=>({url:q.url(e),method:`post`});var J=e=>({url:J.url(e),method:`post`});J.definition={methods:[`post`],url:`/admin/actions/app/render-markdown`},J.url=e=>J.definition.url+a(e),J.post=e=>({url:J.url(e),method:`post`});function Ln(n,r,i){let a=!1,o=0,s=null,c=t({flavor:r,markdown:``});function l(){let e=n.container.querySelector(`[data-button="preview"]`);e&&(e.classList.toggle(`active`,a),e.setAttribute(`aria-pressed`,a.toString()))}async function u(t){let l=++o;s&&window.clearTimeout(s),s=window.setTimeout(async()=>{try{c.flavor=r,c.markdown=t;let e=await c.post(J().url);a&&l===o&&(n.preview.innerHTML=e.html)}catch{a&&l===o&&(n.preview.textContent=e(`Couldn’t render Markdown preview.`))}},i)}async function d(){if(a=!a,l(),!a){n.showNormalEditMode(),n.focus();return}n.showPreviewMode(),await u(n.getValue())}return{destroy(){s&&=(window.clearTimeout(s),null)},isActive:()=>a,render:u,toggle:d}}function Rn(e,t){async function n(n){if(!jn(n))return;let r=zn(n);if(r!==null){if(n.preventDefault(),r===`togglePreview`){await t.toggle();return}await e.performAction(r,n)}}let r=e=>void n(e);return e.textarea.addEventListener(`keydown`,r),()=>{e.textarea.removeEventListener(`keydown`,r)}}function zn(e){let t=e.key.toLowerCase();return t===`e`&&!e.shiftKey?`toggleCode`:t===`.`&&e.shiftKey?`toggleQuote`:t===`p`&&e.shiftKey?`togglePreview`:null}function Bn(){let e=`var(--c-input-fill, var(--c-form-control-fill, var(--c-surface-form)))`,t=`var(--c-input-border-color, var(--c-form-control-border-color, var(--c-color-neutral-border-quiet)))`,n=`var(--c-color-neutral-fill-quiet)`,r=`var(--c-color-neutral-on-quiet, var(--c-text-default))`,i=`var(--c-input-text, var(--c-text-default))`;return{name:`craft`,colors:{bgPrimary:e,bgSecondary:e,border:t,code:i,codeBg:n,cursor:i,del:i,h1:i,h2:i,h3:i,link:i,listMarker:i,placeholder:`var(--c-text-quiet)`,primary:r,rawLine:i,selection:`var(--markdown-field-selection-bg, var(--c-color-accent-fill-quiet))`,strong:i,syntax:i,syntaxMarker:i,text:i,textPrimary:i,textSecondary:i,toolbarActive:n,toolbarBg:e,toolbarBorder:t,toolbarHover:n,toolbarIcon:r,em:i,blockquote:i,hr:i},previewColors:{bg:`transparent`,blockquote:i,code:i,codeBg:n,em:i,h1:i,h2:i,h3:i,hr:i,link:i,strong:i,text:i}}}var Vn=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M0 64C0 46.3 14.3 32 32 32l48 0 16 0 128 0c70.7 0 128 57.3 128 128c0 31.3-11.3 60.1-30 82.3c37.1 22.4 62 63.1 62 109.7c0 70.7-57.3 128-128 128L96 480l-16 0-48 0c-17.7 0-32-14.3-32-32s14.3-32 32-32l16 0 0-160L48 96 32 96C14.3 96 0 81.7 0 64zM224 224c35.3 0 64-28.7 64-64s-28.7-64-64-64L112 96l0 128 112 0zM112 288l0 128 144 0c35.3 0 64-28.7 64-64s-28.7-64-64-64l-32 0-112 0z"/></svg>`,Hn=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM169.8 165.3c7.9-22.3 29.1-37.3 52.8-37.3l58.3 0c34.9 0 63.1 28.3 63.1 63.1c0 22.6-12.1 43.5-31.7 54.8L280 264.4c-.2 13-10.9 23.6-24 23.6c-13.3 0-24-10.7-24-24l0-13.5c0-8.6 4.6-16.5 12.1-20.8l44.3-25.4c4.7-2.7 7.6-7.7 7.6-13.1c0-8.4-6.8-15.1-15.1-15.1l-58.3 0c-3.4 0-6.4 2.1-7.5 5.3l-.4 1.2c-4.4 12.5-18.2 19-30.6 14.6s-19-18.2-14.6-30.6l.4-1.2zM224 352a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z"/></svg>`,Un=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M392.8 1.2c-17-4.9-34.7 5-39.6 22l-128 448c-4.9 17 5 34.7 22 39.6s34.7-5 39.6-22l128-448c4.9-17-5-34.7-22-39.6zm80.6 120.1c-12.5 12.5-12.5 32.8 0 45.3L562.7 256l-89.4 89.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0l112-112c12.5-12.5 12.5-32.8 0-45.3l-112-112c-12.5-12.5-32.8-12.5-45.3 0zm-306.7 0c-12.5-12.5-32.8-12.5-45.3 0l-112 112c-12.5 12.5-12.5 32.8 0 45.3l112 112c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L77.3 256l89.4-89.4c12.5-12.5 12.5-32.8 0-45.3z"/></svg>`,Wn=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M288 32c-80.8 0-145.5 36.8-192.6 80.6C48.6 156 17.3 208 2.5 243.7c-3.3 7.9-3.3 16.7 0 24.6C17.3 304 48.6 356 95.4 399.4C142.5 443.2 207.2 480 288 480s145.5-36.8 192.6-80.6c46.8-43.5 78.1-95.4 93-131.1c3.3-7.9 3.3-16.7 0-24.6c-14.9-35.7-46.2-87.7-93-131.1C433.5 68.8 368.8 32 288 32zM144 256a144 144 0 1 1 288 0 144 144 0 1 1 -288 0zm144-64c0 35.3-28.7 64-64 64c-7.1 0-13.9-1.2-20.3-3.3c-5.5-1.8-11.9 1.6-11.7 7.4c.3 6.9 1.3 13.8 3.2 20.7c13.7 51.2 66.4 81.6 117.6 67.9s81.6-66.4 67.9-117.6c-11.1-41.5-47.8-69.4-88.6-71.1c-5.8-.2-9.2 6.1-7.4 11.7c2.1 6.4 3.3 13.2 3.3 20.3z"/></svg>`,Gn=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M64 96c0-17.7-14.3-32-32-32S0 78.3 0 96L0 256 0 416c0 17.7 14.3 32 32 32s32-14.3 32-32l0-128 192 0 0 128c0 17.7 14.3 32 32 32s32-14.3 32-32l0-160 0-160c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 128L64 224 64 96zm448 0c0-11.1-5.7-21.4-15.2-27.2s-21.2-6.4-31.1-1.4l-64 32c-15.8 7.9-22.2 27.1-14.3 42.9s27.1 22.2 42.9 14.3l17.7-8.8L448 384l-32 0c-17.7 0-32 14.3-32 32s14.3 32 32 32l64 0 64 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-32 0 0-288z"/></svg>`,Kn=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M64 96c0-17.7-14.3-32-32-32S0 78.3 0 96L0 256 0 416c0 17.7 14.3 32 32 32s32-14.3 32-32l0-128 192 0 0 128c0 17.7 14.3 32 32 32s32-14.3 32-32l0-160 0-160c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 128L64 224 64 96zm385.9 47.4c11.6-9.9 26.4-15.4 41.7-15.4l4.5 0c35.3 0 64 28.7 64 64l0 5.8c0 17.9-7.5 35.1-20.8 47.2L378.4 392.4c-9.7 8.9-13 22.9-8.2 35.2S386.8 448 400 448l208 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-125.7 0 100.2-91.9c26.4-24.2 41.5-58.5 41.5-94.4l0-5.8c0-70.7-57.3-128-128-128l-4.5 0c-30.6 0-60.1 10.9-83.3 30.8l-29 24.9c-13.4 11.5-15 31.7-3.5 45.1s31.7 15 45.1 3.5l29-24.9z"/></svg>`,qn=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M64 96c0-17.7-14.3-32-32-32S0 78.3 0 96L0 256 0 416c0 17.7 14.3 32 32 32s32-14.3 32-32l0-128 192 0 0 128c0 17.7 14.3 32 32 32s32-14.3 32-32l0-160 0-160c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 128L64 224 64 96zM400 64c-17.7 0-32 14.3-32 32s14.3 32 32 32l114.7 0-89.4 89.4c-9.2 9.2-11.9 22.9-6.9 34.9s16.6 19.8 29.6 19.8l72 0c30.9 0 56 25.1 56 56s-25.1 56-56 56l-64.6 0c-11.7 0-21.7-8.5-23.7-20.1l-.2-1.2c-2.9-17.4-19.4-29.2-36.8-26.3s-29.2 19.4-26.3 36.8l.2 1.2c7.1 42.4 43.8 73.5 86.8 73.5l64.6 0c66.3 0 120-53.7 120-120c0-64.6-51-117.2-114.9-119.9l89.5-89.5c9.2-9.2 11.9-22.9 6.9-34.9s-16.6-19.8-29.6-19.8L400 64z"/></svg>`,Jn=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M479 103.8L441 256l135 0 0-160c0-17.7 14.3-32 32-32s32 14.3 32 32l0 320c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-96-176 0c-9.9 0-19.2-4.5-25.2-12.3s-8.2-17.9-5.8-27.5l48-192c4.3-17.1 21.7-27.6 38.8-23.3s27.6 21.7 23.3 38.8zM32 64c17.7 0 32 14.3 32 32l0 128 192 0 0-128c0-17.7 14.3-32 32-32s32 14.3 32 32l0 160 0 160c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-128L64 288l0 128c0 17.7-14.3 32-32 32s-32-14.3-32-32L0 256 0 96C0 78.3 14.3 64 32 64z"/></svg>`,Yn=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M64 96c0-17.7-14.3-32-32-32S0 78.3 0 96L0 256 0 416c0 17.7 14.3 32 32 32s32-14.3 32-32l0-128 192 0 0 128c0 17.7 14.3 32 32 32s32-14.3 32-32l0-160 0-160c0-17.7-14.3-32-32-32s-32 14.3-32 32l0 128L64 224 64 96zM432 64c-15.1 0-28.2 10.6-31.3 25.4l-32 152c-2 9.4 .4 19.3 6.5 26.8s15.2 11.8 24.8 11.8l124 0c28.7 0 52 23.3 52 52s-23.3 52-52 52l-67.6 0c-10.3 0-19.5-6.6-22.8-16.4l-3.2-9.7c-5.6-16.8-23.7-25.8-40.5-20.2s-25.8 23.7-20.2 40.5l3.2 9.7c12 35.9 45.6 60.2 83.5 60.2l67.6 0c64.1 0 116-51.9 116-116s-51.9-116-116-116l-84.6 0L458 128l118 0c17.7 0 32-14.3 32-32s-14.3-32-32-32L432 64z"/></svg>`,Xn=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M537 116l-35.3 44.1C578.6 163.1 640 226.4 640 304c0 79.5-64.5 144-144 144s-144-64.5-144-144c0-38.3 13-75.5 37-105.5L487 76c11-13.8 31.2-16 45-5s16 31.2 5 45zM416 304a80 80 0 1 0 160 0 80 80 0 1 0 -160 0zM32 64c17.7 0 32 14.3 32 32l0 128 192 0 0-128c0-17.7 14.3-32 32-32s32 14.3 32 32l0 160 0 160c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-128L64 288l0 128c0 17.7-14.3 32-32 32s-32-14.3-32-32L0 256 0 96C0 78.3 14.3 64 32 64z"/></svg>`,Zn=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><path d="M128 64c0-17.7 14.3-32 32-32l192 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-58.7 0L160 416l64 0c17.7 0 32 14.3 32 32s-14.3 32-32 32L32 480c-17.7 0-32-14.3-32-32s14.3-32 32-32l58.7 0L224 96l-64 0c-17.7 0-32-14.3-32-32z"/></svg>`,Qn=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512"><path d="M579.8 267.7c56.5-56.5 56.5-148 0-204.5c-50-50-128.8-56.5-186.3-15.4l-1.6 1.1c-14.4 10.3-17.7 30.3-7.4 44.6s30.3 17.7 44.6 7.4l1.6-1.1c32.1-22.9 76-19.3 103.8 8.6c31.5 31.5 31.5 82.5 0 114L422.3 334.8c-31.5 31.5-82.5 31.5-114 0c-27.9-27.9-31.5-71.8-8.6-103.8l1.1-1.6c10.3-14.4 6.9-34.4-7.4-44.6s-34.4-6.9-44.6 7.4l-1.1 1.6C206.5 251.2 213 330 263 380c56.5 56.5 148 56.5 204.5 0L579.8 267.7zM60.2 244.3c-56.5 56.5-56.5 148 0 204.5c50 50 128.8 56.5 186.3 15.4l1.6-1.1c14.4-10.3 17.7-30.3 7.4-44.6s-30.3-17.7-44.6-7.4l-1.6 1.1c-32.1 22.9-76 19.3-103.8-8.6C74 372 74 321 105.5 289.5L217.7 177.2c31.5-31.5 82.5-31.5 114 0c27.9 27.9 31.5 71.8 8.6 103.9l-1.1 1.6c-10.3 14.4-6.9 34.4 7.4 44.6s34.4 6.9 44.6-7.4l1.1-1.6C433.5 260.8 427 182 377 132c-56.5-56.5-148-56.5-204.5 0L60.2 244.3z"/></svg>`,$n=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M152.1 38.2c9.9 8.9 10.7 24 1.8 33.9l-72 80c-4.4 4.9-10.6 7.8-17.2 7.9s-12.9-2.4-17.6-7L7 113C-2.3 103.6-2.3 88.4 7 79s24.6-9.4 33.9 0l22.1 22.1 55.1-61.2c8.9-9.9 24-10.7 33.9-1.8zm0 160c9.9 8.9 10.7 24 1.8 33.9l-72 80c-4.4 4.9-10.6 7.8-17.2 7.9s-12.9-2.4-17.6-7L7 273c-9.4-9.4-9.4-24.6 0-33.9s24.6-9.4 33.9 0l22.1 22.1 55.1-61.2c8.9-9.9 24-10.7 33.9-1.8zM224 96c0-17.7 14.3-32 32-32l224 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-224 0c-17.7 0-32-14.3-32-32zm0 160c0-17.7 14.3-32 32-32l224 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-224 0c-17.7 0-32-14.3-32-32zM160 416c0-17.7 14.3-32 32-32l288 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-288 0c-17.7 0-32-14.3-32-32zM48 368a48 48 0 1 1 0 96 48 48 0 1 1 0-96z"/></svg>`,er=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M24 56c0-13.3 10.7-24 24-24l32 0c13.3 0 24 10.7 24 24l0 120 16 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-80 0c-13.3 0-24-10.7-24-24s10.7-24 24-24l16 0 0-96-8 0C34.7 80 24 69.3 24 56zM86.7 341.2c-6.5-7.4-18.3-6.9-24 1.2L51.5 357.9c-7.7 10.8-22.7 13.3-33.5 5.6s-13.3-22.7-5.6-33.5l11.1-15.6c23.7-33.2 72.3-35.6 99.2-4.9c21.3 24.4 20.8 60.9-1.1 84.7L86.8 432l33.2 0c13.3 0 24 10.7 24 24s-10.7 24-24 24l-88 0c-9.5 0-18.2-5.6-22-14.4s-2.1-18.9 4.3-25.9l72-78c5.3-5.8 5.4-14.6 .3-20.5zM224 64l256 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-256 0c-17.7 0-32-14.3-32-32s14.3-32 32-32zm0 160l256 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-256 0c-17.7 0-32-14.3-32-32s14.3-32 32-32zm0 160l256 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-256 0c-17.7 0-32-14.3-32-32s14.3-32 32-32z"/></svg>`,tr=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M64 144a48 48 0 1 0 0-96 48 48 0 1 0 0 96zM192 64c-17.7 0-32 14.3-32 32s14.3 32 32 32l288 0c17.7 0 32-14.3 32-32s-14.3-32-32-32L192 64zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32l288 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-288 0zm0 160c-17.7 0-32 14.3-32 32s14.3 32 32 32l288 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-288 0zM64 464a48 48 0 1 0 0-96 48 48 0 1 0 0 96zm48-208a48 48 0 1 0 -96 0 48 48 0 1 0 96 0z"/></svg>`,nr=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M364.2 83.8c-24.4-24.4-64-24.4-88.4 0l-184 184c-42.1 42.1-42.1 110.3 0 152.4s110.3 42.1 152.4 0l152-152c10.9-10.9 28.7-10.9 39.6 0s10.9 28.7 0 39.6l-152 152c-64 64-167.6 64-231.6 0s-64-167.6 0-231.6l184-184c46.3-46.3 121.3-46.3 167.6 0s46.3 121.3 0 167.6l-176 176c-28.6 28.6-75 28.6-103.6 0s-28.6-75 0-103.6l144-144c10.9-10.9 28.7-10.9 39.6 0s10.9 28.7 0 39.6l-144 144c-6.7 6.7-6.7 17.7 0 24.4s17.7 6.7 24.4 0l176-176c24.4-24.4 24.4-64 0-88.4z"/></svg>`,rr=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M0 216C0 149.7 53.7 96 120 96l8 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-8 0c-30.9 0-56 25.1-56 56l0 8 64 0c35.3 0 64 28.7 64 64l0 64c0 35.3-28.7 64-64 64l-64 0c-35.3 0-64-28.7-64-64l0-32 0-32 0-72zm256 0c0-66.3 53.7-120 120-120l8 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-8 0c-30.9 0-56 25.1-56 56l0 8 64 0c35.3 0 64 28.7 64 64l0 64c0 35.3-28.7 64-64 64l-64 0c-35.3 0-64-28.7-64-64l0-32 0-32 0-72z"/></svg>`,ir=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M161.3 144c3.2-17.2 14-30.1 33.7-38.6c21.1-9 51.8-12.3 88.6-6.5c11.9 1.9 48.8 9.1 60.1 12c17.1 4.5 34.6-5.6 39.2-22.7s-5.6-34.6-22.7-39.2c-14.3-3.8-53.6-11.4-66.6-13.4c-44.7-7-88.3-4.2-123.7 10.9c-36.5 15.6-64.4 44.8-71.8 87.3c-.1 .6-.2 1.1-.2 1.7c-2.8 23.9 .5 45.6 10.1 64.6c4.5 9 10.2 16.9 16.7 23.9L32 224c-17.7 0-32 14.3-32 32s14.3 32 32 32l448 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-209.9 0-.4-.1-1.1-.3c-36-10.8-65.2-19.6-85.2-33.1c-9.3-6.3-15-12.6-18.2-19.1c-3.1-6.1-5.2-14.6-3.8-27.4zM348.9 337.2c2.7 6.5 4.4 15.8 1.9 30.1c-3 17.6-13.8 30.8-33.9 39.4c-21.1 9-51.7 12.3-88.5 6.5c-18-2.9-49.1-13.5-74.4-22.1c-5.6-1.9-11-3.7-15.9-5.4c-16.8-5.6-34.9 3.5-40.5 20.3s3.5 34.9 20.3 40.5c3.6 1.2 7.9 2.7 12.7 4.3c0 0 0 0 0 0s0 0 0 0c24.9 8.5 63.6 21.7 87.6 25.6c0 0 0 0 0 0l.2 0c44.7 7 88.3 4.2 123.7-10.9c36.5-15.6 64.4-44.8 71.8-87.3c3.6-21 2.7-40.4-3.1-58.1l-75.7 0c7 5.6 11.4 11.2 13.9 17.2z"/></svg>`,ar=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path d="M288 109.3L288 352c0 17.7-14.3 32-32 32s-32-14.3-32-32l0-242.7-73.4 73.4c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3l128-128c12.5-12.5 32.8-12.5 45.3 0l128 128c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0L288 109.3zM64 352l128 0c0 35.3 28.7 64 64 64s64-28.7 64-64l128 0c35.3 0 64 28.7 64 64l0 32c0 35.3-28.7 64-64 64L64 512c-35.3 0-64-28.7-64-64l0-32c0-35.3 28.7-64 64-64zM432 456a24 24 0 1 0 0-48 24 24 0 1 0 0 48z"/></svg>`,or={prefix:`~~`,suffix:`~~`,trimFirst:!0},sr={bold:X(Vn),"circle-question":X(Hn),code:X(Un),eye:X(Wn),h1:X(Gn),h2:X(Kn),h3:X(qn),h4:X(Jn),h5:X(Yn),h6:X(Xn),italic:X(Zn),link:X(Qn),"list-check":X($n),"list-ol":X(er),"list-ul":X(tr),paperclip:X(nr),"quotes-left":X(rr),strikethrough:X(ir),upload:X(ar)};function cr(e,t){let n=new Set(e.toolbarButtons),r=new Set(e.uploadFolderId?[`upload`]:[]);e.assetSources.length||n.delete(`asset`);let i=[];for(let e of lr(t)){let t=e.filter(e=>n.has(e.name)||r.has(e.name));t.length&&(i.length&&i.push(U.separator),i.push(...t))}return i}function lr(t){return[[Y(U.bold,e(`Bold`),`bold`),Y(U.italic,e(`Italic`),`italic`),dr(`strikethrough`,`strikethrough`,e(`Strikethrough`),({editor:e})=>{ne.applyCustomFormat(e.textarea,or)}),Y(U.code,e(`Code`),`code`)],[Y(U.h1,e(`Big Heading`),`h1`,`heading-1`),Y(U.h2,e(`Medium Heading`),`h2`,`heading-2`),Y(U.h3,e(`Small Heading`),`h3`,`heading-3`),ur(4,e(`Heading 4`)),ur(5,e(`Heading 5`)),ur(6,e(`Heading 6`)),Y(U.quote,e(`Quote`),`quotes-left`)],[Y(U.bulletList,e(`Bulleted List`),`list-ul`,`unordered-list`),Y(U.orderedList,e(`Numbered List`),`list-ol`,`ordered-list`),Y(U.taskList,e(`Check List`),`list-check`,`check-list`)],[Y(U.link,e(`Link`),`link`),dr(`asset`,`paperclip`,e(`Asset`),t.openAssetSelector),Y(U.upload,e(`Upload File`),`upload`)],[dr(`preview`,`eye`,e(`Preview`),t.togglePreview),dr(`guide`,`circle-question`,e(`Markdown Guide`),()=>{window.open(`https://www.markdownguide.org/basic-syntax/`,`_blank`,`noopener`)})]]}function ur(e,t){return dr(`heading-${e}`,`h${e}`,t,({editor:t})=>{ne.insertHeader(t.textarea,e,!0),t.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))})}function Y(e,t,n,r=e.name){return{...e,icon:sr[n]??e.icon,name:r,title:t}}function dr(e,t,n,r){return{action:r,icon:sr[t]??``,name:e,title:n}}function X(e){return e.replace(`<svg `,`<svg aria-hidden="true" focusable="false" `)}var Z=e=>({url:Z.url(e),method:`post`});Z.definition={methods:[`post`],url:`/admin/actions/assets/upload`},Z.url=e=>Z.definition.url+a(e),Z.post=e=>({url:Z.url(e),method:`post`});var Q=e=>({url:Q.url(e),method:`post`});Q.definition={methods:[`post`],url:`/admin/actions/assets/replace-file`},Q.url=e=>Q.definition.url+a(e),Q.post=e=>({url:Q.url(e),method:`post`});var fr=`asset`,{flash:pr}=o();function mr(e,t){if(e)return{batch:!1,enabled:!0,maxSize:2**53-1,onInsertFile:n=>hr(n,e,t)}}async function hr(e,n,r){let i=t({"assets-upload":e,folderId:n.toString()});try{return gr(e,await i.post(Z().url),r)}catch(e){throw pr(`error`,_r(e)),e}}function gr(t,n,r){if(!n.assetId)throw Error(n.message||e(`Couldn’t upload file.`));let i=An(n.filename||t.name),a=`{${fr}:${n.assetId}@${r}:url}`;return t.type.startsWith(`image/`)?`![${i}](${a})`:`[${i||a}](${a})`}function _r(t){let n=t.response?.data;return(typeof n==`string`?vr(n):void 0)||(t instanceof Error?t.message:e(`Couldn’t upload file.`))}function vr(e){try{return JSON.parse(e).message}catch{return}}var $=class extends n{constructor(...e){super(...e),this.assetController=null,this.cleanups=[],this.editor=null,this.previewController=null,this.resolvedInputId=null,this.assetAnyUploader=!1,this.assetSources=[],this.describedBy=null,this.disabled=!1,this.flavor=`gfm`,this.maxLength=null,this.name=null,this.placeholder=null,this.previewDelay=250,this.rows=8,this.showStats=!1,this.toolbarButtons=[],this.showToolbar=!0,this.uploadFolderId=null,this.uploadSiteId=``}connectedCallback(){super.connectedCallback(),this.initializeEditor()}disconnectedCallback(){super.disconnectedCallback(),this.destroy()}initializeEditor(){if(this.editor)return;let e=this.releaseInputIdToTextarea(),t=cr({assetSources:this.assetSources,toolbarButtons:this.toolbarButtons,uploadFolderId:this.uploadFolderId},{openAssetSelector:()=>this.assetController?.open(),togglePreview:()=>this.previewController?.toggle()}),[n]=new kn(this,this.editorOptions(e,t));if(!n)return;this.editor=n,this.editor.preview.classList.add(`markdown-field-preview`);let r=Ln(n,this.flavor,this.previewDelay);this.previewController=r,this.assetController=Pn(n,this.assetAnyUploader?{uploaderId:null}:{},this.assetSources,r),this.cleanups=[()=>r.destroy(),In(n,r),Rn(n,r)],this.syncInitialFormValue(n.textarea.name)}releaseInputIdToTextarea(){return this.resolvedInputId===null?(this.resolvedInputId=this.id,this.resolvedInputId&&(this.id=`${this.resolvedInputId}-editor`),this.resolvedInputId):this.resolvedInputId}editorOptions(e,t){let n={autoResize:!0,fontFamily:`var(--c-font-mono)`,fontSize:`var(--c-text-base)`,lineHeight:`var(--c-leading-normal)`,maxHeight:null,minHeight:void 0,padding:`calc(var(--c-input-spacing-block, var(--c-spacing-md)) + var(--c-spacing-xs))`,placeholder:this.placeholder??``,showStats:this.showStats,smartLists:!0,spellcheck:!1,textareaProps:this.textareaProps(e),theme:Bn(),toolbar:!this.disabled&&this.showToolbar&&(t?.length??0)>0,toolbarButtons:t,value:this.textContent??``},r=this.disabled?void 0:mr(this.uploadFolderId,this.uploadSiteId);return r&&(n.fileUpload=r),n}textareaProps(e){let t={class:`nicetext code`};return e&&(t.id=e),this.name&&(t.name=this.name),this.describedBy&&(t[`aria-describedby`]=this.describedBy),this.maxLength&&(t.maxlength=this.maxLength),this.disabled&&(t.disabled=`disabled`),t}syncInitialFormValue(e){if(!e)return;let t=this.closest(`form`),n=window.jQuery??window.$;if(!t||!n)return;let r=n(t),i=r.data(`initialSerializedValue`);if(typeof i!=`string`)return;let a=r.data(`serializer`),o=typeof a==`function`?a():r.serialize();this.serializedWithoutInput(o,e)===i&&r.data(`initialSerializedValue`,o)}serializedWithoutInput(e,t){return e.split(`&`).filter(e=>this.serializedParamName(e)!==t).join(`&`)}serializedParamName(e){let[t=``]=e.split(`=`);return decodeURIComponent(t.replace(/\+/g,`%20`))}destroy(){for(let e of this.cleanups)e();this.editor?.destroy(),this.assetController=null,this.cleanups=[],this.editor=null,this.previewController=null}createRenderRoot(){return this}shouldUpdate(){return!1}};s([r({attribute:`asset-any-uploader`,type:Boolean})],$.prototype,`assetAnyUploader`,void 0),s([r({attribute:`asset-sources`,type:Array})],$.prototype,`assetSources`,void 0),s([r({attribute:`described-by`})],$.prototype,`describedBy`,void 0),s([r({type:Boolean})],$.prototype,`disabled`,void 0),s([r()],$.prototype,`flavor`,void 0),s([r({attribute:`max-length`,type:Number})],$.prototype,`maxLength`,void 0),s([r()],$.prototype,`name`,void 0),s([r()],$.prototype,`placeholder`,void 0),s([r({attribute:`preview-delay`,type:Number})],$.prototype,`previewDelay`,void 0),s([r({type:Number})],$.prototype,`rows`,void 0),s([r({attribute:`show-stats`,type:Boolean})],$.prototype,`showStats`,void 0),s([r({attribute:`toolbar-buttons`,type:Array})],$.prototype,`toolbarButtons`,void 0),s([r({attribute:`show-toolbar`,type:Boolean})],$.prototype,`showToolbar`,void 0),s([r({attribute:`upload-folder-id`,type:Number})],$.prototype,`uploadFolderId`,void 0),s([r({attribute:`upload-site-id`})],$.prototype,`uploadSiteId`,void 0),$=s([i(`craft-markdown-field`)],$);var yr=$;export{yr as default};
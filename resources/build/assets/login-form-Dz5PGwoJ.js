...
`,N=class extends e{constructor(e){if(super(e),this.it=d,e.type!==r.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===d||e==null)return this._t=void 0,this.it=e;if(e===u)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};N.directiveName=`unsafeHTML`,N.resultType=1;var P=n(N),F=class extends s{static{this.METHOD=`totp`}get endpoint(){return`auth/verify-totp`}renderInput(){return c`
      <craft-input
        ...
        aria-required="true"
      ></craft-input>
    `}};g([h(`craft-input.totp-code`)],F.prototype,`_input`,void 0),s.register(`craft-totp-form`,F);var I=class extends s{static{this.METHOD=`recovery-codes`}get endpoint(){return`auth/verify-recovery-code`}renderInput(){return c`
      <craft-input

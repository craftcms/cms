...
</svg>`,title:`Bold (Ctrl+B)`,isActive:({activeFormats:e})=>e.includes(`bold`),action:({editor:e})=>{Ne(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},italic:{name:`italic`,actionId:`toggleItalic`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Italic (Ctrl+I)`,isActive:({activeFormats:e})=>e.includes(`italic`),action:({editor:e})=>{Pe(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},code:{name:`code`,actionId:`toggleCode`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Inline Code`,isActive:()=>!1,action:({editor:e})=>{Fe(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},separator:{name:`separator`},link:{name:`link`,actionId:`insertLink`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Heading 1`,isActive:({activeFormats:e})=>e.includes(`header`),action:({editor:e})=>{He(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},h2:{name:`h2`,actionId:`toggleH2`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Heading 2`,isActive:({activeFormats:e})=>e.includes(`header-2`),action:({editor:e})=>{Ue(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},h3:{name:`h3`,actionId:`toggleH3`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Heading 3`,isActive:({activeFormats:e})=>e.includes(`header-3`),action:({editor:e})=>{We(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},bulletList:{name:`bulletList`,actionId:`toggleBulletList`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Bullet List`,isActive:({activeFormats:e})=>e.includes(`bullet-list`),action:({editor:e})=>{Le(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},orderedList:{name:`orderedList`,actionId:`toggleNumberedList`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Numbered List`,isActive:({activeFormats:e})=>e.includes(`numbered-list`),action:({editor:e})=>{Re(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},taskList:{name:`taskList`,actionId:`toggleTaskList`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Task List`,isActive:({activeFormats:e})=>e.includes(`task-list`),action:({editor:e})=>{Be&&(Be(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0})))}},quote:{name:`quote`,actionId:`toggleQuote`,icon:`<svg viewBox="2 2 20 20">
...
</svg>`,title:`Quote`,isActive:({activeFormats:e})=>e.includes(`quote`),action:({editor:e})=>{ze(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},upload:{name:`upload`,actionId:`uploadFile`,icon:`<svg viewBox="0 0 18 18">

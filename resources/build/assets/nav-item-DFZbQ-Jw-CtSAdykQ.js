...
`,q=class extends i{constructor(){super(),this.altText=null,this.badgeCount=null,this.badgeCountSuffix=null,this.variant=`primary`,this.id=this.id||`badge-${Math.floor(Math.random()*1e9).toString()}`}showCount(){return this.badgeCount!==null&&this.badgeCount>0}truncatedNumber(){if(this.showCount)return this.badgeCount>99?`99+`:this.badgeCount.toString()}getBadgeRole(){return this.altText?`img`:r}getLabelId(){return`${this.id}-label`}renderBadgeContents(){return e`
    ...
    `}};q.styles=[K],C([a()],q.prototype,`altText`,void 0),C([a()],q.prototype,`badgeCount`,void 0),C([a()],q.prototype,`badgeCountSuffix`,void 0),C([a()],q.prototype,`variant`,void 0),C([a()],q.prototype,`id`,void 0),customElements.get(`craft-badge-indicator`)||customElements.define(`craft-badge-indicator`,q);var J=`important`,Y=` !`+J,X=T(class extends E{constructor(e){if(super(e),e.type!==w.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`}),``)}update(e,[t]){let{style:r}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?r.removeProperty(e):r[e]=null);for(let e in t){let n=t[e];if(n!=null){this.ft.add(e);let t=typeof n==`string`&&n.endsWith(Y);e.includes(`-`)||t?r.setProperty(e,t?n.slice(0,-11):n,t?J:``):r[e]=n}}return n}}),Z=t`
  :host {
...
`,Q=class extends i{constructor(){super(),this.active=!1,this.external=!1,this.indicator=!1,this.iconOnly=!1,this.flush=!1,this.subnavState=`closed`,this.id=this.id||Math.random().toString(36).substring(2,6)}connectedCallback(){super.connectedCallback(),this.subnavState=this.active?`open`:`closed`}toggleSubnav(e){e.preventDefault(),e.stopPropagation(),this.subnavState=this.subnavState===`open`?`closed`:`open`}renderIconItem(t){let n=`item-${this.id}`;return e`
    ...
    `}};Q.styles=Z,C([a()],Q.prototype,`icon`,void 0),C([a()],Q.prototype,`href`,void 0),C([a({type:Boolean,reflect:!0})],Q.prototype,`active`,void 0),C([a({type:Boolean})],Q.prototype,`external`,void 0),C([a({type:Boolean})],Q.prototype,`indicator`,void 0),C([a()],Q.prototype,`id`,void 0),C([a({reflect:!0,type:Boolean,attribute:`icon-only`})],Q.prototype,`iconOnly`,void 0),C([a()],Q.prototype,`flush`,void 0),C([o()],Q.prototype,`subnavState`,void 0),customElements.get(`craft-nav-item`)||customElements.define(`craft-nav-item`,Q);export{E as a,x as c,T as i,S as l,X as n,w as o,D as r,C as s,Q as t};
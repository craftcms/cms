...
`,N=class extends e{constructor(e){if(super(e),this.it=d,e.type!==r.CHILD)throw Error(this.constructor.directiveName+`() can only be used in child bindings`)}render(e){if(e===d||e==null)return this._t=void 0,this.it=e;if(e===u)return e;if(typeof e!=`string`)throw Error(this.constructor.directiveName+`() called with a non-string value`);if(e===this.it)return this._t;this.it=e;let t=[e];return t.raw=t,this._t={_$litType$:this.constructor.resultType,strings:t,values:[]}}};N.directiveName=`unsafeHTML`,N.resultType=1;var P=t(N),F=class extends o{static{this.METHOD=`totp`}get endpoint(){return`auth/verify-totp`}renderInput(){return c`
      <craft-input
        ...
        aria-required="true"
      ></craft-input>
    `}};g([h(`craft-input.totp-code`)],F.prototype,`_input`,void 0),o.register(`craft-totp-form`,F);var I=class extends o{static{this.METHOD=`recovery-codes`}get endpoint(){return`auth/verify-recovery-code`}renderInput(){return c`
      <craft-input
    ...
    `}#l(){let e=this._canUsePasskey||this.querySelector(`[slot="alternative-methods"]`);return c`
      ...
      ${e?c`
          ...
          `:d}
    `}};g([p({type:Boolean,attribute:`show-passkey-btn`})],z.prototype,`showPasskeyBtn`,void 0),g([p({type:Boolean,attribute:`show-reset-password`})],z.prototype,`showResetPassword`,void 0),g([p({type:Boolean,attribute:`show-remember-me`})],z.prototype,`showRememberMe`,void 0),g([p()],z.prototype,`username`,void 0),g([p({attribute:`static-email`})],z.prototype,`staticEmail`,void 0),g([p({type:Boolean,attribute:`use-email-as-username`})],z.prototype,`useEmailAsUsername`,void 0),g([p({attribute:`remember-me-label`})],z.prototype,`rememberMeLabel`,void 0),g([p({attribute:`initial-error`})],z.prototype,`initialError`,void 0),g([p()],z.prototype,`action`,void 0),g([m()],z.prototype,`_view`,void 0),g([m()],z.prototype,`_error`,void 0),g([m()],z.prototype,`_loginBusy`,void 0),g([m()],z.prototype,`_passkeyBusy`,void 0),g([m()],z.prototype,`_canUsePasskey`,void 0),g([m()],z.prototype,`_twoFactorData`,void 0),g([m()],z.prototype,`_resetUsername`,void 0),g([h(`.login-username`)],z.prototype,`_usernameInput`,void 0),g([h(`craft-input-password.login-password`)],z.prototype,`_passwordInput`,void 0),g([h(`.login-remember-me`)],z.prototype,`_rememberMeInput`,void 0),customElements.get(`craft-login-form`)||customElements.define(`craft-login-form`,z);
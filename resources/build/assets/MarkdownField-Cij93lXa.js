...
`)}function S(e,t={},n={}){return{...e,colors:{...e.colors,...t},previewColors:{...e.previewColors,...n}}}function C(e={}){let{fontSize:t=`14px`,lineHeight:n=1.6,fontFamily:r=`"SF Mono", SFMono-Regular, Menlo, Monaco, "Cascadia Code", Consolas, "Roboto Mono", "Noto Sans Mono", "Droid Sans Mono", "Ubuntu Mono", "DejaVu Sans Mono", "Liberation Mono", "Courier New", Courier, monospace`,padding:i=`20px`,theme:a=null,mobile:o={}}=e,s=Object.keys(o).length>0?`
...
`),processed:n}}function Ee(e,t){return t?`- `:`${e+1}. `}function De(e,t){let n,r,i;return e.orderedList?(n=we(t),r=Te(n.text),i=r.text):(n=Te(t),r=we(n.text),i=r.text),[n,r,i]}function Oe(e,t){let n=e.selectionStart===e.selectionEnd,r=e.selectionStart,i=e.selectionEnd;_e(e);let[a,o,s]=De(t,e.value.slice(e.selectionStart,e.selectionEnd)),c=s.split(`
`).map((e,n)=>`${Ee(n,t.unorderedList)}${e}`),l=c.reduce((e,n,r)=>e+Ee(r,t.unorderedList).length,0),u=c.reduce((e,n,r)=>e+Ee(r,!t.unorderedList).length,0);if(a.processed)return n?(r=Math.max(r-Ee(0,t.unorderedList).length,0),i=r):(r=e.selectionStart,i=e.selectionEnd-l),{text:s,selectionStart:r,selectionEnd:i};let{newlinesToAppend:d,newlinesToPrepend:f}=ye(e),p=d+c.join(`
`)+f;return n?(r=Math.max(r+Ee(0,t.unorderedList).length+d.length,0),i=r):o.processed?(r=Math.max(e.selectionStart+d.length,0),i=e.selectionEnd+d.length+l-u):(r=Math.max(e.selectionStart+d.length,0),i=e.selectionEnd+d.length+l),{text:p,selectionStart:r,selectionEnd:i}}function ke(e,t){k(e,xe(e,e=>Oe(e,t),{adjustSelection:(n,r,i,a)=>{let o=e.value.slice(a,e.selectionEnd),s=/^\d+\.\s+/,c=/^- /,l=s.test(o),u=c.test(o),d=t.orderedList&&l||t.unorderedList&&u;if(r===i)if(d){let e=o.match(t.orderedList?s:c),n=e?e[0].length:0;return{start:Math.max(r-n,a),end:Math.max(r-n,a)}}else if(l||u){let e=o.match(l?s:c),n=e?e[0].length:0,i=(t.unorderedList?2:3)-n;return{start:r+i,end:r+i}}else{let e=t.unorderedList?2:3;return{start:r+e,end:r+e}}else if(d){let e=o.match(t.orderedList?s:c),n=e?e[0].length:0;return{start:Math.max(r-n,a),end:Math.max(i-n,a)}}else if(l||u){let e=o.match(l?s:c),n=e?e[0].length:0,a=(t.unorderedList?2:3)-n;return{start:r+a,end:i+a}}else{let e=t.unorderedList?2:3;return{start:r+e,end:i+e}}}}))}function Ae(e){if(!e)return[];let t=[],{selectionStart:n,selectionEnd:r,value:i}=e,a=i.split(`
`),o=0,s=``;for(let e of a){if(n>=o&&n<=o+e.length){s=e;break}o+=e.length+1}s.startsWith(`- `)&&(s.startsWith(`- [ ] `)||s.startsWith(`- [x] `)?t.push(`task-list`):t.push(`bullet-list`)),/^\d+\.\s/.test(s)&&t.push(`numbered-list`),s.startsWith(`> `)&&t.push(`quote`),s.startsWith(`# `)&&t.push(`header`),s.startsWith(`## `)&&t.push(`header-2`),s.startsWith(`### `)&&t.push(`header-3`);let c=Math.max(0,n-10),l=Math.min(i.length,r+10),u=i.slice(c,l);if(u.includes(`**`)){let e=i.slice(Math.max(0,n-100),n),a=i.slice(r,Math.min(i.length,r+100)),o=e.lastIndexOf(`**`),s=a.indexOf(`**`);o!==-1&&s!==-1&&t.push(`bold`)}if(u.includes(`_`)){let e=i.slice(Math.max(0,n-100),n),a=i.slice(r,Math.min(i.length,r+100)),o=e.lastIndexOf(`_`),s=a.indexOf(`_`);o!==-1&&s!==-1&&t.push(`italic`)}if(u.includes("`")){let e=i.slice(Math.max(0,n-100),n),a=i.slice(r,Math.min(i.length,r+100));e.includes("`")&&a.includes("`")&&t.push(`code`)}if(u.includes(`[`)&&u.includes(`]`)){let e=i.slice(Math.max(0,n-100),n),a=i.slice(r,Math.min(i.length,r+100)),o=e.lastIndexOf(`[`),s=a.indexOf(`]`);o!==-1&&s!==-1&&i.slice(r+s+1,r+s+10).startsWith(`(`)&&t.push(`link`)}return t}function je(e,t){return Ae(e).includes(t)}function Me(e,t={}){if(!e)return;let{toWord:n,toLine:r,toFormat:i}=t,{selectionStart:a,selectionEnd:o,value:s}=e;if(r){let t=s.split(`
`),n=0,r=0,i=0;for(let e of t){if(a>=i&&a<=i+e.length){n=i,r=i+e.length;break}i+=e.length+1}e.selectionStart=n,e.selectionEnd=r}else if(n&&a===o){let t=a,n=o;for(;t>0&&!/\s/.test(s[t-1]);)t--;for(;n<s.length&&!/\s/.test(s[n]);)n++;e.selectionStart=t,e.selectionEnd=n}}function Ne(e){if(!e||e.disabled||e.readOnly)return;D(`toggleBold`,`Starting`),de(e,`Before`);let t=Se(e,E(T.bold));fe(t),k(e,t),de(e,`After`)}function Pe(e){!e||e.disabled||e.readOnly||k(e,Se(e,E(T.italic)))}function Fe(e){!e||e.disabled||e.readOnly||k(e,Se(e,E(T.code)))}function Ie(e,t={}){if(!e||e.disabled||e.readOnly)return;let n=e.value.slice(e.selectionStart,e.selectionEnd),r=E(T.link);if(n&&n.match(/^https?:\/\//)&&!t.url?(r.suffix=`](${n})`,r.replaceNext=``):t.url&&(r.suffix=`](${t.url})`,r.replaceNext=``),t.text&&!n){let n=e.selectionStart;e.value=e.value.slice(0,n)+t.text+e.value.slice(n),e.selectionStart=n,e.selectionEnd=n+t.text.length}k(e,Se(e,r))}function Le(e){!e||e.disabled||e.readOnly||ke(e,E(T.bulletList))}function Re(e){!e||e.disabled||e.readOnly||ke(e,E(T.numberedList))}function ze(e){if(!e||e.disabled||e.readOnly)return;D(`toggleQuote`,`Starting`),de(e,`Initial`);let t=E(T.quote),n=xe(e,e=>Ce(e,t),{prefix:t.prefix});fe(n),k(e,n),de(e,`Final`)}function Be(e){if(!e||e.disabled||e.readOnly)return;let t=E(T.taskList);k(e,xe(e,e=>Ce(e,t),{prefix:t.prefix}))}function Ve(e,t=1,n=!1){if(!e||e.disabled||e.readOnly)return;(t<1||t>6)&&(t=1),D(`insertHeader`,`============ START ============`),D(`insertHeader`,`Level: ${t}, Toggle: ${n}`),D(`insertHeader`,`Initial cursor: ${e.selectionStart}-${e.selectionEnd}`);let r=E(T[`header${t===1?`1`:t}`]||T.header1);D(`insertHeader`,`Style prefix: "${r.prefix}"`);let i=e.value,a=e.selectionStart,o=e.selectionEnd,s=a;for(;s>0&&i[s-1]!==`
`;)s--;let c=o;for(;c<i.length&&i[c]!==`
`;)c++;let l=i.slice(s,c);D(`insertHeader`,`Current line (before): "${l}"`);let u=l.match(/^(#{1,6})\s*/),d=u?u[1].length:0,f=u?u[0].length:0;D(`insertHeader`,`Existing header check:`),D(`insertHeader`,`  - Match: ${u?`"${u[0]}"`:`none`}`),D(`insertHeader`,`  - Existing level: ${d}`),D(`insertHeader`,`  - Existing prefix length: ${f}`),D(`insertHeader`,`  - Target level: ${t}`);let p=n&&d===t;D(`insertHeader`,`Should toggle OFF: ${p} (toggle=${n}, existingLevel=${d}, level=${t})`);let m=xe(e,e=>{let n=e.value.slice(e.selectionStart,e.selectionEnd);D(`insertHeader`,`Line in operation: "${n}"`);let i=n.replace(/^#{1,6}\s*/,``);D(`insertHeader`,`Cleaned line: "${i}"`);let a;return p?(D(`insertHeader`,`ACTION: Toggling OFF - removing header`),a=i):d>0?(D(`insertHeader`,`ACTION: Replacing H${d} with H${t}`),a=r.prefix+i):(D(`insertHeader`,`ACTION: Adding new header`),a=r.prefix+i),D(`insertHeader`,`New line: "${a}"`),{text:a,selectionStart:e.selectionStart,selectionEnd:e.selectionEnd}},{prefix:r.prefix,adjustSelection:(e,t,n,i)=>{if(D(`insertHeader`,`Adjusting selection:`),D(`insertHeader`,`  - isRemoving param: ${e}`),D(`insertHeader`,`  - shouldToggleOff: ${p}`),D(`insertHeader`,`  - selStart: ${t}, selEnd: ${n}`),D(`insertHeader`,`  - lineStartPos: ${i}`),p){let e=Math.max(t-f,i);return D(`insertHeader`,`  - Removing header, adjusting by -${f}`),{start:e,end:t===n?e:Math.max(n-f,i)}}else if(f>0){let e=r.prefix.length-f;return D(`insertHeader`,`  - Replacing header, adjusting by ${e}`),{start:t+e,end:n+e}}else return D(`insertHeader`,`  - Adding header, adjusting by +${r.prefix.length}`),{start:t+r.prefix.length,end:n+r.prefix.length}}});D(`insertHeader`,`Final result: text="${m.text}", cursor=${m.selectionStart}-${m.selectionEnd}`),D(`insertHeader`,`============ END ============`),k(e,m)}function He(e){Ve(e,1,!0)}function Ue(e){Ve(e,2,!0)}function We(e){Ve(e,3,!0)}function Ge(e){return Ae(e)}function Ke(e,t){return je(e,t)}function qe(e,t={}){Me(e,t)}function Je(e,t){if(!e||e.disabled||e.readOnly)return;let n=E(t),r;r=n.multiline&&me(e.value.slice(e.selectionStart,e.selectionEnd))?Ce(e,n):Se(e,n),k(e,r)}var Ye={toggleBold:Ne,toggleItalic:Pe,toggleCode:Fe,insertLink:Ie,toggleBulletList:Le,toggleNumberedList:Re,toggleQuote:ze,toggleTaskList:Be,insertHeader:Ve,toggleH1:He,toggleH2:Ue,toggleH3:We,getActiveFormats:Ge,hasFormat:Ke,expandSelection:qe,applyCustomFormat:Je,preserveSelection:be,setUndoMethod:pe,setDebugMode:le,getDebugMode:ue},Xe=class{constructor(e,t={}){this.editor=e,this.container=null,this.buttons={},this.toolbarButtons=t.toolbarButtons||[]}create(){this.container=document.createElement(`div`),this.container.className=`overtype-toolbar`,this.container.setAttribute(`role`,`toolbar`),this.container.setAttribute(`aria-label`,`Formatting toolbar`),this.toolbarButtons.forEach(e=>{if(e.name===`separator`){let e=this.createSeparator();this.container.appendChild(e)}else{let t=this.createButton(e);this.buttons[e.name]=t,this.container.appendChild(t)}}),this.editor.container.insertBefore(this.container,this.editor.wrapper)}createSeparator(){let e=document.createElement(`div`);return e.className=`overtype-toolbar-separator`,e.setAttribute(`role`,`separator`),e}createButton(e){let t=document.createElement(`button`);return t.className=`overtype-toolbar-button`,t.type=`button`,t.setAttribute(`data-button`,e.name),t.title=e.title||``,t.setAttribute(`aria-label`,e.title||e.name),t.innerHTML=this.sanitizeSVG(e.icon||``),e.name===`viewMode`?(t.classList.add(`has-dropdown`),t.dataset.dropdown=`true`,t.addEventListener(`click`,e=>{e.preventDefault(),this.toggleViewModeDropdown(t)}),t):(t._clickHandler=t=>{t.preventDefault();let n=e.actionId||e.name;this.editor.performAction(n,t)},t.addEventListener(`click`,t._clickHandler),t)}async handleAction(e){if(e&&typeof e==`object`&&typeof e.action==`function`){this.editor.textarea.focus();try{return await e.action({editor:this.editor,getValue:()=>this.editor.getValue(),setValue:e=>this.editor.setValue(e),event:null}),!0}catch(t){return console.error(`Action "${e.name}" error:`,t),this.editor.wrapper.dispatchEvent(new CustomEvent(`button-error`,{detail:{buttonName:e.name,error:t}})),!1}}return typeof e==`string`?this.editor.performAction(e,null):!1}sanitizeSVG(e){return typeof e==`string`?e.replace(/<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi,``).replace(/\son\w+\s*=\s*["'][^"']*["']/gi,``).replace(/\son\w+\s*=\s*[^\s>]*/gi,``):``}toggleViewModeDropdown(e){let t=document.querySelector(`.overtype-dropdown-menu`);if(t){t.remove(),e.classList.remove(`dropdown-active`);return}e.classList.add(`dropdown-active`);let n=this.createViewModeDropdown(e),r=e.getBoundingClientRect();n.style.position=`absolute`,n.style.top=`${r.bottom+5}px`,n.style.left=`${r.left}px`,document.body.appendChild(n),this.handleDocumentClick=t=>{!n.contains(t.target)&&!e.contains(t.target)&&(n.remove(),e.classList.remove(`dropdown-active`),document.removeEventListener(`click`,this.handleDocumentClick))},setTimeout(()=>{document.addEventListener(`click`,this.handleDocumentClick)},0)}createViewModeDropdown(e){let t=document.createElement(`div`);t.className=`overtype-dropdown-menu`;let n=[{id:`normal`,label:`Normal Edit`,icon:`✓`},{id:`plain`,label:`Plain Textarea`,icon:`✓`},{id:`preview`,label:`Preview Mode`,icon:`✓`}],r=this.editor.container.dataset.mode||`normal`;return n.forEach(n=>{let i=document.createElement(`button`);if(i.className=`overtype-dropdown-item`,i.type=`button`,i.textContent=n.label,n.id===r){i.classList.add(`active`),i.setAttribute(`aria-current`,`true`);let e=document.createElement(`span`);e.className=`overtype-dropdown-icon`,e.textContent=n.icon,i.prepend(e)}i.addEventListener(`click`,r=>{switch(r.preventDefault(),n.id){case`plain`:this.editor.showPlainTextarea();break;case`preview`:this.editor.showPreviewMode();break;default:this.editor.showNormalEditMode();break}t.remove(),e.classList.remove(`dropdown-active`),document.removeEventListener(`click`,this.handleDocumentClick)}),t.appendChild(i)}),t}updateButtonStates(){try{let e=Ge?.(this.editor.textarea,this.editor.textarea.selectionStart)||[];Object.entries(this.buttons).forEach(([t,n])=>{if(t===`viewMode`)return;let r=!1;switch(t){case`bold`:r=e.includes(`bold`);break;case`italic`:r=e.includes(`italic`);break;case`code`:r=!1;break;case`bulletList`:r=e.includes(`bullet-list`);break;case`orderedList`:r=e.includes(`numbered-list`);break;case`taskList`:r=e.includes(`task-list`);break;case`quote`:r=e.includes(`quote`);break;case`h1`:r=e.includes(`header`);break;case`h2`:r=e.includes(`header-2`);break;case`h3`:r=e.includes(`header-3`);break}n.classList.toggle(`active`,r),n.setAttribute(`aria-pressed`,r.toString())})}catch{}}show(){this.container&&this.container.classList.remove(`overtype-toolbar-hidden`)}hide(){this.container&&this.container.classList.add(`overtype-toolbar-hidden`)}destroy(){this.container&&(this.handleDocumentClick&&document.removeEventListener(`click`,this.handleDocumentClick),Object.values(this.buttons).forEach(e=>{e._clickHandler&&(e.removeEventListener(`click`,e._clickHandler),delete e._clickHandler)}),this.container.remove(),this.container=null,this.buttons={})}},Ze=Math.min,A=Math.max,Qe=Math.round,j=e=>({x:e,y:e}),$e={left:`right`,right:`left`,bottom:`top`,top:`bottom`},et={start:`end`,end:`start`};function tt(e,t,n){return A(e,Ze(t,n))}function nt(e,t){return typeof e==`function`?e(t):e}function M(e){return e.split(`-`)[0]}function rt(e){return e.split(`-`)[1]}function it(e){return e===`x`?`y`:`x`}function at(e){return e===`y`?`height`:`width`}var ot=new Set([`top`,`bottom`]);function N(e){return ot.has(M(e))?`y`:`x`}function st(e){return it(N(e))}function ct(e,t,n){n===void 0&&(n=!1);let r=rt(e),i=st(e),a=at(i),o=i===`x`?r===(n?`end`:`start`)?`right`:`left`:r===`start`?`bottom`:`top`;return t.reference[a]>t.floating[a]&&(o=_t(o)),[o,_t(o)]}function lt(e){let t=_t(e);return[ut(e),t,ut(t)]}function ut(e){return e.replace(/start|end/g,e=>et[e])}var dt=[`left`,`right`],ft=[`right`,`left`],pt=[`top`,`bottom`],mt=[`bottom`,`top`];function ht(e,t,n){switch(e){case`top`:case`bottom`:return n?t?ft:dt:t?dt:ft;case`left`:case`right`:return t?pt:mt;default:return[]}}function gt(e,t,n,r){let i=rt(e),a=ht(M(e),n===`start`,r);return i&&(a=a.map(e=>e+`-`+i),t&&(a=a.concat(a.map(ut)))),a}function _t(e){return e.replace(/left|right|bottom|top/g,e=>$e[e])}function vt(e){return{top:0,right:0,bottom:0,left:0,...e}}function yt(e){return typeof e==`number`?{top:e,right:e,bottom:e,left:e}:vt(e)}function bt(e){let{x:t,y:n,width:r,height:i}=e;return{width:r,height:i,top:n,left:t,right:t+r,bottom:n+i,x:t,y:n}}function xt(e,t,n){let{reference:r,floating:i}=e,a=N(t),o=st(t),s=at(o),c=M(t),l=a===`y`,u=r.x+r.width/2-i.width/2,d=r.y+r.height/2-i.height/2,f=r[s]/2-i[s]/2,p;switch(c){case`top`:p={x:u,y:r.y-i.height};break;case`bottom`:p={x:u,y:r.y+r.height};break;case`right`:p={x:r.x+r.width,y:d};break;case`left`:p={x:r.x-i.width,y:d};break;default:p={x:r.x,y:r.y}}switch(rt(t)){case`start`:p[o]-=f*(n&&l?-1:1);break;case`end`:p[o]+=f*(n&&l?-1:1);break}return p}async function St(e,t){t===void 0&&(t={});let{x:n,y:r,platform:i,rects:a,elements:o,strategy:s}=e,{boundary:c=`clippingAncestors`,rootBoundary:l=`viewport`,elementContext:u=`floating`,altBoundary:d=!1,padding:f=0}=nt(t,e),p=yt(f),m=o[d?u===`floating`?`reference`:`floating`:u],h=bt(await i.getClippingRect({element:await(i.isElement==null?void 0:i.isElement(m))??!0?m:m.contextElement||await(i.getDocumentElement==null?void 0:i.getDocumentElement(o.floating)),boundary:c,rootBoundary:l,strategy:s})),g=u===`floating`?{x:n,y:r,width:a.floating.width,height:a.floating.height}:a.reference,_=await(i.getOffsetParent==null?void 0:i.getOffsetParent(o.floating)),v=await(i.isElement==null?void 0:i.isElement(_))&&await(i.getScale==null?void 0:i.getScale(_))||{x:1,y:1},y=bt(i.convertOffsetParentRelativeRectToViewportRelativeRect?await i.convertOffsetParentRelativeRectToViewportRelativeRect({elements:o,rect:g,offsetParent:_,strategy:s}):g);return{top:(h.top-y.top+p.top)/v.y,bottom:(y.bottom-h.bottom+p.bottom)/v.y,left:(h.left-y.left+p.left)/v.x,right:(y.right-h.right+p.right)/v.x}}var Ct=async(e,t,n)=>{let{placement:r=`bottom`,strategy:i=`absolute`,middleware:a=[],platform:o}=n,s=a.filter(Boolean),c=await(o.isRTL==null?void 0:o.isRTL(t)),l=await o.getElementRects({reference:e,floating:t,strategy:i}),{x:u,y:d}=xt(l,r,c),f=r,p={},m=0;for(let n=0;n<s.length;n++){let{name:a,fn:h}=s[n],{x:g,y:_,data:v,reset:y}=await h({x:u,y:d,initialPlacement:r,placement:f,strategy:i,middlewareData:p,rects:l,platform:{...o,detectOverflow:o.detectOverflow??St},elements:{reference:e,floating:t}});u=g??u,d=_??d,p={...p,[a]:{...p[a],...v}},y&&m<=50&&(m++,typeof y==`object`&&(y.placement&&(f=y.placement),y.rects&&(l=y.rects===!0?await o.getElementRects({reference:e,floating:t,strategy:i}):y.rects),{x:u,y:d}=xt(l,f,c)),n=-1)}return{x:u,y:d,placement:f,strategy:i,middlewareData:p}},wt=function(e){return e===void 0&&(e={}),{name:`flip`,options:e,async fn(t){var n;let{placement:r,middlewareData:i,rects:a,initialPlacement:o,platform:s,elements:c}=t,{mainAxis:l=!0,crossAxis:u=!0,fallbackPlacements:d,fallbackStrategy:f=`bestFit`,fallbackAxisSideDirection:p=`none`,flipAlignment:m=!0,...h}=nt(e,t);if((n=i.arrow)!=null&&n.alignmentOffset)return{};let g=M(r),_=N(o),v=M(o)===o,y=await(s.isRTL==null?void 0:s.isRTL(c.floating)),b=d||(v||!m?[_t(o)]:lt(o)),ee=p!==`none`;!d&&ee&&b.push(...gt(o,m,p,y));let x=[o,...b],S=await s.detectOverflow(t,h),C=[],w=i.flip?.overflows||[];if(l&&C.push(S[g]),u){let e=ct(r,a,y);C.push(S[e[0]],S[e[1]])}if(w=[...w,{placement:r,overflows:C}],!C.every(e=>e<=0)){let e=(i.flip?.index||0)+1,t=x[e];if(t&&(!(u===`alignment`&&_!==N(t))||w.every(e=>N(e.placement)===_?e.overflows[0]>0:!0)))return{data:{index:e,overflows:w},reset:{placement:t}};let n=w.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0]?.placement;if(!n)switch(f){case`bestFit`:{let e=w.filter(e=>{if(ee){let t=N(e.placement);return t===_||t===`y`}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0]?.[0];e&&(n=e);break}case`initialPlacement`:n=o;break}if(r!==n)return{reset:{placement:n}}}return{}}}},Tt=new Set([`left`,`top`]);async function Et(e,t){let{placement:n,platform:r,elements:i}=e,a=await(r.isRTL==null?void 0:r.isRTL(i.floating)),o=M(n),s=rt(n),c=N(n)===`y`,l=Tt.has(o)?-1:1,u=a&&c?-1:1,d=nt(t,e),{mainAxis:f,crossAxis:p,alignmentAxis:m}=typeof d==`number`?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return s&&typeof m==`number`&&(p=s===`end`?m*-1:m),c?{x:p*u,y:f*l}:{x:f*l,y:p*u}}var Dt=function(e){return e===void 0&&(e=0),{name:`offset`,options:e,async fn(t){var n;let{x:r,y:i,placement:a,middlewareData:o}=t,s=await Et(t,e);return a===o.offset?.placement&&(n=o.arrow)!=null&&n.alignmentOffset?{}:{x:r+s.x,y:i+s.y,data:{...s,placement:a}}}}},Ot=function(e){return e===void 0&&(e={}),{name:`shift`,options:e,async fn(t){let{x:n,y:r,placement:i,platform:a}=t,{mainAxis:o=!0,crossAxis:s=!1,limiter:c={fn:e=>{let{x:t,y:n}=e;return{x:t,y:n}}},...l}=nt(e,t),u={x:n,y:r},d=await a.detectOverflow(t,l),f=N(M(i)),p=it(f),m=u[p],h=u[f];if(o){let e=p===`y`?`top`:`left`,t=p===`y`?`bottom`:`right`,n=m+d[e],r=m-d[t];m=tt(n,m,r)}if(s){let e=f===`y`?`top`:`left`,t=f===`y`?`bottom`:`right`,n=h+d[e],r=h-d[t];h=tt(n,h,r)}let g=c.fn({...t,[p]:m,[f]:h});return{...g,data:{x:g.x-n,y:g.y-r,enabled:{[p]:o,[f]:s}}}}}};function kt(){return typeof window<`u`}function P(e){return At(e)?(e.nodeName||``).toLowerCase():`#document`}function F(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function I(e){return((At(e)?e.ownerDocument:e.document)||window.document)?.documentElement}function At(e){return kt()?e instanceof Node||e instanceof F(e).Node:!1}function L(e){return kt()?e instanceof Element||e instanceof F(e).Element:!1}function R(e){return kt()?e instanceof HTMLElement||e instanceof F(e).HTMLElement:!1}function jt(e){return!kt()||typeof ShadowRoot>`u`?!1:e instanceof ShadowRoot||e instanceof F(e).ShadowRoot}var Mt=new Set([`inline`,`contents`]);function Nt(e){let{overflow:t,overflowX:n,overflowY:r,display:i}=B(e);return/auto|scroll|overlay|hidden|clip/.test(t+r+n)&&!Mt.has(i)}var Pt=new Set([`table`,`td`,`th`]);function Ft(e){return Pt.has(P(e))}var It=[`:popover-open`,`:modal`];function Lt(e){return It.some(t=>{try{return e.matches(t)}catch{return!1}})}var Rt=[`transform`,`translate`,`scale`,`rotate`,`perspective`],zt=[`transform`,`translate`,`scale`,`rotate`,`perspective`,`filter`],Bt=[`paint`,`layout`,`strict`,`content`];function Vt(e){let t=Ut(),n=L(e)?B(e):e;return Rt.some(e=>n[e]?n[e]!==`none`:!1)||(n.containerType?n.containerType!==`normal`:!1)||!t&&(n.backdropFilter?n.backdropFilter!==`none`:!1)||!t&&(n.filter?n.filter!==`none`:!1)||zt.some(e=>(n.willChange||``).includes(e))||Bt.some(e=>(n.contain||``).includes(e))}function Ht(e){let t=V(e);for(;R(t)&&!z(t);){if(Vt(t))return t;if(Lt(t))return null;t=V(t)}return null}function Ut(){return typeof CSS>`u`||!CSS.supports?!1:CSS.supports(`-webkit-backdrop-filter`,`none`)}var Wt=new Set([`html`,`body`,`#document`]);function z(e){return Wt.has(P(e))}function B(e){return F(e).getComputedStyle(e)}function Gt(e){return L(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function V(e){if(P(e)===`html`)return e;let t=e.assignedSlot||e.parentNode||jt(e)&&e.host||I(e);return jt(t)?t.host:t}function Kt(e){let t=V(e);return z(t)?e.ownerDocument?e.ownerDocument.body:e.body:R(t)&&Nt(t)?t:Kt(t)}function qt(e,t,n){t===void 0&&(t=[]),n===void 0&&(n=!0);let r=Kt(e),i=r===e.ownerDocument?.body,a=F(r);if(i){let e=Jt(a);return t.concat(a,a.visualViewport||[],Nt(r)?r:[],e&&n?qt(e):[])}return t.concat(r,qt(r,[],n))}function Jt(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function Yt(e){let t=B(e),n=parseFloat(t.width)||0,r=parseFloat(t.height)||0,i=R(e),a=i?e.offsetWidth:n,o=i?e.offsetHeight:r,s=Qe(n)!==a||Qe(r)!==o;return s&&(n=a,r=o),{width:n,height:r,$:s}}function Xt(e){return L(e)?e:e.contextElement}function H(e){let t=Xt(e);if(!R(t))return j(1);let n=t.getBoundingClientRect(),{width:r,height:i,$:a}=Yt(t),o=(a?Qe(n.width):n.width)/r,s=(a?Qe(n.height):n.height)/i;return(!o||!Number.isFinite(o))&&(o=1),(!s||!Number.isFinite(s))&&(s=1),{x:o,y:s}}var Zt=j(0);function Qt(e){let t=F(e);return!Ut()||!t.visualViewport?Zt:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function $t(e,t,n){return t===void 0&&(t=!1),!n||t&&n!==F(e)?!1:t}function en(e,t,n,r){t===void 0&&(t=!1),n===void 0&&(n=!1);let i=e.getBoundingClientRect(),a=Xt(e),o=j(1);t&&(r?L(r)&&(o=H(r)):o=H(e));let s=$t(a,n,r)?Qt(a):j(0),c=(i.left+s.x)/o.x,l=(i.top+s.y)/o.y,u=i.width/o.x,d=i.height/o.y;if(a){let e=F(a),t=r&&L(r)?F(r):r,n=e,i=Jt(n);for(;i&&r&&t!==n;){let e=H(i),t=i.getBoundingClientRect(),r=B(i),a=t.left+(i.clientLeft+parseFloat(r.paddingLeft))*e.x,o=t.top+(i.clientTop+parseFloat(r.paddingTop))*e.y;c*=e.x,l*=e.y,u*=e.x,d*=e.y,c+=a,l+=o,n=F(i),i=Jt(n)}}return bt({width:u,height:d,x:c,y:l})}function tn(e,t){let n=Gt(e).scrollLeft;return t?t.left+n:en(I(e)).left+n}function nn(e,t){let n=e.getBoundingClientRect();return{x:n.left+t.scrollLeft-tn(e,n),y:n.top+t.scrollTop}}function rn(e){let{elements:t,rect:n,offsetParent:r,strategy:i}=e,a=i===`fixed`,o=I(r),s=t?Lt(t.floating):!1;if(r===o||s&&a)return n;let c={scrollLeft:0,scrollTop:0},l=j(1),u=j(0),d=R(r);if((d||!d&&!a)&&((P(r)!==`body`||Nt(o))&&(c=Gt(r)),R(r))){let e=en(r);l=H(r),u.x=e.x+r.clientLeft,u.y=e.y+r.clientTop}let f=o&&!d&&!a?nn(o,c):j(0);return{width:n.width*l.x,height:n.height*l.y,x:n.x*l.x-c.scrollLeft*l.x+u.x+f.x,y:n.y*l.y-c.scrollTop*l.y+u.y+f.y}}function an(e){return Array.from(e.getClientRects())}function on(e){let t=I(e),n=Gt(e),r=e.ownerDocument.body,i=A(t.scrollWidth,t.clientWidth,r.scrollWidth,r.clientWidth),a=A(t.scrollHeight,t.clientHeight,r.scrollHeight,r.clientHeight),o=-n.scrollLeft+tn(e),s=-n.scrollTop;return B(r).direction===`rtl`&&(o+=A(t.clientWidth,r.clientWidth)-i),{width:i,height:a,x:o,y:s}}var sn=25;function cn(e,t){let n=F(e),r=I(e),i=n.visualViewport,a=r.clientWidth,o=r.clientHeight,s=0,c=0;if(i){a=i.width,o=i.height;let e=Ut();(!e||e&&t===`fixed`)&&(s=i.offsetLeft,c=i.offsetTop)}let l=tn(r);if(l<=0){let e=r.ownerDocument,t=e.body,n=getComputedStyle(t),i=e.compatMode===`CSS1Compat`&&parseFloat(n.marginLeft)+parseFloat(n.marginRight)||0,o=Math.abs(r.clientWidth-t.clientWidth-i);o<=sn&&(a-=o)}else l<=sn&&(a+=l);return{width:a,height:o,x:s,y:c}}var ln=new Set([`absolute`,`fixed`]);function un(e,t){let n=en(e,!0,t===`fixed`),r=n.top+e.clientTop,i=n.left+e.clientLeft,a=R(e)?H(e):j(1);return{width:e.clientWidth*a.x,height:e.clientHeight*a.y,x:i*a.x,y:r*a.y}}function dn(e,t,n){let r;if(t===`viewport`)r=cn(e,n);else if(t===`document`)r=on(I(e));else if(L(t))r=un(t,n);else{let n=Qt(e);r={x:t.x-n.x,y:t.y-n.y,width:t.width,height:t.height}}return bt(r)}function fn(e,t){let n=V(e);return n===t||!L(n)||z(n)?!1:B(n).position===`fixed`||fn(n,t)}function pn(e,t){let n=t.get(e);if(n)return n;let r=qt(e,[],!1).filter(e=>L(e)&&P(e)!==`body`),i=null,a=B(e).position===`fixed`,o=a?V(e):e;for(;L(o)&&!z(o);){let t=B(o),n=Vt(o);!n&&t.position===`fixed`&&(i=null),(a?!n&&!i:!n&&t.position===`static`&&i&&ln.has(i.position)||Nt(o)&&!n&&fn(e,o))?r=r.filter(e=>e!==o):i=t,o=V(o)}return t.set(e,r),r}function mn(e){let{element:t,boundary:n,rootBoundary:r,strategy:i}=e,a=[...n===`clippingAncestors`?Lt(t)?[]:pn(t,this._c):[].concat(n),r],o=a[0],s=a.reduce((e,n)=>{let r=dn(t,n,i);return e.top=A(r.top,e.top),e.right=Ze(r.right,e.right),e.bottom=Ze(r.bottom,e.bottom),e.left=A(r.left,e.left),e},dn(t,o,i));return{width:s.right-s.left,height:s.bottom-s.top,x:s.left,y:s.top}}function hn(e){let{width:t,height:n}=Yt(e);return{width:t,height:n}}function gn(e,t,n){let r=R(t),i=I(t),a=n===`fixed`,o=en(e,!0,a,t),s={scrollLeft:0,scrollTop:0},c=j(0);function l(){c.x=tn(i)}if(r||!r&&!a)if((P(t)!==`body`||Nt(i))&&(s=Gt(t)),r){let e=en(t,!0,a,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}else i&&l();a&&!r&&i&&l();let u=i&&!r&&!a?nn(i,s):j(0);return{x:o.left+s.scrollLeft-c.x-u.x,y:o.top+s.scrollTop-c.y-u.y,width:o.width,height:o.height}}function _n(e){return B(e).position===`static`}function vn(e,t){if(!R(e)||B(e).position===`fixed`)return null;if(t)return t(e);let n=e.offsetParent;return I(e)===n&&(n=n.ownerDocument.body),n}function yn(e,t){let n=F(e);if(Lt(e))return n;if(!R(e)){let t=V(e);for(;t&&!z(t);){if(L(t)&&!_n(t))return t;t=V(t)}return n}let r=vn(e,t);for(;r&&Ft(r)&&_n(r);)r=vn(r,t);return r&&z(r)&&_n(r)&&!Vt(r)?n:r||Ht(e)||n}var bn=async function(e){let t=this.getOffsetParent||yn,n=this.getDimensions,r=await n(e.floating);return{reference:gn(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:r.width,height:r.height}}};function xn(e){return B(e).direction===`rtl`}var Sn={convertOffsetParentRelativeRectToViewportRelativeRect:rn,getDocumentElement:I,getClippingRect:mn,getOffsetParent:yn,getElementRects:bn,getClientRects:an,getDimensions:hn,getScale:H,isElement:L,isRTL:xn},Cn=Dt,wn=Ot,Tn=wt,En=(e,t,n)=>{let r=new Map,i={platform:Sn,...n},a={...i.platform,_c:r};return Ct(e,t,{...i,platform:a})},Dn=class{constructor(e){this.editor=e,this.tooltip=null,this.currentLink=null,this.hideTimeout=null,this.visibilityChangeHandler=null,this.isTooltipHovered=!1,this.init()}init(){this.createTooltip(),this.editor.textarea.addEventListener(`selectionchange`,()=>this.checkCursorPosition()),this.editor.textarea.addEventListener(`keyup`,e=>{(e.key.includes(`Arrow`)||e.key===`Home`||e.key===`End`)&&this.checkCursorPosition()}),this.editor.textarea.addEventListener(`input`,()=>this.hide()),this.editor.textarea.addEventListener(`scroll`,()=>{this.currentLink&&this.positionTooltip(this.currentLink)}),this.editor.textarea.addEventListener(`blur`,()=>{this.isTooltipHovered||this.hide()}),this.visibilityChangeHandler=()=>{document.hidden&&this.hide()},document.addEventListener(`visibilitychange`,this.visibilityChangeHandler),this.tooltip.addEventListener(`mouseenter`,()=>{this.isTooltipHovered=!0,this.cancelHide()}),this.tooltip.addEventListener(`mouseleave`,()=>{this.isTooltipHovered=!1,this.scheduleHide()})}createTooltip(){this.tooltip=document.createElement(`div`),this.tooltip.className=`overtype-link-tooltip`,this.tooltip.innerHTML=`
...
</svg>`,title:`Bold (Ctrl+B)`,action:({editor:e})=>{Ne(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},italic:{name:`italic`,actionId:`toggleItalic`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Italic (Ctrl+I)`,action:({editor:e})=>{Pe(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},code:{name:`code`,actionId:`toggleCode`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Inline Code`,action:({editor:e})=>{Fe(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},separator:{name:`separator`},link:{name:`link`,actionId:`insertLink`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Insert Link`,action:({editor:e})=>{Ie(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},h1:{name:`h1`,actionId:`toggleH1`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Heading 1`,action:({editor:e})=>{He(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},h2:{name:`h2`,actionId:`toggleH2`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Heading 2`,action:({editor:e})=>{Ue(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},h3:{name:`h3`,actionId:`toggleH3`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Heading 3`,action:({editor:e})=>{We(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},bulletList:{name:`bulletList`,actionId:`toggleBulletList`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Bullet List`,action:({editor:e})=>{Le(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},orderedList:{name:`orderedList`,actionId:`toggleNumberedList`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Numbered List`,action:({editor:e})=>{Re(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},taskList:{name:`taskList`,actionId:`toggleTaskList`,icon:`<svg viewBox="0 0 18 18">
...
</svg>`,title:`Task List`,action:({editor:e})=>{Be&&(Be(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0})))}},quote:{name:`quote`,actionId:`toggleQuote`,icon:`<svg viewBox="2 2 20 20">
...
</svg>`,title:`Quote`,action:({editor:e})=>{ze(e.textarea),e.textarea.dispatchEvent(new Event(`input`,{bubbles:!0}))}},upload:{name:`upload`,actionId:`uploadFile`,icon:`<svg viewBox="0 0 18 18">

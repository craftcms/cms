...
`,Ji=class extends Event{constructor(){super(`wa-reposition`,{bubbles:!0,cancelable:!1,composed:!0})}},Yi=d`
  :host {
    --arrow-color: black;
    --arrow-size: var(--wa-tooltip-arrow-size);
...
`,Xi=Math.min,Zi=Math.max,Qi=Math.round,$i=Math.floor,ea=e=>({x:e,y:e}),ta={left:`right`,right:`left`,bottom:`top`,top:`bottom`};function na(e,t,n){return Zi(e,Xi(t,n))}function ra(e,t){return typeof e==`function`?e(t):e}function ia(e){return e.split(`-`)[0]}function aa(e){return e.split(`-`)[1]}function oa(e){return e===`x`?`y`:`x`}function sa(e){return e===`y`?`height`:`width`}function ca(e){let t=e[0];return t===`t`||t===`b`?`y`:`x`}function la(e){return oa(ca(e))}function ua(e,t,n){n===void 0&&(n=!1);let r=aa(e),i=la(e),a=sa(i),o=i===`x`?r===(n?`end`:`start`)?`right`:`left`:r===`start`?`bottom`:`top`;return t.reference[a]>t.floating[a]&&(o=ya(o)),[o,ya(o)]}function da(e){let t=ya(e);return[fa(e),t,fa(t)]}function fa(e){return e.includes(`start`)?e.replace(`start`,`end`):e.replace(`end`,`start`)}var pa=[`left`,`right`],ma=[`right`,`left`],ha=[`top`,`bottom`],ga=[`bottom`,`top`];function _a(e,t,n){switch(e){case`top`:case`bottom`:return n?t?ma:pa:t?pa:ma;case`left`:case`right`:return t?ha:ga;default:return[]}}function va(e,t,n,r){let i=aa(e),a=_a(ia(e),n===`start`,r);return i&&(a=a.map(e=>e+`-`+i),t&&(a=a.concat(a.map(fa)))),a}function ya(e){let t=ia(e);return ta[t]+e.slice(t.length)}function ba(e){return{top:0,right:0,bottom:0,left:0,...e}}function xa(e){return typeof e==`number`?{top:e,right:e,bottom:e,left:e}:ba(e)}function Sa(e){let{x:t,y:n,width:r,height:i}=e;return{width:r,height:i,top:n,left:t,right:t+r,bottom:n+i,x:t,y:n}}function Ca(e,t,n){let{reference:r,floating:i}=e,a=ca(t),o=la(t),s=sa(o),c=ia(t),l=a===`y`,u=r.x+r.width/2-i.width/2,d=r.y+r.height/2-i.height/2,f=r[s]/2-i[s]/2,p;switch(c){case`top`:p={x:u,y:r.y-i.height};break;case`bottom`:p={x:u,y:r.y+r.height};break;case`right`:p={x:r.x+r.width,y:d};break;case`left`:p={x:r.x-i.width,y:d};break;default:p={x:r.x,y:r.y}}switch(aa(t)){case`start`:p[o]-=f*(n&&l?-1:1);break;case`end`:p[o]+=f*(n&&l?-1:1);break}return p}async function wa(e,t){t===void 0&&(t={});let{x:n,y:r,platform:i,rects:a,elements:o,strategy:s}=e,{boundary:c=`clippingAncestors`,rootBoundary:l=`viewport`,elementContext:u=`floating`,altBoundary:d=!1,padding:f=0}=ra(t,e),p=xa(f),m=o[d?u===`floating`?`reference`:`floating`:u],h=Sa(await i.getClippingRect({element:await(i.isElement==null?void 0:i.isElement(m))??!0?m:m.contextElement||await(i.getDocumentElement==null?void 0:i.getDocumentElement(o.floating)),boundary:c,rootBoundary:l,strategy:s})),g=u===`floating`?{x:n,y:r,width:a.floating.width,height:a.floating.height}:a.reference,_=await(i.getOffsetParent==null?void 0:i.getOffsetParent(o.floating)),v=await(i.isElement==null?void 0:i.isElement(_))&&await(i.getScale==null?void 0:i.getScale(_))||{x:1,y:1},y=Sa(i.convertOffsetParentRelativeRectToViewportRelativeRect?await i.convertOffsetParentRelativeRectToViewportRelativeRect({elements:o,rect:g,offsetParent:_,strategy:s}):g);return{top:(h.top-y.top+p.top)/v.y,bottom:(y.bottom-h.bottom+p.bottom)/v.y,left:(h.left-y.left+p.left)/v.x,right:(y.right-h.right+p.right)/v.x}}var Ta=50,Ea=async(e,t,n)=>{let{placement:r=`bottom`,strategy:i=`absolute`,middleware:a=[],platform:o}=n,s=o.detectOverflow?o:{...o,detectOverflow:wa},c=await(o.isRTL==null?void 0:o.isRTL(t)),l=await o.getElementRects({reference:e,floating:t,strategy:i}),{x:u,y:d}=Ca(l,r,c),f=r,p=0,m={};for(let n=0;n<a.length;n++){let h=a[n];if(!h)continue;let{name:g,fn:_}=h,{x:v,y,data:b,reset:x}=await _({x:u,y:d,initialPlacement:r,placement:f,strategy:i,middlewareData:m,rects:l,platform:s,elements:{reference:e,floating:t}});u=v??u,d=y??d,m[g]={...m[g],...b},x&&p<Ta&&(p++,typeof x==`object`&&(x.placement&&(f=x.placement),x.rects&&(l=x.rects===!0?await o.getElementRects({reference:e,floating:t,strategy:i}):x.rects),{x:u,y:d}=Ca(l,f,c)),n=-1)}return{x:u,y:d,placement:f,strategy:i,middlewareData:m}},Da=e=>({name:`arrow`,options:e,async fn(t){let{x:n,y:r,placement:i,rects:a,platform:o,elements:s,middlewareData:c}=t,{element:l,padding:u=0}=ra(e,t)||{};if(l==null)return{};let d=xa(u),f={x:n,y:r},p=la(i),m=sa(p),h=await o.getDimensions(l),g=p===`y`,_=g?`top`:`left`,v=g?`bottom`:`right`,y=g?`clientHeight`:`clientWidth`,b=a.reference[m]+a.reference[p]-f[p]-a.floating[m],x=f[p]-a.reference[p],S=await(o.getOffsetParent==null?void 0:o.getOffsetParent(l)),C=S?S[y]:0;(!C||!await(o.isElement==null?void 0:o.isElement(S)))&&(C=s.floating[y]||a.floating[m]);let w=b/2-x/2,T=C/2-h[m]/2-1,E=Xi(d[_],T),D=Xi(d[v],T),ee=E,te=C-h[m]-D,ne=C/2-h[m]/2+w,re=na(ee,ne,te),ie=!c.arrow&&aa(i)!=null&&ne!==re&&a.reference[m]/2-(ne<ee?E:D)-h[m]/2<0,ae=ie?ne<ee?ne-ee:ne-te:0;return{[p]:f[p]+ae,data:{[p]:re,centerOffset:ne-re-ae,...ie&&{alignmentOffset:ae}},reset:ie}}}),Oa=function(e){return e===void 0&&(e={}),{name:`flip`,options:e,async fn(t){var n;let{placement:r,middlewareData:i,rects:a,initialPlacement:o,platform:s,elements:c}=t,{mainAxis:l=!0,crossAxis:u=!0,fallbackPlacements:d,fallbackStrategy:f=`bestFit`,fallbackAxisSideDirection:p=`none`,flipAlignment:m=!0,...h}=ra(e,t);if((n=i.arrow)!=null&&n.alignmentOffset)return{};let g=ia(r),_=ca(o),v=ia(o)===o,y=await(s.isRTL==null?void 0:s.isRTL(c.floating)),b=d||(v||!m?[ya(o)]:da(o)),x=p!==`none`;!d&&x&&b.push(...va(o,m,p,y));let S=[o,...b],C=await s.detectOverflow(t,h),w=[],T=i.flip?.overflows||[];if(l&&w.push(C[g]),u){let e=ua(r,a,y);w.push(C[e[0]],C[e[1]])}if(T=[...T,{placement:r,overflows:w}],!w.every(e=>e<=0)){let e=(i.flip?.index||0)+1,t=S[e];if(t&&(!(u===`alignment`&&_!==ca(t))||T.every(e=>ca(e.placement)===_?e.overflows[0]>0:!0)))return{data:{index:e,overflows:T},reset:{placement:t}};let n=T.filter(e=>e.overflows[0]<=0).sort((e,t)=>e.overflows[1]-t.overflows[1])[0]?.placement;if(!n)switch(f){case`bestFit`:{let e=T.filter(e=>{if(x){let t=ca(e.placement);return t===_||t===`y`}return!0}).map(e=>[e.placement,e.overflows.filter(e=>e>0).reduce((e,t)=>e+t,0)]).sort((e,t)=>e[1]-t[1])[0]?.[0];e&&(n=e);break}case`initialPlacement`:n=o;break}if(r!==n)return{reset:{placement:n}}}return{}}}},ka=new Set([`left`,`top`]);async function Aa(e,t){let{placement:n,platform:r,elements:i}=e,a=await(r.isRTL==null?void 0:r.isRTL(i.floating)),o=ia(n),s=aa(n),c=ca(n)===`y`,l=ka.has(o)?-1:1,u=a&&c?-1:1,d=ra(t,e),{mainAxis:f,crossAxis:p,alignmentAxis:m}=typeof d==`number`?{mainAxis:d,crossAxis:0,alignmentAxis:null}:{mainAxis:d.mainAxis||0,crossAxis:d.crossAxis||0,alignmentAxis:d.alignmentAxis};return s&&typeof m==`number`&&(p=s===`end`?m*-1:m),c?{x:p*u,y:f*l}:{x:f*l,y:p*u}}var ja=function(e){return e===void 0&&(e=0),{name:`offset`,options:e,async fn(t){var n;let{x:r,y:i,placement:a,middlewareData:o}=t,s=await Aa(t,e);return a===o.offset?.placement&&(n=o.arrow)!=null&&n.alignmentOffset?{}:{x:r+s.x,y:i+s.y,data:{...s,placement:a}}}}},Ma=function(e){return e===void 0&&(e={}),{name:`shift`,options:e,async fn(t){let{x:n,y:r,placement:i,platform:a}=t,{mainAxis:o=!0,crossAxis:s=!1,limiter:c={fn:e=>{let{x:t,y:n}=e;return{x:t,y:n}}},...l}=ra(e,t),u={x:n,y:r},d=await a.detectOverflow(t,l),f=ca(ia(i)),p=oa(f),m=u[p],h=u[f];if(o){let e=p===`y`?`top`:`left`,t=p===`y`?`bottom`:`right`,n=m+d[e],r=m-d[t];m=na(n,m,r)}if(s){let e=f===`y`?`top`:`left`,t=f===`y`?`bottom`:`right`,n=h+d[e],r=h-d[t];h=na(n,h,r)}let g=c.fn({...t,[p]:m,[f]:h});return{...g,data:{x:g.x-n,y:g.y-r,enabled:{[p]:o,[f]:s}}}}}},Na=function(e){return e===void 0&&(e={}),{name:`size`,options:e,async fn(t){var n,r;let{placement:i,rects:a,platform:o,elements:s}=t,{apply:c=()=>{},...l}=ra(e,t),u=await o.detectOverflow(t,l),d=ia(i),f=aa(i),p=ca(i)===`y`,{width:m,height:h}=a.floating,g,_;d===`top`||d===`bottom`?(g=d,_=f===(await(o.isRTL==null?void 0:o.isRTL(s.floating))?`start`:`end`)?`left`:`right`):(_=d,g=f===`end`?`top`:`bottom`);let v=h-u.top-u.bottom,y=m-u.left-u.right,b=Xi(h-u[g],v),x=Xi(m-u[_],y),S=!t.middlewareData.shift,C=b,w=x;if((n=t.middlewareData.shift)!=null&&n.enabled.x&&(w=y),(r=t.middlewareData.shift)!=null&&r.enabled.y&&(C=v),S&&!f){let e=Zi(u.left,0),t=Zi(u.right,0),n=Zi(u.top,0),r=Zi(u.bottom,0);p?w=m-2*(e!==0||t!==0?e+t:Zi(u.left,u.right)):C=h-2*(n!==0||r!==0?n+r:Zi(u.top,u.bottom))}await c({...t,availableWidth:w,availableHeight:C});let T=await o.getDimensions(s.floating);return m!==T.width||h!==T.height?{reset:{rects:!0}}:{}}}};function Pa(){return typeof window<`u`}function Fa(e){return Ra(e)?(e.nodeName||``).toLowerCase():`#document`}function Ia(e){var t;return(e==null||(t=e.ownerDocument)==null?void 0:t.defaultView)||window}function La(e){return((Ra(e)?e.ownerDocument:e.document)||window.document)?.documentElement}function Ra(e){return Pa()?e instanceof Node||e instanceof Ia(e).Node:!1}function za(e){return Pa()?e instanceof Element||e instanceof Ia(e).Element:!1}function Ba(e){return Pa()?e instanceof HTMLElement||e instanceof Ia(e).HTMLElement:!1}function Va(e){return!Pa()||typeof ShadowRoot>`u`?!1:e instanceof ShadowRoot||e instanceof Ia(e).ShadowRoot}function Ha(e){let{overflow:t,overflowX:n,overflowY:r,display:i}=$a(e);return/auto|scroll|overlay|hidden|clip/.test(t+r+n)&&i!==`inline`&&i!==`contents`}function Ua(e){return/^(table|td|th)$/.test(Fa(e))}function Wa(e){try{if(e.matches(`:popover-open`))return!0}catch{}try{return e.matches(`:modal`)}catch{return!1}}var Ga=/transform|translate|scale|rotate|perspective|filter/,Ka=/paint|layout|strict|content/,qa=e=>!!e&&e!==`none`,Ja;function Ya(e){let t=za(e)?$a(e):e;return qa(t.transform)||qa(t.translate)||qa(t.scale)||qa(t.rotate)||qa(t.perspective)||!Za()&&(qa(t.backdropFilter)||qa(t.filter))||Ga.test(t.willChange||``)||Ka.test(t.contain||``)}function Xa(e){let t=to(e);for(;Ba(t)&&!Qa(t);){if(Ya(t))return t;if(Wa(t))return null;t=to(t)}return null}function Za(){return Ja??=typeof CSS<`u`&&CSS.supports&&CSS.supports(`-webkit-backdrop-filter`,`none`),Ja}function Qa(e){return/^(html|body|#document)$/.test(Fa(e))}function $a(e){return Ia(e).getComputedStyle(e)}function eo(e){return za(e)?{scrollLeft:e.scrollLeft,scrollTop:e.scrollTop}:{scrollLeft:e.scrollX,scrollTop:e.scrollY}}function to(e){if(Fa(e)===`html`)return e;let t=e.assignedSlot||e.parentNode||Va(e)&&e.host||La(e);return Va(t)?t.host:t}function no(e){let t=to(e);return Qa(t)?e.ownerDocument?e.ownerDocument.body:e.body:Ba(t)&&Ha(t)?t:no(t)}function ro(e,t,n){t===void 0&&(t=[]),n===void 0&&(n=!0);let r=no(e),i=r===e.ownerDocument?.body,a=Ia(r);if(i){let e=io(a);return t.concat(a,a.visualViewport||[],Ha(r)?r:[],e&&n?ro(e):[])}else return t.concat(r,ro(r,[],n))}function io(e){return e.parent&&Object.getPrototypeOf(e.parent)?e.frameElement:null}function ao(e){let t=$a(e),n=parseFloat(t.width)||0,r=parseFloat(t.height)||0,i=Ba(e),a=i?e.offsetWidth:n,o=i?e.offsetHeight:r,s=Qi(n)!==a||Qi(r)!==o;return s&&(n=a,r=o),{width:n,height:r,$:s}}function oo(e){return za(e)?e:e.contextElement}function so(e){let t=oo(e);if(!Ba(t))return ea(1);let n=t.getBoundingClientRect(),{width:r,height:i,$:a}=ao(t),o=(a?Qi(n.width):n.width)/r,s=(a?Qi(n.height):n.height)/i;return(!o||!Number.isFinite(o))&&(o=1),(!s||!Number.isFinite(s))&&(s=1),{x:o,y:s}}var co=ea(0);function lo(e){let t=Ia(e);return!Za()||!t.visualViewport?co:{x:t.visualViewport.offsetLeft,y:t.visualViewport.offsetTop}}function uo(e,t,n){return t===void 0&&(t=!1),!n||t&&n!==Ia(e)?!1:t}function fo(e,t,n,r){t===void 0&&(t=!1),n===void 0&&(n=!1);let i=e.getBoundingClientRect(),a=oo(e),o=ea(1);t&&(r?za(r)&&(o=so(r)):o=so(e));let s=uo(a,n,r)?lo(a):ea(0),c=(i.left+s.x)/o.x,l=(i.top+s.y)/o.y,u=i.width/o.x,d=i.height/o.y;if(a){let e=Ia(a),t=r&&za(r)?Ia(r):r,n=e,i=io(n);for(;i&&r&&t!==n;){let e=so(i),t=i.getBoundingClientRect(),r=$a(i),a=t.left+(i.clientLeft+parseFloat(r.paddingLeft))*e.x,o=t.top+(i.clientTop+parseFloat(r.paddingTop))*e.y;c*=e.x,l*=e.y,u*=e.x,d*=e.y,c+=a,l+=o,n=Ia(i),i=io(n)}}return Sa({width:u,height:d,x:c,y:l})}function po(e,t){let n=eo(e).scrollLeft;return t?t.left+n:fo(La(e)).left+n}function mo(e,t){let n=e.getBoundingClientRect();return{x:n.left+t.scrollLeft-po(e,n),y:n.top+t.scrollTop}}function ho(e){let{elements:t,rect:n,offsetParent:r,strategy:i}=e,a=i===`fixed`,o=La(r),s=t?Wa(t.floating):!1;if(r===o||s&&a)return n;let c={scrollLeft:0,scrollTop:0},l=ea(1),u=ea(0),d=Ba(r);if((d||!d&&!a)&&((Fa(r)!==`body`||Ha(o))&&(c=eo(r)),d)){let e=fo(r);l=so(r),u.x=e.x+r.clientLeft,u.y=e.y+r.clientTop}let f=o&&!d&&!a?mo(o,c):ea(0);return{width:n.width*l.x,height:n.height*l.y,x:n.x*l.x-c.scrollLeft*l.x+u.x+f.x,y:n.y*l.y-c.scrollTop*l.y+u.y+f.y}}function go(e){return Array.from(e.getClientRects())}function _o(e){let t=La(e),n=eo(e),r=e.ownerDocument.body,i=Zi(t.scrollWidth,t.clientWidth,r.scrollWidth,r.clientWidth),a=Zi(t.scrollHeight,t.clientHeight,r.scrollHeight,r.clientHeight),o=-n.scrollLeft+po(e),s=-n.scrollTop;return $a(r).direction===`rtl`&&(o+=Zi(t.clientWidth,r.clientWidth)-i),{width:i,height:a,x:o,y:s}}var vo=25;function yo(e,t){let n=Ia(e),r=La(e),i=n.visualViewport,a=r.clientWidth,o=r.clientHeight,s=0,c=0;if(i){a=i.width,o=i.height;let e=Za();(!e||e&&t===`fixed`)&&(s=i.offsetLeft,c=i.offsetTop)}let l=po(r);if(l<=0){let e=r.ownerDocument,t=e.body,n=getComputedStyle(t),i=e.compatMode===`CSS1Compat`&&parseFloat(n.marginLeft)+parseFloat(n.marginRight)||0,o=Math.abs(r.clientWidth-t.clientWidth-i);o<=vo&&(a-=o)}else l<=vo&&(a+=l);return{width:a,height:o,x:s,y:c}}function bo(e,t){let n=fo(e,!0,t===`fixed`),r=n.top+e.clientTop,i=n.left+e.clientLeft,a=Ba(e)?so(e):ea(1);return{width:e.clientWidth*a.x,height:e.clientHeight*a.y,x:i*a.x,y:r*a.y}}function xo(e,t,n){let r;if(t===`viewport`)r=yo(e,n);else if(t===`document`)r=_o(La(e));else if(za(t))r=bo(t,n);else{let n=lo(e);r={x:t.x-n.x,y:t.y-n.y,width:t.width,height:t.height}}return Sa(r)}function So(e,t){let n=to(e);return n===t||!za(n)||Qa(n)?!1:$a(n).position===`fixed`||So(n,t)}function Co(e,t){let n=t.get(e);if(n)return n;let r=ro(e,[],!1).filter(e=>za(e)&&Fa(e)!==`body`),i=null,a=$a(e).position===`fixed`,o=a?to(e):e;for(;za(o)&&!Qa(o);){let t=$a(o),n=Ya(o);!n&&t.position===`fixed`&&(i=null),(a?!n&&!i:!n&&t.position===`static`&&i&&(i.position===`absolute`||i.position===`fixed`)||Ha(o)&&!n&&So(e,o))?r=r.filter(e=>e!==o):i=t,o=to(o)}return t.set(e,r),r}function wo(e){let{element:t,boundary:n,rootBoundary:r,strategy:i}=e,a=[...n===`clippingAncestors`?Wa(t)?[]:Co(t,this._c):[].concat(n),r],o=xo(t,a[0],i),s=o.top,c=o.right,l=o.bottom,u=o.left;for(let e=1;e<a.length;e++){let n=xo(t,a[e],i);s=Zi(n.top,s),c=Xi(n.right,c),l=Xi(n.bottom,l),u=Zi(n.left,u)}return{width:c-u,height:l-s,x:u,y:s}}function To(e){let{width:t,height:n}=ao(e);return{width:t,height:n}}function Eo(e,t,n){let r=Ba(t),i=La(t),a=n===`fixed`,o=fo(e,!0,a,t),s={scrollLeft:0,scrollTop:0},c=ea(0);function l(){c.x=po(i)}if(r||!r&&!a)if((Fa(t)!==`body`||Ha(i))&&(s=eo(t)),r){let e=fo(t,!0,a,t);c.x=e.x+t.clientLeft,c.y=e.y+t.clientTop}else i&&l();a&&!r&&i&&l();let u=i&&!r&&!a?mo(i,s):ea(0);return{x:o.left+s.scrollLeft-c.x-u.x,y:o.top+s.scrollTop-c.y-u.y,width:o.width,height:o.height}}function Do(e){return $a(e).position===`static`}function Oo(e,t){if(!Ba(e)||$a(e).position===`fixed`)return null;if(t)return t(e);let n=e.offsetParent;return La(e)===n&&(n=n.ownerDocument.body),n}function ko(e,t){let n=Ia(e);if(Wa(e))return n;if(!Ba(e)){let t=to(e);for(;t&&!Qa(t);){if(za(t)&&!Do(t))return t;t=to(t)}return n}let r=Oo(e,t);for(;r&&Ua(r)&&Do(r);)r=Oo(r,t);return r&&Qa(r)&&Do(r)&&!Ya(r)?n:r||Xa(e)||n}var Ao=async function(e){let t=this.getOffsetParent||ko,n=this.getDimensions,r=await n(e.floating);return{reference:Eo(e.reference,await t(e.floating),e.strategy),floating:{x:0,y:0,width:r.width,height:r.height}}};function jo(e){return $a(e).direction===`rtl`}var Mo={convertOffsetParentRelativeRectToViewportRelativeRect:ho,getDocumentElement:La,getClippingRect:wo,getOffsetParent:ko,getElementRects:Ao,getClientRects:go,getDimensions:To,getScale:so,isElement:za,isRTL:jo};function No(e,t){return e.x===t.x&&e.y===t.y&&e.width===t.width&&e.height===t.height}function Po(e,t){let n=null,r,i=La(e);function a(){var e;clearTimeout(r),(e=n)==null||e.disconnect(),n=null}function o(s,c){s===void 0&&(s=!1),c===void 0&&(c=1),a();let l=e.getBoundingClientRect(),{left:u,top:d,width:f,height:p}=l;if(s||t(),!f||!p)return;let m=$i(d),h=$i(i.clientWidth-(u+f)),g=$i(i.clientHeight-(d+p)),_=$i(u),v={rootMargin:-m+`px `+-h+`px `+-g+`px `+-_+`px`,threshold:Zi(0,Xi(1,c))||1},y=!0;function b(t){let n=t[0].intersectionRatio;if(n!==c){if(!y)return o();n?o(!1,n):r=setTimeout(()=>{o(!1,1e-7)},1e3)}n===1&&!No(l,e.getBoundingClientRect())&&o(),y=!1}try{n=new IntersectionObserver(b,{...v,root:i.ownerDocument})}catch{n=new IntersectionObserver(b,v)}n.observe(e)}return o(!0),a}function Fo(e,t,n,r){r===void 0&&(r={});let{ancestorScroll:i=!0,ancestorResize:a=!0,elementResize:o=typeof ResizeObserver==`function`,layoutShift:s=typeof IntersectionObserver==`function`,animationFrame:c=!1}=r,l=oo(e),u=i||a?[...l?ro(l):[],...t?ro(t):[]]:[];u.forEach(e=>{i&&e.addEventListener(`scroll`,n,{passive:!0}),a&&e.addEventListener(`resize`,n)});let d=l&&s?Po(l,n):null,f=-1,p=null;o&&(p=new ResizeObserver(e=>{let[r]=e;r&&r.target===l&&p&&t&&(p.unobserve(t),cancelAnimationFrame(f),f=requestAnimationFrame(()=>{var e;(e=p)==null||e.observe(t)})),n()}),l&&!c&&p.observe(l),t&&p.observe(t));let m,h=c?fo(e):null;c&&g();function g(){let t=fo(e);h&&!No(h,t)&&n(),h=t,m=requestAnimationFrame(g)}return n(),()=>{var e;u.forEach(e=>{i&&e.removeEventListener(`scroll`,n),a&&e.removeEventListener(`resize`,n)}),d?.(),(e=p)==null||e.disconnect(),p=null,c&&cancelAnimationFrame(m)}}var Io=ja,Lo=Ma,Ro=Oa,zo=Na,Bo=Da,Vo=(e,t,n)=>{let r=new Map,i={platform:Mo,...n},a={...i.platform,_c:r};return Ea(e,t,{...i,platform:a})};function Ho(e){return Wo(e)}function Uo(e){return e.assignedSlot?e.assignedSlot:e.parentNode instanceof ShadowRoot?e.parentNode.host:e.parentNode}function Wo(e){for(let t=e;t;t=Uo(t))if(t instanceof Element&&getComputedStyle(t).display===`none`)return null;for(let t=Uo(e);t;t=Uo(t)){if(!(t instanceof Element))continue;let e=getComputedStyle(t);if(e.display!==`contents`&&(e.position!==`static`||Ya(e)||t.tagName===`BODY`))return t}return null}function Go(e){return typeof e==`object`&&!!e&&`getBoundingClientRect`in e&&(`contextElement`in e?e instanceof Element:!0)}var Ko=globalThis?.HTMLElement?.prototype.hasOwnProperty(`popover`),P=class extends ki{constructor(){super(...arguments),this.localize=new Yr(this),this.active=!1,this.placement=`top`,this.boundary=`viewport`,this.distance=0,this.skidding=0,this.arrow=!1,this.arrowPlacement=`anchor`,this.arrowPadding=10,this.flip=!1,this.flipFallbackPlacements=``,this.flipFallbackStrategy=`best-fit`,this.flipPadding=0,this.shift=!1,this.shiftPadding=0,this.autoSizePadding=0,this.hoverBridge=!1,this.updateHoverBridge=()=>{if(this.hoverBridge&&this.anchorEl&&this.popup){let e=this.anchorEl.getBoundingClientRect(),t=this.popup.getBoundingClientRect(),n=this.placement.includes(`top`)||this.placement.includes(`bottom`),r=0,i=0,a=0,o=0,s=0,c=0,l=0,u=0;n?e.top<t.top?(r=e.left,i=e.bottom,a=e.right,o=e.bottom,s=t.left,c=t.top,l=t.right,u=t.top):(r=t.left,i=t.bottom,a=t.right,o=t.bottom,s=e.left,c=e.top,l=e.right,u=e.top):e.left<t.left?(r=e.right,i=e.top,a=t.left,o=t.top,s=e.right,c=e.bottom,l=t.left,u=t.bottom):(r=t.right,i=t.top,a=e.left,o=e.top,s=t.right,c=t.bottom,l=e.left,u=e.bottom),this.style.setProperty(`--hover-bridge-top-left-x`,`${r}px`),this.style.setProperty(`--hover-bridge-top-left-y`,`${i}px`),this.style.setProperty(`--hover-bridge-top-right-x`,`${a}px`),this.style.setProperty(`--hover-bridge-top-right-y`,`${o}px`),this.style.setProperty(`--hover-bridge-bottom-left-x`,`${s}px`),this.style.setProperty(`--hover-bridge-bottom-left-y`,`${c}px`),this.style.setProperty(`--hover-bridge-bottom-right-x`,`${l}px`),this.style.setProperty(`--hover-bridge-bottom-right-y`,`${u}px`)}}}async connectedCallback(){super.connectedCallback(),await this.updateComplete,this.start()}disconnectedCallback(){super.disconnectedCallback(),this.stop()}async updated(e){super.updated(e),e.has(`active`)&&(this.active?this.start():this.stop()),e.has(`anchor`)&&this.handleAnchorChange(),this.active&&(await this.updateComplete,this.reposition())}async handleAnchorChange(){if(await this.stop(),this.anchor&&typeof this.anchor==`string`){let e=this.getRootNode();this.anchorEl=e.getElementById(this.anchor)}else this.anchor instanceof Element||Go(this.anchor)?this.anchorEl=this.anchor:this.anchorEl=this.querySelector(`[slot="anchor"]`);this.anchorEl instanceof HTMLSlotElement&&(this.anchorEl=this.anchorEl.assignedElements({flatten:!0})[0]),this.anchorEl&&this.start()}start(){!this.anchorEl||!this.active||!this.isConnected||(this.popup?.showPopover?.(),this.cleanup=Fo(this.anchorEl,this.popup,()=>{this.reposition()}))}async stop(){return new Promise(e=>{this.popup?.hidePopover?.(),this.cleanup?(this.cleanup(),this.cleanup=void 0,this.removeAttribute(`data-current-placement`),this.style.removeProperty(`--auto-size-available-width`),this.style.removeProperty(`--auto-size-available-height`),requestAnimationFrame(()=>e())):e()})}reposition(){if(!this.active||!this.anchorEl||!this.popup)return;let e=[Io({mainAxis:this.distance,crossAxis:this.skidding})];this.sync?e.push(zo({apply:({rects:e})=>{let t=this.sync===`width`||this.sync===`both`,n=this.sync===`height`||this.sync===`both`;this.popup.style.width=t?`${e.reference.width}px`:``,this.popup.style.height=n?`${e.reference.height}px`:``}})):(this.popup.style.width=``,this.popup.style.height=``);let t;Ko&&!Go(this.anchor)&&this.boundary===`scroll`&&(t=ro(this.anchorEl).filter(e=>e instanceof Element)),this.flip&&e.push(Ro({boundary:this.flipBoundary||t,fallbackPlacements:this.flipFallbackPlacements,fallbackStrategy:this.flipFallbackStrategy===`best-fit`?`bestFit`:`initialPlacement`,padding:this.flipPadding})),this.shift&&e.push(Lo({boundary:this.shiftBoundary||t,padding:this.shiftPadding})),this.autoSize?e.push(zo({boundary:this.autoSizeBoundary||t,padding:this.autoSizePadding,apply:({availableWidth:e,availableHeight:t})=>{this.autoSize===`vertical`||this.autoSize===`both`?this.style.setProperty(`--auto-size-available-height`,`${t}px`):this.style.removeProperty(`--auto-size-available-height`),this.autoSize===`horizontal`||this.autoSize===`both`?this.style.setProperty(`--auto-size-available-width`,`${e}px`):this.style.removeProperty(`--auto-size-available-width`)}})):(this.style.removeProperty(`--auto-size-available-width`),this.style.removeProperty(`--auto-size-available-height`)),this.arrow&&e.push(Bo({element:this.arrowEl,padding:this.arrowPadding}));let n=Ko?e=>Mo.getOffsetParent(e,Ho):Mo.getOffsetParent;Vo(this.anchorEl,this.popup,{placement:this.placement,middleware:e,strategy:Ko?`absolute`:`fixed`,platform:{...Mo,getOffsetParent:n}}).then(({x:e,y:t,middlewareData:n,placement:r})=>{let i=this.localize.dir()===`rtl`,a={top:`bottom`,right:`left`,bottom:`top`,left:`right`}[r.split(`-`)[0]];if(this.setAttribute(`data-current-placement`,r),Object.assign(this.popup.style,{left:`${e}px`,top:`${t}px`}),this.arrow){let e=n.arrow.x,t=n.arrow.y,r=``,o=``,s=``,c=``;if(this.arrowPlacement===`start`){let n=typeof e==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``;r=typeof t==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``,o=i?n:``,c=i?``:n}else if(this.arrowPlacement===`end`){let n=typeof e==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``;o=i?``:n,c=i?n:``,s=typeof t==`number`?`calc(${this.arrowPadding}px - var(--arrow-padding-offset))`:``}else this.arrowPlacement===`center`?(c=typeof e==`number`?`calc(50% - var(--arrow-size-diagonal))`:``,r=typeof t==`number`?`calc(50% - var(--arrow-size-diagonal))`:``):(c=typeof e==`number`?`${e}px`:``,r=typeof t==`number`?`${t}px`:``);Object.assign(this.arrowEl.style,{top:r,right:o,bottom:s,left:c,[a]:`calc(var(--arrow-base-offset) - var(--arrow-size-diagonal))`})}}),requestAnimationFrame(()=>this.updateHoverBridge()),this.dispatchEvent(new Ji)}render(){return l`
    ...
    `}};P.css=Yi,M([y(`.popup`)],P.prototype,`popup`,2),M([y(`.arrow`)],P.prototype,`arrowEl`,2),M([g()],P.prototype,`anchor`,2),M([g({type:Boolean,reflect:!0})],P.prototype,`active`,2),M([g({reflect:!0})],P.prototype,`placement`,2),M([g()],P.prototype,`boundary`,2),M([g({type:Number})],P.prototype,`distance`,2),M([g({type:Number})],P.prototype,`skidding`,2),M([g({type:Boolean})],P.prototype,`arrow`,2),M([g({attribute:`arrow-placement`})],P.prototype,`arrowPlacement`,2),M([g({attribute:`arrow-padding`,type:Number})],P.prototype,`arrowPadding`,2),M([g({type:Boolean})],P.prototype,`flip`,2),M([g({attribute:`flip-fallback-placements`,converter:{fromAttribute:e=>e.split(` `).map(e=>e.trim()).filter(e=>e!==``),toAttribute:e=>e.join(` `)}})],P.prototype,`flipFallbackPlacements`,2),M([g({attribute:`flip-fallback-strategy`})],P.prototype,`flipFallbackStrategy`,2),M([g({type:Object})],P.prototype,`flipBoundary`,2),M([g({attribute:`flip-padding`,type:Number})],P.prototype,`flipPadding`,2),M([g({type:Boolean})],P.prototype,`shift`,2),M([g({type:Object})],P.prototype,`shiftBoundary`,2),M([g({attribute:`shift-padding`,type:Number})],P.prototype,`shiftPadding`,2),M([g({attribute:`auto-size`})],P.prototype,`autoSize`,2),M([g()],P.prototype,`sync`,2),M([g({type:Object})],P.prototype,`autoSizeBoundary`,2),M([g({attribute:`auto-size-padding`,type:Number})],P.prototype,`autoSizePadding`,2),M([g({attribute:`hover-bridge`,type:Boolean})],P.prototype,`hoverBridge`,2),P=M([v(`wa-popup`)],P);var qo=[];function Jo(e){qo.push(e)}function Yo(e){for(let t=qo.length-1;t>=0;t--)if(qo[t]===e){qo.splice(t,1);break}}function Xo(e){return qo.length>0&&qo[qo.length-1]===e}var Zo=class extends Event{constructor(){super(`wa-show`,{bubbles:!0,cancelable:!0,composed:!0})}},Qo=class extends Event{constructor(e){super(`wa-hide`,{bubbles:!0,cancelable:!0,composed:!0}),this.detail=e}},$o=class extends Event{constructor(){super(`wa-after-hide`,{bubbles:!0,cancelable:!1,composed:!0})}},es=class extends Event{constructor(){super(`wa-after-show`,{bubbles:!0,cancelable:!1,composed:!0})}},ts=`useandom-26T198340PX75pxJACKVERYMINDBUSHWOLF_GQZbfghjklqvwyzrict`,ns=(e=21)=>{let t=``,n=crypto.getRandomValues(new Uint8Array(e|=0));for(;e--;)t+=ts[n[e]&63];return t};function rs(e=``){return`${e}${ns()}`}function is(e,t){return new Promise(n=>{function r(i){i.target===e&&(e.removeEventListener(t,r),n())}e.addEventListener(t,r)})}function as(e,t){return new Promise(n=>{let r=new AbortController,{signal:i}=r;if(e.classList.contains(t))return;e.classList.add(t);let a=!1,o=()=>{a||(a=!0,e.classList.remove(t),n(),r.abort())};e.addEventListener(`animationend`,o,{once:!0,signal:i}),e.addEventListener(`animationcancel`,o,{once:!0,signal:i}),requestAnimationFrame(()=>{!a&&e.getAnimations().length===0&&o()})})}var F=class extends ki{constructor(){super(...arguments),this.placement=`top`,this.disabled=!1,this.distance=8,this.open=!1,this.skidding=0,this.showDelay=150,this.hideDelay=0,this.trigger=`hover focus`,this.withoutArrow=!1,this.for=null,this.anchor=null,this.eventController=new AbortController,this.handleBlur=()=>{this.hasTrigger(`focus`)&&this.hide()},this.handleClick=()=>{this.hasTrigger(`click`)&&(this.open?this.hide():this.show())},this.handleFocus=()=>{this.hasTrigger(`focus`)&&this.show()},this.handleDocumentKeyDown=e=>{e.key===`Escape`&&this.open&&Xo(this)&&(e.preventDefault(),e.stopPropagation(),this.hide())},this.handleMouseOver=()=>{this.hasTrigger(`hover`)&&(clearTimeout(this.hoverTimeout),this.hoverTimeout=window.setTimeout(()=>this.show(),this.showDelay))},this.handleMouseOut=()=>{if(this.hasTrigger(`hover`)){let e=!!this.anchor?.matches(`:hover`),t=this.matches(`:hover`);if(e||t)return;clearTimeout(this.hoverTimeout),e||t||(this.hoverTimeout=window.setTimeout(()=>{this.hide()},this.hideDelay))}}}connectedCallback(){super.connectedCallback(),this.eventController.signal.aborted&&(this.eventController=new AbortController),this.addEventListener(`mouseout`,this.handleMouseOut),this.open&&(this.open=!1,this.updateComplete.then(()=>{this.open=!0})),this.id||=rs(`wa-tooltip-`),this.for&&this.anchor?(this.anchor=null,this.handleForChange()):this.for&&this.handleForChange()}disconnectedCallback(){super.disconnectedCallback(),document.removeEventListener(`keydown`,this.handleDocumentKeyDown),Yo(this),this.eventController.abort(),this.anchor&&this.removeFromAriaLabelledBy(this.anchor,this.id)}firstUpdated(){this.body.hidden=!this.open,this.open&&(this.popup.active=!0,this.popup.reposition())}hasTrigger(e){return this.trigger.split(` `).includes(e)}addToAriaLabelledBy(e,t){let n=(e.getAttribute(`aria-labelledby`)||``).split(/\s+/).filter(Boolean);n.includes(t)||(n.push(t),e.setAttribute(`aria-labelledby`,n.join(` `)))}removeFromAriaLabelledBy(e,t){let n=(e.getAttribute(`aria-labelledby`)||``).split(/\s+/).filter(Boolean).filter(e=>e!==t);n.length>0?e.setAttribute(`aria-labelledby`,n.join(` `)):e.removeAttribute(`aria-labelledby`)}async handleOpenChange(){if(this.open){if(this.disabled)return;let e=new Zo;if(this.dispatchEvent(e),e.defaultPrevented){this.open=!1;return}document.addEventListener(`keydown`,this.handleDocumentKeyDown,{signal:this.eventController.signal}),Jo(this),this.body.hidden=!1,this.popup.active=!0,await as(this.popup.popup,`show-with-scale`),this.popup.reposition(),this.dispatchEvent(new es)}else{let e=new Qo;if(this.dispatchEvent(e),e.defaultPrevented){this.open=!1;return}document.removeEventListener(`keydown`,this.handleDocumentKeyDown),Yo(this),await as(this.popup.popup,`hide-with-scale`),this.popup.active=!1,this.body.hidden=!0,this.dispatchEvent(new $o)}}handleForChange(){let e=this.getRootNode();if(!e)return;let t=this.for?e.getElementById(this.for):null,n=this.anchor;if(t===n)return;let{signal:r}=this.eventController;t&&(this.addToAriaLabelledBy(t,this.id),t.addEventListener(`blur`,this.handleBlur,{capture:!0,signal:r}),t.addEventListener(`focus`,this.handleFocus,{capture:!0,signal:r}),t.addEventListener(`click`,this.handleClick,{signal:r}),t.addEventListener(`mouseover`,this.handleMouseOver,{signal:r}),t.addEventListener(`mouseout`,this.handleMouseOut,{signal:r})),n&&(this.removeFromAriaLabelledBy(n,this.id),n.removeEventListener(`blur`,this.handleBlur,{capture:!0}),n.removeEventListener(`focus`,this.handleFocus,{capture:!0}),n.removeEventListener(`click`,this.handleClick),n.removeEventListener(`mouseover`,this.handleMouseOver),n.removeEventListener(`mouseout`,this.handleMouseOut)),this.anchor=t}async handleOptionsChange(){this.hasUpdated&&(await this.updateComplete,this.popup.reposition())}handleDisabledChange(){this.disabled&&this.open&&this.hide()}async show(){if(!this.open)return this.open=!0,is(this,`wa-after-show`)}async hide(){if(this.open)return this.open=!1,is(this,`wa-after-hide`)}render(){return l`
      <wa-popup
        part="base"
        exportparts="
          popup:base__popup,
    ...
    `}};F.css=qi,F.dependencies={"wa-popup":P},M([y(`slot:not([name])`)],F.prototype,`defaultSlot`,2),M([y(`.body`)],F.prototype,`body`,2),M([y(`wa-popup`)],F.prototype,`popup`,2),M([g()],F.prototype,`placement`,2),M([g({type:Boolean,reflect:!0})],F.prototype,`disabled`,2),M([g({type:Number})],F.prototype,`distance`,2),M([g({type:Boolean,reflect:!0})],F.prototype,`open`,2),M([g({type:Number})],F.prototype,`skidding`,2),M([g({attribute:`show-delay`,type:Number})],F.prototype,`showDelay`,2),M([g({attribute:`hide-delay`,type:Number})],F.prototype,`hideDelay`,2),M([g()],F.prototype,`trigger`,2),M([g({attribute:`without-arrow`,type:Boolean,reflect:!0})],F.prototype,`withoutArrow`,2),M([g()],F.prototype,`for`,2),M([_()],F.prototype,`anchor`,2),M([Ei(`open`,{waitUntilFirstUpdate:!0})],F.prototype,`handleOpenChange`,1),M([Ei(`for`)],F.prototype,`handleForChange`,1),M([Ei([`distance`,`placement`,`skidding`])],F.prototype,`handleOptionsChange`,1),M([Ei(`disabled`)],F.prototype,`handleDisabledChange`,1),F=M([v(`wa-tooltip`)],F);var os=class extends F{static get styles(){return[F.styles,d`
        :host {
  ...
  `,e}var Cs=class extends bs{get _nativeButtonNode(){return xs.get(this._form)?.helper||null}constructor(){super(),this.type=`submit`,this.__implicitSubmitHelperButton=null}_setupSubmitAndResetHelperOnConnected(){if(super._setupSubmitAndResetHelperOnConnected(),!this._form||this.type!==`submit`)return;let e=this._form;if(!xs.get(this._form)){let t=Ss(),n=document.createElement(`div`);n.appendChild(t),xs.set(this._form,{lionButtons:new Set,helper:t,observer:new MutationObserver(()=>{e.appendChild(n)})}),e.appendChild(n),xs.get(e)?.observer.observe(n,{childList:!0})}xs.get(e)?.lionButtons.add(this)}_teardownSubmitAndResetHelperOnDisconnected(){if(super._teardownSubmitAndResetHelperOnDisconnected(),this._form){let e=xs.get(this._form);e&&(e.lionButtons.delete(this),e.lionButtons.size||(this._form.contains(e.helper)&&e.helper.remove(),xs.get(this._form)?.observer.disconnect(),xs.delete(this._form)))}}},ws=d`
  :host {
    --_size: var(--size, 24px);
  }
...
`,Ds=Object.prototype.toString;function Os(e){return typeof e==`function`||Ds.call(e)===`[object Function]`}function ks(e){var t=Number(e);return isNaN(t)?0:t===0||!isFinite(t)?t:(t>0?1:-1)*Math.floor(Math.abs(t))}var As=2**53-1;function js(e){var t=ks(e);return Math.min(Math.max(t,0),As)}function Ms(e,t){var n=Array,r=Object(e);if(e==null)throw TypeError(`Array.from requires an array-like object - not null or undefined`);if(t!==void 0&&!Os(t))throw TypeError(`Array.from: when provided, the second argument must be a function`);for(var i=js(r.length),a=Os(n)?Object(new n(i)):Array(i),o=0,s;o<i;)s=r[o],t?a[o]=t(s,o):a[o]=s,o+=1;return a.length=i,a}function Ns(e){"@babel/helpers - typeof";return Ns=typeof Symbol==`function`&&typeof Symbol.iterator==`symbol`?function(e){return typeof e}:function(e){return e&&typeof Symbol==`function`&&e.constructor===Symbol&&e!==Symbol.prototype?`symbol`:typeof e},Ns(e)}function Ps(e,t){if(!(e instanceof t))throw TypeError(`Cannot call a class as a function`)}function Fs(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,`value`in r&&(r.writable=!0),Object.defineProperty(e,Rs(r.key),r)}}function Is(e,t,n){return t&&Fs(e.prototype,t),n&&Fs(e,n),Object.defineProperty(e,`prototype`,{writable:!1}),e}function Ls(e,t,n){return t=Rs(t),t in e?Object.defineProperty(e,t,{value:n,enumerable:!0,configurable:!0,writable:!0}):e[t]=n,e}function Rs(e){var t=zs(e,`string`);return Ns(t)==`symbol`?t:t+``}function zs(e,t){if(Ns(e)!=`object`||!e)return e;var n=e[Symbol.toPrimitive];if(n!==void 0){var r=n.call(e,t||`default`);if(Ns(r)!=`object`)return r;throw TypeError(`@@toPrimitive must return a primitive value.`)}return(t===`string`?String:Number)(e)}var Bs=typeof Set>`u`?Set:function(){function e(){var t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:[];Ps(this,e),Ls(this,`items`,void 0),this.items=t}return Is(e,[{key:`add`,value:function(e){return this.has(e)===!1&&this.items.push(e),this}},{key:`clear`,value:function(){this.items=[]}},{key:`delete`,value:function(e){var t=this.items.length;return this.items=this.items.filter(function(t){return t!==e}),t!==this.items.length}},{key:`forEach`,value:function(e){var t=this;this.items.forEach(function(n){e(n,n,t)})}},{key:`has`,value:function(e){return this.items.indexOf(e)!==-1}},{key:`size`,get:function(){return this.items.length}}])}();function Vs(e){return e.localName??e.tagName.toLowerCase()}var Hs={article:`article`,aside:`complementary`,button:`button`,datalist:`listbox`,dd:`definition`,details:`group`,dialog:`dialog`,dt:`term`,fieldset:`group`,figure:`figure`,form:`form`,footer:`contentinfo`,h1:`heading`,h2:`heading`,h3:`heading`,h4:`heading`,h5:`heading`,h6:`heading`,header:`banner`,hr:`separator`,html:`document`,legend:`legend`,li:`listitem`,math:`math`,main:`main`,menu:`list`,nav:`navigation`,ol:`list`,optgroup:`group`,option:`option`,output:`status`,progress:`progressbar`,section:`region`,summary:`button`,table:`table`,tbody:`rowgroup`,textarea:`textbox`,tfoot:`rowgroup`,td:`cell`,th:`columnheader`,thead:`rowgroup`,tr:`row`,ul:`list`},Us={caption:new Set([`aria-label`,`aria-labelledby`]),code:new Set([`aria-label`,`aria-labelledby`]),deletion:new Set([`aria-label`,`aria-labelledby`]),emphasis:new Set([`aria-label`,`aria-labelledby`]),generic:new Set([`aria-label`,`aria-labelledby`,`aria-roledescription`]),insertion:new Set([`aria-label`,`aria-labelledby`]),none:new Set([`aria-label`,`aria-labelledby`]),paragraph:new Set([`aria-label`,`aria-labelledby`]),presentation:new Set([`aria-label`,`aria-labelledby`]),strong:new Set([`aria-label`,`aria-labelledby`]),subscript:new Set([`aria-label`,`aria-labelledby`]),superscript:new Set([`aria-label`,`aria-labelledby`])};function Ws(e,t){return[`aria-atomic`,`aria-busy`,`aria-controls`,`aria-current`,`aria-description`,`aria-describedby`,`aria-details`,`aria-dropeffect`,`aria-flowto`,`aria-grabbed`,`aria-hidden`,`aria-keyshortcuts`,`aria-label`,`aria-labelledby`,`aria-live`,`aria-owns`,`aria-relevant`,`aria-roledescription`].some(function(n){var r;return e.hasAttribute(n)&&!((r=Us[t])!=null&&r.has(n))})}function Gs(e,t){return Ws(e,t)}function Ks(e){var t=Js(e);if(t===null||Ys.indexOf(t)!==-1){var n=qs(e);if(Ys.indexOf(t||``)===-1||Gs(e,n||``))return n}return t}function qs(e){var t=Hs[Vs(e)];if(t!==void 0)return t;switch(Vs(e)){case`a`:case`area`:case`link`:if(e.hasAttribute(`href`))return`link`;break;case`img`:return e.getAttribute(`alt`)===``&&!Gs(e,`img`)?`presentation`:`img`;case`input`:var n=e.type;switch(n){case`button`:case`image`:case`reset`:case`submit`:return`button`;case`checkbox`:case`radio`:return n;case`range`:return`slider`;case`email`:case`tel`:case`text`:case`url`:return e.hasAttribute(`list`)?`combobox`:`textbox`;case`search`:return e.hasAttribute(`list`)?`combobox`:`searchbox`;case`number`:return`spinbutton`;default:return null}case`select`:return e.hasAttribute(`multiple`)||e.size>1?`listbox`:`combobox`}return null}function Js(e){var t=e.getAttribute(`role`);if(t!==null){var n=t.trim().split(` `)[0];if(n.length>0)return n}return null}var Ys=[`presentation`,`none`];function L(e){return e!==null&&e.nodeType===e.ELEMENT_NODE}function Xs(e){return L(e)&&Vs(e)===`caption`}function Zs(e){return L(e)&&Vs(e)===`input`}function Qs(e){return L(e)&&Vs(e)===`optgroup`}function $s(e){return L(e)&&Vs(e)===`select`}function ec(e){return L(e)&&Vs(e)===`table`}function tc(e){return L(e)&&Vs(e)===`textarea`}function nc(e){var t=(e.ownerDocument===null?e:e.ownerDocument).defaultView;if(t===null)throw TypeError(`no window available`);return t}function rc(e){return L(e)&&Vs(e)===`fieldset`}function ic(e){return L(e)&&Vs(e)===`legend`}function ac(e){return L(e)&&Vs(e)===`slot`}function oc(e){return L(e)&&e.ownerSVGElement!==void 0}function sc(e){return L(e)&&Vs(e)===`svg`}function cc(e){return oc(e)&&Vs(e)===`title`}function lc(e,t){if(L(e)&&e.hasAttribute(t)){var n=e.getAttribute(t).split(` `),r=e.getRootNode?e.getRootNode():e.ownerDocument;return n.map(function(e){return r.getElementById(e)}).filter(function(e){return e!==null})}return[]}function uc(e,t){return L(e)?t.indexOf(Ks(e))!==-1:!1}function dc(e){return e.trim().replace(/\s\s+/g,` `)}function fc(e,t){if(!L(e))return!1;if(e.hasAttribute(`hidden`)||e.getAttribute(`aria-hidden`)===`true`)return!0;var n=t(e);return n.getPropertyValue(`display`)===`none`||n.getPropertyValue(`visibility`)===`hidden`}function pc(e){return uc(e,[`button`,`combobox`,`listbox`,`textbox`])||mc(e,`range`)}function mc(e,t){if(!L(e))return!1;switch(t){case`range`:return uc(e,[`meter`,`progressbar`,`scrollbar`,`slider`,`spinbutton`]);default:throw TypeError(`No knowledge about abstract role '${t}'. This is likely a bug :(`)}}function hc(e,t){var n=Ms(e.querySelectorAll(t));return lc(e,`aria-owns`).forEach(function(e){n.push.apply(n,Ms(e.querySelectorAll(t)))}),n}function gc(e){return $s(e)?e.selectedOptions||hc(e,`[selected]`):hc(e,`[aria-selected="true"]`)}function _c(e){return uc(e,Ys)}function vc(e){return Xs(e)}function yc(e){return uc(e,[`button`,`cell`,`checkbox`,`columnheader`,`gridcell`,`heading`,`label`,`legend`,`link`,`menuitem`,`menuitemcheckbox`,`menuitemradio`,`option`,`radio`,`row`,`rowheader`,`switch`,`tab`,`tooltip`,`treeitem`])}function bc(e){return!1}function xc(e){return Zs(e)||tc(e)?e.value:e.textContent||``}function Sc(e){var t=e.getPropertyValue(`content`);return/^["'].*["']$/.test(t)?t.slice(1,-1):``}function Cc(e){var t=Vs(e);return t===`button`||t===`input`&&e.getAttribute(`type`)!==`hidden`||t===`meter`||t===`output`||t===`progress`||t===`select`||t===`textarea`}function wc(e){if(Cc(e))return e;var t=null;return e.childNodes.forEach(function(e){if(t===null&&L(e)){var n=wc(e);n!==null&&(t=n)}}),t}function Tc(e){if(e.control!==void 0)return e.control;var t=e.getAttribute(`for`);return t===null?wc(e):e.ownerDocument.getElementById(t)}function Ec(e){var t=e.labels;if(t===null)return t;if(t!==void 0)return Ms(t);if(!Cc(e))return null;var n=e.ownerDocument;return Ms(n.querySelectorAll(`label`)).filter(function(t){return Tc(t)===e})}function Dc(e){var t=e.assignedNodes();return t.length===0?Ms(e.childNodes):t}function Oc(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{},n=new Bs,r=typeof Map>`u`?void 0:new Map,i=nc(e),a=t.compute,o=a===void 0?`name`:a,s=t.computedStyleSupportsPseudoElements,c=s===void 0?t.getComputedStyle!==void 0:s,l=t.getComputedStyle,u=l===void 0?i.getComputedStyle.bind(i):l,d=t.hidden,f=d===void 0?!1:d,p=function(e,t){if(t!==void 0)throw Error(`use uncachedGetComputedStyle directly for pseudo elements`);if(r===void 0)return u(e);var n=r.get(e);if(n)return n;var i=u(e,t);return r.set(e,i),i};function m(e,t){var n=``;if(L(e)&&c&&(n=`${Sc(u(e,`::before`))} ${n}`),(ac(e)?Dc(e):Ms(e.childNodes).concat(lc(e,`aria-owns`))).forEach(function(e){var r=v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1,recursion:!0}),i=(L(e)?p(e).getPropertyValue(`display`):`inline`)===`inline`?``:` `;n+=`${i}${r}${i}`}),L(e)&&c){var r=Sc(u(e,`::after`));n=`${n} ${r}`}return n.trim()}function h(e,t){var r=e.getAttributeNode(t);return r!==null&&!n.has(r)&&r.value.trim()!==``?(n.add(r),r.value):null}function g(e){return L(e)?h(e,`title`):null}function _(e){if(!L(e))return null;if(rc(e)){n.add(e);for(var t=Ms(e.childNodes),r=0;r<t.length;r+=1){var i=t[r];if(ic(i))return v(i,{isEmbeddedInLabel:!1,isReferenced:!1,recursion:!1})}}else if(ec(e)){n.add(e);for(var a=Ms(e.childNodes),o=0;o<a.length;o+=1){var s=a[o];if(Xs(s))return v(s,{isEmbeddedInLabel:!1,isReferenced:!1,recursion:!1})}}else if(sc(e)){n.add(e);for(var c=Ms(e.childNodes),l=0;l<c.length;l+=1){var u=c[l];if(cc(u))return u.textContent}return null}else if(Vs(e)===`img`||Vs(e)===`area`){var d=h(e,`alt`);if(d!==null)return d}else if(Qs(e)){var f=h(e,`label`);if(f!==null)return f}if(Zs(e)&&(e.type===`button`||e.type===`submit`||e.type===`reset`)){var p=h(e,`value`);if(p!==null)return p;if(e.type===`submit`)return`Submit`;if(e.type===`reset`)return`Reset`}var g=Ec(e);if(g!==null&&g.length!==0)return n.add(e),Ms(g).map(function(e){return v(e,{isEmbeddedInLabel:!0,isReferenced:!1,recursion:!0})}).filter(function(e){return e.length>0}).join(` `);if(Zs(e)&&e.type===`image`){var _=h(e,`alt`);if(_!==null)return _;var y=h(e,`title`);return y===null?`Submit Query`:y}if(uc(e,[`button`])){var b=m(e,{isEmbeddedInLabel:!1,isReferenced:!1});if(b!==``)return b}return null}function v(e,t){if(n.has(e))return``;if(!f&&fc(e,p)&&!t.isReferenced)return n.add(e),``;var r=L(e)?e.getAttributeNode(`aria-labelledby`):null,i=r!==null&&!n.has(r)?lc(e,`aria-labelledby`):[];if(o===`name`&&!t.isReferenced&&i.length>0)return n.add(r),i.map(function(e){return v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!0,recursion:!1})}).join(` `);var a=t.recursion&&pc(e)&&o===`name`;if(!a){var s=(L(e)&&e.getAttribute(`aria-label`)||``).trim();if(s!==``&&o===`name`)return n.add(e),s;if(!_c(e)){var c=_(e);if(c!==null)return n.add(e),c}}if(uc(e,[`menu`]))return n.add(e),``;if(a||t.isEmbeddedInLabel||t.isReferenced){if(uc(e,[`combobox`,`listbox`])){n.add(e);var l=gc(e);return l.length===0?Zs(e)?e.value:``:Ms(l).map(function(e){return v(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1,recursion:!0})}).join(` `)}if(mc(e,`range`))return n.add(e),e.hasAttribute(`aria-valuetext`)?e.getAttribute(`aria-valuetext`):e.hasAttribute(`aria-valuenow`)?e.getAttribute(`aria-valuenow`):e.getAttribute(`value`)||``;if(uc(e,[`textbox`]))return n.add(e),xc(e)}if(yc(e)||L(e)&&t.isReferenced||vc(e)||bc(e)){var u=m(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1});if(u!==``)return n.add(e),u}if(e.nodeType===e.TEXT_NODE)return n.add(e),e.textContent||``;if(t.recursion)return n.add(e),m(e,{isEmbeddedInLabel:t.isEmbeddedInLabel,isReferenced:!1});var d=g(e);return d===null?(n.add(e),``):(n.add(e),d)}return dc(v(e,{isEmbeddedInLabel:!1,isReferenced:o===`description`,recursion:!1}))}function kc(e){return uc(e,[`caption`,`code`,`deletion`,`emphasis`,`generic`,`insertion`,`none`,`paragraph`,`presentation`,`strong`,`subscript`,`superscript`])}function Ac(e){var t=arguments.length>1&&arguments[1]!==void 0?arguments[1]:{};return kc(e)?``:Oc(e,t)}var jc=class extends Cs{constructor(...e){super(...e),this.appearance=`solid`,this.variant=`neutral`,this.size=`medium`,this.active=!1,this.loading=!1,this.align=`center`,this.icon=null,this._hasAccessibilityError=!1}static get styles(){return[...super.styles,Ki,Es]}async firstUpdated(e){super.firstUpdated(e),await this.updateComplete;let t=this.querySelectorAll(`craft-icon, craft-spinner`);await Promise.all(Array.from(t).map(e=>e.updateComplete)),this.accessibleName||=Ac(this),this._hasAccessibilityError=!this.accessibleName||this.accessibleName.trim()===``}render(){return l`
    ...
    `}};s([g()],jc.prototype,`accessibleName`,void 0),s([g({reflect:!0})],jc.prototype,`appearance`,void 0),s([g({reflect:!0})],jc.prototype,`variant`,void 0),s([g({reflect:!0})],jc.prototype,`size`,void 0),s([g({reflect:!0})],jc.prototype,`value`,void 0),s([g({reflect:!0,type:Boolean})],jc.prototype,`active`,void 0),s([g({reflect:!0,type:Boolean})],jc.prototype,`loading`,void 0),s([g()],jc.prototype,`align`,void 0),s([g()],jc.prototype,`icon`,void 0),s([_()],jc.prototype,`_hasAccessibilityError`,void 0),customElements.get(`craft-button`)||customElements.define(`craft-button`,jc);var Mc=new WeakMap,Nc=class extends h{constructor(...e){super(...e),this.label=r(`More Info`),this.icon=`circle-info`,this.disabled=!1,this.status=``,w(this,Mc,new AbortController)}connectedCallback(){super.connectedCallback(),D(Mc,this).signal.aborted&&E(Mc,this,new AbortController),this.id||=`info-icon-${Math.random().toString(36).slice(2,8)}`;let{signal:e}=D(Mc,this);this.addEventListener(`wa-show`,()=>{Pc._&&Pc._!==this&&Pc._.renderRoot.querySelector(`c-tooltip`)?.hide(),Pc._=this},{signal:e}),this.addEventListener(`wa-after-show`,()=>{this.status=``,setTimeout(()=>{this.status=`Some new status`},200)},{signal:e}),this.addEventListener(`wa-after-hide`,()=>{Pc._===this&&(Pc._=null),this.status=``},{signal:e})}disconnectedCallback(){Pc._===this&&(Pc._=null),D(Mc,this).abort(),super.disconnectedCallback()}render(){return l`
  ...
  `;var Pc={_:null};s([g()],Nc.prototype,`label`,void 0),s([g()],Nc.prototype,`icon`,void 0),s([g({type:Boolean,reflect:!0})],Nc.prototype,`disabled`,void 0),s([g()],Nc.prototype,`id`,void 0),s([_()],Nc.prototype,`status`,void 0),s([y(`c-tooltip`)],Nc.prototype,`tooltip`,void 0),customElements.get(`craft-info-icon`)||customElements.define(`craft-info-icon`,Nc);var Fc=class extends h{constructor(...e){super(...e),this.debug=!1}render(){return l`<slot></slot>`}};Fc.styles=d`
    :host(:not([debug])) {
      position: absolute;
      width: 1px;
      height: 1px;
  ...
  `,s([g({type:Boolean,reflect:!0})],Fc.prototype,`debug`,void 0),customElements.get(`craft-visually-hidden`)||customElements.define(`craft-visually-hidden`,Fc);var Ic=class extends h{constructor(...e){super(...e),this.visible=!0}show(){this.visible=!0,this.dispatchEvent(new CustomEvent(`show`))}hide(){this.visible=!1,this.dispatchEvent(new CustomEvent(`hide`))}focus(){this.wrapper?.focus()}render(){return l`
      <div
        tabindex="-1"
    ...
    `}};Ic.styles=[Ts,ws],s([g({reflect:!0,type:Boolean})],Ic.prototype,`visible`,void 0),s([y(`.wrapper`)],Ic.prototype,`wrapper`,void 0),customElements.get(`craft-spinner`)||customElements.define(`craft-spinner`,Ic);var Lc=d`
  :host {
    display: inline-block;
  }
...
`,Rc={"icon.in":{keyframes:[{scale:.25,opacity:.25},{scale:1,opacity:1}],options:{duration:100}},"icon.out":{keyframes:[{scale:1,opacity:1},{scale:.25,opacity:.25}],options:{duration:100}}},zc=class extends h{constructor(...e){super(...e),this.isCopying=!1,this.status=`rest`,this.value=``,this.disabled=!1,this.feedbackDuration=1e3,this.tooltipLabel=null}async copyValue(){if(!(this.status===`copying`||this.disabled)){this.status=`copying`;try{await navigator.clipboard.writeText(this.value),this.dispatchEvent(new CustomEvent(`craft-copy`,{bubbles:!0,cancelable:!1,composed:!0,detail:{value:this.value}}))}catch{this.dispatchEvent(new CustomEvent(`craft-error`,{cancelable:!1,composed:!0,bubbles:!0}))}finally{this.isCopying=!1}}}async showStatus(e){let t=e===`success`?this.successIconEl:this.errorIconEl;this.tooltipLabel=e===`success`?`Copied`:`Copy failed`,await t.animate(Rc[`icon.out`].keyframes,Rc[`icon.out`].options),this.copyIconEl.hidden=!0,t.hidden=!1,await t.animate(Rc[`icon.in`].keyframes,Rc[`icon.in`].options),this.status=e,setTimeout(async()=>{await t.animate(Rc[`icon.out`].keyframes,Rc[`icon.out`].options),t.hidden=!0,this.copyIconEl.hidden=!1,await this.copyIconEl.animate(Rc[`icon.in`].keyframes,Rc[`icon.in`].options),this.status=`rest`,this.tooltipLabel=`Copy`},this.feedbackDuration)}connectedCallback(){super.connectedCallback(),this.tooltipLabel=this.getAttribute(`tooltip-label`)||r(`Copy`),this.id||=`copy-${Math.floor(Math.random()*1e8)}`,this.addEventListener(`craft-copy`,()=>{this.showStatus(`success`)}),this.addEventListener(`craft-error`,()=>{this.showStatus(`error`)})}render(){return l`
    ...
    `}};zc.styles=[Lc],s([_()],zc.prototype,`isCopying`,void 0),s([_()],zc.prototype,`status`,void 0),s([y(`slot[name="copy-icon"]`)],zc.prototype,`copyIconEl`,void 0),s([y(`slot[name="success-icon"]`)],zc.prototype,`successIconEl`,void 0),s([y(`slot[name="error-icon"]`)],zc.prototype,`errorIconEl`,void 0),s([g({type:String})],zc.prototype,`value`,void 0),s([g({type:Boolean})],zc.prototype,`disabled`,void 0),s([g({attribute:`feedback-duration`,type:Number})],zc.prototype,`feedbackDuration`,void 0),s([g()],zc.prototype,`tooltipLabel`,void 0),customElements.get(`craft-copy-button`)||customElements.define(`craft-copy-button`,zc);var Bc=d`
  :host {
    box-sizing: border-box;
  }
...
`,Hc=class extends h{constructor(...e){super(...e),this.value=``,this.disabled=!1}getId(){return`attribute-${this.value.replace(/([a-z])([A-Z])/g,`$1-$2`).replace(/[\s_]+/g,`-`).toLowerCase()}`}render(){return l`
      <craft-copy-button
        id="${this.getId()}"
        value="${this.value}"
    ...
    `}};Hc.styles=[Bc,Vc],s([y(`craft-copy-button`)],Hc.prototype,`copyButtonEl`,void 0),s([g({type:String})],Hc.prototype,`value`,void 0),s([g({type:Boolean,reflect:!0})],Hc.prototype,`disabled`,void 0),customElements.get(`craft-copy-attribute`)||customElements.define(`craft-copy-attribute`,Hc);var Uc=d`
  :host {
    --color-start: red;
    --color-end: blue;
    --color-text: inherit;
...
`,Wc=class extends h{constructor(...e){super(...e),this.label=null,this._gradientId=null}connectedCallback(){super.connectedCallback(),this._gradientId=`avatar-gradient-${Math.random().toString(36).slice(2,8)}`}text(){return this.label?this.label.split(` `).map(e=>e.charAt(0).toUpperCase()).join(``):`?`}render(){return l`
      <span class="avatar">
        <svg
          viewBox="0 0 100 100"
    ...
    `}};Wc.styles=[Uc],s([g()],Wc.prototype,`label`,void 0),s([_()],Wc.prototype,`_gradientId`,void 0),customElements.get(`craft-avatar`)||customElements.define(`craft-avatar`,Wc);var Gc=d`
  --_border-width: var(
...
`)),n?this.registry.get(e):this.registry.define(e,t)}attachShadow(e){let{scopedElements:t}=this.constructor;if(!this.registry||this.registry===this.constructor.__registry&&!Object.prototype.hasOwnProperty.call(this.constructor,`__registry`)){this.registry=Bl()?new CustomElementRegistry:customElements;for(let[e,n]of Object.entries(t??{}))this.defineScopedElement(e,n)}return Element.prototype.attachShadow.call(this,{...e,customElements:this.registry,registry:this.registry})}createRenderRoot(){let{shadowRootOptions:e,elementStyles:t}=this.constructor,n=this.attachShadow(e);return Bl()&&(this.renderOptions.creationScope=n),n instanceof ShadowRoot&&(u(n,t),this.renderOptions.renderBefore=this.renderOptions.renderBefore||n.firstChild),n}}),Hl=[Node.DOCUMENT_POSITION_PRECEDING,Node.DOCUMENT_POSITION_CONTAINS,Node.DOCUMENT_POSITION_CONTAINS|Node.DOCUMENT_POSITION_PRECEDING];function Ul(e,{reverse:t}={}){let n=(e,t)=>{let n=e.compareDocumentPosition(t);return Hl.includes(n)?1:-1},r=e.filter(e=>e);return r.sort(n),t&&r.reverse(),r}var Wl=class{constructor(e){this.type=`unparseable`,this.viewValue=e}toString(){return JSON.stringify({type:this.type,viewValue:this.viewValue})}},Gl=I(e=>class extends e{constructor(){super(),this.name=``,this._parentFormGroup=void 0,this.allowCrossRootRegistration=!1}get name(){return this.__name||``}set name(e){let t=this.name;this.__name=e.toString(),this.requestUpdate(`name`,t)}static get properties(){return{name:{type:String,reflect:!0},allowCrossRootRegistration:{type:Boolean,attribute:`allow-cross-root-registration`}}}connectedCallback(){super.connectedCallback(),this.dispatchEvent(new CustomEvent(`form-element-register`,{detail:{element:this},bubbles:!0,composed:!!this.allowCrossRootRegistration}))}disconnectedCallback(){super.disconnectedCallback(),this.__unregisterFormElement()}__unregisterFormElement(){this._parentFormGroup&&this._parentFormGroup.removeFormElement(this)}}),Kl=I(e=>class extends Gl(ls(ps(e))){static get properties(){return{readOnly:{type:Boolean,attribute:`readonly`,reflect:!0},label:String,labelSrOnly:{type:Boolean,attribute:`label-sr-only`,reflect:!0},helpText:{type:String,attribute:`help-text`},modelValue:{attribute:!1},_ariaLabelledNodes:{attribute:!1},_ariaDescribedNodes:{attribute:!1},_repropagationRole:{attribute:!1},_isRepropagationEndpoint:{attribute:!1}}}get label(){return this.__label??(this._labelNode?.textContent||``)}set label(e){let t=this.label;this.__label=e,this.requestUpdate(`label`,t)}get helpText(){return this.__helpText??(this._helpTextNode?.textContent||``)}set helpText(e){let t=this.helpText;this.__helpText=e,this.requestUpdate(`helpText`,t)}get fieldName(){return this.__fieldName||this.label||this.name||``}set fieldName(e){this.__fieldName=e}get slots(){return{...super.slots,label:()=>{let e=document.createElement(`label`);return e.textContent=this.label,e},"help-text":()=>{let e=document.createElement(`div`);return e.textContent=this.helpText,e}}}get _inputNode(){return this.__getDirectSlotChild(`input`)}get _labelNode(){return this.__getDirectSlotChild(`label`)}get _helpTextNode(){return this.__getDirectSlotChild(`help-text`)}get _feedbackNode(){return this.__getDirectSlotChild(`feedback`)}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];constructor(){super(),this.readOnly=!1,this.labelSrOnly=!1,this._inputId=gs(this.localName),this._ariaLabelledNodes=[],this._ariaDescribedNodes=[],this._repropagationRole=`child`,this._isRepropagationEndpoint=!1,this.addEventListener(`model-value-changed`,this.__repropagateChildrenValues),this._onLabelClick=this._onLabelClick.bind(this)}connectedCallback(){super.connectedCallback(),this._enhanceLightDomClasses(),this._enhanceLightDomA11y(),this._triggerInitialModelValueChangedEvent(),this._labelNode&&this._labelNode.addEventListener(`click`,this._onLabelClick)}disconnectedCallback(){super.disconnectedCallback(),this._labelNode&&this._labelNode.removeEventListener(`click`,this._onLabelClick)}updated(e){super.updated(e),e.has(`disabled`)&&this._inputNode?.setAttribute(`aria-disabled`,`${!!this.disabled}`),e.has(`_ariaLabelledNodes`)&&this.__reflectAriaAttr(`aria-labelledby`,this._ariaLabelledNodes,this.__reorderAriaLabelledNodes),e.has(`_ariaDescribedNodes`)&&this.__reflectAriaAttr(`aria-describedby`,this._ariaDescribedNodes,this.__reorderAriaDescribedNodes),e.has(`label`)&&this.__label!==void 0&&this._labelNode&&(this._labelNode.textContent=this.label),e.has(`helpText`)&&this.__helpText!==void 0&&this._helpTextNode&&(this._helpTextNode.textContent=this.helpText),e.has(`name`)&&this.dispatchEvent(new CustomEvent(`form-element-name-changed`,{detail:{oldName:e.get(`name`),newName:this.name},bubbles:!0}))}_triggerInitialModelValueChangedEvent(){this._dispatchInitialModelValueChangedEvent()}_enhanceLightDomClasses(){this._inputNode&&this._inputNode.classList.add(`form-control`)}_enhanceLightDomA11y(){let{_inputNode:e,_labelNode:t,_helpTextNode:n,_feedbackNode:r}=this;e&&(e.id=e.id||this._inputId),t&&(t.setAttribute(`for`,this._inputId),this.addToAriaLabelledBy(t,{idPrefix:`label`})),n&&this.addToAriaDescribedBy(n,{idPrefix:`help-text`}),r&&(this.addEventListener(`focusin`,()=>{r.setAttribute(`aria-live`,`polite`)}),this.addEventListener(`focusout`,()=>{r.setAttribute(`aria-live`,`assertive`)}),this.addToAriaDescribedBy(r,{idPrefix:`feedback`})),this._enhanceLightDomA11yForAdditionalSlots()}_enhanceLightDomA11yForAdditionalSlots(e=[`prefix`,`suffix`,`before`,`after`]){e.forEach(e=>{let t=this.__getDirectSlotChild(e);t&&(t.hasAttribute(`data-label`)&&this.addToAriaLabelledBy(t,{idPrefix:e}),t.hasAttribute(`data-description`)&&this.addToAriaDescribedBy(t,{idPrefix:e}))})}__reflectAriaAttr(e,t,n){if(this._inputNode){if(n){let e=t.filter(e=>this.contains(e)),n=t.filter(e=>!this.contains(e)),r=[...Ul(e.map(e=>e.assignedSlot||e))],i=[];r.forEach(t=>{e.forEach(e=>{t.name===e.slot&&i.push(e)})}),t=[...i,...n]}let r=t.map(e=>e.id).join(` `);this._inputNode.setAttribute(e,r)}}render(){return l`
      ...
      `}_isEmpty(e=this.modelValue){let t=e;return this.modelValue instanceof Wl&&(t=this.modelValue.viewValue),typeof t==`object`&&t&&!(t instanceof Date)?!Object.keys(t).length:!t&&!(typeof t==`number`&&(t===0||Number.isNaN(t)))&&!(typeof t==`boolean`&&t===!1)}static get styles(){return[d`
          /**********************
            {block} .form-field
           ********************/
        ...
        `]}_getAriaDescriptionElements(){return[this._helpTextNode,this._feedbackNode]}addToAriaLabelledBy(e,{idPrefix:t=``,reorder:n=!0}={}){e.id=e.id||`${t}-${this._inputId}`,this._ariaLabelledNodes.includes(e)||(this._ariaLabelledNodes=[...this._ariaLabelledNodes,e],this.__reorderAriaLabelledNodes=!!n)}removeFromAriaLabelledBy(e){this._ariaLabelledNodes.includes(e)&&(this._ariaLabelledNodes.splice(this._ariaLabelledNodes.indexOf(e),1),this._ariaLabelledNodes=[...this._ariaLabelledNodes],this.__reorderAriaLabelledNodes=!1)}addToAriaDescribedBy(e,{idPrefix:t=``,reorder:n=!0}={}){e.id=e.id||`${t}-${this._inputId}`,this._ariaDescribedNodes.includes(e)||(this._ariaDescribedNodes=[...this._ariaDescribedNodes,e],this.__reorderAriaDescribedNodes=!!n)}removeFromAriaDescribedBy(e){this._ariaDescribedNodes.includes(e)&&(this._ariaDescribedNodes.splice(this._ariaDescribedNodes.indexOf(e),1),this._ariaDescribedNodes=[...this._ariaDescribedNodes],this.__reorderAriaLabelledNodes=!1)}__getDirectSlotChild(e){return Array.from(this.children).find(t=>t.slot===e)}_dispatchInitialModelValueChangedEvent(){this._repropagationRole!==`child`&&(this.__repropagateChildrenInitialized=!0,this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:[this],initialize:!0,isTriggeredByUser:!1}})))}_onBeforeRepropagateChildrenValues(e){}__repropagateChildrenValues(e){this._onBeforeRepropagateChildrenValues(e);let t=e.detail&&e.detail.element||e.target,n=this._isRepropagationEndpoint||this._repropagationRole===`choice-group`;if(t===this)return;e.stopImmediatePropagation();let r=this._repropagationRole!==`child`&&!this.__repropagateChildrenInitialized,i=e.detail&&e.detail.initialize;if(r||i||!this._repropagationCondition(t))return;let a=[];n||(a=e.detail&&e.detail.formPath||[t]);let o=[...a,this];this.dispatchEvent(new CustomEvent(`model-value-changed`,{bubbles:!0,detail:{formPath:o,isTriggeredByUser:!!e.detail?.isTriggeredByUser}}))}_repropagationCondition(e){return!!e}_onLabelClick(){}}),ql=class{constructor(){this.__running=!1,this.__queue=[]}add(e){this.__queue.push(e),this.__running||(this.complete=new Promise(e=>{this.__callComplete=e}),this.__run())}async __run(){this.__running=!0,await this.__queue[0](),this.__queue.shift(),this.__queue.length>0?this.__run():(this.__running=!1,this.__callComplete&&this.__callComplete())}};function Jl(e){return e.charAt(0).toUpperCase()+e.slice(1)}var Yl=I(e=>class extends e{constructor(){super(),this.__SyncUpdatableNamespace={}}firstUpdated(e){super.firstUpdated(e),this.__syncUpdatableInitialize()}connectedCallback(){super.connectedCallback(),this.__SyncUpdatableNamespace.connected=!0}disconnectedCallback(){super.disconnectedCallback(),this.__SyncUpdatableNamespace.connected=!1}static enabledWarnings=super.enabledWarnings?.filter(e=>e!==`change-in-update`)||[];static __syncUpdatableHasChanged(e,t,n){let r=this.elementProperties;return r.get(e)&&r.get(e).hasChanged?r.get(e).hasChanged(t,n):t!==n}__syncUpdatableInitialize(){let e=this.__SyncUpdatableNamespace,t=this.constructor;e.initialized=!0,e.queue&&Array.from(e.queue).forEach(e=>{t.__syncUpdatableHasChanged(e,this[e],void 0)&&this.updateSync(e,void 0)})}requestUpdate(e,t,n){if(super.requestUpdate(e,t,n),e===void 0)return;this.__SyncUpdatableNamespace=this.__SyncUpdatableNamespace||{};let r=this.__SyncUpdatableNamespace,i=this.constructor;r.initialized?i.__syncUpdatableHasChanged(e,this[e],t)&&this.updateSync(e,t):(r.queue=r.queue||new Set,r.queue.add(e))}updateSync(e,t){}}),Xl=e=>{switch(e){case`bg-BG`:return j(()=>import(`./bg-BG-iWPJs5Tl.js`),__vite__mapDeps([0,1]),import.meta.url);case`bg`:return j(()=>import(`./bg-aTY7Mr5o.js`),[],import.meta.url);case`cs-CZ`:return j(()=>import(`./cs-CZ-Bzcvcm_J.js`),__vite__mapDeps([2,3]),import.meta.url);case`cs`:return j(()=>import(`./cs-LLqzSHLu.js`),[],import.meta.url);case`de-DE`:return j(()=>import(`./de-DE-5HdsI68e.js`),__vite__mapDeps([4,5]),import.meta.url);case`de`:return j(()=>import(`./de-2T-EEAml.js`),[],import.meta.url);case`en-AU`:return j(()=>import(`./en-AU-sv2I_xAS.js`),__vite__mapDeps([6,7]),import.meta.url);case`en-GB`:return j(()=>import(`./en-GB-Ccjnmx68.js`),__vite__mapDeps([8,7]),import.meta.url);case`en-US`:return j(()=>import(`./en-US-Bd1wjHHP.js`),__vite__mapDeps([9,7]),import.meta.url);case`en-PH`:case`en`:return j(()=>import(`./en-DfIS5RjH.js`),[],import.meta.url);case`es-ES`:return j(()=>import(`./es-ES-B5qX0okH.js`),__vite__mapDeps([10,11]),import.meta.url);case`es`:return j(()=>import(`./es-I1N26rBY.js`),[],import.meta.url);case`fr-FR`:return j(()=>import(`./fr-FR-C8E7R-S4.js`),__vite__mapDeps([12,13]),import.meta.url);case`fr-BE`:return j(()=>import(`./fr-BE-CWelk8SZ.js`),__vite__mapDeps([14,13]),import.meta.url);case`fr`:return j(()=>import(`./fr-HB97ISbZ.js`),[],import.meta.url);case`hu-HU`:return j(()=>import(`./hu-HU-DqhBYiMO.js`),__vite__mapDeps([15,16]),import.meta.url);case`hu`:return j(()=>import(`./hu-BuHnmMwT.js`),[],import.meta.url);case`it-IT`:return j(()=>import(`./it-IT-DTUSrNNJ.js`),__vite__mapDeps([17,18]),import.meta.url);case`it`:return j(()=>import(`./it-BSZ9w0Uq.js`),[],import.meta.url);case`nl-BE`:return j(()=>import(`./nl-BE--JuiBZ2y.js`),__vite__mapDeps([19,20]),import.meta.url);case`nl-NL`:return j(()=>import(`./nl-NL-Cp7nHh8j.js`),__vite__mapDeps([21,20]),import.meta.url);case`nl`:return j(()=>import(`./nl-DUs1DdJI.js`),[],import.meta.url);case`pl-PL`:return j(()=>import(`./pl-PL-roW2zSu3.js`),__vite__mapDeps([22,23]),import.meta.url);case`pl`:return j(()=>import(`./pl-A43X9V-z.js`),[],import.meta.url);case`ro-RO`:return j(()=>import(`./ro-RO-CfAyHnbr.js`),__vite__mapDeps([24,25]),import.meta.url);case`ro`:return j(()=>import(`./ro-D5VpuZ2D.js`),[],import.meta.url);case`ru-RU`:return j(()=>import(`./ru-RU-CAM982Dc.js`),__vite__mapDeps([26,27]),import.meta.url);case`ru`:return j(()=>import(`./ru-DWKb5rLM.js`),[],import.meta.url);case`sk-SK`:return j(()=>import(`./sk-SK-ssLhzYxe.js`),__vite__mapDeps([28,29]),import.meta.url);case`sk`:return j(()=>import(`./sk-CcpHfFuo.js`),[],import.meta.url);case`tr-TR`:return j(()=>import(`./tr-TR-BmRy6qFq.js`),__vite__mapDeps([30,31]),import.meta.url);case`tr`:return j(()=>import(`./tr-CdhJoVvN.js`),[],import.meta.url);case`uk-UA`:return j(()=>import(`./uk-UA-B9Qc6QPR.js`),__vite__mapDeps([32,33]),import.meta.url);case`uk`:return j(()=>import(`./uk-h1uxyBaZ.js`),[],import.meta.url);case`zh-CN`:case`zh`:return j(()=>import(`./zh-C7jH59M_.js`),[],import.meta.url);default:return j(()=>import(`./en-DfIS5RjH.js`),[],import.meta.url)}},Zl=e=>`${e[0].toUpperCase()}${e.slice(1)}`,Ql=class extends Fl(h){static get properties(){return{feedbackData:{attribute:!1}}}static localizeNamespaces=[{"lion-form-core":Xl},...super.localizeNamespaces];static get styles(){return[d`
...
`,_u=class extends hu{constructor(...e){super(...e),this.size=`medium`,this.small=!1,this.center=!1}static get styles(){return[...super.styles,qc,gu]}connectedCallback(){super.connectedCallback(),this._inputNode&&this.maxlength&&this.maxlength>0&&(this._inputNode.maxLength=this.maxlength)}};s([g({type:Number,reflect:!0})],_u.prototype,`maxlength`,void 0),s([g({type:String,reflect:!0})],_u.prototype,`size`,void 0),s([g({reflect:!0,type:Boolean})],_u.prototype,`small`,void 0),s([g({reflect:!0,type:Boolean})],_u.prototype,`center`,void 0),customElements.get(`craft-input`)||customElements.define(`craft-input`,_u);var vu=e=>e??m,yu=class extends $l{static validatorName=`IsAcceptedFile`;static checkFileSize(e,t){return e<=t}static getExtension(e){return e?.slice(e.lastIndexOf(`.`))}static isExtensionAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}static isFileTypeAllowed(e,t){return t?.find(t=>t.toUpperCase()===e.toUpperCase())}execute(e,t=this.param){let n,r,i=this.constructor,{allowedFileTypes:a,allowedFileExtensions:o,maxFileSize:s}=t;return a?.length?(n=e.some(e=>!i.isFileTypeAllowed(e.type,a)),n):o?.length?(r=e.some(e=>!i.isExtensionAllowed(i.getExtension(e.name),o)),r):e.findIndex(e=>!i.checkFileSize(e.size,s))>-1}static async getMessage(){return``}},bu=class extends $l{static validatorName=`DuplicateFileNames`;constructor(e,t){super(e,t),this.type=`info`}execute(e,t=this.param){return t.show}static async getMessage(){return Sl().msg(`lion-input-file:uploadTextDuplicateFileName`)}},xu=524288e3,Su={type:`FILE_TYPE`,size:`FILE_SIZE`},Cu={fail:`FAIL`,pass:`SUCCESS`},wu=class{constructor(e,t){this.failedProp=[],this.systemFile=e,this._acceptCriteria=t,this.uploadFileStatus(),this.failedProp.length===0&&this.createDownloadUrl(e)}_getFileNameExtension(e){return e.slice(e.lastIndexOf(`.`))}uploadFileStatus(){if(this._acceptCriteria.allowedFileExtensions.length){let e=this._getFileNameExtension(this.systemFile.name);yu.isExtensionAllowed(e,this._acceptCriteria.allowedFileExtensions)||(this.status=Cu.fail,this.failedProp.push(Su.type))}else if(this._acceptCriteria.allowedFileTypes.length){let e=this.systemFile.type;yu.isFileTypeAllowed(e,this._acceptCriteria.allowedFileTypes)||(this.status=Cu.fail,this.failedProp.push(Su.type))}yu.checkFileSize(this.systemFile.size,this._acceptCriteria.maxFileSize)?this.status!==Cu.fail&&(this.status=Cu.pass):(this.status=Cu.fail,this.failedProp.push(Su.size))}createDownloadUrl(e){this.downloadUrl=window.URL.createObjectURL(e)}},Tu=(e,t,n)=>{let r=new Map;for(let i=t;i<=n;i++)r.set(e[i],i);return r},Eu=n(class extends t{constructor(e){if(super(e),e.type!==a.CHILD)throw Error(`repeat() can only be used in text expressions`)}dt(e,t,n){let r;n===void 0?n=t:t!==void 0&&(r=t);let i=[],a=[],o=0;for(let t of e)i[o]=r?r(t,o):o,a[o]=n(t,o),o++;return{values:a,keys:i}}render(e,t,n){return this.dt(e,t,n).values}update(e,[t,n,r]){let i=zi(e),{values:a,keys:o}=this.dt(t,n,r);if(!Array.isArray(i))return this.ut=o,a;let s=this.ut??=[],c=[],l,u,d=0,p=i.length-1,m=0,h=a.length-1;for(;d<=p&&m<=h;)if(i[d]===null)d++;else if(i[p]===null)p--;else if(s[d]===o[m])c[m]=Ii(i[d],a[m]),d++,m++;else if(s[p]===o[h])c[h]=Ii(i[p],a[h]),p--,h--;else if(s[d]===o[h])c[h]=Ii(i[d],a[h]),Fi(e,c[h+1],i[d]),d++,h--;else if(s[p]===o[m])c[m]=Ii(i[p],a[m]),Fi(e,i[d],i[p]),p--,m++;else if(l===void 0&&(l=Tu(o,m,h),u=Tu(s,d,p)),l.has(s[d]))if(l.has(s[p])){let t=u.get(o[m]),n=t===void 0?null:i[t];if(n===null){let t=Fi(e,i[d]);Ii(t,a[m]),c[m]=t}else c[m]=Ii(n,a[m]),Fi(e,i[d],n),i[t]=null;m++}else Bi(i[p]),p--;else Bi(i[d]),d++;for(;m<=h;){let t=Fi(e,c[h+1]);Ii(t,a[m]),c[m++]=t}for(;d<=p;){let e=i[d++];e!==null&&Bi(e)}return this.ut=o,Ri(e,c),f}}),Du=e=>{switch(e){case`bg-BG`:return j(()=>import(`./bg-BG-BfHUWwsR.js`),__vite__mapDeps([34,35]),import.meta.url);case`bg`:return j(()=>import(`./bg-CrlP4VyV.js`),[],import.meta.url);case`cs-CZ`:return j(()=>import(`./cs-CZ-BI3dwFI7.js`),__vite__mapDeps([36,37]),import.meta.url);case`cs`:return j(()=>import(`./cs-DXRHYEHK.js`),[],import.meta.url);case`de-DE`:return j(()=>import(`./de-DE-lABGuGEf.js`),__vite__mapDeps([38,39]),import.meta.url);case`de`:return j(()=>import(`./de-BRyKYnKI.js`),[],import.meta.url);case`en-AU`:return j(()=>import(`./en-AU-DRTaN8yU.js`),__vite__mapDeps([40,41]),import.meta.url);case`en-GB`:return j(()=>import(`./en-GB-DnDkxqUn.js`),__vite__mapDeps([42,41]),import.meta.url);case`en-US`:return j(()=>import(`./en-US-Be4KPffb.js`),__vite__mapDeps([43,41]),import.meta.url);case`en-PH`:case`en`:return j(()=>import(`./en-Ied68Ew1.js`),[],import.meta.url);case`es-ES`:return j(()=>import(`./es-ES-kusLvxmX.js`),__vite__mapDeps([44,45]),import.meta.url);case`es`:return j(()=>import(`./es--yGGemB2.js`),[],import.meta.url);case`fr-FR`:return j(()=>import(`./fr-FR-DxdmjyYP.js`),__vite__mapDeps([46,47]),import.meta.url);case`fr-BE`:return j(()=>import(`./fr-BE-DrNf2Toq.js`),__vite__mapDeps([48,47]),import.meta.url);case`fr`:return j(()=>import(`./fr-CWJvUBUH.js`),[],import.meta.url);case`hu-HU`:return j(()=>import(`./hu-HU-BQsRMa3N.js`),__vite__mapDeps([49,50]),import.meta.url);case`hu`:return j(()=>import(`./hu-DA3EH3LV.js`),[],import.meta.url);case`id-ID`:return j(()=>import(`./id-ID-D8wGo9tX.js`),__vite__mapDeps([51,52]),import.meta.url);case`id`:return j(()=>import(`./id-XoGAd2fw.js`),[],import.meta.url);case`it-IT`:return j(()=>import(`./it-IT-DIdc02_w.js`),__vite__mapDeps([53,54]),import.meta.url);case`it`:return j(()=>import(`./it-OaKIrP_W.js`),[],import.meta.url);case`nl-BE`:return j(()=>import(`./nl-BE-DW8-0cjD.js`),__vite__mapDeps([55,56]),import.meta.url);case`nl-NL`:return j(()=>import(`./nl-NL-BQ5mTUWd.js`),__vite__mapDeps([57,56]),import.meta.url);case`nl`:return j(()=>import(`./nl-Dt3UX_-l.js`),[],import.meta.url);case`pl-PL`:return j(()=>import(`./pl-PL-C72C17ts.js`),__vite__mapDeps([58,59]),import.meta.url);case`pl`:return j(()=>import(`./pl-Arghll_8.js`),[],import.meta.url);case`ro-RO`:return j(()=>import(`./ro-RO-CnZiywsg.js`),__vite__mapDeps([60,61]),import.meta.url);case`ro`:return j(()=>import(`./ro-SJ108zWB.js`),[],import.meta.url);case`ru-RU`:return j(()=>import(`./ru-RU-CooP5rXl.js`),__vite__mapDeps([62,63]),import.meta.url);case`ru`:return j(()=>import(`./ru-D7AwbwCR.js`),[],import.meta.url);case`sk-SK`:return j(()=>import(`./sk-SK-TxNQoZlM.js`),__vite__mapDeps([64,65]),import.meta.url);case`sk`:return j(()=>import(`./sk-uNz6XVsN.js`),[],import.meta.url);case`uk-UA`:return j(()=>import(`./uk-UA-r70QGUUk.js`),__vite__mapDeps([66,67]),import.meta.url);case`uk`:return j(()=>import(`./uk-BG8Mmvma.js`),[],import.meta.url);case`zh-CN`:case`zh`:return j(()=>import(`./zh-B6RupHE5.js`),[],import.meta.url);default:return j(()=>import(`./en-Ied68Ew1.js`),[],import.meta.url)}},Ou=class extends Fl(Vl(h)){static get scopedElements(){return{...super.scopedElements,"lion-validation-feedback":Ql}}static get properties(){return{fileList:{type:Array},multiple:{type:Boolean}}}static localizeNamespaces=[{"lion-input-file":Du},...super.localizeNamespaces];constructor(){super(),this.fileList=[],this.multiple=!1}updated(e){super.updated(e),e.has(`fileList`)&&this._enhanceLightDomA11y()}_enhanceLightDomA11y(){let e=this.shadowRoot?.querySelectorAll(`[id^="file-feedback"]`),t=this.parentNode?.parentNode;e?.forEach(e=>{t?.addEventListener(`focusin`,()=>{e.setAttribute(`aria-live`,`polite`)}),t?.addEventListener(`focusout`,()=>{e.setAttribute(`aria-live`,`assertive`)})})}_removeFile(e){this.dispatchEvent(new CustomEvent(`file-remove-requested`,{detail:{removedFile:e,status:e.status,uploadResponse:e.response}}))}_validationFeedbackTemplate(e,t){return l`
    ...
    `}_removeButtonContentTemplate(){return l`✖️`}_selectedListItemTemplate(e){let t=gs();return l`
    ...
    `}render(){return this.fileList?.length?l`
      ...
      `]}};function ku(e,t=2){if(!+e)return`0 Bytes`;let n=1024,r=t<0?0:t,i=[` bytes`,`KB`,`MB`,`GB`,`TB`,`PB`,`EB`,`ZB`,`YB`],a=Math.floor(Math.log(e)/Math.log(n));return`${parseFloat((e/n**a).toFixed(r))}${i[a]}`}var Au=class extends Vl(Fl(au)){static get scopedElements(){return{...super.scopedElements,"lion-selected-file-list":Ou}}static get properties(){return{accept:{type:String},multiple:{type:Boolean,reflect:!0},buttonLabel:{type:String,attribute:`button-label`},maxFileSize:{type:Number,attribute:`max-file-size`},enableDropZone:{type:Boolean,attribute:`enable-drop-zone`},uploadOnSelect:{type:Boolean,attribute:`upload-on-select`},isDragging:{type:Boolean,attribute:`is-dragging`,reflect:!0},uploadResponse:{type:Array,state:!1},_selectedFilesMetaData:{type:Array,state:!0}}}static localizeNamespaces=[{"lion-input-file":Du},...super.localizeNamespaces];static get validationTypes(){return[`error`,`info`]}get slots(){return{...super.slots,input:()=>l`<input .value="${vu(this.getAttribute(`value`))}" />`,"file-select-button":()=>l`<button
          type="button"
    ...
    `}static get styles(){return[super.styles,d`
      ...
      `]}__openDialogOnBtnClick(e){e.preventDefault(),e.stopPropagation(),this._inputNode.click()}},ju=class extends Ou{static get styles(){return[...super.styles,d`
        ul {
          display: flex;
          flex-direction: column;
          gap: var(--c-spacing-sm);
    ...
    `}_removeButtonContentTemplate(){return l`<craft-icon name="x"></craft-icon>`}_listItemBeforeTemplate(e){return l`<img src="${e.downloadUrl}" alt="" class="preview-thumb" />`}},Mu=d`
  /* Add any craft-specific styles for input-file here */
  ::slotted([slot='selected-file-list']) {
    margin-block-start: var(--c-spacing-lg);
  }
`,Nu=class extends Au{static get styles(){return[...super.styles,qc,Mu]}get slots(){return{...super.slots,"file-select-button":()=>l`<craft-button
          type="button"
          id="select-button-${this._inputId}"
          @click="${this.__openDialogOnBtnClick}"
        >
          ${this.buttonLabel}
        </craft-button>`}}static get scopedElements(){return{...super.scopedElements,"lion-selected-file-list":ju}}};customElements.get(`craft-input-file`)||customElements.define(`craft-input-file`,Nu);var Pu=class extends hu{static get styles(){return[...super.styles,qc,d`
        .input-group__container {
          position: relative;
        }
    ...
    `,this.type=`password`}get slots(){return{...super.slots,suffix:()=>({template:this.renderSuffix()})}}};s([_()],Pu.prototype,`_visible`,void 0),customElements.get(`craft-input-password`)||customElements.define(`craft-input-password`,Pu);var Fu=d`
  :host {
    display: contents;
  }
...
`,Iu=class extends h{constructor(...e){super(...e),this.size=``,this.variant=``,this.icon=null}renderPrefix(){return l`<div class="cp-chip__prefix" part="prefix">
      <slot name="prefix">
        <slot name="icon">
          ${this.icon?l`<craft-icon name="${this.icon}"></craft-icon>`:m}
        </slot>
    ...
    `}};Iu.styles=[Fu],s([g()],Iu.prototype,`size`,void 0),s([g()],Iu.prototype,`variant`,void 0),s([g()],Iu.prototype,`icon`,void 0),customElements.get(`craft-chip`)||customElements.define(`craft-chip`,Iu);var Lu=d`
  :host {
    display: inline-flex;
...
`,Ru=class extends h{constructor(...e){super(...e),this.label=null,this.status=null}getLabel(){return!this.label&&this.status?`Status: ${this.status}`:this.label}render(){return l`
      <span
...
`,td=class extends $u{constructor(...e){super(...e),this.monospace=!1}static get styles(){return[...super.styles,qc,ed]}};s([g({type:Boolean,reflect:!0})],td.prototype,`monospace`,void 0),customElements.get(`craft-textarea`)||customElements.define(`craft-textarea`,td);var nd=d`
  :host {
    display: flex;
...
`,Vd=class extends h{render(){return l`<slot></slot> `}};Vd.styles=[Bd],customElements.get(`craft-tab`)||customElements.define(`craft-tab`,Vd);var Hd=class extends us(h){static get properties(){return{checked:{type:Boolean,reflect:!0}}}static get styles(){return[d`
        :host {
          display: inline-block;
          position: relative;
          width: 36px;
...
`,Kd=class extends Ud{constructor(...e){super(...e),this.size=`medium`}static get styles(){return[...super.styles,Kc,Gd]}get slots(){return{...super.slots,input:()=>{let e=this.createScopedElement(`craft-switch-button`);return e.setAttribute(`size`,this.size),e.setAttribute(`data-tag-name`,`craft-switch-button`),e}}}static get scopedElements(){return{...super.scopedElements,"craft-switch-button":Wd}}};s([g({type:String,reflect:!0})],Kd.prototype,`size`,void 0),customElements.get(`craft-switch`)||customElements.define(`craft-switch`,Kd);var qd=d`
  .breadcrumbs {
    display: flex;
    align-items: center;
  }
...
`,Pf=class extends Af(h){constructor(...e){super(...e),this.placement=`bottom-start`,this.matchInvokerWidth=!1}_defineOverlayConfig(){return{...Mf(),inheritsReferenceWidth:this.matchInvokerWidth?`min`:`none`,popperConfig:{placement:this.placement,modifiers:[{name:`offset`,options:{offset:[0,4]}}]}}}get _overlayContentNode(){return this.shadowRoot?.querySelector(`.popover-pane`)}render(){return l`
...
`,Hf=class extends ki{constructor(){super(...arguments),this.localize=new Yr(this),this.hasSlotController=new wd(this,`footer`,`header-actions`,`label`),this.open=!1,this.label=``,this.placement=`end`,this.withoutHeader=!1,this.lightDismiss=!0,this.withFooter=!1,this.handleDocumentKeyDown=e=>{e.key===`Escape`&&this.open&&Xo(this)&&(e.preventDefault(),e.stopPropagation(),this.requestClose(this.drawer))}}firstUpdated(){this.open&&(this.addOpenListeners(),this.drawer.showModal(),Rf(this))}disconnectedCallback(){super.disconnectedCallback(),zf(this),this.removeOpenListeners()}async requestClose(e){let t=new Qo({source:e});if(this.dispatchEvent(t),t.defaultPrevented){this.open=!0,as(this.drawer,`pulse`);return}this.removeOpenListeners(),await as(this.drawer,`hide`),this.open=!1,this.drawer.close(),zf(this);let n=this.originalTrigger;typeof n?.focus==`function`&&setTimeout(()=>n.focus()),this.dispatchEvent(new $o)}addOpenListeners(){document.addEventListener(`keydown`,this.handleDocumentKeyDown),Jo(this)}removeOpenListeners(){document.removeEventListener(`keydown`,this.handleDocumentKeyDown),Yo(this)}handleDialogCancel(e){e.preventDefault(),!this.drawer.classList.contains(`hide`)&&e.target===this.drawer&&Xo(this)&&this.requestClose(this.drawer)}handleDialogClick(e){let t=e.target.closest(`[data-drawer="close"]`);t&&(e.stopPropagation(),this.requestClose(t))}async handleDialogPointerDown(e){e.target===this.drawer&&(this.lightDismiss?this.requestClose(this.drawer):await as(this.drawer,`pulse`))}handleOpenChange(){this.open&&!this.drawer.open?this.show():this.drawer.open&&(this.open=!0,this.requestClose(this.drawer))}async show(){let e=new Zo;if(this.dispatchEvent(e),e.defaultPrevented){this.open=!1;return}this.addOpenListeners(),this.originalTrigger=document.activeElement,this.open=!0,this.drawer.showModal(),Rf(this),requestAnimationFrame(()=>{let e=this.querySelector(`[autofocus]`);e&&typeof e.focus==`function`?e.focus():this.drawer.focus()}),await as(this.drawer,`show`),this.dispatchEvent(new es)}render(){let e=!this.withoutHeader,t=this.hasUpdated?this.hasSlotController.test(`footer`):this.withFooter;return l`
      <dialog
        part="dialog"
...
`,ip=class extends ki{constructor(){super(...arguments),this.localize=new Yr(this),this.hasSlotController=new wd(this,`footer`,`header-actions`,`label`),this.open=!1,this.label=``,this.withoutHeader=!1,this.lightDismiss=!1,this.withFooter=!1,this.handleDocumentKeyDown=e=>{e.key===`Escape`&&this.open&&Xo(this)&&(e.preventDefault(),e.stopPropagation(),this.requestClose(this.dialog))}}firstUpdated(){this.open&&(this.addOpenListeners(),this.dialog.showModal(),Rf(this))}disconnectedCallback(){super.disconnectedCallback(),zf(this),this.removeOpenListeners()}async requestClose(e){let t=new Qo({source:e});if(this.dispatchEvent(t),t.defaultPrevented){this.open=!0,as(this.dialog,`pulse`);return}this.removeOpenListeners(),await as(this.dialog,`hide`),this.open=!1,this.dialog.close(),zf(this);let n=this.originalTrigger;typeof n?.focus==`function`&&setTimeout(()=>n.focus()),this.dispatchEvent(new $o)}addOpenListeners(){document.addEventListener(`keydown`,this.handleDocumentKeyDown),Jo(this)}removeOpenListeners(){document.removeEventListener(`keydown`,this.handleDocumentKeyDown),Yo(this)}handleDialogCancel(e){e.preventDefault(),!this.dialog.classList.contains(`hide`)&&e.target===this.dialog&&Xo(this)&&this.requestClose(this.dialog)}handleDialogClick(e){let t=e.target.closest(`[data-dialog="close"]`);t&&(e.stopPropagation(),this.requestClose(t))}async handleDialogPointerDown(e){e.target===this.dialog&&(this.lightDismiss?this.requestClose(this.dialog):await as(this.dialog,`pulse`))}handleOpenChange(){this.open&&!this.dialog.open?this.show():!this.open&&this.dialog.open&&(this.open=!0,this.requestClose(this.dialog))}async show(){let e=new Zo;if(this.dispatchEvent(e),e.defaultPrevented){this.open=!1;return}this.addOpenListeners(),this.originalTrigger=document.activeElement,this.open=!0,this.dialog.showModal(),Rf(this),requestAnimationFrame(()=>{let e=this.querySelector(`[autofocus]`);e&&typeof e.focus==`function`?e.focus():this.dialog.focus()}),await as(this.dialog,`show`),this.dispatchEvent(new es)}render(){let e=!this.withoutHeader,t=this.hasUpdated?this.hasSlotController.test(`footer`):this.withFooter;return l`
      <dialog
        part="dialog"
    ...
    `}};ip.css=rp,M([y(`.dialog`)],ip.prototype,`dialog`,2),M([g({type:Boolean,reflect:!0})],ip.prototype,`open`,2),M([g({reflect:!0})],ip.prototype,`label`,2),M([g({attribute:`without-header`,type:Boolean,reflect:!0})],ip.prototype,`withoutHeader`,2),M([g({attribute:`light-dismiss`,type:Boolean})],ip.prototype,`lightDismiss`,2),M([g({attribute:`with-footer`,type:Boolean})],ip.prototype,`withFooter`,2),M([Ei(`open`,{waitUntilFirstUpdate:!0})],ip.prototype,`handleOpenChange`,1),ip=M([v(`wa-dialog`)],ip),document.addEventListener(`click`,e=>{let t=e.target.closest(`[data-dialog]`);if(t instanceof Element){let[e,n]=Bf(t.getAttribute(`data-dialog`)||``);if(e===`open`&&n?.length){let e=t.getRootNode().getElementById(n);e?.localName===`wa-dialog`?e.open=!0:console.warn(`A dialog with an ID of "${n}" could not be found in this document.`)}}}),document.addEventListener(`pointerdown`,()=>{});var ap=class extends ip{static get styles(){return[ip.styles,d`
      ...
      `]}};customElements.get(`craft-dialog`)||customElements.define(`craft-dialog`,ap);var op=class extends uu(mu(h)){constructor(){super(),this.multipleChoice=!0}},sp=class extends fu(hu){connectedCallback(){super.connectedCallback(),this.type=`checkbox`}},cp=class extends sp{static get styles(){return[...super.styles||[],d`
...
`,J=class extends h{constructor(...e){super(...e),this.icon=null,this.href=null,this.disabled=!1,this.variant=zu.Neutral,this.checked=!1,this.active=!1,this.type=`button`,this.action=null,this.feedback=null,this.feedbackDuration=1e3,this.confirm=null,this.state=S.Idle,this.feedbackMessage=null,this.shortcut=null}renderShortcut(){return typeof this.shortcut==`string`?l`<craft-shortcut>${this.shortcut}</craft-shortcut>`:this.shortcut===null?m:l`<craft-shortcut
    ...
    `],s([b({slot:`content`})],_p.prototype,`contentNodes`,void 0),customElements.get(`craft-action-menu`)||customElements.define(`craft-action-menu`,_p);var vp=new WeakMap;function yp(e,t){Array.from(e.childNodes).forEach(n=>{if(n.nodeName===`#text`){let r=RegExp(`^(.*?)(${t})(.*)$`,`i`),i=n.nodeValue.match(r);if(i){let t=document.createTextNode(i[1]);e.appendChild(t);let r=document.createElement(`b`);r.textContent=i[2],e.appendChild(r);let a=document.createTextNode(i[3]);e.appendChild(a),e.removeChild(n),vp.set(e,()=>{e.appendChild(n),e.contains(t)&&t.parentNode!==null&&t.parentNode.removeChild(t),e.contains(r)&&r.parentNode!==null&&r.parentNode.removeChild(r),e.contains(a)&&a.parentNode!==null&&a.parentNode.removeChild(a)})}}else yp(n,t)})}function bp(e){vp.has(e)&&vp.get(e)(),Array.from(e.childNodes).forEach(e=>{e.nodeName===`#text`?vp.has(e)&&vp.get(e)():bp(e)})}var xp=class extends $l{static get validatorName(){return`MatchesOption`}execute(e,t,n){return n?.node.modelValue instanceof Wl}};function Sp(e){return Array.isArray(e)?e:[e]}var wp=I(e=>class extends uu(e){static get properties(){return{allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},modelValue:{type:Object}}}get modelValue(){return this.__getChoicesFrom(super.modelValue)}set modelValue(e){if(super.modelValue=e,e==null||e===``)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Sp(e)),this.requestUpdate(`modelValue`,t)}}get formattedValue(){return this.__getChoicesFrom(super.formattedValue)}set formattedValue(e){if(super.formattedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Sp(e).map(e=>this.formElements.find(t=>t.formattedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get serializedValue(){return this.__getChoicesFrom(super.serializedValue)}set serializedValue(e){if(super.serializedValue=e,e==null)this._customChoices=new Set;else if(this.allowCustomChoice){let t=this.modelValue;this._customChoices=new Set(Sp(e).map(e=>this.formElements.find(t=>t.serializedValue===e)?.modelValue||e)),this.requestUpdate(`modelValue`,t)}}get customChoices(){if(!this.allowCustomChoice)return[];let e=this._getCheckedElements();return Array.from(this._customChoices).filter(t=>!e.some(e=>e.choiceValue===t))}constructor(){super(),this.allowCustomChoice=!1,this._customChoices=new Set}__getChoicesFrom(e){let t=e;return this.allowCustomChoice?this.multipleChoice?[...Sp(t),...this.customChoices]:t===``?this._customChoices.values().next().value||``:t:t}_isEmpty(){return super._isEmpty()&&this._customChoices.size===0}clear(){this._customChoices=new Set,super.clear()}parser(e){return this.allowCustomChoice&&Array.isArray(e)?e.filter(e=>e.trim()!==``):e}}),Tp=new WeakMap,Ep=class extends Fl(Af(wp(od))){static get properties(){return{autocomplete:{type:String,reflect:!0},matchMode:{type:String,attribute:`match-mode`},showAllOnEmpty:{type:Boolean,attribute:`show-all-on-empty`},requireOptionMatch:{type:Boolean},allowCustomChoice:{type:Boolean,attribute:`allow-custom-choice`},__shouldAutocompleteNextUpdate:Boolean}}static get styles(){return[...super.styles,d`
      ...
      `]}static get localizeNamespaces(){return[{"lion-combobox":e=>{switch(e){case`bg-BG`:case`bg`:return j(()=>import(`./bg-GgaKLP2g.js`),[],import.meta.url);case`cs-CZ`:case`cs`:return j(()=>import(`./cs-Dl4t3cIA.js`),[],import.meta.url);case`de-AT`:case`de-DE`:case`de`:return j(()=>import(`./de-CeT-e9nb.js`),[],import.meta.url);case`en-AU`:case`en-GB`:case`en-PH`:case`en-US`:case`en`:return j(()=>import(`./en-lC2HMZ8a.js`),[],import.meta.url);case`es-ES`:case`es`:return j(()=>import(`./es-DHq7X5nb.js`),[],import.meta.url);case`fr-FR`:case`fr-BE`:case`fr`:return j(()=>import(`./fr-Bm7HRYdU.js`),[],import.meta.url);case`hu-HU`:case`hu`:return j(()=>import(`./hu-DQ3Ip0Fv.js`),[],import.meta.url);case`it-IT`:case`it`:return j(()=>import(`./it-D2kSdSsw.js`),[],import.meta.url);case`nl-BE`:case`nl-NL`:case`nl`:return j(()=>import(`./nl-CmvuYrRd.js`),[],import.meta.url);case`pl-PL`:case`pl`:return j(()=>import(`./pl-D3RjjIae.js`),[],import.meta.url);case`ro-RO`:case`ro`:return j(()=>import(`./ro-C4zGmueB.js`),[],import.meta.url);case`ru-RU`:case`ru`:return j(()=>import(`./ru-DX5bbOaW.js`),[],import.meta.url);case`sk-SK`:case`sk`:return j(()=>import(`./sk-C5VxeJ8x.js`),[],import.meta.url);case`uk-UA`:case`uk`:return j(()=>import(`./uk-CGl_0hvu.js`),[],import.meta.url);case`zh-CN`:case`zh`:return j(()=>import(`./zh-DcViyFPC.js`),[],import.meta.url);default:return j(()=>import(`./en-lC2HMZ8a.js`),[],import.meta.url)}}},...super.localizeNamespaces]}get modelValue(){let e=super.modelValue;return e===``?this.parser(this.value):e}set modelValue(e){super.modelValue=e}get value(){return this._inputNode?.value||this.__value||``}set value(e){this._inputNode?(this._inputNode.value=e,this.__value=void 0):this.__value=e}reset(){super.reset(),this.multipleChoice||(this.value=this._initialModelValue),this._resetListboxOptions()}_resetListboxOptions(){this.formElements.forEach((e,t)=>{this._unhighlightMatchedOption(e),!this.showAllOnEmpty||!this.opened?e.style.display=`none`:(e.style.display=``,e.setAttribute(`aria-posinset`,`${t+1}`),e.setAttribute(`aria-setsize`,`${this.formElements.length}`),e.removeAttribute(`aria-hidden`))})}_inputGroupInputTemplate(){return l`
      <div class="input-group__input">
...
`,Op=class extends Ep{static get styles(){return[...super.styles,Dp]}constructor(){super(),this.defaultValidators=[]}_inputGroupInputTemplate(){return l`
    ...
    `}parser(e){return e===``?super.parser(e):e}_getTextboxValueFromOption(e){return e?e.textContent?.trim()||``:super._getTextboxValueFromOption(e)}};customElements.get(`craft-combobox`)||customElements.define(`craft-combobox`,Op);var kp=class extends ps(ys){static get styles(){return[...super.styles,d`
        :host {
          justify-content: space-between;
          align-items: center;
        }
...
`,nm=new WeakMap,rm=class extends h{constructor(...e){super(...e),this.progress=0,this.total=0,this.processed=0,this.showStatus=!1,this.pending=!1,this.smooth=!1,this.label=`Progress`,w(this,nm,0)}updated(e){if((e.has(`total`)||e.has(`processed`))&&this.total>0){let e=Math.min(100,Math.round(this.processed/this.total*100));e>=100&&D(nm,this)<100&&this.dispatchEvent(new CustomEvent(`complete`,{bubbles:!0,composed:!0})),this.progress=e}e.has(`progress`)&&(this.progress>0&&this.pending&&(this.pending=!1),E(nm,this,this.progress))}get progressPercent(){return Math.min(100,Math.max(0,this.progress))}get statusText(){return this.total>0?`${this.processed} / ${this.total}`:`${this.progressPercent}%`}reset(){this.progress=0,this.processed=0,this.pending=!0,E(nm,this,0)}show(){this.hidden=!1}hide(){this.hidden=!0}render(){let e={width:this.pending?`100%`:`${this.progressPercent}%`};return l`
    ...
    `}};rm.styles=[tm],s([g({type:Number})],rm.prototype,`progress`,void 0),s([g({type:Number})],rm.prototype,`total`,void 0),s([g({type:Number})],rm.prototype,`processed`,void 0),s([g({type:Boolean,attribute:`show-status`})],rm.prototype,`showStatus`,void 0),s([g({type:Boolean,reflect:!0})],rm.prototype,`pending`,void 0),s([g({type:Boolean})],rm.prototype,`smooth`,void 0),s([g({type:String})],rm.prototype,`label`,void 0),customElements.get(`craft-progress-bar`)||customElements.define(`craft-progress-bar`,rm);var im=class extends uu(mu(h)){connectedCallback(){super.connectedCallback(),this.setAttribute(`role`,`radiogroup`)}resetGroup(){let e;this.formElements.forEach(t=>{typeof t.resetGroup==`function`?t.resetGroup():typeof t.reset==`function`&&(t.reset(),t.checked&&(e=t.choiceValue))}),this.modelValue=e,this.resetInteractionState()}},am=class extends fu(hu){connectedCallback(){super.connectedCallback(),this.type=`radio`}},om=class extends im{static get styles(){return[...super.styles,qc,d`
        .input-group {
          display: grid;
          gap: var(--c-spacing-xs);
        }

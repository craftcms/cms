...
`,qs=class extends v{constructor(...e){super(...e),this.size=``,this.variant=``,this.icon=null}renderPrefix(){return d`<div class="cp-chip__prefix" part="prefix">
      <slot name="prefix">
      ...
      >
        ...
        ${t?d`<div class="cp-chip__suffix" part="suffix">
              <slot name="suffix"></slot>
            </div>`:_}
      </div>

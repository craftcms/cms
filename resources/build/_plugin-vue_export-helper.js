...
`,Js=class extends v{constructor(...e){super(...e),this.size=``,this.variant=``,this.icon=null}renderPrefix(){return d`<div class="cp-chip__prefix" part="prefix">
      <slot name="prefix">
        <slot name="icon">
          ${this.icon?d`<craft-icon name="${this.icon}"></craft-icon>`:_}
        </slot>
      </slot>
    </div>`}render(){let e=!!this.querySelector(`[slot="prefix"]`)||!!this.querySelector(`[slot="icon"]`)||this.icon,t=!!this.querySelector(`[slot="suffix"]`);return d`
      <div
        part="chip"

...
`,n=class extends g{constructor(){super(),this.active=!1,this.external=!1,this.indicator=!1,this.iconOnly=!1,this.subnavState="closed",this.id=this.id||Math.random().toString(36).substring(2,6)}connectedCallback(){super.connectedCallback(),this.subnavState=this.active?"open":"closed"}toggleSubnav(t){t.preventDefault(),t.stopPropagation(),this.subnavState=this.subnavState==="open"?"closed":"open"}renderIconItem(t){let i=`item-${this.id}`;return a`
    ...
    `}};n.styles=S,o([c()],n.prototype,"icon",void 0),o([c()],n.prototype,"url",void 0),o([c({type:Boolean,reflect:!0})],n.prototype,"active",void 0),o([c({type:Boolean})],n.prototype,"external",void 0),o([c({type:Boolean})],n.prototype,"indicator",void 0),o([c()],n.prototype,"id",void 0),o([c({reflect:!0,type:Boolean,attribute:"icon-only"})],n.prototype,"iconOnly",void 0),o([f()],n.prototype,"subnavState",void 0),customElements.get("craft-nav-item")||customElements.define("craft-nav-item",n);const C=Object.freeze(Object.defineProperty({__proto__:null,default:n},Symbol.toStringTag,{value:"Module"}));export{h as a,y as e,m as i,C as n,p as t};

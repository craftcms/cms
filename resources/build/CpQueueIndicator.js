import{e as k,n as c,f as M,Q as x,g as E,E as _,x as g,J as C,h as I}from"./cp3.js";var O=Object.defineProperty,S=Object.getOwnPropertyDescriptor,Q=e=>{throw TypeError(e)},l=(e,s,t,d)=>{for(var n=d>1?void 0:d?S(s,t):s,b=e.length-1,f;b>=0;b--)(f=e[b])&&(n=(d?f(s,t,n):f(n))||n);return d&&n&&O(s,t,n),n},W=(e,s,t)=>s.has(e)||Q("Cannot "+t),a=(e,s,t)=>(W(e,s,"read from private field"),t?t.call(e):s.get(e)),p=(e,s,t)=>s.has(e)?Q("Cannot add the same private member more than once"):s instanceof WeakSet?s.add(e):s.set(e,t),h=(e,s,t)=>(W(e,s,"access private method"),t),r,J,u,i,v,y,$,w,m;let o=class extends M{constructor(){super(...arguments),p(this,i),this.enabled=!0,this.displayedJob=null,this.hasReservedJobs=!1,this.hasWaitingJobs=!1,p(this,r,x.getInstance()),p(this,J,E.getInstance()),p(this,u,e=>{this.displayedJob=e.detail.displayedJob})}connectedCallback(){super.connectedCallback(),this.displayedJob||(this.displayedJob=a(this,r).displayedJob),a(this,r).addEventListener("job-update",a(this,u)),h(this,i,y).call(this),h(this,i,v).call(this)}disconnectedCallback(){super.disconnectedCallback(),a(this,r).removeEventListener("job-update",a(this,u))}update(e){super.update(e),(e.has("hasReservedJobs")||e.has("hasWaitingJobs"))&&h(this,i,v).call(this),e.has("displayedJob")&&h(this,i,y).call(this)}render(){if(!this.displayedJob)return _;const e=a(this,i,m);return g`
  ...
  `;l([c({type:Boolean})],o.prototype,"enabled",2);l([c({type:Object,attribute:"displayed-job"})],o.prototype,"displayedJob",2);l([c({type:Boolean,attribute:"has-reserved-jobs"})],o.prototype,"hasReservedJobs",2);l([c({type:Boolean,attribute:"has-waiting-jobs"})],o.prototype,"hasWaitingJobs",2);o=l([I("cp-queue-indicator")],o);const q=o;export{q as default};

...
`,I=class extends a{constructor(){super(),this.altText=null,this.badgeCount=null,this.badgeCountSuffix=null,this.variant=`primary`,this.id=this.id||`badge-${Math.floor(Math.random()*1e9).toString()}`}showCount(){return this.badgeCount!==null&&this.badgeCount>0}truncatedNumber(){if(this.showCount)return this.badgeCount>99?`99+`:this.badgeCount.toString()}getBadgeRole(){return this.altText?`img`:i}getLabelId(){return`${this.id}-label`}renderBadgeContents(){return t`
    ...
    `}};I.styles=[F],e([o()],I.prototype,`altText`,void 0),e([o()],I.prototype,`badgeCount`,void 0),e([o()],I.prototype,`badgeCountSuffix`,void 0),e([o()],I.prototype,`variant`,void 0),e([o()],I.prototype,`id`,void 0),customElements.get(`craft-badge-indicator`)||customElements.define(`craft-badge-indicator`,I);var L=`important`,R=` !`+L,z=l(class extends u{constructor(e){if(super(e),e.type!==c.ATTRIBUTE||e.name!==`style`||e.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(e){return Object.keys(e).reduce(((t,n)=>{let r=e[n];return r==null?t:t+`${n=n.includes(`-`)?n:n.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,`-$&`).toLowerCase()}:${r};`}),``)}update(e,[t]){let{style:n}=e.element;if(this.ft===void 0)return this.ft=new Set(Object.keys(t)),this.render(t);for(let e of this.ft)t[e]??(this.ft.delete(e),e.includes(`-`)?n.removeProperty(e):n[e]=null);for(let e in t){let r=t[e];if(r!=null){this.ft.add(e);let t=typeof r==`string`&&r.endsWith(R);e.includes(`-`)||t?n.setProperty(e,t?r.slice(0,-11):r,t?L:``):n[e]=r}}return r}}),B=n`
  :host {

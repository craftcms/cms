...
describe('isInteractiveElement', () => {
    it('is true for focusable elements', () => {
        ...
        expect(isInteractiveElement(document.createElement('button'))).toBe(
            true
        );
        expect(isInteractiveElement(document.createElement('input'))).toBe(
            true
        );
    ...
    it('is false for passive content and non-elements', () => {
        expect(isInteractiveElement(document.createElement('span'))).toBe(
            false
        );
...
describe('isInteractiveClick', () => {
    ...
    it('is true when a focusable control is anywhere on the path', () => {
        ...
        expect(
            isInteractiveClick(event(document.createElement('button')))
        ).toBe(true);

<script setup lang="ts">
  ...
  import PluginLinks from '@/components/Plugins/PluginLinks.vue';
  import PluginLicenseIssues from '@/components/Plugins/PluginLicenseIssues.vue';
  import PluginLicenseInput from '@/components/Plugins/PluginLicenseInput.vue';

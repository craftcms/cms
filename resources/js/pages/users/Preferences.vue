                ...
                <section class="grid gap-3">
                    ...
                    <craft-field-group>
                        <CraftCombobox
                            ...
                            :help-text="
                                t(
                                    'The language that the control panel should use.'
                                )
                            "
                        ...
                        <craft-field-group>
                            ...
                            <craft-button-group role="group">
                                <craft-button
                                    ...
                                    :title="option.label"
                                    @click="
                                        form.notificationPosition = option.value
                                    "
                                >
                                    <craft-icon
                                        :name="option.icon"
                            ...
                            <ul
                                class="error-list"
                                v-if="form.errors.notificationPosition"
                            >
                        ...
                        <craft-field-group>
                            ...
                            <craft-button-group role="group">
                                <craft-button
                                    ...
                                    variant="outline"
                                    :active="
                                        form.slideoutPosition === option.value
                                            ? 'true'
                                            : null
                                    "
                                    :aria-pressed="
                            ...
                            <ul
                                class="error-list"
                                v-if="form.errors.slideoutPosition"
                            >

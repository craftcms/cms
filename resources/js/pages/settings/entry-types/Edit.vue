<script setup lang="ts">
    ...
    const form = useForm({
        ...
        titleTranslationKeyFormat:
            props.entryType.titleTranslationKeyFormat ?? '',
        ...
        slugTranslationKeyFormat:
            props.entryType.slugTranslationKeyFormat ?? '',
        ...
        const formActionItems = computed(() => {
            ...
            if (!props.brandNew) {
                actions.unshift({
                    ...
                    onClick: () =>
                        save({data: {saveAsNew: true}, preserveState: false}),
                });
            }
        ...
        <Pane appearance="raised" class="col-span-3">
            <craft-field-group>
                ...
                <CraftInput
                    ...
                    :help-text="
                        t(
                            'What this {type} will be called in the control panel.',
                            {
                                type: lowerTypeName,
                            }
                        )
                ...
                <CraftInput
                    ...
                    :help-text="
                        t(
                            'The format that {type} titles should take when generated.',
                            {
                                type: lowerTypeName,
                            }
                        )

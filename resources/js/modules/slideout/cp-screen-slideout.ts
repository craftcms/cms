    ...
    update(data: any): Promise<void> {
        return new Promise((resolve) => {
            ...
            requestAnimationFrame(async () => {
                ...
                if (data.inertiaPage) {
                    const inertiaPage = await resolveInertiaPage(
                        data.inertiaPage
                    );
                    ...
                    this.inertiaApp.config.compilerOptions.isCustomElement = (
                        tag
                    ) => tag.includes('-');

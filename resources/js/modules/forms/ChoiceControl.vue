    ...
    >
        ...
        <input
            v-for="option in control.props.multiple
                ? control.props.options.filter((option) =>
        ...
        <craft-button
            ...
            :aria-label="
                option.icon || option.labelHtml ? option.label : undefined
            "
        ...
        >
           ...
           itself, and only stays square while its light DOM is empty. -->
            <span
                v-if="!option.icon && option.labelHtml"
            ...
            >
                ...
                >
                    <input
                        ...
                        :disabled="!editable || option.disabled"
                        :required="
                            editable && required && !control.props.multiple
                        "
                        :aria-invalid="invalid ? 'true' : undefined"

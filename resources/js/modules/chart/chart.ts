...
export class BaseChart extends Base {
    ...
    init(container: any, settings?: any): void {
        ...
        const globalSettings = {
            ...
            timeFormatLocaleDefinition: (window as any)
    ...
    draw(dataTable: any, settings?: any): void {
        ...
        this.formatLocale = d3.formatLocale(
            this.settings.formatLocaleDefinition
        );
        ...
        this.$chart = $(`<div class="${className}" />`).appendTo(
            this.$container
        );
    }
...
export class Area extends BaseChart {
    ...
    override draw(dataTable: any, settings?: any): void {
        ...
        this.drawingArea = this.svg
            ...
            .attr(
                'transform',
                `translate(${svg.translateX},${svg.translateY})`
            );
        ...
        if (this.settings.yAxis.showAxis) {
            ...
            if (this.orientation === 'rtl') {
                ...
                this.drawingArea
                    ...
                    .attr(
                        'transform',
                        `translate(${this.width - chartPadding}, 0)`
                    )
                    .call(yAxis);
            } else {
        ...
        this.drawingArea
            ...
            .on('mouseover', (event: any, dataValue: any) => {
                ...
                if (this.orientation !== 'rtl') {
                    ...
                    if (calcLeft > maxLeft) {
                        left =
                            x(dataValue[0]) - (this.tip.$tip.width() + offset);
                    }
                } else {
                    left =
                        x(dataValue[0]) -
    ...
    getXFormatter(): any {
        ...
        return chartsUtils.getTimeFormatter(
...
export const chartsUtils = {
    ...
    getNumberFormatter(formatLocale: any, type: any, chartSettings: any): any {
        switch (type) {
            case 'currency':
                return formatLocale.format(
                    chartSettings.formats.currencyFormat
                );

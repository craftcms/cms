...
<template>
    <ul
        :class="
            inline ? 'element-chips element-chips--inline' : 'element-chips'
        "
    >
        <li
        ...
        -->
                ...
                <div slot="suffix" class="flex gap-0.5 items-center">
                    ...
                    <span
                        v-if="sortable"
                        :ref="
                            (el) => setHandleRef(el as HTMLElement, element.id)
                        "
                        class="drag-handle"
                    >

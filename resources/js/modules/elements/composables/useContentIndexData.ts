...
>(extra?: Extra) {
    ...
    return reactive({
        ...
        elementDisplayName: computed(
            () => inertiaPage.props.elementDisplayName
        ),
        ...
        selectedSubnavItem: computed(
            () => inertiaPage.props.selectedSubnavItem
        ),
        ...
        defaultTableColumns: computed(
            () => inertiaPage.props.defaultTableColumns
        ),

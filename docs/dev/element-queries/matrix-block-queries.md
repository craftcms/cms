...
:   [$ownerId](api:craft\elements\db\MatrixBlockQuery::$ownerId)
...
:   [$ownerSiteId](api:craft\elements\db\MatrixBlockQuery::$ownerSiteId)
...
:   [$typeId](api:craft\elements\db\MatrixBlockQuery::$typeId)

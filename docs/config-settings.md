...
This array is merged into the default mapping array in [StringHelper::getAsciiCharMap()](http://buildwithcraft.com/classreference/helpers/StringHelper#getAsciiCharMap-detail).
